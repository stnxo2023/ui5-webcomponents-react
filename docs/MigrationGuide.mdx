...
For a full list of all changes, please refer to [the list of releases](https://github.com/UI5/webcomponents-react/releases)
...
> For migration guides for older releases, please refer to our [Migration Guide Archive](https://github.com/UI5/webcomponents-react/blob/main/docs/MigrationGuide.archive.md).
...
If you encounter any issues migrating to the `BusyIndicator`, please feel free to reach out via [GitHub Discussions](https://github.com/UI5/webcomponents-react/discussions) or create an [Issue](https://github.com/UI5/webcomponents-react/issues/new/choose) if the behavior seems like a bug.
...
- `hyphenated` and `emptyIndicator`
  These props are currently not supported by the new `ui5-text` component. You can follow this [feature request](https://github.com/UI5/webcomponents/issues/9244) for updates.
...
You can follow this [feature request](https://github.com/UI5/webcomponents/issues/9244) for updates.
