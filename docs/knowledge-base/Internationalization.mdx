...
_Please also read the [general configuration](https://ui5.github.io/webcomponents/docs/advanced/configuration/) and [i18n documentation](https://ui5.github.io/webcomponents/docs/advanced/using-i18n-for-apps/) of UI5 Web Components._
...
<MessageStrip
  ...
  children={
    <>
      ...
      <a
        href="https://ui5.github.io/webcomponents/docs/advanced/configuration/#fetchDefaultLanguage"
        target="_blank"
      >
        here
      </a>
