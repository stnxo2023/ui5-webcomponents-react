...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"footer",required:!1,type:{name:"UI5WCSlotsNode"}},allowTargetOverlap:{defaultValue:{value:"false"},description:`Determines if there is no enough space, the component can be placed
