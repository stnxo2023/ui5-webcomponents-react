...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},resizable:{defaultValue:{value:"false"},description:`Determines whether the component is resizable.
**Note:** This property is effective only on desktop devices.

**Note:** Available since [v2.19.0](https://github.com/UI5/webcomponents/releases/tag/v2.19.0) of **@ui5/webcomponents**.`,name:"resizable",required:!1,type:{name:"boolean"}},accessibleDescription:{defaultValue:{value:"undefined"},description:`Defines the accessible description of the component.
