import{n as l,aI as $,aH as R,g as s,j as n,a3 as U,U as r,Q as N,eL as z,p as W,gi as V,eF as G,ah as g,gj as k,a0 as J,S as X,a1 as K,cB as Y,cm as Q}from"./iframe-D-ZP0dY4.js";import"./delete-DE6k9FGx.js";import{f as Z,g as ee}from"./utils-CIzQ8GjY.js";import{a as te}from"./addCustomCSSWithScoping-DSa3TmU8.js";var I=(e=>(e.ActionSheetBoxShadow="--_ui5wcr_ActionSheet_BoxShadow",e.ActionSheetHeaderBoxShadow="--_ui5wcr_ActionSheet_HeaderBoxShadow",e.ActionSheetMobileHeaderBackground="--_ui5wcr_ActionSheet_MobileHeaderBackground",e.ActionSheetMobileHeaderBorderRadius="--_ui5wcr_ActionSheet_MobileHeaderBorderRadius",e.ActionSheetMobileHeaderBoxShadow="--_ui5wcr_ActionSheet_MobileHeaderBoxShadow",e.ActionSheetMobileHeaderTextColor="--_ui5wcr_ActionSheet_MobileHeaderTextColor",e.ActionSheetTopBorderRadius="--_ui5wcr_ActionSheet_TopBorderRadius",e.AnalyticalTableHeaderActiveTextColor="--_ui5wcr-AnalyticalTable-HeaderActiveTextColor",e.AnalyticalTableHeaderBorderWidth="--_ui5wcr-AnalyticalTable-HeaderBorderWidth",e.AnalyticalTableHeaderFontFamily="--_ui5wcr-AnalyticalTable-HeaderFontFamily",e.AnalyticalTableOuterBorderBlock="--_ui5wcr-AnalyticalTable-OuterBorderBlock",e.AnalyticalTableOuterBorderInline="--_ui5wcr-AnalyticalTable-OuterBorderInline",e.AnalyticalTableOuterCellBorder="--_ui5wcr-AnalyticalTable-OuterCellBorder",e.FormHeaderBorderWidth="--_ui5wcr_Form_HeaderBorderWidth",e.ObjectPageSectionBorderTop="--_ui5wcr_ObjectPage_SectionBorderTop",e.ObjectPageSectionTitleFontFamily="--_ui5wcr_ObjectPage_SectionTitleFontFamily",e.ObjectPageSectionTitleHeight="--_ui5wcr_ObjectPage_SectionTitleHeight",e.ObjectPageSectionTitleLineHeight="--_ui5wcr_ObjectPage_SectionTitleLineHeight",e.ObjectPageSectionTitleTextDecoration="--_ui5wcr_ObjectPage_SectionTitleTextDecoration",e.ObjectPageSubSectionBackgroundColor="--_ui5wcr_ObjectPage_SubSectionBackgroundColor",e.ObjectPageSubSectionBorderRadius="--_ui5wcr_ObjectPage_SubSectionBorderRadius",e.ObjectPageSubSectionPaddingBlockStart="--_ui5wcr_ObjectPage_PaddingBlockStart",e.SplitterBarBorderFix="--_ui5wcr_Splitter_BarBorderHighContrastFix",e.SplitterBarBorderFocus="--_ui5wcr_Splitter_BarBorderFocus",e.SplitterBarBorderStyle="--_ui5wcr_Splitter_BarBorderStyle",e.SplitterBarOutline="--_ui5wcr_Splitter_BarOutline",e.SplitterContentBorderColor="--_ui5wcr_Splitter_ContentBorderColor",e.SplitterIconColor="--_ui5wcr_Splitter_IconColor",e.ToolbarFocusOutline="--_ui5wcr_Toolbar_FocusOutline",e.ToolbarFocusShadow="--_ui5wcr_Toolbar_FocusShadow",e.ScrollbarBorder="--_ui5wcr_Scrollbar_Border",e.ScrollbarBorderRadius="--_ui5wcr_Scrollbar_BorderRadius",e))(I||{});const v=new Proxy(I,{get:(e,a)=>`var(${e[a]})`}),ne="@layer ui5-webcomponents-react{._actionSheet_189eg_1::part(content){padding:.1875rem .375rem}._actionSheet_189eg_1 [ui5-button]{display:block;margin:var(--_ui5wcr-ButtonTopBottomPadding)}._actionSheet_189eg_1 [ui5-button]:not([data-cancel-btn])::part(button){justify-content:flex-start}._actionSheet_189eg_1::part(header){background:#0000;box-shadow:var(--_ui5wcr_ActionSheet_HeaderBoxShadow)}._actionSheetMobile_189eg_20::part(content){padding:0!important}._contentMobile_189eg_25{background-color:var(--sapGroup_ContentBackground);border-top-left-radius:var(--_ui5wcr_ActionSheet_TopBorderRadius);border-top-right-radius:var(--_ui5wcr_ActionSheet_TopBorderRadius);box-shadow:var(--_ui5wcr_ActionSheet_BoxShadow);box-sizing:border-box;max-height:82vh;overflow:auto;padding:.25rem .5rem}._contentMobile_189eg_25>*{margin:.25rem 0}}",w={actionSheet:"_actionSheet_189eg_1",actionSheetMobile:"_actionSheetMobile_189eg_20",contentMobile:"_contentMobile_189eg_25"};s()&&te("ui5-responsive-popover",`
  ...
  `);function oe(e){const{index:a,totalLength:d,...c}=e,p=R("@ui5/webcomponents-react");return n.jsx(r,{accessibleName:`${c.children} ${p.getText(G,a+1,d)}`,...c,design:N.Transparent,"data-action-btn-index":a})}const u=l.forwardRef((e,a)=>{const{accessibilityAttributes:d,children:c,className:p,header:C,headerText:H,hideCancelButton:y,onOpen:A,open:B,...M}=e;$(ne,u.displayName);const T=R("@ui5/webcomponents-react"),i=l.useRef(null),[_,x]=l.useReducer((t,o)=>parseInt(o.target.dataset.actionBtnIndex),0),D=Z(c),q=D.length,h=s()&&!y?q+1:q,[P,S]=l.useState(void 0);l.useEffect(()=>{const t=ee("ui5-responsive-popover");customElements.whenDefined(t).then(()=>{S(B)})},[B]);const F=()=>{S(!1)},j=(t,o,f)=>n.jsx(oe,{index:o,totalLength:f.length,tabIndex:_===o?0:-1,...t.props,onClick:b=>{S(!1),typeof t.props?.onClick=="function"&&t.props?.onClick(b)},onFocus:b=>{typeof t.props?.onFocus=="function"&&t.props?.onFocus(b),x(b)}},o),E=t=>{s()&&i.current.querySelector(`[data-action-btn-index="${_}"]`).focus(),typeof A=="function"&&A(t)},L=t=>{const o=parseInt(t.target.dataset.actionBtnIndex),f=i.current?.matches(":dir(rtl)");switch(t.key){case"ArrowDown":case(f?"ArrowLeft":"ArrowRight"):o+1<h&&(t.preventDefault(),i.current.querySelector(`[data-action-btn-index="${o+1}"]`).focus());break;case"ArrowUp":case(f?"ArrowRight":"ArrowLeft"):o>0&&(t.preventDefault(),i.current.querySelector(`[data-action-btn-index="${o-1}"]`).focus());break;case"PageUp":t.preventDefault(),i.current.querySelector(`[data-action-btn-index="${Math.max(o-5,0)}"]`).focus();break;case"PageDown":t.preventDefault(),i.current.querySelector(`[data-action-btn-index="${Math.min(o+5,h-1)}"]`).focus();break;case"Home":t.preventDefault(),i.current.querySelector('[data-action-btn-index="0"]').focus();break;case"End":t.preventDefault(),i.current.querySelector(`[data-action-btn-index="${h-1}"]`).focus();break}},O=s();return n.jsx(U,{open:P,headerText:O?H:void 0,header:O?C:void 0,accessibleName:T.getText(V),...M,onOpen:E,ref:a,className:W(w.actionSheet,s()&&w.actionSheetMobile,p),"data-actionsheet":!0,children:n.jsxs("div",{className:s()?w.contentMobile:void 0,"data-component-name":"ActionSheetMobileContent",role:d?.actionSheetMobileContent?.role??"application",onKeyDown:L,ref:i,children:[D.map(j),s()&&!y&&n.jsx(r,{design:N.Negative,onClick:F,tabIndex:_===h-1?0:-1,"data-action-btn-index":h-1,"data-cancel-btn":!0,onFocus:x,children:T.getText(z)})]})})});u.displayName="ActionSheet";try{u.displayName="ActionSheet",u.__docgenInfo={description:`The \`ActionSheet\` holds a list of buttons from which the user can select to complete an action.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<ResponsivePopoverDomRef, never>) => void"}},placement:{defaultValue:{value:'"End"'},description:"Determines on which side the component is placed at.",name:"placement",required:!1,type:{name:"enum",value:[{value:'"Start"'},{value:'"End"'},{value:'"Top"'},{value:'"Bottom"'},{value:'"Start"'},{value:'"End"'},{value:'"Top"'},{value:'"Bottom"'}]}},accessibleRole:{defaultValue:{value:'"Dialog"'},description:`Allows setting a custom role.
...
over the target.`,name:"allowTargetOverlap",required:!1,type:{name:"boolean"}},hideArrow:{defaultValue:{value:"false"},description:"Determines whether the component arrow is hidden.",name:"hideArrow",required:!1,type:{name:"boolean"}},horizontalAlign:{defaultValue:{value:'"Center"'},description:"Determines the horizontal alignment of the component.",name:"horizontalAlign",required:!1,type:{name:"enum",value:[{value:'"Start"'},{value:'"End"'},{value:'"Center"'},{value:'"Stretch"'},{value:'"Center"'},{value:'"Start"'},{value:'"End"'},{value:'"Stretch"'}]}},initialFocus:{defaultValue:{value:"undefined"},description:"Defines the ID of the HTML Element, which will get the initial focus.\n\n**Note:** If an element with `autofocus` attribute is added inside the component,\n`initialFocus` won't take effect.",name:"initialFocus",required:!1,type:{name:"string"}},modal:{defaultValue:{value:"false"},description:`Defines whether the component should close when
clicking/tapping outside the popover.
If enabled, it blocks any interaction with the background.`,name:"modal",required:!1,type:{name:"boolean"}},opener:{defaultValue:{value:"undefined"},description:"Defines the ID or DOM Reference of the element at which the popover is shown.\nWhen using this attribute in a declarative way, you must only use the `id` (as a string) of the element at which you want to show the popover.\nYou can only set the `opener` attribute to a DOM Reference when using JavaScript.\n\n**Note:** Available since [v1.2.0](https://github.com/UI5/webcomponents/releases/tag/v1.2.0) of **@ui5/webcomponents**.",name:"opener",required:!1,type:{name:"string | HTMLElement"}},preventFocusRestore:{defaultValue:{value:"false"},description:`Defines if the focus should be returned to the previously focused element,
...
**Note:** Available since [v2.19.0](https://github.com/UI5/webcomponents/releases/tag/v2.19.0) of **@ui5/webcomponents**.`,name:"resizable",required:!1,type:{name:"boolean"}},verticalAlign:{defaultValue:{value:'"Center"'},description:"Determines the vertical alignment of the component.",name:"verticalAlign",required:!1,type:{name:"enum",value:[{value:'"Top"'},{value:'"Bottom"'},{value:'"Center"'},{value:'"Stretch"'},{value:'"Center"'},{value:'"Top"'},{value:'"Bottom"'},{value:'"Stretch"'}]}},footer:{defaultValue:null,description:`Defines the footer HTML Element.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ✅|❌|`,name:"onBeforeOpen",required:!1,type:{name:"(event: Ui5CustomEvent<ResponsivePopoverDomRef, never>) => void"}}}}}catch{}const ae="delete",ie="email",re="M480 64q14 0 23 9t9 23v320q0 13-9 22.5t-23 9.5H32q-13 0-22.5-9.5T0 416V96q0-14 9.5-23T32 64h448zM64 96l192 160L448 96H64zm416 16L256 288 32 112v288l133-136 19 18L48 416h416L329 282l17-18 134 136V112z",ce=!1,le="SAP-icons-v4",se="@ui5/webcomponents-icons";g(ie,{pathData:re,ltr:ce,collection:le,packageName:se});const ue="email",de="M422 64q38 0 64 26t26 64v204q0 38-26 64t-64 26H90q-38 0-64-26T0 358V154q0-38 26-64t64-26h332zM90 115q-11 0-22 7l167 108q8 7 21 7t21-7l166-109q-9-6-21-6H90zm332 282q17 0 28-11t11-28V171L305 273q-22 15-49 15-26 0-49-15L51 172v186q0 17 11 28t28 11h332z",pe=!1,he="SAP-icons-v5",me="@ui5/webcomponents-icons";g(ue,{pathData:de,ltr:pe,collection:he,packageName:me});const fe="email",be="forward",ve="M471.5 170q9 10 9 23t-9 22l-128 128q-10 10-23 10t-23-10q-9-9-9-22.5t9-22.5l74-73h-84q-40 0-75 15t-61 41-41 61-15 75v32q0 13-9 22.5t-23 9.5q-13 0-22.5-9.5T31.5 449v-32q0-53 20.5-99.5t55-81.5 81-55 99.5-20h84l-74-74q-10-10-10-23t10-22q9-10 22-10t23 10z",ge=!1,_e=k,Se="SAP-icons-v4",we="@ui5/webcomponents-icons";g(be,{pathData:ve,ltr:ge,accData:_e,collection:Se,packageName:we});const ye="forward",Ae="M320 151h74L289 43q-7-9-7-17 0-11 7.5-18.5T308 0q10 0 18 8l147 151q7 7 7 17 0 11-7 18L326 345q-8 8-18 8-11 0-18.5-7.5T282 327q0-9 7-18l105-107h-74q-49 0-92.5 17T152 266.5t-50.5 73T83 432v54q0 11-7 18.5T58 512t-18.5-7.5T32 486v-54q0-61 22.5-112.5t61.5-89 91.5-58.5T320 151z",Be=!1,Te=k,xe="SAP-icons-v5",De="@ui5/webcomponents-icons";g(ye,{pathData:Ae,ltr:Be,accData:Te,collection:xe,packageName:De});const qe="forward",Oe={title:"Modals & Popovers / ActionSheet",component:u,argTypes:{children:{control:{disable:!0}},footer:{control:{disable:!0}},header:{control:{disable:!0}},accessibilityAttributes:{table:{category:"Accessibility props"}}},args:{horizontalAlign:K.Center,placement:X.End,verticalAlign:J.Center,open:!1},parameters:{chromatic:{disableSnapshot:!0}},tags:["extends:@ui5/webcomponents","cem-module:ResponsivePopover","package:@ui5/webcomponents-react"]},m={render(e){const a=l.useRef(null),[d,c]=l.useState(e.open);return l.useEffect(()=>{c(e.open)},[e.open]),n.jsxs(n.Fragment,{children:[n.jsx(r,{onClick:()=>{c(!0)},ref:a,children:"Open ActionSheet"}),n.jsxs(u,{...e,opener:a.current,open:d,onClose:p=>{e.onClose(p),c(!1)},children:[n.jsx(r,{icon:Y,children:"Accept"}),n.jsx(r,{icon:Q,children:"Reject"}),n.jsx(r,{icon:fe,children:"Email"}),n.jsx(r,{icon:qe,children:"Forward"}),n.jsx(r,{icon:ae,children:"Delete"}),n.jsx(r,{children:"Other"})]})]})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render(args) {
