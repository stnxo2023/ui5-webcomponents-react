...
`,(0,T.jsxs)(t.p,{children:[`Set `,(0,T.jsx)(t.code,{children:`isTreeTable`}),` to `,(0,T.jsx)(t.code,{children:`true`}),` and provide nested data via the `,(0,T.jsx)(t.code,{children:`subRows`}),` key (configurable with `,(0,T.jsx)(t.code,{children:`subRowsKey`}),`). Each row with `,(0,T.jsx)(t.code,{children:`subRows`}),` becomes expandable.`]}),`
`,(0,T.jsx)(u,{of:m,sourceState:`none`}),`
...
`,(0,T.jsxs)(t.p,{children:[(0,T.jsx)(t.strong,{children:`Note:`}),` To prevent the table state from resetting when the data is updated, please see `,(0,T.jsx)(t.a,{href:`?path=/docs/data-display-analyticaltable-faq--docs#how-to-stop-the-table-state-from-automatically-resetting-when-the-data-changes`,children:`this faq entry`}),`.`]}),`
...
`})})]}),`
`,(0,T.jsx)(t.h2,{id:`auto-row-count`,children:`Auto Row Count`}),`
`,(0,T.jsxs)(t.p,{children:[`Set `,(0,T.jsx)(t.code,{children:`visibleRowCountMode`}),` to `,(0,T.jsx)(t.code,{children:`AnalyticalTableVisibleRowCountMode.Auto`}),` or `,(0,T.jsx)(t.code,{children:`AutoWithEmptyRows`}),` to let the table automatically fill its container with rows.`]}),`
`,(0,T.jsx)(t.p,{children:(0,T.jsx)(t.strong,{children:`Prerequisites:`})}),`
`,(0,T.jsxs)(t.ul,{children:[`
`,(0,T.jsxs)(t.li,{children:[`The table `,(0,T.jsx)(t.strong,{children:`must`}),` be placed inside a container with a `,(0,T.jsx)(t.strong,{children:`defined height`}),` (e.g. `,(0,T.jsx)(t.code,{children:`height: 500px`}),`, `,(0,T.jsx)(t.code,{children:`flex: 1`}),`, or a CSS Grid row). Without a constrained parent, the table cannot determine how many rows to render.`]}),`
`,(0,T.jsxs)(t.li,{children:[(0,T.jsx)(t.code,{children:`AutoWithEmptyRows`}),` fills remaining space with empty rows when there aren't enough data rows to fill the container.`]}),`
`,(0,T.jsxs)(t.li,{children:[(0,T.jsx)(t.code,{children:`Auto`}),` may lead to inconsistent table heights depending on the container — prefer `,(0,T.jsx)(t.code,{children:`AutoWithEmptyRows`}),` for a stable layout.`]}),`
`]}),`
`,(0,T.jsx)(a,{of:h,include:[`containerHeight`,`visibleRowCountMode`],hideHTMLPropsNote:!0}),`
`,(0,T.jsx)(u,{sourceState:`none`,of:h}),`
...
`})}),`
`,(0,T.jsx)(t.h2,{id:`responsive-columns-pop-in`,children:`Responsive Columns (Pop-In)`}),`
`,(0,T.jsx)(a,{of:p,hideHTMLPropsNote:!0,include:[`adjustTableHeightOnPopIn`,`containerWidth`]}),`
...
`]}),`
`,(0,T.jsx)(u,{sourceState:`none`,of:p}),`
...
`,(0,T.jsxs)(t.p,{children:[`Use the `,(0,T.jsx)(t.code,{children:`NoDataComponent`}),` prop to customize the empty state. By default, a simple text message is shown. You can pass a custom component (e.g. an `,(0,T.jsx)(t.code,{children:`IllustratedMessage`}),`) to display a richer empty state for different scenarios like "no data" vs. "no filter results". The component receives an `,(0,T.jsx)(t.code,{children:`accessibleRole`}),` prop that should be forwarded for accessibility.`]}),`
`,(0,T.jsxs)(t.p,{children:[(0,T.jsx)(t.strong,{children:`Note:`}),` When using an `,(0,T.jsx)(t.code,{children:`IllustratedMessage`}),` as `,(0,T.jsx)(t.code,{children:`NoDataComponent`}),`, the table must have sufficient height for the illustration to render properly. With `,(0,T.jsx)(t.code,{children:`visibleRowCountMode`}),` set to `,(0,T.jsx)(t.code,{children:`Auto`}),` or `,(0,T.jsx)(t.code,{children:`AutoWithEmptyRows`}),`, the table container needs a minimum height of approximately `,(0,T.jsx)(t.code,{children:`300px`}),`. With the default `,(0,T.jsx)(t.code,{children:`Fixed`}),` mode, ensure `,(0,T.jsx)(t.code,{children:`visibleRows`}),` provides enough vertical space (typically 5+ rows).`]}),`
`,(0,T.jsx)(u,{of:v}),`
...
`,(0,T.jsxs)(t.p,{children:[`A comprehensive example combining many AnalyticalTable features: sorting, filtering, grouping, custom cells, row and navigation highlighting, infinite scrolling, column reordering, vertical alignment, `,(0,T.jsx)(t.code,{children:`scaleWidthModeOptions`}),` for custom renderers, `,(0,T.jsx)(t.code,{children:`retainColumnWidth`}),`, `,(0,T.jsx)(t.code,{children:`sortDescFirst`}),`, and more.`]}),`
`,(0,T.jsx)(u,{of:g}),`
...
`})})]}),`
`,(0,T.jsx)(i,{})]})}function w(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,T.jsx)(t,{...e,children:(0,T.jsx)(C,{...e})}):C(e)}var T;e((()=>{T=t(),r(),s(),c(),b(),S()}))();export{w as default};