import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$d as n,$l as r,$u as i,Bl as a,Bm as o,Bu as s,Cn as c,Fd as l,Jd as u,Ji as d,Km as f,Ku as p,M as m,N as ee,Pd as h,Qd as te,Ql as ne,Qu as re,Rm as g,Un as _,Vl as ie,Vu as ae,Wn as oe,Xi as se,Xl as v,Yd as ce,Yi as le,Zl as ue,cf as y,d as de,ef as b,gf as fe,lh as pe,mf as me,nf as x,of as S,qi as he,tf as ge,vp as C,wn as w,yp as _e,zg as ve}from"./iframe-T-XyFmV0.js";import{t as T}from"./reset-CpMx6g0D.js";import{n as E,t as D}from"./Friends500-D0m9jF3L.js";import{d as O,f as ye}from"./AnalyticalTable.stories-D7BPltzg.js";import{n as be,t as k}from"./Friends50-C3SOMX2S.js";var A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{be(),E(),n(),te(),T(),A=e(ve(),1),de(),_e(),r(),l(),se(),d(),ue(),i(),ie(),oe(),ce(),w(),ge(),ee(),ae(),O(),j=pe(),M={...ye,title:`Data Display / AnalyticalTable / Feature Examples`,tags:[`package:@ui5/webcomponents-react`]},N={args:{withNavigationHighlight:!0,selectionMode:g.Multiple,data:D},render:e=>{let[t,n]=(0,A.useState)(),r=e=>{n(e.detail.row)},i=(0,A.useCallback)(e=>t?.id===e.id,[t]);return(0,j.jsx)(s,{...e,markNavigatedRow:i,onRowSelect:r})}},P={args:{data:D,filterable:!0},render:e=>{let t=(0,A.useCallback)((e,t,n)=>n.length>0?e.filter(e=>{let r=e.values[t];return!!n.some(e=>r.includes(e))}):e,[]),n=(0,A.useMemo)(()=>[{Header:`Custom Column Filter`,accessor:`name`,filter:t,Filter:({column:e})=>(0,j.jsx)(le,{placeholder:`Filter Names`,onSelectionChange:t=>{e.setFilter(t.detail.items.map(e=>e.getAttribute(`text`)))},children:[`Carl`,`Dan`,`Rose`,`Susanne`].map(t=>{let n=e?.filterValue?.some(e=>e.includes(t));return(0,j.jsx)(he,{text:t,selected:n},t)})})},{Header:`Age`,accessor:`age`}],[]);return(0,j.jsx)(s,{...e,columns:n})}},F={args:{subComponentsBehavior:me.Expandable},render:e=>{let t=(0,A.useCallback)(e=>e.id===`0`?(0,j.jsxs)(b,{style:{backgroundColor:`lightblue`,height:`300px`},justifyContent:`Center`,alignItems:y.Center,direction:S.Column,children:[(0,j.jsx)(_,{children:`height: 300px`}),(0,j.jsx)(u,{children:`This subcomponent will only be displayed below the first row.`}),(0,j.jsx)(`hr`,{}),(0,j.jsx)(u,{children:"The button below is rendered with `data-subcomponent-active-element` attribute to ensure consistent focus behavior"}),(0,j.jsx)(C,{"data-subcomponent-active-element":!0,children:`Click`})]}):e.id===`1`?(0,j.jsxs)(b,{style:{backgroundColor:`lightyellow`,height:`100px`},justifyContent:`Center`,alignItems:y.Center,direction:S.Column,children:[(0,j.jsx)(_,{children:`height: 100px`}),(0,j.jsx)(u,{children:`This subcomponent will only be displayed below the second row.`})]}):e.id===`2`?null:(0,j.jsxs)(b,{style:{backgroundColor:`lightgrey`,height:`50px`},justifyContent:`Center`,alignItems:y.Center,direction:S.Column,children:[(0,j.jsx)(_,{children:`height: 50px`}),(0,j.jsx)(u,{children:`This subcomponent will be displayed below all rows except the first, second and third.`})]}),[]);return(0,j.jsx)(s,{...e,renderRowSubComponent:t,header:`subComponentsBehavior: "${e.subComponentsBehavior}"`})}},I={render(e){let t=[`Available`,`Out of Office`,`Do Not Disturb`,`Away`,`Temporarily Unavailable — On Extended Leave Until Further Notice`],n=(0,A.useMemo)(()=>Array.from({length:10},(e,n)=>({id:n,name:[`Al`,`Bob`,`Jonathan Wetherby Longnamington the Third of Blackcastle`,`Di`,`Eve Martinez de la Cruz`][n%5],age:20+n*3,score:Math.round(50+Math.sin(n)*40),status:t[n%5],tiny:`X`})),[]),r=(0,A.useMemo)(()=>[{Header:`ID`,accessor:`id`,hAlign:f.End},{Header:`Name`,accessor:`name`},{Header:`Status`,accessor:`status`,Cell:({value:e})=>(0,j.jsx)(_,{children:e}),scaleWidthModeOptions:{cellString:`Temporarily Unavailable — On Extended Leave Until Further Notice`}},{Header:`Age`,accessor:`age`,hAlign:f.End},{accessor:`score`,hAlign:f.End,Header:({webComponentsReactProperties:e})=>(0,j.jsx)(m,{state:p.Indication08,className:e.classes.textEllipsis,children:`Average Quarterly Employee Satisfaction Score`}),scaleWidthModeOptions:{headerString:`Average Quarterly Employee Satisfaction Score`}},{Header:`T`,accessor:`tiny`}],[]);return(0,j.jsx)(b,{direction:S.Column,style:{gap:`2rem`},children:[`Default`,`Smart`,`Grow`].map(e=>(0,j.jsx)(s,{data:n,columns:r,scaleWidthMode:fe[e],header:`scaleWidthMode: "${e}"`,visibleRows:3},e))})}},L={args:{data:D,groupable:!0,visibleRows:8},render(e){let[t,n]=(0,A.useState)([]),[r,i]=(0,A.useState)(``),a=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`,disableGroupBy:!0},{Header:`Age`,accessor:`age`,hAlign:f.End,aggregate:`average`,Aggregated:e=>`Avg: ${Math.round(e.value)}`},{Header:`Status`,accessor:`status`,aggregate:e=>{let t=[`Negative`,`Critical`,`Positive`,`Information`,`None`];return e.reduce((e,n)=>t.indexOf(n)<t.indexOf(e)?n:e,`None`)},Aggregated:e=>`Max: ${e.value}`},{Header:`Friend Name`,accessor:`friend.name`,disableGroupBy:!0}],[]),o=e=>{let{column:t,groupedColumns:n,isGrouped:r}=e.detail;i(`Column "${t.Header}" ${r?`grouped`:`ungrouped`}. Active groups: [${n.join(`, `)}]`)};return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},children:[(0,j.jsx)(C,{onClick:()=>n([`status`]),children:`Group by Status`}),(0,j.jsx)(C,{onClick:()=>n([`age`]),children:`Group by Age`}),(0,j.jsx)(C,{onClick:()=>n([`status`,`age`]),children:`Group by Status + Age`}),(0,j.jsx)(C,{onClick:()=>n([]),children:`Clear Groups`})]}),(0,j.jsx)(s,{...e,columns:a,groupBy:t,onGroup:o}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:r||`Group columns via the column header menu or the buttons above.`})]})}},R={render(e){let t=(0,A.useMemo)(()=>Array.from({length:50},(e,t)=>({name:[`Alice`,`Bob`,`Charlie`,`Diana`,`Eve`,`Frank`,`Grace`,`Hank`,`Iris`,`Jack`][t%10]+` #${t}`,age:20+t%50,department:[`Engineering`,`Sales`,`Marketing`,`Support`,`HR`][t%5]})),[]),n=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`,disableGroupBy:!0},{Header:`Age`,accessor:`age`,hAlign:f.End,disableGroupBy:!0},{Header:`Department`,accessor:`department`}],[]),[r,i]=(0,A.useState)(t),[a,o]=(0,A.useState)(!1),c=(0,A.useRef)({groupedColumns:[]}),l=(0,A.useCallback)(e=>{o(!0),setTimeout(()=>{let n=t;if(e.filter?.value){let{columnId:t,value:r}=e.filter;n=n.filter(e=>String(e[t]).toLowerCase().includes(r.toLowerCase()))}if(e.sort&&e.sort.direction!==`none`){let{columnId:t,direction:r}=e.sort;n=[...n].sort((e,n)=>{let i=e[t],a=n[t];return typeof i==`number`?r===`asc`?i-a:a-i:r===`asc`?String(i).localeCompare(String(a)):String(a).localeCompare(String(i))})}if(e.groupedColumns.length>0){let t=e.groupedColumns[0],r=new Map;for(let e of n){let n=String(e[t]),i=r.get(n);i?i.push(e):r.set(n,[e])}i(Array.from(r.entries()).map(([e,n])=>({[t]:e,subRows:n})))}else i(n);o(!1)},500)},[t]),u=(0,A.useCallback)(e=>{let{column:t,sortDirection:n}=e.detail;c.current.sort={columnId:t.id,direction:n},l(c.current)},[l]),d=(0,A.useCallback)(e=>{let{columnId:t,value:n}=e;c.current.filter=n?{columnId:String(t),value:n}:void 0,l(c.current)},[l]),p=(0,A.useCallback)(e=>{let{groupedColumns:t}=e.detail;c.current.groupedColumns=t,l(c.current)},[l]),m=(0,A.useMemo)(()=>({manualSortBy:!0,manualFilters:!0,manualGroupBy:!0,autoResetGroupBy:!1,autoResetExpanded:!1}),[]);return(0,j.jsx)(s,{...e,data:r,columns:n,loading:a,sortable:!0,filterable:!0,groupable:!0,alwaysShowBusyIndicator:!0,reactTableOptions:m,onSort:u,onFilter:d,onGroup:p,visibleRows:8,header:`Server-Side Operations (simulated 500ms delay)`})}},z={render(e){let[t,n]=(0,A.useState)(!0),[r,i]=(0,A.useState)(!1),[a,o]=(0,A.useState)(!1),[l,u]=(0,A.useState)(!1),d=(0,A.useMemo)(()=>t?k:[],[t]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:x.Wrap,children:[(0,j.jsx)(c,{pressed:r,onClick:()=>i(e=>!e),children:`loading`}),(0,j.jsx)(c,{pressed:a,onClick:()=>o(e=>!e),children:`showOverlay`}),(0,j.jsx)(c,{pressed:l,onClick:()=>u(e=>!e),children:`alwaysShowBusyIndicator`}),(0,j.jsx)(c,{pressed:!t,onClick:()=>n(e=>!e),children:`Empty data`})]}),(0,j.jsx)(s,{...e,data:d,loading:r,showOverlay:a,alwaysShowBusyIndicator:l,loadingDelay:500,header:`loading: ${r} | showOverlay: ${a} | alwaysShowBusyIndicator: ${l} | data: ${t?`50 rows`:`empty`}`})]})}},B={render(e){let[t,n]=(0,A.useState)({}),r=(0,A.useMemo)(()=>k.slice(0,20),[]),i=(0,A.useCallback)(e=>{n({...e.detail.selectedRowIds})},[]),a=Object.keys(t).length;return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:x.Wrap,children:[(0,j.jsxs)(C,{onClick:()=>{let e={};r.forEach((t,n)=>{e[n]=!0}),n(e)},children:[`Select All (`,r.length,`)`]}),(0,j.jsx)(C,{onClick:()=>n({}),children:`Clear All`}),(0,j.jsx)(C,{onClick:()=>{let e={};for(let t=0;t<5;t++)e[t]=!0;n(e)},children:`Select First 5`})]}),(0,j.jsx)(s,{...e,data:r,selectionMode:g.Multiple,selectedRowIds:t,onRowSelect:i,visibleRows:8,header:`${a} row${a===1?``:`s`} selected`}),(0,j.jsxs)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:[`Selected IDs: `,a>0?`[${Object.keys(t).join(`, `)}]`:`none`]})]})}},V={render(){let[e,t]=(0,A.useState)(!1),n=(0,A.useMemo)(()=>[{name:`Alice`,age:28,status:`Positive`},{name:`Bob`,age:35,status:`Negative`},{name:`Charlie`,age:42,status:`Critical`},{name:`Diana`,age:31,status:`Information`},{name:`Eve`,age:26,status:`None`},{name:`Frank`,age:39,status:p.Indication01},{name:`Grace`,age:45,status:p.Indication04},{name:`Hank`,age:33,status:p.Indication05},{name:`Iris`,age:29,status:p.Indication07},{name:`Jack`,age:50,status:p.Indication08}],[]),r=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Status Value`,accessor:`status`}],[]),i=(0,A.useCallback)(e=>e.age>40?p.Indication03:p.Indication07,[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(c,{pressed:e,onClick:()=>t(e=>!e),style:{marginBlockEnd:`0.5rem`},children:e?`highlightField: function (age > 40 = Indication03)`:`highlightField: "status" (string accessor)`}),(0,j.jsx)(s,{data:n,columns:r,withRowHighlight:!0,highlightField:e?i:`status`,visibleRows:10,header:e?`Function-based highlighting (age > 40 = Indication03)`:`String-based highlighting (status field)`})]})}},H={render(e){let t=(0,A.useMemo)(()=>[`name`,`age`,`friend.name`,`friend.age`],[]),[n,r]=(0,A.useState)(t),i=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age (fixed)`,accessor:`friend.age`,hAlign:f.End,disableDragAndDrop:!0}],[]),a=(0,A.useMemo)(()=>k.slice(0,20),[]),o=(0,A.useCallback)(e=>{r(e.detail.columnsNewOrder.map(e=>e.id))},[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},alignItems:y.Center,children:[(0,j.jsx)(C,{onClick:()=>r(t),children:`Reset Order`}),(0,j.jsxs)(u,{children:[`Current order: [`,n.join(`, `),`]`]})]}),(0,j.jsx)(s,{...e,data:a,columns:i,columnOrder:n,onColumnsReorder:o,visibleRows:5,header:`Drag column headers to reorder. "Friend Age" has disableDragAndDrop.`})]})}},U={render(e){let[t,n]=(0,A.useState)(``),r=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End,disableGlobalFilter:!0},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:f.End}],[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},alignItems:y.Center,children:[(0,j.jsx)(h,{placeholder:`Search across all rows...`,value:t,onInput:e=>n(e.target.value),showClearIcon:!0,style:{width:`300px`}}),(0,j.jsx)(u,{children:`Age column has disableGlobalFilter: true`})]}),(0,j.jsx)(s,{...e,data:e.data,columns:r,globalFilterValue:t,visibleRows:8,header:t?`Filtering by: "${t}"`:`Type in the search field to filter`})]})}},W={render(e){let t=(0,A.useRef)(null),[n,r]=(0,A.useState)(``),[i,a]=(0,A.useState)(!1),o=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:f.End}],[]),c=(0,A.useMemo)(()=>k.slice(0,30),[]),l=(0,A.useMemo)(()=>k.slice(10,40),[]),d=i?l:c,p=(0,A.useCallback)(()=>{let e=t.current;e&&r(`Sorts: [${e.state.sortBy.map(e=>`${e.id} (${e.desc?`desc`:`asc`})`).join(`, `)||`none`}] | Filters: [${e.state.filters.map(e=>`${e.id}="${e.value}"`).join(`, `)||`none`}] | Hidden: [${e.state.hiddenColumns?.join(`, `)||`none`}]`)},[]),m=(0,A.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1,autoResetHiddenColumns:!1,autoResetExpanded:!1,autoResetGroupBy:!1}),[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:x.Wrap,children:[(0,j.jsx)(C,{onClick:()=>{t.current?.setSortBy([{id:`name`,desc:!1}]),setTimeout(p,50)},children:`Sort Name (asc)`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setSortBy([]),setTimeout(p,50)},children:`Clear Sort`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setFilter(`age`,`3`),setTimeout(p,50)},children:`Filter Age contains "3"`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setAllFilters([]),setTimeout(p,50)},children:`Clear Filters`}),(0,j.jsx)(C,{onClick:()=>{t.current?.toggleHideColumn(`friend.name`),setTimeout(p,50)},children:`Toggle "Friend Name" visibility`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setHiddenColumns([]),setTimeout(p,50)},children:`Show All Columns`}),(0,j.jsx)(C,{onClick:()=>{t.current?.resetResizing()},children:`Reset Column Widths`}),(0,j.jsxs)(C,{design:`Emphasized`,onClick:()=>a(e=>!e),children:[`Toggle Data Set (`,i?`B`:`A`,`)`]})]}),(0,j.jsx)(s,{...e,data:d,columns:o,sortable:!0,filterable:!0,groupable:!0,tableInstance:t,reactTableOptions:m,visibleRows:8,header:`Data Set: ${i?`B`:`A`} — Use buttons above to programmatically control the table`}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:n||`Click a button to see table state.`})]})}},G={render(){let[e,t]=(0,A.useReducer)(e=>e+1,0),n=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:f.End}],[]),r=(0,A.useMemo)(()=>k.slice(0,30),[]),i=(0,A.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1,autoResetHiddenColumns:!1,initialState:{sortBy:[{id:`age`,desc:!0}],filters:[{id:`name`,value:`a`}],hiddenColumns:[`friend.age`],selectedRowIds:{0:!0,2:!0}}}),[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(C,{onClick:t,style:{marginBlockEnd:`0.5rem`},children:`Reset to Initial State (remount)`}),(0,j.jsx)(s,{data:r,columns:n,sortable:!0,filterable:!0,selectionMode:g.Multiple,reactTableOptions:i,visibleRows:8,header:`Initial: sorted by Age desc, filtered Name by "a", Friend Age hidden, rows 0 & 2 selected`},e)]})}},K=(0,A.memo)(({row:e})=>{let{age:t,friend:n,status:r}=e.original,i=n.age-t;return(0,j.jsxs)(b,{alignItems:y.Center,style:{gap:`0.25rem`},children:[(0,j.jsx)(m,{state:r,children:n.name}),(0,j.jsxs)(_,{colorScheme:i>=0?`5`:`3`,children:[i>=0?`+`:``,i,` yrs`]})]})}),K.displayName=`FriendComparisonCell`,q={render(e){let[t,n]=(0,A.useState)(null),r=(0,A.useMemo)(()=>k.slice(0,20).map((e,t)=>({...e,status:[`Positive`,`Negative`,`Critical`,`Information`,`None`][t%5],description:`This is a longer description for row ${t} that should be truncated with an ellipsis when the column is too narrow.`})),[]),i=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End,Cell:({value:e})=>(0,j.jsx)(m,{state:e>40?`Critical`:`Positive`,children:e})},{Header:`Friend Comparison`,id:`friendComparison`,Cell:K},{Header:`Description`,accessor:`description`,Cell:({value:e,webComponentsReactProperties:t})=>(0,j.jsx)(`span`,{className:t.classes.textEllipsis,title:e,children:e})},{Header:`Notes`,id:`notes`,Cell:()=>(0,j.jsx)(h,{onKeyDown:e=>{(e.key===`ArrowLeft`||e.key===`ArrowRight`)&&e.stopPropagation()}})},{Header:`Details`,id:`details`,Cell:({row:e})=>(0,j.jsx)(C,{onClick:()=>n(e.original),children:`Show`})}],[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(s,{...e,data:r,columns:i,visibleRows:8,header:`Custom Cell renderers`}),(0,j.jsx)(ne,{open:!!t,onClose:()=>n(null),headerText:t?.name??``,children:(0,j.jsxs)(b,{direction:S.Column,style:{padding:`1rem`,gap:`0.5rem`},children:[(0,j.jsxs)(u,{children:[`Age: `,t?.age]}),(0,j.jsxs)(u,{children:[`Friend: `,t?.friend?.name]}),(0,j.jsxs)(u,{children:[`Status: `,t?.status]})]})})]})}},J={render(e){let[t,n]=(0,A.useState)(``),[r,i]=(0,A.useState)(``),a=(0,A.useMemo)(()=>[{Header:`Name (Custom Popover)`,accessor:`name`,Popover:e=>{let{setOpen:t,openerId:a}=e.popoverProps;return(0,j.jsx)(re,{open:!0,opener:a,onClose:()=>t(!1),onClick:e=>e.stopPropagation(),headerText:`Custom Column Menu`,children:(0,j.jsxs)(b,{direction:S.Column,style:{padding:`0.5rem`,gap:`0.5rem`},children:[(0,j.jsx)(C,{icon:`sort-ascending`,onClick:()=>{e.setSortBy([{id:`name`,desc:!1}]),n(`Name: ascending`),t(!1)},children:`Sort A → Z`}),(0,j.jsx)(C,{icon:`sort-descending`,onClick:()=>{e.setSortBy([{id:`name`,desc:!0}]),n(`Name: descending`),t(!1)},children:`Sort Z → A`}),(0,j.jsx)(h,{placeholder:`Filter Name...`,value:r,onInput:t=>{let n=t.target.value;i(n),e.setFilter(`name`,n||void 0)}}),(0,j.jsx)(C,{icon:`reset`,onClick:()=>{e.setSortBy([]),e.setAllFilters([]),n(``),i(``),t(!1)},children:`Reset All`})]})})}},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Friend Name`,accessor:`friend.name`}],[r]),o=(0,A.useMemo)(()=>k.slice(0,30),[]),c=(0,A.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1}),[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(s,{...e,data:o,columns:a,sortable:!0,filterable:!0,reactTableOptions:c,visibleRows:8,header:`Click the "Name" column header to see the custom popover`}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:t?`Sort: ${t}`:`Click the "Name (Custom Popover)" column header.`})]})}},Y={render(e){let[t,n]=(0,A.useState)(g.Multiple),[r,i]=(0,A.useState)(o.Row),[c,l]=(0,A.useState)(``),d=(0,A.useMemo)(()=>k.slice(0,20),[]),p=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:f.End},{Header:`Friend Name`,accessor:`friend.name`}],[]),m=(0,A.useCallback)(e=>{let{row:t,isSelected:n,allRowsSelected:r,selectedRowIds:i}=e.detail,a=Object.keys(i).length;l(t?`Row "${t.original.name}" ${n?`selected`:`deselected`}. Total selected: ${a}`:`Select All toggled. All selected: ${r}. Total selected: ${a}`)},[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`1rem`,marginBlockEnd:`0.5rem`},alignItems:y.End,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{htmlFor:`sel-mode`,children:`selectionMode`}),(0,j.jsx)(a,{id:`sel-mode`,value:t,onChange:e=>n(e.detail.selectedOption.getAttribute(`value`)),children:Object.values(g).map(e=>(0,j.jsx)(v,{value:e,children:e},e))})]}),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`label`,{htmlFor:`sel-behavior`,children:`selectionBehavior`}),(0,j.jsx)(a,{id:`sel-behavior`,value:r,onChange:e=>i(e.detail.selectedOption.getAttribute(`value`)),children:Object.values(o).map(e=>(0,j.jsx)(v,{value:e,children:e},e))})]})]}),(0,j.jsx)(s,{...e,data:d,columns:p,selectionMode:t,selectionBehavior:r,onRowSelect:m,header:`selectionMode: ${t} | selectionBehavior: ${r}`}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:c||`Click a row or selection checkbox to see event details.`})]})}},X={render(e){let t=(0,A.useRef)(null),[n,r]=(0,A.useState)([]),i=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`,enableMultiSort:!0},{Header:`Age`,accessor:`age`,hAlign:f.End,enableMultiSort:!0},{Header:`Friend Name`,accessor:`friend.name`,enableMultiSort:!0},{Header:`Friend Age`,accessor:`friend.age`,hAlign:f.End,enableMultiSort:!0}],[]),a=(0,A.useMemo)(()=>k.slice(0,30),[]),o=(0,A.useMemo)(()=>({autoResetSortBy:!1}),[]),c=(0,A.useCallback)(e=>{let{column:t,sortDirection:n}=e.detail;r(e=>{if(n===`clear`)return e.filter(e=>e.id!==t.id);let r=n===`desc`,i=e.findIndex(e=>e.id===t.id);if(i>=0){let n=[...e];return n[i]={id:t.id,desc:r},n}return[...e,{id:t.id,desc:r}]})},[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(b,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:x.Wrap,children:[(0,j.jsx)(C,{onClick:()=>{t.current?.setSortBy([{id:`age`,desc:!1},{id:`name`,desc:!1}]),r([{id:`age`,desc:!1},{id:`name`,desc:!1}])},children:`Sort: Age ↑, Name ↑`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setSortBy([{id:`friend.name`,desc:!0},{id:`friend.age`,desc:!1}]),r([{id:`friend.name`,desc:!0},{id:`friend.age`,desc:!1}])},children:`Sort: Friend Name ↓, Friend Age ↑`}),(0,j.jsx)(C,{onClick:()=>{t.current?.setSortBy([]),r([])},children:`Clear Sort`})]}),(0,j.jsx)(s,{...e,data:a,columns:i,sortable:!0,onSort:c,reactTableOptions:o,tableInstance:t,visibleRows:8,header:`Hold Ctrl/Cmd and click column headers to sort by multiple columns`}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:n.length>0?`Sort priorities: ${n.map((e,t)=>`${t+1}. ${e.id} (${e.desc?`desc`:`asc`})`).join(` → `)}`:`No active sort. Use the column header menu or the buttons above.`})]})}},Z={render(e){let[t,n]=(0,A.useState)(``),r=(0,A.useMemo)(()=>[{name:`A very long name that will exceed the column width`,age:28,description:`Short`},{name:`Bob`,age:3500,description:`A medium length description for this row`},{name:`Charlie Brown`,age:42,description:`Another description that is quite long and should cause the column to expand when auto-resized`},{name:`Di`,age:9,description:`Tiny`},{name:`Eve Martinez de la Cruz`,age:26123,description:`Medium text here`}],[]),i=(0,A.useMemo)(()=>[{Header:`Name`,accessor:`name`,autoResizable:!0},{Header:`Age`,accessor:`age`,hAlign:f.End,autoResizable:!0},{Header:`Description`,accessor:`description`,autoResizable:!0}],[]),a=(0,A.useCallback)(e=>{n(`Column "${e.detail.columnId}" auto-resized to ${Math.round(e.detail.width)}px`)},[]);return(0,j.jsxs)(j.Fragment,{children:[(0,j.jsx)(s,{...e,data:r,columns:i,onAutoResize:a,visibleRows:5,header:`Double-click a column resizer to auto-fit width to content`}),(0,j.jsx)(u,{style:{marginBlockStart:`0.5rem`,display:`block`},children:t||`Double-click a column border to auto-resize.`})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  args: {
