import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{t as r}from"./jsx-runtime-BBQGix-2.js";import{a as i,h as a,p as o,s,t as c,y as l}from"./IndicationColor-BsNCqgX4.js";import{n as u,t as d}from"./Button-CZnCgKU1.js";import{a as f,s as p,t as m}from"./FlexBoxWrap-D5LV9P_x.js";import{r as ee,t as te}from"./sort-descending-Cr2LaWe7.js";import{n as ne,t as h}from"./Text-CmKUdMOE.js";import{n as re,t as g}from"./Input-C2vqtsEa.js";import{n as ie,t as ae}from"./Popover-D4_A_g_O.js";import{n as oe,t as se}from"./Dialog-CYup68uZ.js";import{n as ce,t as _}from"./Option-BkRvcc2b.js";import{n as le,t as v}from"./Select-Ch24Rm6e.js";import{i as ue,n as de,r as y,t as fe}from"./MultiComboBoxItem-CaDYwsxO.js";import{n as pe,t as b}from"./Tag-BumaS1N7.js";import{n as me,t as x}from"./ToggleButton-BCUqAQge.js";import{M as S,N as he,d as ge,ht as _e,mt as C,vt as w,yt as ve}from"./iframe-D0y9DcsE.js";import{t as T}from"./reset-B7Nljhbg.js";import{n as ye,t as E}from"./Friends500-BqTsezkn.js";import{f as be,p as xe}from"./AnalyticalTable.stories-D2jZQXvY.js";import{n as Se,t as D}from"./Friends50-BO_gu8Zu.js";var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$=t((()=>{Se(),ye(),ee(),te(),T(),O=e(n(),1),ge(),u(),oe(),re(),ue(),de(),ce(),ie(),le(),pe(),ne(),me(),ve(),he(),_e(),be(),k=r(),A={...xe,title:`Data Display / AnalyticalTable / Feature Examples`,tags:[`package:@ui5/webcomponents-react`]},j={args:{withNavigationHighlight:!0,selectionMode:o.Multiple,data:E},render:e=>{let[t,n]=(0,O.useState)(),r=e=>{n(e.detail.row)},i=(0,O.useCallback)(e=>t?.id===e.id,[t]);return(0,k.jsx)(C,{...e,markNavigatedRow:i,onRowSelect:r})}},M={args:{data:E,filterable:!0},render:e=>{let t=(0,O.useCallback)((e,t,n)=>n.length>0?e.filter(e=>{let r=e.values[t];return!!n.some(e=>r.includes(e))}):e,[]),n=(0,O.useMemo)(()=>[{Header:`Custom Column Filter`,accessor:`name`,filter:t,Filter:({column:e})=>(0,k.jsx)(y,{placeholder:`Filter Names`,onSelectionChange:t=>{e.setFilter(t.detail.items.map(e=>e.getAttribute(`text`)))},children:[`Carl`,`Dan`,`Rose`,`Susanne`].map(t=>{let n=e?.filterValue?.some(e=>e.includes(t));return(0,k.jsx)(fe,{text:t,selected:n},t)})})},{Header:`Age`,accessor:`age`}],[]);return(0,k.jsx)(C,{...e,columns:n})}},N={args:{subComponentsBehavior:i.Expandable},render:e=>{let t=(0,O.useCallback)(e=>e.id===`0`?(0,k.jsxs)(w,{style:{backgroundColor:`lightblue`,height:`300px`},justifyContent:`Center`,alignItems:p.Center,direction:f.Column,children:[(0,k.jsx)(b,{children:`height: 300px`}),(0,k.jsx)(h,{children:`This subcomponent will only be displayed below the first row.`}),(0,k.jsx)(`hr`,{}),(0,k.jsx)(h,{children:"The button below is rendered with `data-subcomponent-active-element` attribute to ensure consistent focus behavior"}),(0,k.jsx)(d,{"data-subcomponent-active-element":!0,children:`Click`})]}):e.id===`1`?(0,k.jsxs)(w,{style:{backgroundColor:`lightyellow`,height:`100px`},justifyContent:`Center`,alignItems:p.Center,direction:f.Column,children:[(0,k.jsx)(b,{children:`height: 100px`}),(0,k.jsx)(h,{children:`This subcomponent will only be displayed below the second row.`})]}):e.id===`2`?null:(0,k.jsxs)(w,{style:{backgroundColor:`lightgrey`,height:`50px`},justifyContent:`Center`,alignItems:p.Center,direction:f.Column,children:[(0,k.jsx)(b,{children:`height: 50px`}),(0,k.jsx)(h,{children:`This subcomponent will be displayed below all rows except the first, second and third.`})]}),[]);return(0,k.jsx)(C,{...e,renderRowSubComponent:t,header:`subComponentsBehavior: "${e.subComponentsBehavior}"`})}},P={render(e){let t=[`Available`,`Out of Office`,`Do Not Disturb`,`Away`,`Temporarily Unavailable — On Extended Leave Until Further Notice`],n=(0,O.useMemo)(()=>Array.from({length:10},(e,n)=>({id:n,name:[`Al`,`Bob`,`Jonathan Wetherby Longnamington the Third of Blackcastle`,`Di`,`Eve Martinez de la Cruz`][n%5],age:20+n*3,score:Math.round(50+Math.sin(n)*40),status:t[n%5],tiny:`X`})),[]),r=(0,O.useMemo)(()=>[{Header:`ID`,accessor:`id`,hAlign:l.End},{Header:`Name`,accessor:`name`},{Header:`Status`,accessor:`status`,Cell:({value:e})=>(0,k.jsx)(b,{children:e}),scaleWidthModeOptions:{cellString:`Temporarily Unavailable — On Extended Leave Until Further Notice`}},{Header:`Age`,accessor:`age`,hAlign:l.End},{accessor:`score`,hAlign:l.End,Header:({webComponentsReactProperties:e})=>(0,k.jsx)(S,{state:c.Indication08,className:e.classes.textEllipsis,children:`Average Quarterly Employee Satisfaction Score`}),scaleWidthModeOptions:{headerString:`Average Quarterly Employee Satisfaction Score`}},{Header:`T`,accessor:`tiny`}],[]);return(0,k.jsx)(w,{direction:f.Column,style:{gap:`2rem`},children:[`Default`,`Smart`,`Grow`].map(e=>(0,k.jsx)(C,{data:n,columns:r,scaleWidthMode:s[e],header:`scaleWidthMode: "${e}"`,visibleRows:3},e))})}},F={args:{data:E,groupable:!0,visibleRows:8},render(e){let[t,n]=(0,O.useState)([]),[r,i]=(0,O.useState)(``),a=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`,disableGroupBy:!0},{Header:`Age`,accessor:`age`,hAlign:l.End,aggregate:`average`,Aggregated:e=>`Avg: ${Math.round(e.value)}`},{Header:`Status`,accessor:`status`,aggregate:e=>{let t=[`Negative`,`Critical`,`Positive`,`Information`,`None`];return e.reduce((e,n)=>t.indexOf(n)<t.indexOf(e)?n:e,`None`)},Aggregated:e=>`Max: ${e.value}`},{Header:`Friend Name`,accessor:`friend.name`,disableGroupBy:!0}],[]),o=e=>{let{column:t,groupedColumns:n,isGrouped:r}=e.detail;i(`Column "${t.Header}" ${r?`grouped`:`ungrouped`}. Active groups: [${n.join(`, `)}]`)};return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},children:[(0,k.jsx)(d,{onClick:()=>n([`status`]),children:`Group by Status`}),(0,k.jsx)(d,{onClick:()=>n([`age`]),children:`Group by Age`}),(0,k.jsx)(d,{onClick:()=>n([`status`,`age`]),children:`Group by Status + Age`}),(0,k.jsx)(d,{onClick:()=>n([]),children:`Clear Groups`})]}),(0,k.jsx)(C,{...e,columns:a,groupBy:t,onGroup:o}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:r||`Group columns via the column header menu or the buttons above.`})]})}},I={render(e){let t=(0,O.useMemo)(()=>Array.from({length:50},(e,t)=>({name:[`Alice`,`Bob`,`Charlie`,`Diana`,`Eve`,`Frank`,`Grace`,`Hank`,`Iris`,`Jack`][t%10]+` #${t}`,age:20+t%50,department:[`Engineering`,`Sales`,`Marketing`,`Support`,`HR`][t%5]})),[]),n=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`,disableGroupBy:!0},{Header:`Age`,accessor:`age`,hAlign:l.End,disableGroupBy:!0},{Header:`Department`,accessor:`department`}],[]),[r,i]=(0,O.useState)(t),[a,o]=(0,O.useState)(!1),s=(0,O.useRef)({groupedColumns:[]}),c=(0,O.useCallback)(e=>{o(!0),setTimeout(()=>{let n=t;if(e.filter?.value){let{columnId:t,value:r}=e.filter;n=n.filter(e=>String(e[t]).toLowerCase().includes(r.toLowerCase()))}if(e.sort&&e.sort.direction!==`none`){let{columnId:t,direction:r}=e.sort;n=[...n].sort((e,n)=>{let i=e[t],a=n[t];return typeof i==`number`?r===`asc`?i-a:a-i:r===`asc`?String(i).localeCompare(String(a)):String(a).localeCompare(String(i))})}if(e.groupedColumns.length>0){let t=e.groupedColumns[0],r=new Map;for(let e of n){let n=String(e[t]),i=r.get(n);i?i.push(e):r.set(n,[e])}i(Array.from(r.entries()).map(([e,n])=>({[t]:e,subRows:n})))}else i(n);o(!1)},500)},[t]),u=(0,O.useCallback)(e=>{let{column:t,sortDirection:n}=e.detail;s.current.sort={columnId:t.id,direction:n},c(s.current)},[c]),d=(0,O.useCallback)(e=>{let{columnId:t,value:n}=e;s.current.filter=n?{columnId:String(t),value:n}:void 0,c(s.current)},[c]),f=(0,O.useCallback)(e=>{let{groupedColumns:t}=e.detail;s.current.groupedColumns=t,c(s.current)},[c]),p=(0,O.useMemo)(()=>({manualSortBy:!0,manualFilters:!0,manualGroupBy:!0,autoResetGroupBy:!1,autoResetExpanded:!1}),[]);return(0,k.jsx)(C,{...e,data:r,columns:n,loading:a,sortable:!0,filterable:!0,groupable:!0,alwaysShowBusyIndicator:!0,reactTableOptions:p,onSort:u,onFilter:d,onGroup:f,visibleRows:8,header:`Server-Side Operations (simulated 500ms delay)`})}},L={render(e){let[t,n]=(0,O.useState)(!0),[r,i]=(0,O.useState)(!1),[a,o]=(0,O.useState)(!1),[s,c]=(0,O.useState)(!1),l=(0,O.useMemo)(()=>t?D:[],[t]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:m.Wrap,children:[(0,k.jsx)(x,{pressed:r,onClick:()=>i(e=>!e),children:`loading`}),(0,k.jsx)(x,{pressed:a,onClick:()=>o(e=>!e),children:`showOverlay`}),(0,k.jsx)(x,{pressed:s,onClick:()=>c(e=>!e),children:`alwaysShowBusyIndicator`}),(0,k.jsx)(x,{pressed:!t,onClick:()=>n(e=>!e),children:`Empty data`})]}),(0,k.jsx)(C,{...e,data:l,loading:r,showOverlay:a,alwaysShowBusyIndicator:s,loadingDelay:500,header:`loading: ${r} | showOverlay: ${a} | alwaysShowBusyIndicator: ${s} | data: ${t?`50 rows`:`empty`}`})]})}},R={render(e){let[t,n]=(0,O.useState)({}),r=(0,O.useMemo)(()=>D.slice(0,20),[]),i=(0,O.useCallback)(e=>{n({...e.detail.selectedRowIds})},[]),a=Object.keys(t).length;return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:m.Wrap,children:[(0,k.jsxs)(d,{onClick:()=>{let e={};r.forEach((t,n)=>{e[n]=!0}),n(e)},children:[`Select All (`,r.length,`)`]}),(0,k.jsx)(d,{onClick:()=>n({}),children:`Clear All`}),(0,k.jsx)(d,{onClick:()=>{let e={};for(let t=0;t<5;t++)e[t]=!0;n(e)},children:`Select First 5`})]}),(0,k.jsx)(C,{...e,data:r,selectionMode:o.Multiple,selectedRowIds:t,onRowSelect:i,visibleRows:8,header:`${a} row${a===1?``:`s`} selected`}),(0,k.jsxs)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:[`Selected IDs: `,a>0?`[${Object.keys(t).join(`, `)}]`:`none`]})]})}},z={render(){let[e,t]=(0,O.useState)(!1),n=(0,O.useMemo)(()=>[{name:`Alice`,age:28,status:`Positive`},{name:`Bob`,age:35,status:`Negative`},{name:`Charlie`,age:42,status:`Critical`},{name:`Diana`,age:31,status:`Information`},{name:`Eve`,age:26,status:`None`},{name:`Frank`,age:39,status:c.Indication01},{name:`Grace`,age:45,status:c.Indication04},{name:`Hank`,age:33,status:c.Indication05},{name:`Iris`,age:29,status:c.Indication07},{name:`Jack`,age:50,status:c.Indication08}],[]),r=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Status Value`,accessor:`status`}],[]),i=(0,O.useCallback)(e=>e.age>40?c.Indication03:c.Indication07,[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(x,{pressed:e,onClick:()=>t(e=>!e),style:{marginBlockEnd:`0.5rem`},children:e?`highlightField: function (age > 40 = Indication03)`:`highlightField: "status" (string accessor)`}),(0,k.jsx)(C,{data:n,columns:r,withRowHighlight:!0,highlightField:e?i:`status`,visibleRows:10,header:e?`Function-based highlighting (age > 40 = Indication03)`:`String-based highlighting (status field)`})]})}},B={render(e){let t=(0,O.useMemo)(()=>[`name`,`age`,`friend.name`,`friend.age`],[]),[n,r]=(0,O.useState)(t),i=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age (fixed)`,accessor:`friend.age`,hAlign:l.End,disableDragAndDrop:!0}],[]),a=(0,O.useMemo)(()=>D.slice(0,20),[]),o=(0,O.useCallback)(e=>{let t=e.detail.columnsNewOrder.map(e=>e.id);r(t)},[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},alignItems:p.Center,children:[(0,k.jsx)(d,{onClick:()=>r(t),children:`Reset Order`}),(0,k.jsxs)(h,{children:[`Current order: [`,n.join(`, `),`]`]})]}),(0,k.jsx)(C,{...e,data:a,columns:i,columnOrder:n,onColumnsReorder:o,visibleRows:5,header:`Drag column headers to reorder. "Friend Age" has disableDragAndDrop.`})]})}},V={render(e){let[t,n]=(0,O.useState)(``),r=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End,disableGlobalFilter:!0},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:l.End}],[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},alignItems:p.Center,children:[(0,k.jsx)(g,{placeholder:`Search across all rows...`,value:t,onInput:e=>n(e.target.value),showClearIcon:!0,style:{width:`300px`}}),(0,k.jsx)(h,{children:`Age column has disableGlobalFilter: true`})]}),(0,k.jsx)(C,{...e,data:e.data,columns:r,globalFilterValue:t,visibleRows:8,header:t?`Filtering by: "${t}"`:`Type in the search field to filter`})]})}},H={render(e){let t=(0,O.useRef)(null),[n,r]=(0,O.useState)(``),[i,a]=(0,O.useState)(!1),o=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:l.End}],[]),s=(0,O.useMemo)(()=>D.slice(0,30),[]),c=(0,O.useMemo)(()=>D.slice(10,40),[]),u=i?c:s,f=(0,O.useCallback)(()=>{let e=t.current;if(!e)return;let n=e.state.sortBy.map(e=>`${e.id} (${e.desc?`desc`:`asc`})`).join(`, `)||`none`,i=e.state.filters.map(e=>`${e.id}="${e.value}"`).join(`, `)||`none`,a=e.state.hiddenColumns?.join(`, `)||`none`;r(`Sorts: [${n}] | Filters: [${i}] | Hidden: [${a}]`)},[]),p=(0,O.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1,autoResetHiddenColumns:!1,autoResetExpanded:!1,autoResetGroupBy:!1}),[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:m.Wrap,children:[(0,k.jsx)(d,{onClick:()=>{t.current?.setSortBy([{id:`name`,desc:!1}]),setTimeout(f,50)},children:`Sort Name (asc)`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setSortBy([]),setTimeout(f,50)},children:`Clear Sort`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setFilter(`age`,`3`),setTimeout(f,50)},children:`Filter Age contains "3"`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setAllFilters([]),setTimeout(f,50)},children:`Clear Filters`}),(0,k.jsx)(d,{onClick:()=>{t.current?.toggleHideColumn(`friend.name`),setTimeout(f,50)},children:`Toggle "Friend Name" visibility`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setHiddenColumns([]),setTimeout(f,50)},children:`Show All Columns`}),(0,k.jsx)(d,{onClick:()=>{t.current?.resetResizing()},children:`Reset Column Widths`}),(0,k.jsxs)(d,{design:`Emphasized`,onClick:()=>a(e=>!e),children:[`Toggle Data Set (`,i?`B`:`A`,`)`]})]}),(0,k.jsx)(C,{...e,data:u,columns:o,sortable:!0,filterable:!0,groupable:!0,tableInstance:t,reactTableOptions:p,visibleRows:8,header:`Data Set: ${i?`B`:`A`} — Use buttons above to programmatically control the table`}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:n||`Click a button to see table state.`})]})}},U={render(){let[e,t]=(0,O.useReducer)(e=>e+1,0),n=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`,hAlign:l.End}],[]),r=(0,O.useMemo)(()=>D.slice(0,30),[]),i=(0,O.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1,autoResetHiddenColumns:!1,initialState:{sortBy:[{id:`age`,desc:!0}],filters:[{id:`name`,value:`a`}],hiddenColumns:[`friend.age`],selectedRowIds:{0:!0,2:!0}}}),[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(d,{onClick:t,style:{marginBlockEnd:`0.5rem`},children:`Reset to Initial State (remount)`}),(0,k.jsx)(C,{data:r,columns:n,sortable:!0,filterable:!0,selectionMode:o.Multiple,reactTableOptions:i,visibleRows:8,header:`Initial: sorted by Age desc, filtered Name by "a", Friend Age hidden, rows 0 & 2 selected`},e)]})}},W=(0,O.memo)(({row:e})=>{let{age:t,friend:n,status:r}=e.original,i=n.age-t;return(0,k.jsxs)(w,{alignItems:p.Center,style:{gap:`0.25rem`},children:[(0,k.jsx)(S,{state:r,children:n.name}),(0,k.jsxs)(b,{colorScheme:i>=0?`5`:`3`,children:[i>=0?`+`:``,i,` yrs`]})]})}),W.displayName=`FriendComparisonCell`,G={render(e){let[t,n]=(0,O.useState)(null),r=(0,O.useMemo)(()=>D.slice(0,20).map((e,t)=>({...e,status:[`Positive`,`Negative`,`Critical`,`Information`,`None`][t%5],description:`This is a longer description for row ${t} that should be truncated with an ellipsis when the column is too narrow.`})),[]),i=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End,Cell:({value:e})=>(0,k.jsx)(S,{state:e>40?`Critical`:`Positive`,children:e})},{Header:`Friend Comparison`,id:`friendComparison`,Cell:W},{Header:`Description`,accessor:`description`,Cell:({value:e,webComponentsReactProperties:t})=>(0,k.jsx)(`span`,{className:t.classes.textEllipsis,title:e,children:e})},{Header:`Notes`,id:`notes`,Cell:()=>(0,k.jsx)(g,{onKeyDown:e=>{(e.key===`ArrowLeft`||e.key===`ArrowRight`)&&e.stopPropagation()}})},{Header:`Details`,id:`details`,Cell:({row:e})=>(0,k.jsx)(d,{onClick:()=>n(e.original),children:`Show`})}],[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(C,{...e,data:r,columns:i,visibleRows:8,header:`Custom Cell renderers`}),(0,k.jsx)(se,{open:!!t,onClose:()=>n(null),headerText:t?.name??``,children:(0,k.jsxs)(w,{direction:f.Column,style:{padding:`1rem`,gap:`0.5rem`},children:[(0,k.jsxs)(h,{children:[`Age: `,t?.age]}),(0,k.jsxs)(h,{children:[`Friend: `,t?.friend?.name]}),(0,k.jsxs)(h,{children:[`Status: `,t?.status]})]})})]})}},K={render(e){let[t,n]=(0,O.useState)(``),[r,i]=(0,O.useState)(``),a=(0,O.useMemo)(()=>[{Header:`Name (Custom Popover)`,accessor:`name`,Popover:e=>{let{setOpen:t,openerId:a}=e.popoverProps;return(0,k.jsx)(ae,{open:!0,opener:a,onClose:()=>t(!1),onClick:e=>e.stopPropagation(),headerText:`Custom Column Menu`,children:(0,k.jsxs)(w,{direction:f.Column,style:{padding:`0.5rem`,gap:`0.5rem`},children:[(0,k.jsx)(d,{icon:`sort-ascending`,onClick:()=>{e.setSortBy([{id:`name`,desc:!1}]),n(`Name: ascending`),t(!1)},children:`Sort A → Z`}),(0,k.jsx)(d,{icon:`sort-descending`,onClick:()=>{e.setSortBy([{id:`name`,desc:!0}]),n(`Name: descending`),t(!1)},children:`Sort Z → A`}),(0,k.jsx)(g,{placeholder:`Filter Name...`,value:r,onInput:t=>{let n=t.target.value;i(n),e.setFilter(`name`,n||void 0)}}),(0,k.jsx)(d,{icon:`reset`,onClick:()=>{e.setSortBy([]),e.setAllFilters([]),n(``),i(``),t(!1)},children:`Reset All`})]})})}},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Friend Name`,accessor:`friend.name`}],[r]),o=(0,O.useMemo)(()=>D.slice(0,30),[]),s=(0,O.useMemo)(()=>({autoResetSortBy:!1,autoResetFilters:!1}),[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(C,{...e,data:o,columns:a,sortable:!0,filterable:!0,reactTableOptions:s,visibleRows:8,header:`Click the "Name" column header to see the custom popover`}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:t?`Sort: ${t}`:`Click the "Name (Custom Popover)" column header.`})]})}},q={render(e){let[t,n]=(0,O.useState)(o.Multiple),[r,i]=(0,O.useState)(a.Row),[s,c]=(0,O.useState)(``),u=(0,O.useMemo)(()=>D.slice(0,20),[]),d=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`},{Header:`Age`,accessor:`age`,hAlign:l.End},{Header:`Friend Name`,accessor:`friend.name`}],[]),f=(0,O.useCallback)(e=>{let{row:t,isSelected:n,allRowsSelected:r,selectedRowIds:i}=e.detail,a=Object.keys(i).length;c(t?`Row "${t.original.name}" ${n?`selected`:`deselected`}. Total selected: ${a}`:`Select All toggled. All selected: ${r}. Total selected: ${a}`)},[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`1rem`,marginBlockEnd:`0.5rem`},alignItems:p.End,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`sel-mode`,children:`selectionMode`}),(0,k.jsx)(v,{id:`sel-mode`,value:t,onChange:e=>n(e.detail.selectedOption.getAttribute(`value`)),children:Object.values(o).map(e=>(0,k.jsx)(_,{value:e,children:e},e))})]}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`label`,{htmlFor:`sel-behavior`,children:`selectionBehavior`}),(0,k.jsx)(v,{id:`sel-behavior`,value:r,onChange:e=>i(e.detail.selectedOption.getAttribute(`value`)),children:Object.values(a).map(e=>(0,k.jsx)(_,{value:e,children:e},e))})]})]}),(0,k.jsx)(C,{...e,data:u,columns:d,selectionMode:t,selectionBehavior:r,onRowSelect:f,header:`selectionMode: ${t} | selectionBehavior: ${r}`}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:s||`Click a row or selection checkbox to see event details.`})]})}},J={render(e){let t=(0,O.useRef)(null),[n,r]=(0,O.useState)([]),i=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`,enableMultiSort:!0},{Header:`Age`,accessor:`age`,hAlign:l.End,enableMultiSort:!0},{Header:`Friend Name`,accessor:`friend.name`,enableMultiSort:!0},{Header:`Friend Age`,accessor:`friend.age`,hAlign:l.End,enableMultiSort:!0}],[]),a=(0,O.useMemo)(()=>D.slice(0,30),[]),o=(0,O.useMemo)(()=>({autoResetSortBy:!1}),[]),s=(0,O.useCallback)(e=>{let{column:t,sortDirection:n}=e.detail;r(e=>{if(n===`clear`)return e.filter(e=>e.id!==t.id);let r=n===`desc`,i=e.findIndex(e=>e.id===t.id);if(i>=0){let n=[...e];return n[i]={id:t.id,desc:r},n}return[...e,{id:t.id,desc:r}]})},[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(w,{style:{gap:`0.5rem`,marginBlockEnd:`0.5rem`},wrap:m.Wrap,children:[(0,k.jsx)(d,{onClick:()=>{t.current?.setSortBy([{id:`age`,desc:!1},{id:`name`,desc:!1}]),r([{id:`age`,desc:!1},{id:`name`,desc:!1}])},children:`Sort: Age ↑, Name ↑`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setSortBy([{id:`friend.name`,desc:!0},{id:`friend.age`,desc:!1}]),r([{id:`friend.name`,desc:!0},{id:`friend.age`,desc:!1}])},children:`Sort: Friend Name ↓, Friend Age ↑`}),(0,k.jsx)(d,{onClick:()=>{t.current?.setSortBy([]),r([])},children:`Clear Sort`})]}),(0,k.jsx)(C,{...e,data:a,columns:i,sortable:!0,onSort:s,reactTableOptions:o,tableInstance:t,visibleRows:8,header:`Hold Ctrl/Cmd and click column headers to sort by multiple columns`}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:n.length>0?`Sort priorities: ${n.map((e,t)=>`${t+1}. ${e.id} (${e.desc?`desc`:`asc`})`).join(` → `)}`:`No active sort. Use the column header menu or the buttons above.`})]})}},Y={render(e){let[t,n]=(0,O.useState)(``),r=(0,O.useMemo)(()=>[{name:`A very long name that will exceed the column width`,age:28,description:`Short`},{name:`Bob`,age:3500,description:`A medium length description for this row`},{name:`Charlie Brown`,age:42,description:`Another description that is quite long and should cause the column to expand when auto-resized`},{name:`Di`,age:9,description:`Tiny`},{name:`Eve Martinez de la Cruz`,age:26123,description:`Medium text here`}],[]),i=(0,O.useMemo)(()=>[{Header:`Name`,accessor:`name`,autoResizable:!0},{Header:`Age`,accessor:`age`,hAlign:l.End,autoResizable:!0},{Header:`Description`,accessor:`description`,autoResizable:!0}],[]),a=(0,O.useCallback)(e=>{n(`Column "${e.detail.columnId}" auto-resized to ${Math.round(e.detail.width)}px`)},[]);return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(C,{...e,data:r,columns:i,onAutoResize:a,visibleRows:5,header:`Double-click a column resizer to auto-fit width to content`}),(0,k.jsx)(h,{style:{marginBlockStart:`0.5rem`,display:`block`},children:t||`Double-click a column border to auto-resize.`})]})}},X=[{Header:`Name`,accessor:`name`,className:`feature-example-body-cell`,classNameHeader:`feature-example-header-cell`},{Header:`Age`,accessor:`age`},{Header:`Friend Name`,accessor:`friend.name`},{Header:`Friend Age`,accessor:`friend.age`}],Z={render(e){return(0,k.jsxs)(k.Fragment,{children:[(0,k.jsx)(`style`,{children:`
          .feature-example-header-cell { background-color: lightgrey; }
          .feature-example-body-cell { background-color: lightblue; }
        `}),(0,k.jsx)(C,{...e,data:D,columns:X,visibleRows:5})]})}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...Z.parameters?.docs?.source}}},Q=[`NavigationIndicator`,`CustomFilter`,`Subcomponents`,`ScaleWidthModeComparison`,`Grouping`,`ServerSideOperations`,`LoadingStates`,`ControlledSelection`,`RowHighlighting`,`ColumnDragAndDrop`,`GlobalFilter`,`ProgrammaticTableControl`,`InitialTableState`,`CustomCellRenderers`,`CustomHeaderPopover`,`SelectionModes`,`MultiSort`,`AutoResizeColumns`,`ColumnClassName`]}));$();export{Y as AutoResizeColumns,Z as ColumnClassName,B as ColumnDragAndDrop,R as ControlledSelection,G as CustomCellRenderers,M as CustomFilter,K as CustomHeaderPopover,V as GlobalFilter,F as Grouping,U as InitialTableState,L as LoadingStates,J as MultiSort,j as NavigationIndicator,H as ProgrammaticTableControl,z as RowHighlighting,P as ScaleWidthModeComparison,q as SelectionModes,I as ServerSideOperations,N as Subcomponents,Q as __namedExportsOrder,A as default,$ as t};