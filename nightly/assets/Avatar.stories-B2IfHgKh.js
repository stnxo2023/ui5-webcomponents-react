import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{n,t as r}from"./withWebComponent-C4W40CND.js";import{t as i}from"./jsx-runtime-BdxMnOeJ.js";import{a,i as o,n as s,o as c,r as l,t as u}from"./sys-enter-2-lIjYgeYc.js";import{n as d,t as f}from"./edit-DBeuyUl9.js";import{n as p,t as m}from"./Avatar-Dk4xwStf.js";import{n as h}from"./employee-C-QBRWp8.js";import{n as g}from"./AvatarBadge-Dq5g6dzc.js";var _;function v(){return(v=e((()=>{g(),r(),_=n(`ui5-avatar-badge`,[`colorScheme`,`icon`,`state`,`tooltip`],[],[],[]),_.displayName=`AvatarBadge`;try{_.displayName=`AvatarBadge`,_.__docgenInfo={description:`The \`AvatarBadge\` component is used to display a badge on top of \`Avatar\` component.
...
__Note:__ This is a UI5 Web Component! [AvatarBadge UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/AvatarBadge) | [Repository](https://github.com/UI5/webcomponents)`,displayName:`AvatarBadge`,filePath:`/home/runner/work/ui5-webcomponents-react/ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,methods:[],props:{colorScheme:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:'Defines the color scheme of the badge using the indication color palette.\n\nAvailable options are `"1"` through `"10"`, matching the indication colors.\n\n**Note:** `state` takes precedence - when `state` is set to any value other than `None`,\nthe semantic state styling applies and `colorScheme` is ignored.\n\n**Note:** Available since [v2.27.0](https://github.com/UI5/webcomponents/releases/tag/v2.27.0) of **@ui5/webcomponents**.',name:`colorScheme`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`},required:!1,tags:{default:`undefined`},type:{name:`string`}},icon:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:`Defines the icon name to be displayed inside the badge.

**Note:** You should import the desired icon first, then use its name as "icon".

\`import "@ui5/webcomponents-icons/dist/{icon_name}.js"\``,name:`icon`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`},required:!1,tags:{default:`undefined`},type:{name:`string`}},state:{defaultValue:{value:`"None"`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:"Defines the state of the badge, which determines its styling.\n\nAvailable options:\n- `None` (default) - Standard appearance\n- `Positive` - Green, used for success/approved states\n- `Critical` - Orange, used for warning states\n- `Negative` - Red, used for error/rejected states\n- `Information` - Blue, used for informational states\n\n**Note:** `state` takes precedence over `colorScheme`. When `state` is set\nto any value other than `None`, the semantic styling applies and `colorScheme` is ignored.",name:`state`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"Information" | "Positive" | "Negative" | "Critical" | "None" | ValueState`,value:[{value:`"Information"`},{value:`"Positive"`},{value:`"Negative"`},{value:`"Critical"`},{value:`"None"`},{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}}]}},tooltip:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/AvatarBadge/index.d.ts`,name:`AvatarBadgeAttributes`}],description:`Defines the tooltip text of the badge icon.
