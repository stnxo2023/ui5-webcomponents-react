import{p as I,d as C,b as T,c as m,l as k,a1 as R,s as v,A as B,aH as S,m as N,az as b,av as E,aA as D,dG as O,bl as L,dH as z,dI as U,dJ as W,dK as w,dL as P,k as H,bm as y,bo as V,bp as A,w as j,j as p}from"./iframe-CMRYeg3m.js";import{A as _}from"./index-DVEpH7N4.js";import{A as r}from"./AvatarSize-BtKTMFJ5.js";import{A as G}from"./AvatarColorScheme-8OTP3zdx.js";var i;(function(s){s.Group="Group",s.Individual="Individual"})(i||(i={}));I("@ui5/webcomponents-theming","sap_horizon",async()=>C);I("@ui5/webcomponents","sap_horizon",async()=>T);const q=`:host{-webkit-tap-highlight-color:rgba(0,0,0,0)}:host(:not([hidden])){display:block;width:100%}:host{--_ui5-v2-17-0-rc-5_button_focused_border: var(--_ui5-v2-17-0-rc-5_avatar_group_button_focus_border)}.ui5-avatar-group-items:focus{outline:none}:host([type="Group"][desktop]) .ui5-avatar-group-items:focus,:host([type="Group"]) .ui5-avatar-group-items:focus-visible{outline:var(--_ui5-v2-17-0-rc-5_avatar_outline);outline-offset:var(--_ui5-v2-17-0-rc-5_avatar_focus_offset);border-radius:var(--_ui5-v2-17-0-rc-5_avatar_group_focus_border_radius)}.ui5-avatar-group-root{display:flex;padding:var(--_ui5-v2-17-0-rc-5_avatar_group_padding)}.ui5-avatar-group-items{white-space:nowrap;position:relative;display:inline-flex}:host([type="Group"]) .ui5-avatar-group-items{cursor:pointer}:host([type="Group"]) ::slotted([ui5-button]),:host([type="Group"]) ::slotted([ui5-avatar]),:host([type="Group"]) .ui5-avatar-group-overflow-btn{pointer-events:none}.ui5-avatar-group-overflow-btn{overflow:visible}.ui5-avatar-group-overflow-btn::part(button){min-width:auto}::slotted([ui5-button]:not([hidden])),.ui5-avatar-group-overflow-btn:not([hidden]){--_ui5-v2-17-0-rc-5_button_base_padding: 0;border-radius:50%;display:inline-flex;text-overflow:initial;z-index:0}::slotted([ui5-button][desktop]:focus),.ui5-avatar-group-overflow-btn[desktop]:focus{outline:var(--_ui5-v2-17-0-rc-5_avatar_outline);outline-offset:var(--_ui5-v2-17-0-rc-5_avatar_overflow_button_focus_offset)}.ui5-avatar-group-overflow-btn::part(button):focus-visible:after{outline:var(--_ui5-v2-17-0-rc-5_avatar_outline);outline-offset:var(--_ui5-v2-17-0-rc-5_avatar_focus_offset);border-radius:50%}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xs{height:2rem;width:2rem;min-width:2rem;font-size:.75rem}::slotted([ui5-button]),.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-s{height:3rem;width:3rem;min-width:3rem;font-size:1.125rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-m{height:4rem;width:4rem;min-width:4rem;font-size:1.625rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-l{height:5rem;width:5rem;min-width:5rem;font-size:2rem}.ui5-avatar-group-overflow-btn.ui5-avatar-group-overflow-btn-xl{height:7rem;width:7rem;min-width:7rem;font-size:2.75rem}
`;function M(){return m("div",{class:"ui5-avatar-group-root",children:k("div",{class:"ui5-avatar-group-items",role:this._role,tabindex:this._groupTabIndex,"aria-label":this._ariaLabelText,"aria-haspopup":this._containerAriaHasPopup,onClick:this._onClick,onKeyUp:this._onkeyup,onKeyDown:this._onkeydown,onFocusIn:this._onfocusin,children:[m("slot",{onClick:this.onAvatarClick,"onui5-click":this.onAvatarUI5Click}),this._customOverflowButton?m("slot",{onClick:this.onOverflowButtonClick,name:"overflowButton"}):m(R,{onClick:this.onOverflowButtonClick,accessibilityAttributes:this._overflowButtonAccAttributes,accessibleName:this._overflowButtonAriaLabelText,hidden:this._overflowBtnHidden,nonInteractive:this._isGroup,class:{"ui5-avatar-group-overflow-btn":!0,"ui5-avatar-group-overflow-btn-xs":this.firstAvatarSize===r.XS,"ui5-avatar-group-overflow-btn-s":this.firstAvatarSize===r.S,"ui5-avatar-group-overflow-btn-m":this.firstAvatarSize===r.M,"ui5-avatar-group-overflow-btn-l":this.firstAvatarSize===r.L,"ui5-avatar-group-overflow-btn-xl":this.firstAvatarSize===r.XL},children:this._overflowButtonText})]})})}var u=function(s,e,t,o){var a=arguments.length,l=a<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(s,e,t,o);else for(var g=s.length-1;g>=0;g--)(f=s[g])&&(l=(a<3?f(l):a>3?f(e,t,l):f(e,t))||l);return a>3&&l&&Object.defineProperty(e,t,l),l},h;const x="ui5-avatar-group-overflow-btn",$=`.${x}`,F={[r.XS]:{[i.Individual]:"0.0625rem",[i.Group]:"-0.5rem"},[r.S]:{[i.Individual]:"0.125rem",[i.Group]:"-1.25rem"},[r.M]:{[i.Individual]:"0.125rem",[i.Group]:"-1.625rem"},[r.L]:{[i.Individual]:"0.125rem",[i.Group]:" -2rem"},[r.XL]:{[i.Individual]:"0.25rem",[i.Group]:"-2.75rem"}};let n=h=class extends D{constructor(){super(),this.type="Group",this.accessibilityAttributes={},this._colorIndex=0,this._hiddenItems=0,this._itemNavigation=new O(this,{getItemsCallback:()=>this._isGroup?[]:this.items.slice(0,this._hiddenStartIndex)}),this._onResizeHandler=this._onResize.bind(this)}get hiddenItems(){return this.items.slice(this._hiddenStartIndex)}get colorScheme(){return this.items.map(e=>e.effectiveBackgroundColor)}get _customOverflowButton(){return this.overflowButton.length?this.overflowButton[0]:void 0}get _ariaLabelText(){if(this.accessibleName||this.accessibleNameRef)return L(this);const e=this.hiddenItems.length,t=this._isGroup?z:U;let o=h.i18nBundle.getText(t);return o+=` ${h.i18nBundle.getText(W,this._itemsCount-e,e)}`,this._isGroup?o+=` ${h.i18nBundle.getText(w)}`:o+=` ${h.i18nBundle.getText(P)}`,o}get _overflowButtonAriaLabelText(){return this._isGroup?void 0:h.i18nBundle.getText(w)}get _containerAriaHasPopup(){return this._isGroup?this._getAriaHasPopup():void 0}get _overflowButtonAccAttributes(){return{hasPopup:this._isGroup?void 0:this._getAriaHasPopup()}}get _role(){return this._isGroup?"button":"group"}get _hiddenStartIndex(){return this._itemsCount-this._hiddenItems}get _overflowBtnHidden(){return this._hiddenItems===0}get _isGroup(){return this.type===i.Group}get _itemsCount(){return this.items.length}get _groupTabIndex(){return this._isGroup?0:-1}get _overflowButton(){return this.shadowRoot.querySelector($)}get _overflowButtonEffectiveWidth(){const e=this._customOverflowButton?this._customOverflowButton:this._overflowButton;if(!e)return 0;if(this._isGroup){let t=this.items[1];const o=t.offsetLeft-this.offsetLeft;return(!t||t.hidden)&&(t=e),this.effectiveDir==="rtl"?this._getWidthToItem(t):o}return e.offsetWidth}get firstAvatarSize(){return this.items[0]?.size??r.S}onAfterRendering(){this._overflowItems()}onBeforeRendering(){this._customOverflowButton&&(this._customOverflowButton.nonInteractive=this._isGroup),this._prepareAvatars()}onEnterDOM(){H()&&this.setAttribute("desktop",""),y.register(this,this._onResizeHandler)}onExitDOM(){y.deregister(this,this._onResizeHandler)}_onResize(){this._overflowItems()}_onkeydown(e){this._isGroup&&(V(e)?this._fireGroupEvent(e.target):A(e)&&e.preventDefault())}_onkeyup(e){!e.shiftKey&&A(e)&&this._isGroup&&(this._fireGroupEvent(e.target),e.preventDefault())}_fireGroupEvent(e){const t=e.classList.contains(x)||e===this._customOverflowButton;this.fireDecoratorEvent("click",{targetRef:e,overflowButtonClicked:t})}_onClick(e){e.stopPropagation(),this._isGroup&&this._fireGroupEvent(e.target)}onAvatarClick(e){e.stopPropagation(),this.fireDecoratorEvent("click",{targetRef:e.target,overflowButtonClicked:!1})}onAvatarUI5Click(e){e.stopPropagation()}onOverflowButtonClick(e){e.stopPropagation(),this.fireDecoratorEvent("click",{targetRef:e.target,overflowButtonClicked:!0})}_prepareAvatars(){this._colorIndex=0,this.items.forEach((e,t)=>{const o=this._getNextBackgroundColor();e.interactive=!this._isGroup,e.getAttribute("_color-scheme")===G.Auto&&e.setAttribute("_color-scheme",G[`Accent${o}`]),t!==this._itemsCount-1||this._customOverflowButton?e.style.marginInlineEnd=F[e.effectiveSize][this.type]:e.style.marginInlineEnd=""})}_onfocusin(e){this._itemNavigation.setCurrentItem(e.target)}getFocusDomRef(){return this._itemNavigation._getCurrentItem()}_getWidthToItem(e){const t=this.effectiveDir==="rtl",o=e.offsetLeft-this.offsetLeft;if(t){const a=e.offsetParent;return a?a.offsetWidth-e.offsetLeft-e.offsetWidth:0}return o}_overflowItems(){if(this.items.length<2){this._setHiddenItems(0);return}let e=0;for(let t=0;t<this._itemsCount;t++){const o=this.items[t];o.hidden=!1;let a=this._getWidthToItem(o)+o.offsetWidth;if((t!==this._itemsCount-1||this._customOverflowButton)&&(a+=this._overflowButtonEffectiveWidth),a>this.offsetWidth){e=this._itemsCount-t;break}}this._setHiddenItems(e)}_getNextBackgroundColor(){return++this._colorIndex>10&&(this._colorIndex=1),this._colorIndex}_setHiddenItems(e){const t=this._hiddenItems!==e;this._hiddenItems=e,this.items.forEach((o,a)=>{o.hidden=a>=this._hiddenStartIndex}),this._overflowButtonText=`+${e>99?99:e}`,t&&this.fireDecoratorEvent("overflow")}_getAriaHasPopup(){return this.accessibilityAttributes.hasPopup}};u([v()],n.prototype,"type",void 0);u([v({type:Object})],n.prototype,"accessibilityAttributes",void 0);u([v({noAttribute:!0})],n.prototype,"_overflowButtonText",void 0);u([v()],n.prototype,"accessibleName",void 0);u([v()],n.prototype,"accessibleNameRef",void 0);u([B({type:HTMLElement,default:!0})],n.prototype,"items",void 0);u([B()],n.prototype,"overflowButton",void 0);u([S("@ui5/webcomponents")],n,"i18nBundle",void 0);n=h=u([N({tag:"ui5-avatar-group",renderer:E,template:M,styles:q}),b("click"),b("overflow")],n);n.define();const d=j("ui5-avatar-group",["accessibilityAttributes","accessibleName","accessibleNameRef","type"],[],["overflowButton"],["click","overflow"]);d.displayName="AvatarGroup";try{d.displayName="AvatarGroup",d.__docgenInfo={description:`Displays a group of avatars arranged horizontally. It is useful to visually
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const K={title:"Data Display / AvatarGroup",component:d,argTypes:{children:{control:{disable:!0}},overflowButton:{control:{disable:!0}}},args:{type:i.Group},tags:["package:@ui5/webcomponents"]},c={render(s){return p.jsxs(d,{...s,children:[p.jsx(_,{icon:"employee"}),p.jsx(_,{initials:"JD"}),p.jsx(_,{children:p.jsx("img",{src:"https://ui5.github.io/webcomponents/images/avatars/woman_avatar_5.png",alt:"Avatar1"})}),p.jsx(_,{children:p.jsx("img",{src:"https://ui5.github.io/webcomponents/images/avatars/man_avatar_3.png",alt:"Avatar2"})})]})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...c.parameters?.docs?.source}}};const Y=["Default"],te=Object.freeze(Object.defineProperty({__proto__:null,Default:c,__namedExportsOrder:Y,default:K},Symbol.toStringTag,{value:"Module"}));export{te as C,c as D};
