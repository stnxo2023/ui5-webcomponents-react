import{c as ge,s as ye,a as be,e as Ce,t as ve,l as we}from"./DemoProps-CSQDY9Xq.js";import{r as z,j as a,ao as ke,q as xe}from"./iframe-tj1IXK49.js";import{T as D}from"./ThemingParameters-pyhX3s39.js";import{d as Ae,C as F,u as _e,t as Le,a as Se,b as De,c as Ie,e as Y}from"./staticProps-CV3V8Llx.js";import{u as je,B as Ve}from"./useCancelAnimationFallback-CIGm63AT.js";import{u as Pe,a as Te,C as qe,c as O,X as R,b as ze,Y as Ne}from"./YAxisTicks-DaASlWEb.js";import{u as Be,C as We}from"./ChartDataLabel-Da5Nl63Q.js";import{g as Oe,u as Re,a as Ee,r as Fe,b as E}from"./useTooltipFormatter-BsmLMFwx.js";import{u as Ye}from"./useOnClickInternal-CAP8igzF.js";import{k as Me,B as Ke,e as He,m as $e,l as Ue,R as Xe,T as Ge,n as Je}from"./ChartContainer-CGZG8QsE.js";import{C as Qe}from"./react-content-loader.es-DMCn0vh4.js";import{u as Ze}from"./useIsRTL-BXFoHGh1.js";const et=(o,l,h="")=>z.useMemo(()=>{let c=Array(l.length).fill(0),s=0;if(o instanceof Array&&l){const I=i=>l.map(r=>r.formatter(F.getValueByDataKey(i,r.accessor,"")));o.map(I).forEach(i=>{i.forEach((r,A)=>{c[A]=Math.max(Oe(r),c[A])})}),c=c.map(i=>Math.min(Ae,i)),s=c.reduce((i,r)=>i+r,0)}return h==="middle"?[c,{width:"auto"}]:[c,{marginLeft:s,maxWidth:`calc(100% - ${s+8}px)`}]},[o,l,h]),tt=()=>a.jsxs(Qe,{viewBox:"0 0 165 145",preserveAspectRatio:"xMidYMid meet",width:"100%",height:"100%",speed:2,backgroundColor:D.sapContent_ImagePlaceholderBackground,foregroundColor:D.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:D.sapContent_DisabledOpacity,children:[a.jsx("rect",{x:"20",y:"10",width:"1",height:"135"}),a.jsx("rect",{x:"20",y:"20",width:"85",height:"15"}),a.jsx("rect",{x:"20",y:"40",width:"117",height:"15"}),a.jsx("rect",{x:"20",y:"60",width:"67",height:"15"}),a.jsx("rect",{x:"20",y:"80",width:"75",height:"15"}),a.jsx("rect",{x:"20",y:"100",width:"125",height:"15"}),a.jsx("rect",{x:"20",y:"120",width:"60",height:"15"})]}),at={formatter:Y},ot={formatter:Y,opacity:1},nt=o=>({payload:l})=>F.getValueByDataKey(l,o),u=z.forwardRef((o,l)=>{const{loading:h,loadingDelay:c,dataset:s,noLegend:I,noAnimation:j,tooltipConfig:i,onDataPointClick:r,onLegendClick:A,onClick:N,style:M,className:K,slot:H,syncId:$,ChartPlaceholder:U,children:X,...G}=o,t={margin:{},yAxisVisible:!0,xAxisVisible:!0,gridStroke:D.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:"bottom",legendHorizontalAlign:"left",barGap:3,zoomingTool:!1,resizeDebounce:250,yAxisConfig:{},xAxisConfig:{},secondXAxisConfig:{},...o.chartConfig},d=t.referenceLine,{dimensions:V,measures:_}=Re(o.dimensions,o.measures,at,ot),J=Ee(_),P=V[0],{primaryMeasure:Q,secondaryMeasure:Z}=Fe(_,t?.secondYAxis?.dataKey),ee=_.map(({accessor:e})=>e),T=t.secondYAxis?ee.findIndex(e=>e===t.secondYAxis?.dataKey):0,[te,B]=ke(l),ae=_e(A),oe=Be(P?.formatter),ne=z.useCallback((e,n,L)=>{if(e&&r){const S=e.value.length?e.value[1]-e.value[0]:e.value;r(xe(L,{dataKey:Object.keys(e).filter(q=>q!=="value").find(q=>e[q]===S),value:S,payload:e.payload,dataIndex:n}))}},[r]),re=Ye(N),se=s?.length>30,ie=P?.accessor,[le,ce]=et(s,V,t.legendPosition),de=Pe(t.margin,t.zoomingTool),[he]=Te(B,1),W=Ze(B),{isMounted:ue,handleBarAnimationStart:me,handleBarAnimationEnd:pe}=je(j),{chartConfig:it,dimensions:lt,measures:ct,...fe}=G;return a.jsx(Me,{dataset:s,loading:h,loadingDelay:c,Placeholder:U??tt,ref:te,style:M,className:K,slot:H,resizeDebounce:t.resizeDebounce,...fe,children:a.jsxs(Ve,{syncId:$,onClick:re,stackOffset:"sign",margin:de,layout:"vertical",data:s,barGap:t.barGap,accessibilityLayer:t.accessibilityLayer,className:typeof r=="function"||typeof N=="function"?"has-click-handler":void 0,children:[a.jsx(qe,{vertical:t.gridVertical,horizontal:t.gridHorizontal,stroke:t.gridStroke}),t.xAxisVisible&&a.jsx(O,{interval:0,type:"number",tick:a.jsx(R,{formatter:Q?.formatter}),axisLine:t.xAxisVisible,tickLine:Le,height:he,reversed:W,...t.xAxisConfig}),t.secondYAxis?.dataKey&&a.jsx(O,{dataKey:t.secondYAxis.dataKey,axisLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`},tick:a.jsx(R,{formatter:Z?.formatter,secondYAxisConfig:{color:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`}}),tickLine:{stroke:t.secondYAxis.color??`var(--sapChart_OrderedColor_${T%12+1})`},label:{value:t.secondYAxis.name,offset:2,angle:90,position:"center"},orientation:"top",interval:0,xAxisId:"secondary",type:"number",...t.secondXAxisConfig}),t.yAxisVisible&&V.map((e,n)=>a.jsx(ze,{interval:e?.interval??"preserveStartEnd",minTickGap:se?void 0:-10,type:"category",dataKey:e.accessor,tick:a.jsx(Ne,{formatter:e?.formatter}),tickLine:n<1,axisLine:n<1,yAxisId:n,width:le[n],allowDuplicatedCategory:n===0,orientation:W?"right":"left",...t.yAxisConfig},e.reactKey)),ue&&_.map((e,n)=>a.jsxs(Ke,{stackId:e.stackId,fillOpacity:e.opacity,name:e.label??e.accessor,strokeOpacity:e.opacity,type:"monotone",dataKey:e.accessor,fill:e.color??`var(--sapChart_OrderedColor_${n%12+1})`,stroke:e.color??`var(--sapChart_OrderedColor_${n%12+1})`,barSize:e.width,onClick:ne,isAnimationActive:!j,onAnimationStart:me,onAnimationEnd:pe,children:[a.jsx(He,{data:s,valueAccessor:nt(e.accessor),content:a.jsx(We,{config:e,chartType:"bar",position:"insideRight"})}),s.map((L,S)=>a.jsx($e,{fill:E(e,L,n),stroke:E(e,L,n)},S))]},e.reactKey)),!I&&a.jsx(Ue,{verticalAlign:t.legendPosition,align:t.legendHorizontalAlign,onClick:ae,wrapperStyle:ce,...t.legendConfig}),d&&a.jsx(Xe,{...d,stroke:d?.color??d?.stroke,x:d?.value??d?.x,label:d?.label}),i?.active!==!1&&a.jsx(Ge,{cursor:De,formatter:J,contentStyle:Se,labelFormatter:oe,...i}),!!t.zoomingTool&&a.jsx(Je,{dataKey:ie,tickFormatter:P?.formatter,...Ie,...typeof t.zoomingTool=="object"?t.zoomingTool:{}}),X]})})});u.displayName="BarChart";try{u.displayName="BarChart",u.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.\n\n__Note:__ Charts are custom-built __without__ defined design specifications! They use the Fiori color palette, but functionality and especially accessibility may not meet standard app requirements.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}try{u.displayName="BarChart",u.__docgenInfo={description:"A `BarChart` is a data visualization where each category is represented by a rectangle, with the width of the rectangle being proportional to the values being plotted.\n\n__Note:__ Charts are custom-built __without__ defined design specifications! They use the Fiori color palette, but functionality and especially accessibility may not meet standard app requirements.",displayName:"BarChart",props:{dimensions:{defaultValue:null,description:`An array of config objects. Each object will define one dimension of the chart.
