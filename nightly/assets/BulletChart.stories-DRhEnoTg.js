import{a as e,i as t}from"./preload-helper-DbRxMUml.js";import{a as n,m as r,r as i,s as a}from"./DemoProps-Cx3bXfFk.js";import{n as o,t as s}from"./BulletChart-CTPdZBmy.js";var c=e({Default:()=>u,LoadingPlaceholder:()=>p,WithCustomLegendConfig:()=>h,WithCustomSize:()=>d,WithCustomTooltipConfig:()=>m,WithHighlightedMeasures:()=>f,__namedExportsOrder:()=>g,default:()=>l}),l,u,d,f,p,m,h,g,_=t((()=>{n(),o(),l={title:`BulletChart`,component:s,tags:[`package:@ui5/webcomponents-react-charts`],argTypes:{children:{control:{disable:!0}}},args:{dataset:i,layout:`horizontal`,dimensions:[{accessor:`name`,formatter:e=>`${e} 2019`,interval:0}],measures:[{accessor:`sessions`,label:`Active Sessions`,type:`primary`},{accessor:`users`,label:`Users`,type:`additional`},{accessor:`volume`,label:`Volume`,formatter:e=>e.toLocaleString(),type:`comparison`}]}},u={},d={args:{layout:`vertical`,dimensions:[{accessor:`name`,formatter:e=>e.slice(0,3)}],measures:[{accessor:`users`,formatter:e=>`${e/10}`,type:`additional`,label:`Number of users`,width:10},{accessor:`sessions`,type:`primary`,width:10,opacity:.5},{accessor:`volume`,type:`comparison`,width:10}]}},f={args:{dimensions:[{accessor:`name`,formatter:e=>`${e} 2019`,interval:0}],measures:[{accessor:`sessions`,label:`Active Sessions`,type:`primary`},{accessor:`users`,label:`Users`,type:`additional`,highlightColor:e=>{if(e>100)return`red`}},{accessor:`volume`,label:`Volume`,formatter:e=>e.toLocaleString(),type:`comparison`}]}},p={args:{dataset:[]}},m={args:r},h={args:a},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{}`,...u.parameters?.docs?.source}}},d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    layout: 'vertical',
    dimensions: [{
      accessor: 'name',
