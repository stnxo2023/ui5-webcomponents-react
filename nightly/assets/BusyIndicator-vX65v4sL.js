import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,t as n}from"./withWebComponent-CAFYyfUs.js";import{n as r}from"./BusyIndicator-BJCqcChW.js";var i;function a(){return(a=e((()=>{r(),n(),i=t(`ui5-busy-indicator`,[`delay`,`size`,`text`,`textPlacement`],[`active`],[],[]),i.displayName=`BusyIndicator`;try{i.displayName=`BusyIndicator`,i.__docgenInfo={description:`The \`BusyIndicator\` signals that some operation is going on and that the
...
__Supported Node Type/s:__ \`Array<Node>\``,name:`children`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorPropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`ReactNode | ReactNode[]`,value:[{value:`string`},{value:`number`},{value:`bigint`},{value:`false`},{value:`true`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`Iterable<ReactNode>`,description:``,fullComment:``,tags:{}},{value:`ReactPortal`,description:``,fullComment:``,tags:{}},{value:`Promise<AwaitedReactNode>`,description:`Represents the completion of an asynchronous operation`,fullComment:`Represents the completion of an asynchronous operation`,tags:{}},{value:`ReactNode[]`,description:``,fullComment:``,tags:{}}]}},active:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`}],description:`Defines if the busy indicator is visible on the screen. By default it is not.`,name:`active`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},delay:{defaultValue:{value:`1000`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`}],description:`Defines the delay in milliseconds, after which the busy indicator will be visible on the screen.`,name:`delay`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`},required:!1,tags:{default:`1000`},type:{name:`number`}},size:{defaultValue:{value:`"M"`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`}],description:`Defines the size of the component.`,name:`size`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/BusyIndicator/index.d.ts`,name:`BusyIndicatorAttributes`},required:!1,tags:{default:`"M"`},type:{name:`enum`,raw:`BusyIndicatorSize | "S" | "M" | "L"`,value:[{value:`"S"`,description:`small size`,fullComment:`small size
