...
**Note:** Available since [v2.7.0](https://github.com/UI5/webcomponents/releases/tag/v2.7.0) of **@ui5/webcomponents**.`,name:"design",required:!1,type:{name:'ButtonBadgeDesign | "InlineText" | "OverlayText" | "AttentionDot"'}},text:{defaultValue:null,description:`Defines the text of the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const u={title:"Inputs / Button",component:s,argTypes:{children:{control:"text"},badge:{control:{disable:!0}}},args:{design:d.Default,icon:l,children:"Button Text"},tags:["package:@ui5/webcomponents"]},n={},o={render(a){return e.jsxs(e.Fragment,{children:[e.jsx(s,{...a,badge:e.jsx(t,{design:i.AttentionDot}),children:"ButtonBadgeDesign.AttentionDot"}),e.jsx(s,{...a,badge:e.jsx(t,{design:i.InlineText,text:"badge"}),children:"ButtonBadgeDesign.InlineText"}),e.jsx(s,{...a,badge:e.jsx(t,{design:i.OverlayText,text:"badge"}),children:"ButtonBadgeDesign.OverlayText"})]})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:"{}",...n.parameters?.docs?.source}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render(args) {
    return <>
...
}`,...o.parameters?.docs?.source}}};const c=["Default","WithBadge"],h=Object.freeze(Object.defineProperty({__proto__:null,Default:n,WithBadge:o,__namedExportsOrder:c,default:u},Symbol.toStringTag,{value:"Module"}));export{t as B,h as C,n as D,o as W};
