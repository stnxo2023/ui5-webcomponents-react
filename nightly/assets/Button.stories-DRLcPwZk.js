import{n as e,o as t,r as n}from"./chunk-zsgVPwQN.js";import{$l as r,Au as i,Bp as a,Fh as o,Fp as s,Im as c,Ip as l,Jm as u,Ki as ee,Lp as te,Lt as ne,Mh as d,Nh as re,Ph as ie,Pp as ae,Qi as f,Ql as p,Rt as oe,Vp as se,Wm as ce,Xi as m,Zn as le,_m as h,_p as g,am as _,cm as v,dm as ue,ea as y,fm as de,gm as b,gp as fe,hm as x,id as pe,im as me,jm as S,ku as he,lp as C,mg as w,mm as T,nm as E,pm as D,qm as O,rm as k,ta as A,u as j,um as M,up as N}from"./iframe-CIKiMZfN.js";import{n as P,r as F,t as I,y as L}from"./parameters-bundle.css-Bp5yL5WR.js";var R,z,B=e((()=>{u(),b(),T(),R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},z=class extends O{constructor(){super(...arguments),this.showArrowButton=!1}},R([x()],z.prototype,`name`,void 0),R([x()],z.prototype,`text`,void 0),R([x()],z.prototype,`icon`,void 0),R([x()],z.prototype,`endIcon`,void 0),R([x({type:Boolean})],z.prototype,`showArrowButton`,void 0),z=R([h(`ui5-ai-button-state`)],z),z.define()})),V,H=e((()=>{B(),S(),V=c(`ui5-ai-button-state`,[`endIcon`,`icon`,`name`,`text`],[`showArrowButton`],[],[]),V.displayName=`ButtonState`;try{V.displayName=`ButtonState`,V.__docgenInfo={description:"`ButtonState` is the item to use for defining states of `Button` components.\n\n### Usage\n\n`ButtonState` is an abstract element, representing a state of `Button`. It is meant to be used in the `default` slot\nof `Button` and should not be used as standalone component.\n\n\n\n__Note:__ This is a UI5 Web Component! [ButtonState UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/ai/ButtonState) | [Repository](https://github.com/UI5/webcomponents)",displayName:`ButtonState`,props:{endIcon:{defaultValue:{value:`undefined`},description:`Defines the icon to be displayed as graphical element within the component after the text.
...
__Note:__ This adds a rendering cycle to your component.`,name:`waitForDefine`,required:!1,type:{name:`boolean`}}}}}catch{}}));function ge(){return te(ae,{children:[l(y,{class:`ui5-ai-button-inner`,design:this.design,icon:this._stateIcon,disabled:this.disabled,_endIcon:this._stateEndIcon,_hideArrowButton:this._hideArrowButton,onClick:this._onClick,onArrowClick:this._onArrowClick,accessibilityAttributes:this._computedAccessibilityAttributes,children:this._hasText&&l(`div`,{class:`ui5-ai-button-text`,children:this._stateText})}),l(y,{class:`ui5-ai-button-hidden`,design:this.design})]})}var _e=e((()=>{s(),A()})),U,ve=e((()=>{re(),a(),I(),d(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>se),d(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),U=`:host{display:inline-block}:host([disabled]){pointer-events:none}.ui5-ai-button-text{display:inline-block}:host([icon-only]) .ui5-ai-button-text{min-width:0;margin-inline-start:0}.ui5-ai-button-hidden{position:absolute;top:-10000px;left:-10000px;visibility:hidden;display:block;width:fit-content}:host .ui5-ai-button-inner{width:100%}:host{width:auto;position:relative;transition:width .18s cubic-bezier(.67,1,.95,1.3) .12s}:host([icon-only]) .ui5-ai-button-inner[_end-icon=""]::part(textButton),:host(.ui5-ai-button-menu-to-button[icon-only]) .ui5-ai-button-inner::part(textButton){min-width:var(--_ui5_button_base_min_width)!important;max-width:var(--_ui5_button_base_min_width)!important}:host(.ui5-ai-button-menu-to-button) .ui5-ai-button-inner::part(button),:host(.ui5-ai-button-fade-out:not([icon-only])) .ui5-ai-button-inner::part(button){justify-content:flex-start}:host([icon-only]) .ui5-ai-button-inner[_end-icon]:not([_end-icon=""])::part(button),:host([icon-only]) .ui5-ai-button-inner[_hide-arrow-button]::part(button){justify-content:flex-start;padding-inline-start:var(--_ui5_button_base_padding)}:host(.ui5-ai-button-fade-in[icon-only]) .ui5-ai-button-inner[_end-icon=""]::part(button){max-width:var(--_ui5_button_base_min_width)}:host([icon-only]) .ui5-ai-button-inner[_end-icon=""]::part(textButton),:host(.ui5-ai-button-menu-to-button[icon-only]) .ui5-ai-button-inner::part(textButton){min-width:var(--_ui5_button_base_min_width);max-width:var(--_ui5_button_base_min_width)}:host(:not(.ui5-ai-button-fade-out):not(.ui5-ai-button-fade-mid):not(.ui5-ai-button-fade-in)) .ui5-ai-button-text,:host(:not(.ui5-ai-button-fade-out):not(.ui5-ai-button-fade-mid):not(.ui5-ai-button-fade-in)) ::part(endIcon),:host(:not(.ui5-ai-button-fade-out):not(.ui5-ai-button-fade-mid):not(.ui5-ai-button-fade-in)) ::part(arrowButton){opacity:1;transform:translateY(0)}:host(.ui5-ai-button-button-to-menu) .ui5-ai-button-inner::part(endIcon),:host(.ui5-ai-button-button-to-menu) .ui5-ai-button-inner::part(arrowButton){display:none;transform:translateY(0);opacity:0}:host(.ui5-ai-button-fade-out) .ui5-ai-button-text{opacity:0;transform:translateY(-1rem);transition:opacity .06s ease-in-out .12s,transform .08s ease-in-out .12s}:host(.ui5-ai-button-fade-out) ::part(icon){opacity:0;transform:translateY(-1rem);transition:opacity .05s ease-in-out 25ms,transform .1s ease-in-out 0s}:host(.ui5-ai-button-fade-out) ::part(endIcon){opacity:0;transform:translateY(-1rem);transition:opacity .06s ease-in-out .12s,transform .08s ease-in-out .12s}:host(.ui5-ai-button-fade-mid) .ui5-ai-button-text,:host(.ui5-ai-button-fade-mid) ::part(icon),:host(.ui5-ai-button-fade-mid) ::part(endIcon),:host(.ui5-ai-button-fade-mid) ::part(arrowButton){opacity:0;transform:translateY(1rem);transition:none}:host(.ui5-ai-button-fade-in) .ui5-ai-button-text{opacity:1;transform:translateY(0);transition:opacity .06s ease-in-out .12s,transform .08s ease-in-out .12s}:host(.ui5-ai-button-fade-in) ::part(icon){opacity:1;transform:translateY(0);transition:opacity .05s ease-in-out 25ms,transform .1s ease-in-out 0s}:host(.ui5-ai-button-fade-in) ::part(endIcon){opacity:1;transform:translateY(0);transition:opacity .06s ease-in-out .12s,transform .08s ease-in-out .12s}
`})),W,G,K,ye=e((()=>{u(),o(),b(),T(),pe(),de(),N(),p(),M(),L(),B(),_e(),_(),ve(),W=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},K=G=class extends O{constructor(){super(...arguments),this.design=`Default`,this.disabled=!1,this.arrowButtonPressed=!1,this.accessibilityAttributes={},this.iconOnly=!1}get _hideArrowButton(){return!this._effectiveStateObject?.showArrowButton}get _effectiveState(){return this.state||this.states.length&&this.states[0].name||``}get _effectiveStateObject(){return this.states.find(e=>e.name===this._effectiveState)}get _stateIconOnly(){return!this._stateText&&!!this._stateIcon}get _stateText(){return this._currentStateObject?.text}get _stateIcon(){return this._currentStateObject?.icon}get _stateEndIcon(){return this._effectiveStateObject?.showArrowButton?``:this._effectiveStateObject?.endIcon}get _hasText(){return!!this._stateText}onBeforeRendering(){let e=this._splitButton;e&&(e.activeArrowButton=this.arrowButtonPressed),this._currentStateObject?.name||(this._currentStateObject=this._effectiveStateObject);let t=this._currentStateObject?.name||``;this.iconOnly=this._stateIconOnly,t!==``&&t!==this._effectiveState&&this._fadeOut()}async _fadeOut(){let e=this._splitButton,t=this._hiddenSplitButton,n=this._effectiveStateObject;if(!n){console.warn(`State with name="${this.state}" doesn't exist!`);return}if(!e||!t)return;let r=e.offsetWidth,i=this._currentStateObject||{};(!i.showArrowButton&&n.showArrowButton||!i.endIcon&&n.endIcon)&&this.classList.add(`ui5-ai-button-button-to-menu`),(i.showArrowButton&&!n.showArrowButton||i.endIcon&&!n.endIcon)&&this.classList.add(`ui5-ai-button-menu-to-button`),this.style.width=`${r}px`,t.icon=n.icon,t._endIcon=n.endIcon,t.textContent=n.text||null,t._hideArrowButton=this._hideArrowButton,await ie();let a=t.offsetWidth;this.style.width=`${a}px`,this.classList.add(`ui5-ai-button-fade-out`),setTimeout(()=>{this.classList.add(`ui5-ai-button-fade-mid`),e._hideArrowButton=this._hideArrowButton,this._fadeIn()},180)}_fadeIn(){setTimeout(()=>{this._currentStateObject=this._effectiveStateObject,this.classList.add(`ui5-ai-button-fade-in`),this._resetFade()},160)}_resetFade(){setTimeout(()=>{this.classList.remove(`ui5-ai-button-fade-out`),this.classList.remove(`ui5-ai-button-fade-mid`),this.classList.remove(`ui5-ai-button-fade-in`),this.classList.remove(`ui5-ai-button-button-to-menu`),this.classList.remove(`ui5-ai-button-menu-to-button`)},160);let e=this._splitButton;e&&(e.style.width=``)}_onClick(e){e.stopImmediatePropagation(),this.fireDecoratorEvent(`click`)}_onArrowClick(e){e.stopImmediatePropagation(),this.fireDecoratorEvent(`arrow-button-click`)}get _computedAccessibilityAttributes(){let e=k(this)||E(this)||me(this)||``,t=`${this._hasText?G.i18nBundleAi.getText(F,this._stateText):``} ${e}`.trim();return{root:{hasPopup:this.accessibilityAttributes?.root?.hasPopup||`false`,roleDescription:this.accessibilityAttributes?.root?.roleDescription,title:this.accessibilityAttributes?.root?.title||t,ariaKeyShortcuts:this.accessibilityAttributes?.root?.ariaKeyShortcuts},arrowButton:{hasPopup:this.accessibilityAttributes?.arrowButton?.hasPopup,expanded:this.accessibilityAttributes?.arrowButton?.expanded,title:this.accessibilityAttributes?.arrowButton?.title}}}},W([x()],K.prototype,`design`,void 0),W([x({type:Boolean})],K.prototype,`disabled`,void 0),W([x()],K.prototype,`state`,void 0),W([x({type:Boolean,noAttribute:!0})],K.prototype,`arrowButtonPressed`,void 0),W([x({type:Object})],K.prototype,`accessibilityAttributes`,void 0),W([x({type:Object})],K.prototype,`_currentStateObject`,void 0),W([x({type:Boolean})],K.prototype,`iconOnly`,void 0),W([C({type:HTMLElement,default:!0})],K.prototype,`states`,void 0),W([r(`[ui5-split-button]`)],K.prototype,`_splitButton`,void 0),W([r(`.ui5-ai-button-hidden[ui5-split-button]`)],K.prototype,`_hiddenSplitButton`,void 0),W([v(`@ui5/webcomponents-ai`)],K,`i18nBundleAi`,void 0),K=G=W([h({tag:`ui5-ai-button`,languageAware:!0,renderer:ue,template:ge,styles:U,shadowRootOptions:{delegatesFocus:!0}}),D(`click`,{bubbles:!0}),D(`arrow-button-click`,{bubbles:!0})],K),K.define()})),q,be=e((()=>{ye(),S(),q=c(`ui5-ai-button`,[`accessibilityAttributes`,`design`,`state`],[`arrowButtonPressed`,`disabled`],[],[`arrow-button-click`,`click`]),q.displayName=`Button`;try{q.displayName=`Button`,q.__docgenInfo={description:`The \`Button\` component serves as a button for AI-related scenarios. Users can trigger actions by clicking or tapping the \`Button\`
...
__Note:__ This adds a rendering cycle to your component.`,name:`waitForDefine`,required:!1,type:{name:`boolean`}}}}}catch{}})),xe=n({Default:()=>Z,__namedExportsOrder:()=>Q,default:()=>X}),J,Y,X,Z,Q,$=e((()=>{g(),le(),he(),ne(),j(),J=t(w(),1),H(),be(),Y=ce(),X={title:`Button`,component:q,argTypes:{children:{control:`text`}},args:{design:fe.Default},tags:[`package:@ui5/webcomponents-ai`,`experimental`]},Z={render(e){let t=(0,J.useRef)(null),n=(0,J.useRef)(null),[r,a]=(0,J.useState)(`generate`),[o,s]=(0,J.useState)(!1),c=()=>{t.current=setTimeout(()=>{a(`revise`)},3e3)},l=n=>{let r=n.target;switch(e.onClick(n),s(!1),r.state){case`generate`:a(`generating`),c();break;case`generating`:t.current&&=(clearTimeout(t.current),null),a(`generate`);break;case`revise`:s(!0);break}},u=e=>{e.detail.text===`Regenerate`&&(a(`generating`),c())};return(0,Y.jsxs)(Y.Fragment,{children:[(0,Y.jsxs)(q,{...e,onClick:l,state:r,ref:n,children:[(0,Y.jsx)(V,{name:`generate`,text:`Generate`,icon:`ai`}),(0,Y.jsx)(V,{name:`generating`,text:`Stop Generating`,icon:oe}),(0,Y.jsx)(V,{name:`revise`,text:`Revise`,icon:`ai`,endIcon:i})]}),o&&(0,Y.jsxs)(f,{opener:n.current,open:!0,onItemClick:u,onClose:()=>{s(!1)},children:[(0,Y.jsx)(m,{text:`Regenerate`}),(0,Y.jsx)(ee,{}),(0,Y.jsx)(m,{text:`Fix Spelling & Grammar`}),(0,Y.jsxs)(m,{text:`Change Tone`,children:[(0,Y.jsx)(m,{text:`Option 1`}),(0,Y.jsx)(m,{text:`Option 2`}),(0,Y.jsx)(m,{text:`Option 3`})]}),(0,Y.jsxs)(m,{text:`Adjust Length`,children:[(0,Y.jsx)(m,{text:`Shorten text`}),(0,Y.jsx)(m,{text:`Lengthen text`})]}),(0,Y.jsx)(m,{text:`Bulleted List`}),(0,Y.jsxs)(m,{text:`Translate`,children:[(0,Y.jsx)(m,{text:`English`}),(0,Y.jsx)(m,{text:`German`}),(0,Y.jsx)(m,{text:`Spanish`})]})]})]})}},Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...Z.parameters?.docs?.source}}},Q=[`Default`]}));$();export{Z as Default,Q as __namedExportsOrder,X as default,H as i,$ as n,V as r,xe as t};