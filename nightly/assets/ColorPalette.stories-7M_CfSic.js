import{w as n,j as e}from"./iframe-E6MBpCAt.js";import r from"./ColorPaletteMoreColorsTemplate-6a-oPmXf.js";import{a as s,C as t}from"./index-CNKASAa7.js";const l=n("ui5-color-palette",["accessibleName","accessibleNameRef"],[],[],["item-click"]);l.displayName="ColorPalette";try{l.displayName="ColorPalette",l.__docgenInfo={description:`The \`ColorPalette\` provides the users with a range of predefined colors. The colors are fixed and do not change with the theme.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onItemClick",required:!1,type:{name:"(event: Ui5CustomEvent<ColorPaletteDomRef, ColorPaletteItemClickEventDetail>) => void"}},accessibleName:{defaultValue:{value:"undefined"},description:`Defines the accessible name of the component.
...
**Note:** Available since [v2.20.0](https://github.com/UI5/webcomponents/releases/tag/v2.20.0) of **@ui5/webcomponents**.`,name:"accessibleNameRef",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
