import{n as y,c as p,b3 as w,F as g,b4 as _,f as P,d as R,b as D,s as c,cT as N,S as I,bk as T,e as x,aw as O,aA as b,aB as S,cU as j,cV as E,w as B,_ as k,q as C,j as o,Y as q}from"./iframe-30LZfzOw.js";import{a as A,C as r}from"./index-Bfr9XBDz.js";import{R as V}from"./ResponsivePopoverCommon.css-COYnkjUj.js";function U(){return y(_,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:this.placement,opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,accessibleName:this._colorPaletteTitle,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(w,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(A,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,accessibleName:this.accessibleName,accessibleNameRef:this.accessibleNameRef,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(n=>p("slot",{name:n._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(g,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}P("@ui5/webcomponents-theming","sap_horizon",async()=>R);P("@ui5/webcomponents","sap_horizon",async()=>D,"host");const M=`.ui5-cp-header{width:100%;height:var(--_ui5_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var a=function(n,e,s,i){var u=arguments.length,l=u<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,s):i,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(n,e,s,i);else for(var v=n.length-1;v>=0;v--)(m=n[v])&&(l=(u<3?m(l):u>3?m(e,s,l):m(e,s))||l);return u>3&&l&&Object.defineProperty(e,s,l),l},f;let t=f=class extends S{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1,this.placement="Bottom"}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){const e=this._colorPalette;e._currentlySelected?e._currentlySelected?.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e._defaultColorButton?.focus(),e.allColorsInPalette.forEach(s=>{const i=s.offsetHeight+4;s.style.setProperty("--_ui5_color_palette_item_height",`${i}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return f.i18nBundle.getText(j)}get _cancelButtonLabel(){return f.i18nBundle.getText(E)}get _open(){return this.open||void 0}};a([c({type:Boolean})],t.prototype,"showRecentColors",void 0);a([c({type:Boolean})],t.prototype,"showMoreColors",void 0);a([c({type:Boolean})],t.prototype,"showDefaultColor",void 0);a([c()],t.prototype,"defaultColor",void 0);a([c()],t.prototype,"accessibleName",void 0);a([c()],t.prototype,"accessibleNameRef",void 0);a([c({type:Boolean})],t.prototype,"open",void 0);a([c({converter:N})],t.prototype,"opener",void 0);a([c()],t.prototype,"placement",void 0);a([I({default:!0,type:HTMLElement,individualSlots:!0})],t.prototype,"colors",void 0);a([T("@ui5/webcomponents")],t,"i18nBundle",void 0);t=f=a([x({tag:"ui5-color-palette-popover",renderer:O,styles:[V,M],template:U}),b("item-click",{bubbles:!0}),b("close",{bubbles:!0})],t);t.define();const h=B("ui5-color-palette-popover",["accessibleName","accessibleNameRef","defaultColor","opener","placement"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);h.displayName="ColorPalettePopover";try{h.displayName="ColorPalettePopover",h.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const L={title:"Modals & Popovers / ColorPalettePopover",component:h,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3},open:k},tags:["package:@ui5/webcomponents"]},d={render(n){const e=C.useRef(null),[s,i]=C.useState(n.open),u=()=>{i(l=>!l)};return C.useEffect(()=>{i(n.open)},[n.open]),o.jsxs(o.Fragment,{children:[o.jsx(q,{onClick:u,ref:e,children:"Open ColorPalettePopover"}),o.jsxs(h,{...n,opener:e.current,open:s,onClose:l=>{n.onClose(l),i(!1)},children:[o.jsx(r,{value:"black"}),o.jsx(r,{value:"darkblue"}),o.jsx(r,{value:"#444444"}),o.jsx(r,{value:"rgb(0,200,0)"}),o.jsx(r,{value:"green"}),o.jsx(r,{value:"darkred"}),o.jsx(r,{value:"yellow"}),o.jsx(r,{value:"blue"}),o.jsx(r,{value:"cyan"}),o.jsx(r,{value:"orange"}),o.jsx(r,{value:"#5480e7"}),o.jsx(r,{value:"#ff6699"})]})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render(args) {
