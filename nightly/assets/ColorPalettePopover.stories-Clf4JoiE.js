import{l as y,c as p,dr as w,a1 as g,b8 as _,p as b,d as D,b as R,s as u,ds as x,A as I,aH as O,m as T,az as P,av as j,aA as S,z as E,dt as k,du as B,w as N,K as q,r as C,j as o,Q as A}from"./iframe-BSil-P7u.js";import{a as M,C as r}from"./index-Cod115eq.js";import{R as V}from"./ResponsivePopoverCommon.css-D6ugJ8J6.js";function U(){return y(_,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(w,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(M,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(g,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}b("@ui5/webcomponents-theming","sap_horizon",async()=>D);b("@ui5/webcomponents","sap_horizon",async()=>R);const L=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-18-0-rc-3_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
