import{l as y,c,cF as P,a1 as g,aS as _,p as w,d as D,b as R,s as h,d2 as I,A as T,aq as N,m as O,b6 as b,ai as S,b4 as x,z as k,d3 as q,d4 as E,w as j,K as V,r as C,j as o,Q as U}from"./iframe-Cv2DxGxx.js";import{a as M,C as r}from"./index-AVgnyenP.js";import{R as B}from"./ResponsivePopoverCommon.css-D3KSXKvs.js";function A(){return y(_,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[c("div",{slot:"header",class:"ui5-cp-header",children:c(P,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),c("div",{children:c(M,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>c("slot",{name:t._individualSlot}))})}),c("div",{slot:"footer",class:"ui5-cp-footer",children:c(g,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>D);w("@ui5/webcomponents","sap_horizon",async()=>R);const F=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-15-1_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,a,s){var u=arguments.length,n=u<3?e:s===null?s=Object.getOwnPropertyDescriptor(e,a):s,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,a,s);else for(var v=t.length-1;v>=0;v--)(f=t[v])&&(n=(u<3?f(n):u>3?f(e,a,n):f(e,a))||n);return u>3&&n&&Object.defineProperty(e,a,n),n},m;let l=m=class extends x{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){const e=this._colorPalette;e._currentlySelected?e._currentlySelected?.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e._defaultColorButton?.focus(),e.allColorsInPalette.forEach(a=>{const s=a.offsetHeight+4;a.style.setProperty(k("--_ui5_color_palette_item_height"),`${s}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(q)}get _cancelButtonLabel(){return m.i18nBundle.getText(E)}get _open(){return this.open||void 0}};i([h({type:Boolean})],l.prototype,"showRecentColors",void 0);i([h({type:Boolean})],l.prototype,"showMoreColors",void 0);i([h({type:Boolean})],l.prototype,"showDefaultColor",void 0);i([h()],l.prototype,"defaultColor",void 0);i([h({type:Boolean})],l.prototype,"open",void 0);i([h({converter:I})],l.prototype,"opener",void 0);i([T({default:!0,type:HTMLElement,individualSlots:!0})],l.prototype,"colors",void 0);i([N("@ui5/webcomponents")],l,"i18nBundle",void 0);l=m=i([O({tag:"ui5-color-palette-popover",renderer:S,styles:[B,F],template:A}),b("item-click",{bubbles:!0}),b("close",{bubbles:!0})],l);l.define();const p=j("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);p.displayName="ColorPalettePopover";try{p.displayName="ColorPalettePopover",p.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const L={title:"Modals & Popovers / ColorPalettePopover",component:p,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3},open:V},tags:["package:@ui5/webcomponents"]},d={render(t){const e=C.useRef(null),[a,s]=C.useState(t.open),u=()=>{s(n=>!n)};return C.useEffect(()=>{s(t.open)},[t.open]),o.jsxs(o.Fragment,{children:[o.jsx(U,{onClick:u,ref:e,children:"Open ColorPalettePopover"}),o.jsxs(p,{...t,opener:e.current,open:a,onClose:n=>{t.onClose(n),s(!1)},children:[o.jsx(r,{value:"black"}),o.jsx(r,{value:"darkblue"}),o.jsx(r,{value:"#444444"}),o.jsx(r,{value:"rgb(0,200,0)"}),o.jsx(r,{value:"green"}),o.jsx(r,{value:"darkred"}),o.jsx(r,{value:"yellow"}),o.jsx(r,{value:"blue"}),o.jsx(r,{value:"cyan"}),o.jsx(r,{value:"orange"}),o.jsx(r,{value:"#5480e7"}),o.jsx(r,{value:"#ff6699"})]})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...d.parameters?.docs?.source}}};const Y=["Default"],J=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:Y,default:L},Symbol.toStringTag,{value:"Module"}));export{J as C,d as D};
