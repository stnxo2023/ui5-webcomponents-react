import{l as y,c as p,dl as w,a1 as g,b7 as _,p as b,d as D,b as R,s as u,dm as x,A as I,aH as O,m as T,az as P,av as j,aA as S,z as E,dn as k,dp as B,w as N,K as q,r as C,j as o,Q as A}from"./iframe-CMRYeg3m.js";import{a as M,C as r}from"./index-CLkl0at7.js";import{R as V}from"./ResponsivePopoverCommon.css-CqBO6fZ3.js";function U(){return y(_,{hideArrow:!0,contentOnlyOnDesktop:!0,placement:"Bottom",opener:this.opener,open:this._open,onClose:this.onAfterClose,onOpen:this.onAfterOpen,children:[p("div",{slot:"header",class:"ui5-cp-header",children:p(w,{level:"H1",wrappingType:"None",children:this._colorPaletteTitle})}),p("div",{children:p(M,{showMoreColors:this.showMoreColors,showRecentColors:this.showRecentColors,showDefaultColor:this.showDefaultColor,defaultColor:this.defaultColor,popupMode:!0,onItemClick:this.onSelectedColor,children:this.colorPaletteColors.map(t=>p("slot",{name:t._individualSlot}))})}),p("div",{slot:"footer",class:"ui5-cp-footer",children:p(g,{design:"Transparent",onClick:this.closePopover,children:this._cancelButtonLabel})})]})}b("@ui5/webcomponents-theming","sap_horizon",async()=>D);b("@ui5/webcomponents","sap_horizon",async()=>R);const L=`.ui5-cp-header{width:100%;height:var(--_ui5-v2-17-0-rc-5_color-palette-button-height);display:flex;align-items:center}.ui5-cp-footer{width:100%;display:flex;justify-content:flex-end;align-items:center;margin:.1875rem 0}[ui5-responsive-popover]::part(content){padding:0}.ui5-cp-item-container{padding:.3125rem .6875rem}
`;var i=function(t,e,s,a){var c=arguments.length,n=c<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,s):a,f;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,s,a);else for(var v=t.length-1;v>=0;v--)(f=t[v])&&(n=(c<3?f(n):c>3?f(e,s,n):f(e,s))||n);return c>3&&n&&Object.defineProperty(e,s,n),n},m;let l=m=class extends S{constructor(){super(),this.showRecentColors=!1,this.showMoreColors=!1,this.showDefaultColor=!1,this.open=!1}get responsivePopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}get respPopover(){return this.shadowRoot.querySelector("[ui5-responsive-popover]")}closePopover(){this.open=!1}onAfterClose(){this.closePopover(),this.fireDecoratorEvent("close")}onAfterOpen(){const e=this._colorPalette;e._currentlySelected?e._currentlySelected?.focus():e.showRecentColors&&e.recentColorsElements.length?e.recentColorsElements[0].focus():e.showDefaultColor&&e._defaultColorButton?.focus(),e.allColorsInPalette.forEach(s=>{const a=s.offsetHeight+4;s.style.setProperty(E("--_ui5_color_palette_item_height"),`${a}px`)})}onSelectedColor(e){this.closePopover(),this.fireDecoratorEvent("item-click",e.detail)}get _colorPalette(){return this.responsivePopover.content[0].querySelector("[ui5-color-palette]")}isOpen(){return this.open}get colorPaletteColors(){return this.getSlottedNodes("colors")}get _colorPaletteTitle(){return m.i18nBundle.getText(k)}get _cancelButtonLabel(){return m.i18nBundle.getText(B)}get _open(){return this.open||void 0}};i([u({type:Boolean})],l.prototype,"showRecentColors",void 0);i([u({type:Boolean})],l.prototype,"showMoreColors",void 0);i([u({type:Boolean})],l.prototype,"showDefaultColor",void 0);i([u()],l.prototype,"defaultColor",void 0);i([u({type:Boolean})],l.prototype,"open",void 0);i([u({converter:x})],l.prototype,"opener",void 0);i([I({default:!0,type:HTMLElement,individualSlots:!0})],l.prototype,"colors",void 0);i([O("@ui5/webcomponents")],l,"i18nBundle",void 0);l=m=i([T({tag:"ui5-color-palette-popover",renderer:j,styles:[V,L],template:U}),P("item-click",{bubbles:!0}),P("close",{bubbles:!0})],l);l.define();const h=N("ui5-color-palette-popover",["defaultColor","opener"],["open","showDefaultColor","showMoreColors","showRecentColors"],[],["close","item-click"]);h.displayName="ColorPalettePopover";try{h.displayName="ColorPalettePopover",h.__docgenInfo={description:`Represents a predefined range of colors for easier selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const z={title:"Modals & Popovers / ColorPalettePopover",component:h,argTypes:{children:{control:{disable:!0}},defaultColor:{control:{type:"color"}}},parameters:{chromatic:{delay:1e3},open:q},tags:["package:@ui5/webcomponents"]},d={render(t){const e=C.useRef(null),[s,a]=C.useState(t.open),c=()=>{a(n=>!n)};return C.useEffect(()=>{a(t.open)},[t.open]),o.jsxs(o.Fragment,{children:[o.jsx(A,{onClick:c,ref:e,children:"Open ColorPalettePopover"}),o.jsxs(h,{...t,opener:e.current,open:s,onClose:n=>{t.onClose(n),a(!1)},children:[o.jsx(r,{value:"black"}),o.jsx(r,{value:"darkblue"}),o.jsx(r,{value:"#444444"}),o.jsx(r,{value:"rgb(0,200,0)"}),o.jsx(r,{value:"green"}),o.jsx(r,{value:"darkred"}),o.jsx(r,{value:"yellow"}),o.jsx(r,{value:"blue"}),o.jsx(r,{value:"cyan"}),o.jsx(r,{value:"orange"}),o.jsx(r,{value:"#5480e7"}),o.jsx(r,{value:"#ff6699"})]})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...d.parameters?.docs?.source}}};const F=["Default"],G=Object.freeze(Object.defineProperty({__proto__:null,Default:d,__namedExportsOrder:F,default:z},Symbol.toStringTag,{value:"Module"}));export{G as C,d as D};
