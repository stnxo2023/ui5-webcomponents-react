...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const b={title:"Inputs / ComboBox",component:n,argTypes:{children:{control:{disable:!0}},icon:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:d.None,icon:e.jsx(c,{name:h})},tags:["package:@ui5/webcomponents"]},r={render:a=>e.jsxs(n,{...a,children:[e.jsx(t,{text:"ComboBox Entry 1"}),e.jsx(t,{text:"ComboBox Entry 2"}),e.jsx(t,{text:"ComboBox Entry 3"}),e.jsx(t,{text:"ComboBox Entry 4"}),e.jsx(t,{text:"ComboBox Entry 5"})]})},s={render(a){return e.jsxs(n,{...a,children:[e.jsxs(o,{headerText:"Group 1",children:[e.jsx(t,{text:"ComboBox Entry 1"}),e.jsx(t,{text:"ComboBox Entry 2"})]}),e.jsxs(o,{headerText:"Group 2",children:[e.jsx(t,{text:"ComboBox Entry 3"}),e.jsx(t,{text:"ComboBox Entry 4"}),e.jsx(t,{text:"ComboBox Entry 5"})]})]})}},i={render:()=>e.jsxs(l,{justifyContent:x.SpaceBetween,children:[e.jsxs(l,{direction:m.Column,children:[e.jsx(p,{children:"StartsWithPerTerm (Default)"}),e.jsxs(n,{filter:"StartsWithPerTerm",children:[e.jsx(t,{text:"Austria"}),e.jsx(t,{text:"United Arab Emirates"}),e.jsx(t,{text:"Czech Republic"}),e.jsx(t,{text:"United Kingdom"}),e.jsx(t,{text:"China"}),e.jsx(t,{text:"Ukraine"}),e.jsx(t,{text:"Australia"}),e.jsx(t,{text:"Russia"})]})]}),e.jsxs(l,{direction:m.Column,children:[e.jsx(p,{children:"StartsWith"}),e.jsxs(n,{filter:"StartsWith",children:[e.jsx(t,{text:"Austria"}),e.jsx(t,{text:"United Arab Emirates"}),e.jsx(t,{text:"Czech Republic"}),e.jsx(t,{text:"United Kingdom"}),e.jsx(t,{text:"China"}),e.jsx(t,{text:"Ukraine"}),e.jsx(t,{text:"Australia"}),e.jsx(t,{text:"Russia"})]})]}),e.jsxs(l,{direction:m.Column,children:[e.jsx(p,{children:"Contains"}),e.jsxs(n,{filter:"Contains",children:[e.jsx(t,{text:"Austria"}),e.jsx(t,{text:"United Arab Emirates"}),e.jsx(t,{text:"Czech Republic"}),e.jsx(t,{text:"United Kingdom"}),e.jsx(t,{text:"China"}),e.jsx(t,{text:"Ukraine"}),e.jsx(t,{text:"Australia"}),e.jsx(t,{text:"Russia"})]})]})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...i.parameters?.docs?.source}}};const f=["Default","WithGroups","FilterTypes"],I=Object.freeze(Object.defineProperty({__proto__:null,Default:r,FilterTypes:i,WithGroups:s,__namedExportsOrder:f,default:b},Symbol.toStringTag,{value:"Module"}));export{I as C,r as D,i as F,s as W,o as a};
