import{n as e,o as t,r as n}from"./chunk-jRWAZmH_.js";import{Dg as r,Fu as i,Il as a,Ll as o,Q as s,Rl as c,Ym as l,Yu as u,op as d,r as f,zl as p}from"./iframe-dJJqxMUh.js";var m=n({Default:()=>v,__namedExportsOrder:()=>y,default:()=>_}),h,g,_,v,y,b=e((()=>{f(),h=t(r(),1),p(),s(),o(),g=l(),_={title:`Modals & Popovers / Dialog`,component:a,argTypes:{footer:{control:{disable:!0}},header:{control:{disable:!0}},children:{control:{disable:!0}}},args:{children:(0,g.jsxs)(u,{children:[(0,g.jsx)(i,{additionalText:`Fruits`,text:`Apples`}),(0,g.jsx)(i,{additionalText:`Fruits`,text:`Bananas`}),(0,g.jsx)(i,{additionalText:`Vegetables`,text:`Potato`})]}),headerText:`Dialog Header`,open:!1},tags:[`package:@ui5/webcomponents`]},v={render:e=>{let[t,n]=(0,h.useState)(e.open);return(0,h.useEffect)(()=>{n(e.open)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(d,{onClick:()=>{n(!0)},children:`Open Dialog`}),(0,g.jsx)(a,{...e,"data-sap-ui-fastnavgroup":`true`,className:`contentPartNoPadding footerPartNoPadding`,open:t,onClose:t=>{e.onClose(t),n(!1)},footer:(0,g.jsx)(c,{design:`Footer`,endContent:(0,g.jsx)(d,{"data-sap-ui-fastnavgroup":`true`,onClick:()=>{n(!1)},children:`Close`})})})]})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  render: args => {
