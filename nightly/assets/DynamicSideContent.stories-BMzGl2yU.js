...
__Note:__ This is a UI5 Web Component! [DynamicSideContent UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/DynamicSideContent) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"DynamicSideContent",props:{children:{defaultValue:null,description:"Defines the main content.\n\n__Supported Node Type/s:__ `Array<HTMLElement>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},sideContent:{defaultValue:null,description:`Defines the side content.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"sideContent",required:!1,type:{name:"UI5WCSlotsNode"}},onLayoutChange:{defaultValue:null,description:`Fires when the current breakpoint has been changed.
...
}`,...m.parameters?.docs?.source}}};const P=["Default"],Q=Object.freeze(Object.defineProperty({__proto__:null,Default:m,__namedExportsOrder:P,default:F},Symbol.toStringTag,{value:"Module"}));export{Q as C,m as D};
