import{a}from"./ExpandableText-CURbhTrc.js";import{w as o,aR as i}from"./iframe-dhwXAt1u.js";import{a as r}from"./addCustomCSSWithScoping-cc9WpAMd.js";r("ui5-expandable-text",`
...
__Note:__ This is a UI5 Web Component! [ExpandableText UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/ExpandableText) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"ExpandableText",props:{emptyIndicatorMode:{defaultValue:{value:'"Off"'},description:"Specifies if an empty indicator should be displayed when there is no text.",name:"emptyIndicatorMode",required:!1,type:{name:"enum",value:[{value:'"Off"'},{value:'"On"'},{value:'"Off"'},{value:'"On"'}]}},maxCharacters:{defaultValue:{value:"100"},description:'Maximum number of characters to be displayed initially. If the text length exceeds this limit, the text will be truncated with an ellipsis, and the "More" link will be displayed.',name:"maxCharacters",required:!1,type:{name:"number"}},overflowMode:{defaultValue:{value:'"InPlace"'},description:"Determines how the full text will be displayed.",name:"overflowMode",required:!1,type:{name:"enum",value:[{value:'"InPlace"'},{value:'"Popover"'},{value:'"InPlace"'},{value:'"Popover"'}]}},text:{defaultValue:{value:"undefined"},description:"Text of the component.",name:"text",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const l={title:"Data Display / ExpandableText",component:e,argTypes:{text:{control:"text"},maxCharacters:{control:"number"},children:{control:{disable:!0}},showOverflowInPopover:{control:{disable:!0}}},args:{emptyIndicatorMode:i.Off,overflowMode:a.InPlace,text:'             If "renderWhitespace" is set to true, there will be thirteen white spaces in front and after this sentence.             Lorem ipsum dolor st amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat',maxCharacters:100},tags:["package:@ui5/webcomponents"]},t={};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"{}",...t.parameters?.docs?.source}}};const s=["Default"],c=Object.freeze(Object.defineProperty({__proto__:null,Default:t,__namedExportsOrder:s,default:l},Symbol.toStringTag,{value:"Module"}));export{c as C,t as D};
