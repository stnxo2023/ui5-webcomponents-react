import{i as e}from"./preload-helper-usAeo7Bx.js";import{ea as t,mh as n,ta as r}from"./iframe-C5y_4zmC.js";import{J as i,_ as a,d as o,r as s}from"./blocks-C7LkMy0G.js";import{E as c,m as l,t as u,u as d}from"./components-v-58TleV.js";import{f,o as p}from"./AnalyticalTable.stories-DpKCmVsA.js";function m(e){let n={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,li:`li`,ol:`ol`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...i(),...e.components};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(o,{title:`Data Display / AnalyticalTable / FAQ`}),`
...
`,(0,g.jsxs)(n.p,{children:[`By default, the `,(0,g.jsx)(n.code,{children:`AnalyticalTable`}),` resets most table state whenever the `,(0,g.jsx)(n.code,{children:`data`}),` or `,(0,g.jsx)(n.code,{children:`columns`}),` reference changes.`]}),`
`,(0,g.jsx)(n.h3,{id:`what-resets-when`,children:`What resets when?`}),`
`,(0,g.jsxs)(n.p,{children:[`Each `,(0,g.jsx)(n.code,{children:`autoReset*`}),` option defaults to `,(0,g.jsx)(n.code,{children:`true`}),`. Most trigger on `,(0,g.jsx)(n.strong,{children:(0,g.jsx)(n.code,{children:`data`})}),` changes, but `,(0,g.jsx)(n.code,{children:`autoResetResize`}),` is the exception - it triggers on `,(0,g.jsx)(n.strong,{children:(0,g.jsx)(n.code,{children:`columns`})}),` changes.`]}),`
`,(0,g.jsxs)(`details`,{children:[(0,g.jsxs)(`summary`,{children:[`Full list of `,(0,g.jsx)(`code`,{children:`autoReset*`}),` options`]}),(0,g.jsxs)(n.table,{children:[(0,g.jsx)(n.thead,{children:(0,g.jsxs)(n.tr,{children:[(0,g.jsxs)(n.th,{children:[(0,g.jsx)(n.code,{children:`reactTableOptions`}),` option`]}),(0,g.jsx)(n.th,{children:`Default`}),(0,g.jsx)(n.th,{children:`Resets on`}),(0,g.jsx)(n.th,{children:`What it resets`})]})}),(0,g.jsxs)(n.tbody,{children:[(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetSelectedRows`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsxs)(n.td,{children:[`Row selection (`,(0,g.jsx)(n.code,{children:`selectedRowIds`}),`)`]})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetSortBy`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsxs)(n.td,{children:[`Sort state (unless `,(0,g.jsx)(n.code,{children:`manualSortBy`}),`)`]})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetFilters`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsxs)(n.td,{children:[`Filter state (unless `,(0,g.jsx)(n.code,{children:`manualFilters`}),`)`]})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetGlobalFilter`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsxs)(n.td,{children:[`Global filter (unless `,(0,g.jsx)(n.code,{children:`manualGlobalFilter`}),`)`]})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetGroupBy`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsxs)(n.td,{children:[`Grouping state (unless `,(0,g.jsx)(n.code,{children:`manualGroupBy`}),`)`]})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetExpanded`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsx)(n.td,{children:`Expanded rows`})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetHiddenColumns`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`data`}),` change`]}),(0,g.jsx)(n.td,{children:`Hidden columns`})]}),(0,g.jsxs)(n.tr,{children:[(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`autoResetResize`})}),(0,g.jsx)(n.td,{children:(0,g.jsx)(n.code,{children:`true`})}),(0,g.jsxs)(n.td,{children:[(0,g.jsx)(n.code,{children:`columns`}),` change`]}),(0,g.jsx)(n.td,{children:`User-resized column widths`})]})]})]})]}),`
`,(0,g.jsxs)(n.p,{children:[(0,g.jsx)(n.strong,{children:`Important:`}),` Column resize widths are never reset by `,(0,g.jsx)(n.code,{children:`data`}),` changes - only by `,(0,g.jsx)(n.code,{children:`columns`}),` changes. If you want to preserve user-resized widths across column changes, set `,(0,g.jsx)(n.code,{children:`autoResetResize: false`}),`.`]}),`
`,(0,g.jsxs)(n.h3,{id:`retaincolumnwidth-prop`,children:[(0,g.jsx)(n.code,{children:`retainColumnWidth`}),` prop`]}),`
`,(0,g.jsxs)(n.p,{children:[(0,g.jsx)(n.code,{children:`retainColumnWidth`}),` is a separate mechanism from `,(0,g.jsx)(n.code,{children:`autoResetResize`}),`. It controls what happens on `,(0,g.jsx)(n.strong,{children:`container resizes`}),` (e.g., window resize):`]}),`
`,(0,g.jsxs)(n.ul,{children:[`
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.strong,{children:`Without`}),` `,(0,g.jsx)(n.code,{children:`retainColumnWidth`}),`: A container resize clears user-resized column widths and triggers dynamic width recalculation.`]}),`
`,(0,g.jsxs)(n.li,{children:[(0,g.jsx)(n.strong,{children:`With`}),` `,(0,g.jsx)(n.code,{children:`retainColumnWidth`}),`: User-resized column widths are preserved across container resizes.`]}),`
`]}),`
`,(0,g.jsx)(n.h3,{id:`keeping-state-across-data-updates`,children:`Keeping state across data updates`}),`
`,(0,g.jsxs)(n.p,{children:[`To prevent automatic resets when updating data, set the corresponding `,(0,g.jsx)(n.code,{children:`autoReset*`}),` option to `,(0,g.jsx)(n.code,{children:`false`}),` in `,(0,g.jsx)(n.code,{children:`reactTableOptions`}),`. The ref-based flag shown below is optional - it avoids an unnecessary re-render by reading the flag during render instead of toggling state:`]}),`
`,(0,g.jsx)(n.pre,{children:(0,g.jsx)(n.code,{className:`language-jsx`,children:`const [data, setData] = useState([])
...
`,(0,g.jsx)(`br`,{}),`
`,(0,g.jsx)(`br`,{}),`
`,(0,g.jsx)(d,{})]})}function h(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,g.jsx)(t,{...e,children:(0,g.jsx)(m,{...e})}):m(e)}var g;e((()=>{g=n(),c(),u(),a(),r(),f()}))();export{h as default};