...
`,(0,_.jsxs)(n.li,{children:[(0,_.jsx)(d,{type:`custom`}),`: There are no global design or UX specifications for this component, or it deviates from them partially or fully. More details can be found in the component’s description.`]}),`
`,(0,_.jsxs)(n.li,{children:[(0,_.jsx)(d,{type:`experimental`}),`: The component or pattern is in an experimental state, meaning changes to its public API may occur without a major version update (`,(0,_.jsx)(n.code,{children:`v3.0.0`}),`).`]}),`
`,(0,_.jsxs)(n.li,{children:[(0,_.jsx)(d,{type:`deprecated`}),`: The component is deprecated and will be removed in the next major version update (`,(0,_.jsx)(n.code,{children:`v3.0.0`}),`). More details can be found in the component's description.`]}),`
`]}),`
...
`})}),`
`,(0,_.jsx)(u,{})]})}function g(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,_.jsx)(t,{...e,children:(0,_.jsx)(h,{...e})}):h(e)}var _;e((()=>{_=n(),s(),a(),l(),r(),m(),f()}))();export{g as default};