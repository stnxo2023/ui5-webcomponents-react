import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./jsx-runtime-O9QVJvLM.js";import{t as n}from"./MessageStrip-BJ04gffT.js";import{u as r}from"./iframe-CkFIdUqc.js";import{A as i,_ as a,d as o}from"./blocks-CPeRNyGc.js";import{E as s,m as c,t as l,u,v as d,y as f}from"./components-u94k_Ttd.js";var p,m=e((()=>{p=``+new URL(`sb-pkg-filter-B5sbXu1N.png`,import.meta.url).href}));function h(e){let t={a:`a`,blockquote:`blockquote`,br:`br`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,"ui5-link":`ui5-link`,ul:`ul`,...i(),...e.components},r=t[`ui5-link`];return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(o,{title:`FAQ`}),`
`,(0,_.jsx)(c,{}),`
`,(0,_.jsx)(t.h1,{id:`faq`,children:`FAQ`}),`
`,(0,_.jsx)(n,{hideCloseButton:!0,children:(0,_.jsxs)(_.Fragment,{children:[`Please also take a look at the FAQ of`,` `,(0,_.jsx)(r,{href:`https://ui5.github.io/webcomponents/docs/FAQ/`,children:`UI5 Web Components`}),`.`]})}),`
`,(0,_.jsx)(`br`,{}),`
`,(0,_.jsx)(`br`,{}),`
...
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(d,{type:`custom`}),`: There are no global design or UX specifications for this component, or it deviates from them partially or fully. More details can be found in the component’s description.`]}),`
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(d,{type:`experimental`}),`: The component or pattern is in an experimental state, meaning changes to its public API may occur without a major version update (`,(0,_.jsx)(t.code,{children:`v3.0.0`}),`).`]}),`
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(d,{type:`deprecated`}),`: The component is deprecated and will be removed in the next major version update (`,(0,_.jsx)(t.code,{children:`v3.0.0`}),`). More details can be found in the component's description.`]}),`
`]}),`
...
`,(0,_.jsx)(n,{hideCloseButton:!0,design:`Critical`,children:(0,_.jsxs)(_.Fragment,{children:[`The codemod is a best-effort attempt to help you migrate to direct imports. Please review the generated code thoroughly!`,(0,_.jsx)(t.br,{}),(0,_.jsx)(t.strong,{children:`Applying the codemod might break your code formatting, so please don't forget to run prettier and/or eslint after you've applied the codemod!`})]})}),`
...
`})}),`
`,(0,_.jsx)(u,{})]})}function g(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,_.jsx)(t,{...e,children:(0,_.jsx)(h,{...e})}):h(e)}var _;e((()=>{_=t(),s(),a(),l(),r(),m(),f()}))();export{g as default};