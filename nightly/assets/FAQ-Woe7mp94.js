import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{t}from"./jsx-runtime-CFwixLRt.js";import{t as n}from"./MessageStrip-BaJ3UPzT.js";import{u as r}from"./iframe-DB_r2er9.js";import{i}from"./react-B0KOWr-5.js";import{E as a,g as o,h as s,m as c,t as l,u}from"./components-Ca7YWk3L.js";import{_ as d,d as f}from"./blocks-Dbrcsz24.js";var p,m=e((()=>{p=``+new URL(`sb-pkg-filter-B5sbXu1N.png`,import.meta.url).href}));function h(e){let t={a:`a`,blockquote:`blockquote`,br:`br`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,"ui5-link":`ui5-link`,ul:`ul`,...i(),...e.components},r=t[`ui5-link`];return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(f,{title:`FAQ`}),`
`,(0,_.jsx)(o,{}),`
...
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(c,{type:`custom`}),`: There are no global design or UX specifications for this component, or it deviates from them partially or fully. More details can be found in the component’s description.`]}),`
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(c,{type:`experimental`}),`: The component or pattern is in an experimental state, meaning changes to its public API may occur without a major version update (`,(0,_.jsx)(t.code,{children:`v3.0.0`}),`).`]}),`
`,(0,_.jsxs)(t.li,{children:[(0,_.jsx)(c,{type:`deprecated`}),`: The component is deprecated and will be removed in the next major version update (`,(0,_.jsx)(t.code,{children:`v3.0.0`}),`). More details can be found in the component's description.`]}),`
`]}),`
...
`})}),`
`,(0,_.jsx)(u,{})]})}function g(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,_.jsx)(t,{...e,children:(0,_.jsx)(h,{...e})}):h(e)}var _;e((()=>{_=t(),a(),d(),l(),r(),m(),s()}))();export{g as default};