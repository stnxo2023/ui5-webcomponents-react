import{i as e}from"./preload-helper-usAeo7Bx.js";import{cu as t,lh as n,lu as r}from"./iframe-DJROyjuH.js";import{J as i,_ as a,d as o,o as s,r as c,u as l}from"./blocks-BAg0rPxk.js";import{E as u,S as d,b as f,f as p,t as m,u as h}from"./components-gO_z0wjs.js";import{n as g,t as _}from"./SubcomponentsSection-Da9yr5rF.js";import{Default as v,IdentifyInputEventOrigin as y,InDynamicPage as b,WithLogic as x,WithReordering as S,n as C,t as w}from"./FilterBar.stories-DW7lE8SM.js";function T(e){let n={code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,...i(),...e.components};return(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(o,{of:w}),`
`,(0,D.jsx)(p,{of:w,subComponents:[`FilterGroupItem`]}),`
`,(0,D.jsx)(`br`,{}),`
...
`,(0,D.jsx)(n.h2,{id:`filterbar-with-logic`,children:`FilterBar with logic`}),`
`,(0,D.jsx)(n.p,{children:`This is a basic example of how the FilterBar could be used inside an app.`}),`
`,(0,D.jsx)(c,{of:x}),`
`,(0,D.jsx)(n.h3,{id:`code`,children:`Code`}),`
`,(0,D.jsxs)(`details`,{children:[(0,D.jsx)(`summary`,{children:`Show Code`}),(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-tsx`,children:`const initialState = {
  age: 37,
  countries: {},
  currency: 'USD',
  date: '',
...
`})})]}),`
`,(0,D.jsx)(n.h2,{id:`filterbar-with-reordering`,children:`FilterBar with Reordering`}),`
`,(0,D.jsxs)(n.p,{children:[`To enable the reordering feature set `,(0,D.jsx)(n.code,{children:`enableReordering`}),` to `,(0,D.jsx)(n.code,{children:`true`}),`.`]}),`
`,(0,D.jsx)(c,{of:S}),`
`,(0,D.jsx)(n.h3,{id:`code-1`,children:`Code`}),`
`,(0,D.jsxs)(`details`,{children:[(0,D.jsx)(`summary`,{children:`Show Code`}),(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-jsx`,children:`function FilterBarWithReordering(props) {
...
`})})]}),`
`,(0,D.jsx)(n.h2,{id:`filterbar-in-a-dynamicpage`,children:`FilterBar in a DynamicPage`}),`
`,(0,D.jsxs)(n.p,{children:[`When a FilterBar is used inside e.g. a DynamicPage, `,(0,D.jsx)(n.code,{children:`hideToolbar`}),` should be set to `,(0,D.jsx)(n.code,{children:`true`}),`, since the `,(0,D.jsx)(n.code,{children:`VariantManagement`}),` of
the page is then responsible for the different views.`]}),`
`,(0,D.jsx)(c,{of:b}),`
`,(0,D.jsx)(n.h2,{id:`identify-the-origin-of-an-inputfilter-event`,children:`Identify the origin of an input/filter event`}),`
`,(0,D.jsxs)(n.p,{children:[`When filters in the FilterBar should only be updated directly within the FilterBar itself, or when a user presses 'OK' in the filters dialog,
it's essential to determine the origin of the corresponding event (e.g., `,(0,D.jsx)(n.code,{children:`onInput`}),`).
To do this, you can check the `,(0,D.jsx)(n.code,{children:`dataset`}),` of the `,(0,D.jsx)(n.code,{children:`parentElement`}),` of the `,(0,D.jsx)(n.code,{children:`currentTarget`}),`.
Depending on where the user interacts with the input component, the `,(0,D.jsx)(n.code,{children:`dataset`}),` of the parent will indicate either `,(0,D.jsx)(n.code,{children:`inFilterBar: "true"`}),` or `,(0,D.jsx)(n.code,{children:`inFiltersDialog: "true"`}),`.`]}),`
`,(0,D.jsx)(n.h3,{id:`example-1`,children:`Example:`}),`
`,(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-jsx`,children:`<FilterGroupItem filterKey="0" label="Input">
  <StepInput onInput={handleInput} />
</FilterGroupItem>
`})}),`
`,(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-js`,children:`const handleInput = (event) => {
...
`})}),`
`,(0,D.jsx)(c,{of:y,source:!0}),`
`,(0,D.jsx)(l,{children:_}),`
`,(0,D.jsx)(n.h2,{id:`filtergroupitem`,children:`FilterGroupItem`}),`
`,(0,D.jsx)(s,{of:t}),`
`,(0,D.jsx)(d,{metaOf:w,of:t,exclude:[`data-index`]}),`
`,(0,D.jsx)(h,{})]})}function E(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,D.jsx)(t,{...e,children:(0,D.jsx)(T,{...e})}):T(e)}var D;e((()=>{D=n(),u(),m(),g(),a(),r(),C()}))();export{E as default};