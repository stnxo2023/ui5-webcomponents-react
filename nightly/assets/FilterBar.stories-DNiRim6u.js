import{j as e,T as X,H as L,r as y,J as x}from"./iframe-CRwp3Tpg.js";import{a as j,F as t}from"./index-C7VBNv3s.js";import{F as m,a as Z}from"./index-DtgT2jRs.js";import{V as P,a as K}from"./VariantItem-DntkPXeG.js";import{R as A}from"./index-C5Nm0jEl.js";import{M as v}from"./index-BqImjfSk.js";import{T as s}from"./index-B-Pdg7o9.js";import{S as R}from"./index-Dzeoy_HR.js";import{D as k}from"./index-D8J7jJJg.js";import{D as ee,a as te,b as re}from"./index-B9dJ6aDs.js";import{I as C}from"./index-xFdAYmE4.js";import{S as D}from"./index-DW8zvMUE.js";import{S as F}from"./index-BfNpixh1.js";import{O as i}from"./index-CRs2PjFa.js";import{M as w,a}from"./index-DbsdpZ0s.js";import{C as _,a as I}from"./index-BDvlKpKL.js";import{D as ie}from"./index-DZIjr0eJ.js";import{L as h}from"./index-B3NhI5Qb.js";const{fn:le}=__STORYBOOK_MODULE_TEST__,ne={title:"Layouts & Floorplans / FilterBar",component:j,args:{search:e.jsx(C,{}),header:e.jsx(X,{level:L.H2,size:L.H4,children:"FilterBar"}),filterContainerWidth:"13.125rem",onFiltersDialogOpen:le()},argTypes:{activeFiltersCount:{control:"number"},search:{control:{disable:!0}},header:{control:{disable:!0}},children:{control:{disable:!0}},filterContainerWidth:{control:"text"},as:{control:{disable:!0}}},tags:["package:@ui5/webcomponents-react"]},T={render:l=>e.jsxs(j,{...l,children:[e.jsx(t,{label:"StepInput",required:!0,filterKey:"stepInput",children:e.jsx(D,{required:!0})}),e.jsx(t,{label:"RatingIndicator",filterKey:"ratingIndicator",children:e.jsx(A,{})}),e.jsx(t,{label:"MultiInput",active:!0,filterKey:"multiInput",children:e.jsx(v,{tokens:e.jsxs(e.Fragment,{children:[e.jsx(s,{text:"Argentina",selected:!0}),e.jsx(s,{text:"Bulgaria"}),e.jsx(s,{text:"England"}),e.jsx(s,{text:"Finland"})]})})}),e.jsx(t,{label:"Input",filterKey:"input",children:e.jsx(C,{placeholder:"Placeholder"})}),e.jsx(t,{label:"Switch",filterKey:"switch",children:e.jsx(R,{})}),e.jsx(t,{label:"SELECT w/ initial selected",hiddenInFilterBar:!0,filterKey:"selectInitialSelected",children:e.jsxs(F,{children:[e.jsx(i,{children:"Option 1"}),e.jsx(i,{selected:!0,children:"Option 2"}),e.jsx(i,{children:"Option 3"}),e.jsx(i,{children:"Option 4"})]})}),e.jsx(t,{label:"SELECT w/o initial selected",filterKey:"selectNoInitialSelected",children:e.jsxs(F,{children:[e.jsx(i,{"data-key":"Test 1",selected:!0,icon:"add",children:"Test 1"}),e.jsx(i,{"data-key":"Test 2",icon:"add",children:"Test 2"}),e.jsx(i,{"data-key":"Test 3",icon:"add",children:"Test 3"}),e.jsx(i,{"data-key":"Test 4",icon:"add",children:"Test 4"}),e.jsx(i,{"data-key":"Test 5",icon:"add",children:"Test 5"})]})}),e.jsx(t,{label:"MultiBox w/ initial selected",groupName:"Group 1",filterKey:"multiBoxInitialSelected",children:e.jsxs(w,{children:[e.jsx(a,{text:"MultiComboBoxItem 1"}),e.jsx(a,{selected:!0,text:"MultiComboBoxItem 2"}),e.jsx(a,{text:"MultiComboBoxItem 3"}),e.jsx(a,{selected:!0,text:"MultiComboBoxItem 4"})]})}),e.jsx(t,{label:"ComboBox w/o initial selected",groupName:"Group 2",filterKey:"comboBoxNoInitialSelected",children:e.jsxs(_,{children:[e.jsx(I,{text:"ComboBoxItem 1"}),e.jsx(I,{text:"ComboBoxItem 2"}),e.jsx(I,{text:"ComboBoxItem 3"}),e.jsx(I,{text:"ComboBoxItem 4"})]})}),e.jsx(t,{label:"Date Picker",groupName:"Group 2",filterKey:"datePicker",children:e.jsx(k,{style:{minWidth:"auto"}})})]})},ae={age:37,countries:{},currency:"USD",date:"",dateRange:"",search:""};function oe(l,r){switch(r.type){case"SET_AGE":return{...l,age:r.payload};case"SET_COUNTRIES":return{...l,countries:r.payload};case"SET_CURRENCY":return{...l,currency:r.payload};case"SET_DATE":return{...l,date:r.payload};case"SET_DATE_RANGE":return{...l,dateRange:r.payload};case"SET_SEARCH":return{...l,search:r.payload};case"DIALOG_RESTORE":return r.payload;default:return l}}const S={render:()=>{const[l,r]=y.useReducer(oe,ae),[c,b]=y.useState(new Set(["age","countries"])),{age:g,countries:d,currency:u,date:p,dateRange:o,search:E}=l,M=y.useRef(void 0),V=n=>{r({type:"SET_SEARCH",payload:n.target.value})},N=n=>{r({type:"SET_AGE",payload:n.target.value})},q=n=>{const B=n.detail.items.reduce((z,Q)=>({...z,[Q.getAttribute("text").toLowerCase()]:!0}),{});r({type:"SET_COUNTRIES",payload:B})},H=n=>{r({type:"SET_CURRENCY",payload:n.detail.selectedOption.textContent})},U=n=>{n.detail.valid&&r({type:"SET_DATE",payload:n.detail.value})},W=n=>{n.detail.valid&&r({type:"SET_DATE_RANGE",payload:n.detail.value})},$=()=>{M.current=l},Y=n=>{const B=n.selectedFilterKeys;r({type:"DIALOG_RESTORE",payload:M.current}),b(new Set(B))},J=n=>{const B=n.selectedFilterKeys;b(new Set(B))};return e.jsxs(e.Fragment,{children:[e.jsxs(j,{showResetButton:!0,search:e.jsx(C,{onInput:V}),onRestore:Y,onFiltersDialogOpen:$,onFiltersDialogSelectionChange:J,children:[e.jsx(t,{filterKey:"age",label:"Age",active:!!g,required:!0,children:e.jsx(D,{value:g,onChange:N,required:!0})}),e.jsx(t,{filterKey:"countries",label:"Countries",active:Object.keys(d).length>0,hiddenInFilterBar:!c.has("countries"),children:e.jsxs(w,{onSelectionChange:q,children:[e.jsx(a,{text:"Argentina",selected:d.argentina}),e.jsx(a,{text:"Bulgaria",selected:d.bulgaria}),e.jsx(a,{text:"Finland",selected:d.finland}),e.jsx(a,{text:"Germany",selected:d.germany}),e.jsx(a,{text:"Ireland",selected:d.ireland}),e.jsx(a,{text:"Ukraine",selected:d.ukraine}),e.jsx(a,{text:"USA",selected:d.usa})]})}),e.jsx(t,{filterKey:"currency",label:"Currency",active:!!u,hiddenInFilterBar:!c.has("currency"),children:e.jsxs(F,{onChange:H,children:[e.jsx(i,{additionalText:"€",selected:u==="EUR",children:"EUR"}),e.jsx(i,{additionalText:"$",selected:u==="USD",children:"USD"}),e.jsx(i,{additionalText:"£",selected:u==="GBP",children:"GBP"}),e.jsx(i,{additionalText:"₺",selected:u==="TRY",children:"TRY"}),e.jsx(i,{additionalText:"¥",selected:u==="JPY",children:"JPY"})]})}),e.jsx(t,{filterKey:"date",label:"Date",active:!!p,hiddenInFilterBar:!c.has("date"),children:e.jsx(ie,{value:p,onChange:U,style:{minWidth:"auto"}})}),e.jsx(t,{filterKey:"date-range",label:"Date Range",active:!!o,hiddenInFilterBar:!c.has("date-range"),children:e.jsx(k,{value:o,onChange:W,style:{minWidth:"auto"}})})]}),e.jsxs(m,{direction:Z.Column,children:[e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Search"}),e.jsx(x,{children:E})]}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Age"}),e.jsx(x,{children:g})]}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Countries"}),e.jsx(x,{children:JSON.stringify(d)})]}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Currency"}),e.jsx(x,{children:u})]}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Date"}),e.jsx(x,{children:p})]}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Date Range"}),e.jsx(x,{children:o})]}),e.jsx("hr",{style:{width:"100%"}}),e.jsxs(m,{children:[e.jsx(h,{showColon:!0,children:"Visible Filters"}),e.jsx(x,{children:Array.from(c).join(", ")})]})]})]})}},O={name:"In DynamicPage",render:l=>e.jsx(ee,{style:{height:"800px",position:"relative",zIndex:0},titleArea:e.jsx(re,{style:{minHeight:"0px"},heading:e.jsxs(P,{onClick:r=>{r.stopPropagation()},children:[e.jsx(K,{children:"Variant 1"}),e.jsx(K,{selected:!0,children:"Variant 2"})]}),snappedHeading:e.jsxs(P,{onClick:r=>{r.stopPropagation()},children:[e.jsx(K,{children:"Variant 1"}),e.jsx(K,{selected:!0,children:"Variant 2"})]})}),headerArea:e.jsx(te,{children:e.jsxs(j,{...l,hideToolbar:!0,children:[e.jsx(t,{filterKey:"StepInput",label:"StepInput",children:e.jsx(D,{})}),e.jsx(t,{filterKey:"MultiInput",label:"MultiInput",active:!0,required:!0,children:e.jsx(v,{required:!0,tokens:e.jsxs(e.Fragment,{children:[e.jsx(s,{text:"Argentina",selected:!0}),e.jsx(s,{text:"Bulgaria"}),e.jsx(s,{text:"England"}),e.jsx(s,{text:"Finland"})]})})}),e.jsx(t,{filterKey:"Input",label:"Input",children:e.jsx(C,{placeholder:"Placeholder"})}),e.jsx(t,{filterKey:"Switch",label:"Switch",hiddenInFilterBar:!0,children:e.jsx(R,{})}),e.jsx(t,{filterKey:"select-init-selected",label:"SELECT w/ initial selected",hiddenInFilterBar:!0,children:e.jsxs(F,{children:[e.jsx(i,{children:"Option 1"}),e.jsx(i,{selected:!0,children:"Option 2"}),e.jsx(i,{children:"Option 3"}),e.jsx(i,{children:"Option 4"})]})}),e.jsx(t,{filterKey:"select-not-selected",label:"SELECT w/o initial selected",hiddenInFilterBar:!0,children:e.jsxs(F,{children:[e.jsx(i,{"data-key":"Test 1",selected:!0,icon:"add",children:"Test 1"}),e.jsx(i,{"data-key":"Test 2",icon:"add",children:"Test 2"}),e.jsx(i,{"data-key":"Test 3",icon:"add",children:"Test 3"}),e.jsx(i,{"data-key":"Test 4",icon:"add",children:"Test 4"}),e.jsx(i,{"data-key":"Test 5",icon:"add",children:"Test 5"})]})}),e.jsx(t,{filterKey:"mcb-selected",label:"MultBox w/ initial selected",groupName:"Group 1",hiddenInFilterBar:!0,children:e.jsxs(w,{children:[e.jsx(a,{text:"MultiComboBoxItem 1"}),e.jsx(a,{selected:!0,text:"MultiComboBoxItem 2"}),e.jsx(a,{text:"MultiComboBoxItem 3"}),e.jsx(a,{selected:!0,text:"MultiComboBoxItem 4"})]})}),e.jsx(t,{filterKey:"cb-not-selected",label:"ComboBox w/o initial selected",groupName:"Group 2",hiddenInFilterBar:!0,children:e.jsxs(_,{children:[e.jsx(I,{text:"ComboBoxItem 1"}),e.jsx(I,{text:"ComboBoxItem 2"}),e.jsx(I,{text:"ComboBoxItem 3"}),e.jsx(I,{text:"ComboBoxItem 4"})]})}),e.jsx(t,{filterKey:"date-picker",label:"Date Picker",groupName:"Group 2",children:e.jsx(k,{style:{minWidth:"auto"}})})]})}),children:e.jsx("div",{style:{background:"cadetblue",height:"200px",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsx(x,{style:{color:"white"},children:"Content"})})})},f={render(l){const r=y.useId(),[c,b]=y.useState({0:!0,1:!0,2:!0,3:!0,5:!0}),[g,d]=y.useState(["0","1","2","3","4","5"]),u=p=>{d(p.detail.reorderedFilterKeys),b(p.detail.selectedFilterKeys.reduce((o,E)=>(o[E]=!0,o),{}))};return e.jsx(j,{...l,enableReordering:!0,showResetButton:!0,onFiltersDialogSave:u,children:g.map(p=>{const o=!c[p];switch(p){case"0":return e.jsx(t,{filterKey:"0",label:"StepInput",required:!0,children:e.jsx(D,{required:!0})},`${r}-0`);case"1":return e.jsx(t,{filterKey:"1",label:"RatingIndicator",hiddenInFilterBar:o,children:e.jsx(A,{})},`${r}-1`);case"2":return e.jsx(t,{filterKey:"2",label:"MultiInput",active:!0,hiddenInFilterBar:o,children:e.jsx(v,{tokens:e.jsxs(e.Fragment,{children:[e.jsx(s,{text:"Argentina",selected:!0}),e.jsx(s,{text:"Bulgaria"}),e.jsx(s,{text:"England"}),e.jsx(s,{text:"Finland"})]})})},`${r}-2`);case"3":return e.jsx(t,{filterKey:"3",label:"Input",hiddenInFilterBar:o,children:e.jsx(C,{placeholder:"Placeholder"})},`${r}-3`);case"4":return e.jsx(t,{filterKey:"4",label:"Switch",hiddenInFilterBar:o,children:e.jsx(R,{})},`${r}-4`);case"5":return e.jsx(t,{filterKey:"5",label:"SELECT w/ initial selected",hiddenInFilterBar:o,children:e.jsxs(F,{children:[e.jsx(i,{children:"Option 1"}),e.jsx(i,{selected:!0,children:"Option 2"}),e.jsx(i,{children:"Option 3"}),e.jsx(i,{children:"Option 4"})]})},`${r}-5`);default:return null}})})}},G={parameters:{docs:{source:{type:"code",transform:()=>`
...
}`,...G.parameters?.docs?.source}}};const se=["Default","WithLogic","InDynamicPage","WithReordering","IdentifyInputEventOrigin"],fe=Object.freeze(Object.defineProperty({__proto__:null,Default:T,IdentifyInputEventOrigin:G,InDynamicPage:O,WithLogic:S,WithReordering:f,__namedExportsOrder:se,default:ne},Symbol.toStringTag,{value:"Module"}));export{fe as C,T as D,O as I,S as W,f as a,G as b};
