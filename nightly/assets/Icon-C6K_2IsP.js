import{i as e}from"./preload-helper-B45gAKPr.js";import{n as t}from"./Icon-C105MiPQ.js";import{t as n}from"./src-DROqZYPT.js";import{n as r}from"./withWebComponent-DZ9c6ddo.js";var i,a=e((()=>{t(),n(),i=r(`ui5-icon`,[`accessibleName`,`design`,`mode`,`name`],[`showTooltip`],[`fontIcon`],[`click`]),i.displayName=`Icon`;try{i.displayName=`Icon`,i.__docgenInfo={description:`The \`Icon\` component represents an SVG icon.
...
**Note:** Available since [v1.9.2](https://github.com/UI5/webcomponents/releases/tag/v1.9.2) of **@ui5/webcomponents**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Icon/index.d.ts`,name:`IconAttributes`},required:!1,tags:{default:`"Default"`},type:{name:`enum`,raw:`"Critical" | "Neutral" | "Positive" | "Negative" | "Information" | "Default" | IconDesign | "Contrast" | "NonInteractive"`,value:[{value:`"Critical"`},{value:`"Neutral"`},{value:`"Positive"`},{value:`"Negative"`},{value:`"Information"`},{value:`"Default"`},{value:`"Contrast"`,description:`Contrast design`,fullComment:`Contrast design
