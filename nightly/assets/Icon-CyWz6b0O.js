import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{n as t}from"./Icon-eEXn1T-O.js";import{t as n}from"./src-gAF68HEc.js";import{n as r}from"./withWebComponent-Bq8vFkn_.js";var i,a=e((()=>{t(),n(),i=r(`ui5-icon`,[`accessibleName`,`design`,`mode`,`name`],[`showTooltip`],[`fontIcon`],[`click`]),i.displayName=`Icon`;try{i.displayName=`Icon`,i.__docgenInfo={description:`The \`Icon\` component represents an SVG icon.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents**.`,name:`mode`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Icon/index.d.ts`,name:`IconAttributes`},required:!1,tags:{default:`"Decorative"`},type:{name:`enum`,raw:`"Image" | "Decorative" | "Interactive" | IconMode`,value:[{value:`"Image"`},{value:`"Decorative"`},{value:`"Interactive"`},{value:`"Image"`,description:`Image mode (by default).
