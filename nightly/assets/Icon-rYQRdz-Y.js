import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t}from"./Icon-DUpuKyj8.js";import{n,t as r}from"./withWebComponent-Dz0M4A-F.js";var i;function a(){return(a=e((()=>{t(),r(),i=n(`ui5-icon`,[`accessibleName`,`design`,`mode`,`name`],[`showTooltip`],[`fontIcon`],[`click`]),i.displayName=`Icon`;try{i.displayName=`Icon`,i.__docgenInfo={description:`The \`Icon\` component represents an SVG icon.
...
**Note:** Available since [v1.9.2](https://github.com/UI5/webcomponents/releases/tag/v1.9.2) of **@ui5/webcomponents**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Icon/index.d.ts`,name:`IconAttributes`},required:!1,tags:{default:`"Default"`},type:{name:`enum`,raw:`"Positive" | "Critical" | "Negative" | "Information" | "Neutral" | "Default" | IconDesign | "Contrast" | "NonInteractive"`,value:[{value:`"Positive"`},{value:`"Critical"`},{value:`"Negative"`},{value:`"Information"`},{value:`"Neutral"`},{value:`"Default"`},{value:`"Contrast"`,description:`Contrast design`,fullComment:`Contrast design
