import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,t as n}from"./withWebComponent-CAFYyfUs.js";import{n as r}from"./IllustratedMessage-D9CBTaqe.js";var i;function a(){return(a=e((()=>{r(),n(),i=t(`ui5-illustrated-message`,[`accessibleNameRef`,`design`,`name`,`subtitleText`,`titleText`],[`decorative`],[`subtitle`,`title`],[]),i.displayName=`IllustratedMessage`;try{i.displayName=`IllustratedMessage`,i.__docgenInfo={description:`An IllustratedMessage is a recommended combination of a solution-oriented message, an engaging
...
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`Iterable<ReactNode>`,description:``,fullComment:``,tags:{}},{value:`ReactPortal`,description:``,fullComment:``,tags:{}},{value:`Promise<AwaitedReactNode>`,description:`Represents the completion of an asynchronous operation`,fullComment:`Represents the completion of an asynchronous operation`,tags:{}},{value:`ReactNode[]`,description:``,fullComment:``,tags:{}}]}},subtitle:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessagePropTypes`}],description:`Defines the subtitle of the component.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:`subtitle`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessagePropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`UI5WCSlotsNode`,value:[{value:`bigint`},{value:`false`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
const element: ReactElement = <div />;
\`\`\``,tags:{template:`P The type of the props object
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`InternalUI5WCSlotsNode[]`,description:``,fullComment:``,tags:{}}]}},title:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessagePropTypes`}],description:`Defines the title of the component.
...
__Supported Node Type/s:__ \`Array<HTMLElement> & string\``,name:`title`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessagePropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`UI5WCSlotsNode`,value:[{value:`bigint`},{value:`false`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
const element: ReactElement = <div />;
\`\`\``,tags:{template:`P The type of the props object
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`InternalUI5WCSlotsNode[]`,description:``,fullComment:``,tags:{}}]}},accessibleNameRef:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`}],description:`Receives id(or many ids) of the elements that label the component.

**Note:** Available since [v1.7.0](https://github.com/UI5/webcomponents/releases/tag/v1.7.0) of **@ui5/webcomponents-fiori**.`,name:`accessibleNameRef`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`},required:!1,tags:{default:`undefined`},type:{name:`string`}},decorative:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`}],description:'Defines whether the illustration is decorative.\n\nWhen set to `true`, the attributes `role="presentation"` and `aria-hidden="true"` are applied to the SVG element.\n\n**Note:** Available since [v2.10.0](https://github.com/UI5/webcomponents/releases/tag/v2.10.0) of **@ui5/webcomponents-fiori**.',name:`decorative`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},design:{defaultValue:{value:`"Auto"`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`}],description:`Determines which illustration breakpoint variant is used.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-fiori**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`},required:!1,tags:{default:`"Auto"`},type:{name:`enum`,raw:`"Dialog" | IllustrationMessageDesign | "Auto" | "Base" | "Dot" | "Spot" | "Scene" | "ExtraSmall" | "Small" | "Medium" | "Large"`,value:[{value:`"Dialog"`},{value:`"Auto"`,description:`Automatically decides the <code>Illustration</code> size (<code>Base</code>, <code>Dot</code>, <code>Spot</code>,
