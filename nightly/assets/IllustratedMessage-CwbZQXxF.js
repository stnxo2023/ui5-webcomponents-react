import{n as e}from"./chunk-jRWAZmH_.js";import{t}from"./src-DKjTx_bB.js";import{n}from"./withWebComponent-BR5PrFuL.js";import{n as r}from"./IllustratedMessage-CiQdtoga.js";var i,a=e((()=>{r(),t(),i=n(`ui5-illustrated-message`,[`accessibleNameRef`,`design`,`name`,`subtitleText`,`titleText`],[`decorative`],[`subtitle`,`title`],[]),i.displayName=`IllustratedMessage`;try{i.displayName=`IllustratedMessage`,i.__docgenInfo={description:`An IllustratedMessage is a recommended combination of a solution-oriented message, an engaging
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-fiori**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/IllustratedMessage/index.d.ts`,name:`IllustratedMessageAttributes`},required:!1,tags:{default:`"Auto"`},type:{name:`enum`,raw:`"Dialog" | "Auto" | "Large" | IllustrationMessageDesign | "Base" | "Dot" | "Spot" | "Scene" | "ExtraSmall" | "Small" | "Medium"`,value:[{value:`"Dialog"`},{value:`"Auto"`},{value:`"Large"`},{value:`"Auto"`,description:`Automatically decides the <code>Illustration</code> size (<code>Base</code>, <code>Dot</code>, <code>Spot</code>,
