import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{X as r,Y as i}from"./CustomElementsScopeUtils-CeUpht4U.js";import{n as a,t as o}from"./Icon-D1bUSmAg.js";import{a as s,c,d as l,f as u,i as d,l as f,n as p,o as m,r as h,s as g,t as _,u as v}from"./jsx-runtime-BpKzXHRO.js";import{Q as ee,Z as te,q as ne}from"./Keys-DqJfIghV.js";import{n as re,t as y}from"./withWebComponent-BAGpl5gP.js";import{t as b}from"./jsx-runtime-BdxMnOeJ.js";import{n as x,t as ie}from"./event-strict-C4u0wMzB.js";import{n as ae,t as oe}from"./slot-strict-BSUUcNBc.js";import{n as se,t as S}from"./Button-BneBjxlg.js";import{n as ce,t as le}from"./BusyIndicator-CJzh4fWM.js";import{i as ue,n as de,r as fe,t as pe}from"./Input-XMc4sGbe.js";import{n as me,t as he}from"./ResponsivePopoverCommon.css-Bt38yHtx.js";import{n as ge,t as _e}from"./ValueStateMessage.css-DN4z_iMC.js";import{t as ve}from"./navigation-right-arrow-Cd8ot11t.js";import{f as ye,p as be,r as C,t as w}from"./MenuItem-BIk63gGJ.js";import{r as T,t as E}from"./Menu-nIsHQONZ.js";import{n as D,t as O}from"./MenuItem-BIc40400.js";import{a as k,i as A}from"./iframe-D4h4sJ3R.js";import{a as j,h as M,i as N,n as P,o as xe,t as Se,y as Ce}from"./parameters-bundle.css-wyLn3OCi.js";import{t as we}from"./navigation-left-arrow-BFVnXDLp.js";var F;function I(){return(I=e((()=>{r(),s(),Se(),i(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>m),i(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),F=`.ui5-ai-input-root{width:100%;height:100%;border-right:none}:host([focused]:not([opened])[_is-menu-open]) .ui5-ai-input-root:hover{border-radius:var(--_ui5_input_border_radius);box-shadow:var(--sapField_Hover_Shadow)}:host([focused]:not([opened])[_is-menu-open]) .ui5-input-focusable-element:after{border:var(--_ui5-input-border)}.ui5-input-busy-indicator{flex:1;width:100%;height:100%;position:relative;box-sizing:border-box;display:block}.ui5-ai-input-busy .ui5-ai-input-button-wrapper{background-color:inherit;border:none}.ui5-ai-input-button-wrapper{display:flex;justify-content:center;align-items:center;width:var(--_ui5_input_icon_width);min-width:var(--_ui5_input_icon_width);height:var(--_ui5_input_icon_wrapper_height);padding:0;box-sizing:border-box;border-radius:var(--_ui5_input_border_radius);cursor:pointer;border:none}.ui5-input-ai-button[hidden]{display:none}.ui5-ai-input-button-wrapper.ui5-input-button-menu-open,.ui5-ai-input-button-wrapper:active{background-color:var(--sapButton_Selected_Background);box-shadow:var(--sapField_Hover_Shadow);color:var(--sapButton_Selected_TextColor)}.ui5-ai-input-button-wrapper:not(.ui5-input-button-menu-open):not(.ui5-ai-input-loading):not(:active):hover,.ui5-ai-input-button-wrapper.ui5-ai-input-loading:hover{background-color:var(--sapButton_Hover_Background);border:1px solid var(--sapButton_Hover_BorderColor);box-shadow:inset 0 0 0 .0625rem var(--sapContent_Neutral_Shadow)}.ui5-input-button-menu-open{background-color:var(--sapButton_Selected_Background);box-shadow:var(--sapField_Hover_Shadow)}[ui5-menu-item].ui5-ai-versioning-menu-footer:hover{background-color:inherit}.ui5-ai-versioning-menu-footer::part(native-li){padding-right:.25rem}#ai-menu-btn{--_ui5_button_focused_border: none}
`})))()}function Te(e){let t=e?.preContent||De,n=e?.postContent||Oe;return h(_,{children:h(`div`,{class:`ui5-ai-input-root ui5-input-focusable-element ${this.loading&&`ui5-ai-input-busy`}`,onFocusIn:this._onfocusin,onFocusOut:this._onfocusout,children:d(`div`,{class:`ui5-input-content`,children:[h(le,{id:`${this._id}-busyIndicator`,active:this.loading,class:`ui5-input-busy-indicator`,children:h(`div`,{class:`ui5-input-root`,part:`root`,children:d(`div`,{class:`ui5-input-content`,children:[t.call(this),h(`input`,{id:`inner`,part:`input`,class:`ui5-input-inner`,style:this.styles.innerInput,type:this.inputNativeType,"inner-input":!0,"inner-input-with-icon":this.iconsCount>0,disabled:this.disabled,readonly:this._readonly||this.loading,value:this.value,placeholder:this._placeholder,maxlength:this.maxlength,role:this.accInfo.role,enterkeyhint:this.hint,"aria-controls":this.accInfo.ariaControls,"aria-invalid":this.accInfo.ariaInvalid,"aria-haspopup":this.accInfo.ariaHasPopup,"aria-describedby":this.accInfo.ariaDescribedBy,"aria-roledescription":this.accInfo.ariaRoledescription,"aria-autocomplete":this.accInfo.ariaAutoComplete,"aria-expanded":this.accInfo.ariaExpanded,"aria-label":this.ariaLabel,"aria-required":this.required,autocomplete:`off`,"data-sap-focus-ref":!0,step:this.nativeInputAttributes.step,min:this.nativeInputAttributes.min,max:this.nativeInputAttributes.max,onInput:this._handleNativeInput,onChange:this._handleChange,onSelect:this._handleSelect,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,onClick:this._click,onFocusIn:this.innerFocusIn}),this._effectiveShowClearIcon&&h(`div`,{tabindex:-1,part:`clear-icon-wrapper`,class:`ui5-input-clear-icon-wrapper inputIcon`,onClick:this._clear,onMouseDown:this._iconMouseDown,children:h(o,{part:`clear-icon`,class:`ui5-input-clear-icon`,name:`decline`,tabindex:-1,accessibleName:this.clearIconAccessibleName})}),this.icon.length>0&&h(`div`,{class:`ui5-input-icon-root`,tabindex:-1,children:h(`slot`,{name:`icon`})}),h(`div`,{class:`ui5-input-value-state-icon`,children:this._valueStateInputIcon}),n.call(this),this.accInfo.ariaDescription&&h(`span`,{id:`descr`,class:`ui5-hidden-text`,children:this.accInfo.ariaDescription}),this.accInfo.accessibleDescription&&h(`span`,{id:`accessibleDescription`,class:`ui5-hidden-text`,children:this.accInfo.accessibleDescription}),this.linksInAriaValueStateHiddenText.length>0&&h(`span`,{id:`hiddenText-value-state-link-shortcut`,class:`ui5-hidden-text`,children:this.valueStateLinksShortcutsTextAcc}),this.hasValueState&&h(`span`,{id:`valueStateDesc`,class:`ui5-hidden-text`,children:this.ariaValueStateHiddenText})]})})}),h(S,{id:`ai-menu-btn`,hidden:!this.isFocused&&!this.loading||!this.hasActions||this.readonly,tabIndex:-1,class:`ui5-input-ai-button ui5-ai-input-button-wrapper ${this._isMenuOpen&&`ui5-input-button-menu-open`} ${this.loading&&`ui5-ai-input-loading`}`,design:`Transparent`,icon:this.loading?`stop`:`ai`,onClick:this._handleAIButtonClick,onKeyDown:this._handleAIButtonKeydown,"aria-keyshortcuts":this.loading?`Esc`:`Shift + F4`,tooltip:this.loading?this.stopGeneratingTooltip:this.ariaLabel,accessibilityAttributes:{hasPopup:this.loading?`false`:`menu`}}),d(E,{onItemClick:this._onMenuIconClick,onBeforeOpen:()=>{this._isMenuOpen=!0},onBeforeClose:()=>{this._isMenuOpen=!1},onClose:()=>{this.loading||this.focus()},children:[h(`slot`,{name:`actions`}),this.totalVersions>1&&Ee.call(this)]})]})})})}function Ee(){return d(_,{children:[h(ye,{}),d(w,{type:`Inactive`,class:`ui5-ai-versioning-menu-footer`,text:`${this.currentVersion} / ${this.totalVersions}`,children:[h(S,{id:`arrow-left`,class:`versioning-button`,slot:`endContent`,design:`Transparent`,icon:`navigation-left-arrow`,tooltip:this.previousButtonAccessibleName,accessibleName:this.previousButtonAccessibleName,"aria-keyshortcut":`Shift+Ctrl+Z`,disabled:this.currentVersion<=1,onClick:this._handlePreviousButtonClick,"data-ui5-versioning-button":`previous`}),h(S,{id:`arrow-right`,class:`versioning-button`,slot:`endContent`,design:`Transparent`,icon:`navigation-right-arrow`,tooltip:this.nextButtonAccessibleName,accessibleName:this.nextButtonAccessibleName,"aria-keyshortcut":`Shift+Ctrl+Y`,disabled:this.currentVersion>=this.totalVersions,onClick:this._handleNextButtonClick,"data-ui5-versioning-button":`next`})]})]})}function De(){}function Oe(){}function L(){return(L=e((()=>{p(),a(),ce(),C(),be(),se(),T(),we(),ve()})))()}var R,z,B;function V(){return(V=e((()=>{l(),f(),ie(),ae(),g(),ne(),de(),I(),ue(),me(),ge(),L(),Ce(),R=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},B=z=class extends pe{constructor(){super(...arguments),this.currentVersion=0,this.totalVersions=0,this.loading=!1,this._isMenuOpen=!1,this._previousCurrentStep=0,this._previousTotalSteps=0,this.isFocused=!1,this._handleAIButtonKeydown=e=>{ee(e)&&this.loading&&this.fireDecoratorEvent(`stop-generation`)}}_onfocusin(e){super._onfocusin(e),this.isFocused=!0}_onfocusout(e){super._onfocusout(e),this.isFocused=!1}_manageVersionButtonsFocus(){let e=this.shadowRoot?.getElementById(`arrow-left`),t=this.shadowRoot?.getElementById(`arrow-right`),n=this.currentVersion<=1,r=this.currentVersion>=this.totalVersions;n&&e?setTimeout(()=>{t.focus()},0):r&&t&&setTimeout(()=>{e.focus()},0)}_handleAIButtonClick(e){if(e.target?.icon===`stop`)this.fireDecoratorEvent(`stop-generation`);else{let e=this.shadowRoot?.querySelector(`.ui5-input-ai-button`);this.fireDecoratorEvent(`button-click`),this.menu.opener=e,this.menu.open=!0,this.menu.horizontalAlign=`End`}}_handleVersionChange(e){this.fireDecoratorEvent(`version-change`,{backwards:e.detail.backwards}),this._manageVersionButtonsFocus()}_handlePreviousButtonClick(){this._handleVersionChange(new CustomEvent(`version-change`,{detail:{backwards:!0}}))}_handleNextButtonClick(){this._handleVersionChange(new CustomEvent(`version-change`,{detail:{backwards:!1}}))}_onMenuIconClick(e){this.fireDecoratorEvent(`item-click`,e.detail)}_onkeydown(e){super._onkeydown(e);let t=this.shadowRoot?.getElementById(`ai-menu-btn`);te(e)&&(t?.focus(),this.menu.opener=t,this.menu.open=!0,this.menu.horizontalAlign=`End`);let n=e.key===`Z`&&e.shiftKey&&e.ctrlKey,r=e.key===`Y`&&e.shiftKey&&e.ctrlKey;n?(e.preventDefault(),this._handlePreviousButtonClick()):r&&(e.preventDefault(),this._handleNextButtonClick())}get hasActions(){return!!this?.menu?.getSlottedNodes(`items`).length}get ariaLabel(){return this.accessibleName||!this.loading?z.i18nBundle.getText(xe):z.i18nBundle.getText(M)}get stopGeneratingTooltip(){return z.i18nBundle.getText(M)}get nextButtonAccessibleName(){return z.i18nBundle.getText(N)}get previousButtonAccessibleName(){return z.i18nBundle.getText(j)}get menu(){return this.shadowRoot?.querySelector(`[ui5-menu]`)}},R([v({type:Number})],B.prototype,`currentVersion`,void 0),R([v({type:Number})],B.prototype,`totalVersions`,void 0),R([v({type:Boolean})],B.prototype,`loading`,void 0),R([v({type:Boolean})],B.prototype,`_isMenuOpen`,void 0),R([oe({type:HTMLElement,invalidateOnChildChange:!0})],B.prototype,`actions`,void 0),B=z=R([u({tag:`ui5-ai-input`,languageAware:!0,renderer:c,template:Te,styles:[F,fe,he,_e]}),x(`button-click`,{cancelable:!0}),x(`item-click`),x(`stop-generation`),x(`version-change`)],B),B.define()})))()}var H;function U(){return(U=e((()=>{V(),y(),H=re(`ui5-ai-input`,[`accessibleDescription`,`accessibleDescriptionRef`,`accessibleName`,`accessibleNameRef`,`currentVersion`,`filter`,`maxlength`,`name`,`placeholder`,`totalVersions`,`type`,`value`,`valueState`],[`disabled`,`loading`,`noTypeahead`,`open`,`readonly`,`required`,`showClearIcon`,`showSuggestions`],[`actions`,`icon`,`valueStateMessage`],[`button-click`,`change`,`close`,`input`,`item-click`,`open`,`select`,`selection-change`,`stop-generation`,`version-change`]),H.displayName=`Input`;try{H.displayName=`Input`,H.__docgenInfo={description:`The \`Input\` component extends the standard \`ui5-input\` with **AI Writing Assistant** capabilities.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:`actions`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`UI5WCSlotsNode`,value:[{value:`bigint`},{value:`false`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
const element: ReactElement = <div />;
\`\`\``,tags:{template:`P The type of the props object
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`InternalUI5WCSlotsNode[]`,description:``,fullComment:``,tags:{}}]}},children:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`}],description:"Defines the suggestion items.\n\n**Note:** The suggestions would be displayed only if the `showSuggestions`\nproperty is set to `true`.\n\n**Note:** The `<ui5-suggestion-item>`, `<ui5-suggestion-item-group>` and `ui5-suggestion-item-custom` are recommended to be used as suggestion items.\n\n**Note:** Input with type `Number` does not support suggestions.\n\n__Supported Node Type/s:__ `Array<IInputSuggestionItem>`",name:`children`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`ReactNode | ReactNode[]`,value:[{value:`string`},{value:`number`},{value:`bigint`},{value:`false`},{value:`true`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
const element: ReactElement = <div />;
\`\`\``,tags:{template:`P The type of the props object
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`Iterable<ReactNode>`,description:``,fullComment:``,tags:{}},{value:`ReactPortal`,description:``,fullComment:``,tags:{}},{value:`Promise<AwaitedReactNode>`,description:`Represents the completion of an asynchronous operation`,fullComment:`Represents the completion of an asynchronous operation`,tags:{}},{value:`ReactNode[]`,description:``,fullComment:``,tags:{}}]}},icon:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`}],description:`Defines the icon to be displayed in the component.
...
__Supported Node Type/s:__ \`Array<IIcon>\``,name:`icon`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`UI5WCSlotsNode`,value:[{value:`bigint`},{value:`false`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:`valueStateMessage`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`},required:!1,tags:{},type:{name:`enum`,raw:`UI5WCSlotsNode`,value:[{value:`bigint`},{value:`false`},{value:`ReactElement<unknown, string | JSXElementConstructor<any>>`,description:`Represents a JSX element.
...
const element: ReactElement = <div />;
\`\`\``,tags:{template:`P The type of the props object
T The type of the component or tag`,example:"```tsx\nconst element: ReactElement = <div />;\n```"}},{value:`InternalUI5WCSlotsNode[]`,description:``,fullComment:``,tags:{}}]}},onButtonClick:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputPropTypes`}],description:`Fired when the user selects the AI button.
...
**Note:** A disabled component is completely noninteractive.`,name:`disabled`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},filter:{defaultValue:{value:`"None"`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines the filter type of the component.

**Note:** Available since [v2.19.0](https://github.com/UI5/webcomponents/releases/tag/v2.19.0) of **@ui5/webcomponents-ai**.`,name:`filter`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"None" | InputSuggestionsFilter | "StartsWithPerTerm" | "StartsWith" | "Contains"`,value:[{value:`"None"`},{value:`"StartsWithPerTerm"`,description:`Defines filtering by first symbol of each word of item's text.`,fullComment:`Defines filtering by first symbol of each word of item's text.
...
@public`,tags:{public:``}},{value:`"StartsWithPerTerm"`},{value:`"StartsWith"`},{value:`"Contains"`}]}},loading:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines whether the AI Writing Assistant is currently loading.

When \`true\`, indicates that an AI action is in progress.`,name:`loading`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},maxlength:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Sets the maximum number of characters available in the input field.
...
**Note:** Available since [v1.4.0](https://github.com/UI5/webcomponents/releases/tag/v1.4.0) of **@ui5/webcomponents-ai**.`,name:`noTypeahead`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},open:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:"Defines whether the suggestions picker is open.\nThe picker will not open if the `showSuggestions` property is set to `false`, the input is disabled or the input is readonly.\nThe picker will close automatically and `close` event will be fired if the input is not in the viewport.\n\n**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-ai**.",name:`open`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},placeholder:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines a short hint intended to aid the user with data entry when the
...
but still provides visual feedback upon user interaction.`,name:`readonly`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},required:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines whether the component is required.`,name:`required`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},showClearIcon:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines whether the clear icon of the input will be shown.

**Note:** Available since [v1.2.0](https://github.com/UI5/webcomponents/releases/tag/v1.2.0) of **@ui5/webcomponents-ai**.`,name:`showClearIcon`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},showSuggestions:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines whether the component should show suggestions, if such are present.`,name:`showSuggestions`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},totalVersions:{defaultValue:{value:`0`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Indicates the total number of result versions available.
...
- Type \`Number\` does not support suggestions.`,name:`type`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`"Text"`},type:{name:`enum`,raw:`InputType | "Text" | "Email" | "Number" | "Password" | "Tel" | "URL" | "Search"`,value:[{value:`"Text"`,description:`Defines a one-line text input field:`,fullComment:`Defines a one-line text input field:
...
**Note:** The property is updated upon typing.`,name:`value`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{},type:{name:`string`}},valueState:{defaultValue:{value:`"None"`},declarations:[{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`}],description:`Defines the value state of the component.`,name:`valueState`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/Input/index.d.ts`,name:`InputAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"None" | "Positive" | "Critical" | "Negative" | "Information" | ValueState`,value:[{value:`"None"`},{value:`"Positive"`},{value:`"Critical"`},{value:`"Negative"`},{value:`"Information"`},{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}}]}},className:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`}],description:`CSS Class Name which will be appended to the most outer element of a component.
...
Furthermore, the package supports **Horizon** themes only.`}}}catch{}})))()}var ke=t({Default:()=>q,WithFakeStream:()=>Z,__namedExportsOrder:()=>Q,default:()=>K}),W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{D(),W=n(),A(),U(),G=b(),K={title:`Input`,component:H,argTypes:{actions:{control:{disable:!0}},children:{control:{disable:!0}},icon:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},tags:[`package:@ui5/webcomponents-ai`,`experimental`]},q={render(e){return(0,G.jsx)(H,{...e,actions:(0,G.jsx)(O,{text:`Generate`,"data-action":`generate`},`generate`)})}},J={en:`Innovation managers lead with creativity.`,bg:`Мениджърите по иновации водят с креативност.`,de:`Innovationsmanager führen mit Kreativität.`,expanded:`They combine creative ideas with strategic action.`,simplified:`They lead using creativity.`,summarized:`Driving innovation creatively.`},Y=[{text:`Regenerate`,action:`regenerate`,processingLabel:`Regenerating text...`,completedLabel:`Regenerated text`,textKey:`en`,replaces:`generate`},{text:`Fix spelling and grammar`,action:`fixSpelling`,processingLabel:`Fixing spelling and grammar...`,completedLabel:`Fixed spelling and grammar`,textKey:`en`},{text:`Rewrite text`,isGroup:!0,children:[{text:`Simplify`,action:`simplify`,processingLabel:`Simplifying text...`,completedLabel:`Simplified text`,textKey:`simplified`,isChild:!0},{text:`Expand`,action:`expand`,processingLabel:`Expanding text...`,completedLabel:`Expanded text`,textKey:`expanded`,isChild:!0},{text:`Summarize`,action:`summarize`,processingLabel:`Summarizing text...`,completedLabel:`Summarized text`,textKey:`summarized`,isChild:!0}]},{text:`Translate`,isGroup:!0,children:[{text:`English`,action:`translateEN`,processingLabel:`Translating to English...`,completedLabel:`Translated to English`,textKey:`en`,isChild:!0},{text:`German`,action:`translateDE`,processingLabel:`Translating to German...`,completedLabel:`Translated to German`,textKey:`de`,isChild:!0},{text:`Bulgarian`,action:`translateBG`,processingLabel:`Translating to Bulgarian...`,completedLabel:`Translated to Bulgarian`,textKey:`bg`,isChild:!0}]}],X=`Write your title`,Z={name:`with Stream`,render:e=>{let[t,n]=(0,W.useState)([]),[r,i]=(0,W.useState)(-1),[a,o]=(0,W.useState)(X),s=t.length>0,c=(0,W.useRef)(``),{value:l,isTyping:u,isProcessing:d,setValue:f,startStream:p,stopStream:m}=k(),h=e=>{i(t=>e.detail.backwards?t-1:t+1)},g=e=>{let{action:t,processingLabel:r,textKey:a}=e.detail.item.dataset;if(d||!t)return;c.current=t;let s=J[a??`en`];switch(t){case`simplify`:s=J.simplified;break;case`expand`:s=J.expanded;break;case`summarize`:s=J.expanded;break;case`translateEN`:s=J.en;break;case`translateDE`:s=J.de;break;case`translateBG`:s=J.bg}o(r),p({text:s,onProcessingComplete:()=>{o(X)},onComplete:e=>{n(n=>[...n,{action:t,endAction:`completed`,timestamp:new Date().toISOString(),value:e}]),i(e=>e+1),f(``)}})},_=e=>{m(),n(t=>[...t,{action:c.current,endAction:`stopped`,timestamp:new Date().toISOString(),value:e.target.value}]),i(e=>e+1),f(``)},v=e=>{f(e.target.value)};return(0,G.jsx)(H,{...e,style:{width:`400px`},value:d?``:l||t[r]?.value||``,placeholder:a,currentVersion:r+1,totalVersions:t.length,loading:d||u,onVersionChange:h,onStopGeneration:_,onItemClick:g,onInput:v,actions:(0,G.jsx)(G.Fragment,{children:s?Y.map((e,t)=>e.replaces&&!s?null:e.isGroup&&Array.isArray(e.children)?(0,G.jsx)(O,{text:e.text,children:e.children.map(e=>(0,G.jsx)(O,{text:e.text,"data-action":e.action,"data-processing-label":e.processingLabel,"data-completed-label":e.completedLabel,"data-text-key":e.textKey},e.text))},t):(0,G.jsx)(O,{text:e.text,"data-action":e.action,"data-processing-label":e.processingLabel,"data-completed-label":e.completedLabel,"data-text-key":e.textKey},e.text)):(0,G.jsx)(O,{text:`Generate`,"data-action":`generate`,"data-processing-label":`Processing...`},`generate`)})})}},q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...Z.parameters?.docs?.source}}},Q=[`Default`,`WithFakeStream`]})))()}export{$ as i,ke as n,Z as r,q as t};