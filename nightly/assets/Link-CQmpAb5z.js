import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,t as n}from"./withWebComponent-CAFYyfUs.js";import{n as r}from"./Link-BEUO3C25.js";var i;function a(){return(a=e((()=>{r(),n(),i=t(`ui5-link`,[`accessibilityAttributes`,`accessibleDescription`,`accessibleName`,`accessibleNameRef`,`accessibleRole`,`design`,`endIcon`,`href`,`icon`,`interactiveAreaSize`,`target`,`tooltip`,`wrappingType`],[`disabled`],[],[`click`]),i.displayName=`Link`;try{i.displayName=`Link`,i.__docgenInfo={description:`The \`Link\` is a hyperlink component that is used to navigate to other
...
**Note:** By default the text will wrap. If "None" is set - the text will truncate.`,name:`wrappingType`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Link/index.d.ts`,name:`LinkAttributes`},required:!1,tags:{default:`"Normal"`},type:{name:`enum`,raw:`WrappingType | "None" | "Normal"`,value:[{value:`"None"`,description:`The text will be truncated with an ellipsis.`,fullComment:`The text will be truncated with an ellipsis.
