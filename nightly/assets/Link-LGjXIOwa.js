import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./src-el6yIa3U.js";import{n}from"./withWebComponent-VrJmgZSQ.js";import{n as r}from"./Link-DuwXeEIc.js";var i,a=e((()=>{r(),t(),i=n(`ui5-link`,[`accessibilityAttributes`,`accessibleDescription`,`accessibleName`,`accessibleNameRef`,`accessibleRole`,`design`,`endIcon`,`href`,`icon`,`interactiveAreaSize`,`target`,`tooltip`,`wrappingType`],[`disabled`],[],[`click`]),i.displayName=`Link`;try{i.displayName=`Link`,i.__docgenInfo={description:`The \`Link\` is a hyperlink component that is used to navigate to other
