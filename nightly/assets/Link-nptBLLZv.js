import{i as e}from"./preload-helper-B45gAKPr.js";import{t}from"./src-TC4bZMcJ.js";import{n}from"./withWebComponent-Dg_qWubB.js";import{n as r}from"./Link-rpumFfLb.js";var i,a=e((()=>{r(),t(),i=n(`ui5-link`,[`accessibilityAttributes`,`accessibleDescription`,`accessibleName`,`accessibleNameRef`,`accessibleRole`,`design`,`endIcon`,`href`,`icon`,`interactiveAreaSize`,`target`,`tooltip`,`wrappingType`],[`disabled`],[],[`click`]),i.displayName=`Link`;try{i.displayName=`Link`,i.__docgenInfo={description:`The \`Link\` is a hyperlink component that is used to navigate to other
