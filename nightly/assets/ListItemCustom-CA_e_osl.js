import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{t}from"./src-gAF68HEc.js";import{n}from"./withWebComponent-Bq8vFkn_.js";import{i as r}from"./List-Di-7tuEV.js";var i,a=e((()=>{r(),t(),i=n(`ui5-li-custom`,[`accessibilityAttributes`,`accessibleName`,`accessibleRole`,`highlight`,`tooltip`,`type`],[`movable`,`navigated`,`selected`],[`deleteButton`],[`click`,`detail-click`]),i.displayName=`ListItemCustom`;try{i.displayName=`ListItemCustom`,i.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
