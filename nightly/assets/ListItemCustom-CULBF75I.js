import{i as e}from"./preload-helper-B45gAKPr.js";import{t}from"./src-B933wmuH.js";import{n}from"./withWebComponent-Bulhy2KK.js";import{n as r}from"./ListItemCustom-DM4Smnyp.js";var i,a=e((()=>{r(),t(),i=n(`ui5-li-custom`,[`accessibilityAttributes`,`accessibleName`,`accessibleRole`,`highlight`,`tooltip`,`type`],[`movable`,`navigated`,`selected`],[`deleteButton`],[`click`,`detail-click`]),i.displayName=`ListItemCustom`;try{i.displayName=`ListItemCustom`,i.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
