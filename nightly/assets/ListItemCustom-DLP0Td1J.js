import{i as e}from"./preload-helper-B45gAKPr.js";import{t}from"./src-DDbT3mEz.js";import{n}from"./withWebComponent-DZ9c6ddo.js";import{i as r}from"./List-DhAs0zSK.js";var i,a=e((()=>{r(),t(),i=n(`ui5-li-custom`,[`accessibilityAttributes`,`accessibleName`,`accessibleRole`,`highlight`,`tooltip`,`type`],[`movable`,`navigated`,`selected`],[`deleteButton`],[`click`,`detail-click`]),i.displayName=`ListItemCustom`;try{i.displayName=`ListItemCustom`,i.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
