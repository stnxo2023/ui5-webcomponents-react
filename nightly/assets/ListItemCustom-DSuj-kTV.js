import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./src-el6yIa3U.js";import{n}from"./withWebComponent-VrJmgZSQ.js";import{n as r}from"./ListItemCustom-Blovc1ia.js";var i,a=e((()=>{r(),t(),i=n(`ui5-li-custom`,[`accessibilityAttributes`,`accessibleName`,`accessibleRole`,`highlight`,`tooltip`,`type`],[`movable`,`navigated`,`selected`],[`deleteButton`],[`click`,`detail-click`]),i.displayName=`ListItemCustom`;try{i.displayName=`ListItemCustom`,i.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
