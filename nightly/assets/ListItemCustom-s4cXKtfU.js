import{n as e}from"./chunk-jRWAZmH_.js";import{t}from"./src-DKjTx_bB.js";import{n}from"./withWebComponent-BR5PrFuL.js";import{n as r}from"./ListItemCustom-Dx6yzEAo.js";var i,a=e((()=>{r(),t(),i=n(`ui5-li-custom`,[`accessibilityAttributes`,`accessibleName`,`highlight`,`tooltip`,`type`],[`movable`,`navigated`,`selected`],[`deleteButton`],[`detail-click`]),i.displayName=`ListItemCustom`;try{i.displayName=`ListItemCustom`,i.__docgenInfo={description:`A component to be used as custom list item within the \`List\`
