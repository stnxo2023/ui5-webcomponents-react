import{i as e}from"./preload-helper-DbRxMUml.js";import{Fm as t}from"./iframe-DClK4JzX.js";import{J as n,_ as r,d as i,u as a}from"./blocks-l9LxST_0.js";import{_ as o,o as s,t as c}from"./components-BRQLOq3a.js";var l,u=e((()=>{l=`# UI5 Web Components for React MCP Server
...
`}));function d(e){return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(i,{title:`MCP Server`}),`
`,(0,p.jsx)(a,{children:l.replace(/^## Contributing[\s\S]*$/m,``)}),`
`,(0,p.jsx)(s,{})]})}function f(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(d,{...e})}):d(e)}var p;e((()=>{p=t(),o(),c(),r(),u()}))();export{f as default};