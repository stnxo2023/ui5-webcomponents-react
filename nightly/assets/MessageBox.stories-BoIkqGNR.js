import{n as e,o as t,r as n}from"./chunk-jRWAZmH_.js";import{Bl as r,Dg as i,Hl as a,Ul as o,Vl as s,X as c,Ym as l,Z as u,op as d,r as f,sp as p}from"./iframe-6cUv-7J0.js";var m=n({Default:()=>v,WithCustomActions:()=>y,__namedExportsOrder:()=>b,default:()=>_}),h,g,_,v,y,b,x=e((()=>{f(),h=t(i(),1),o(),s(),p(),u(),g=l(),_={title:`Modals & Popovers / MessageBox`,component:c,argTypes:{header:{control:{disable:!0}},actions:{control:{disable:!0}},icon:{control:{disable:!0}}},args:{open:!1,type:r.Confirm,children:`You can close the MessageBox by pressing "Escape" or selecting one of the footer buttons.`},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},v={render(e){let[t,n]=(0,h.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,h.useEffect)(()=>{n(e.open)},[e.open]),(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(d,{onClick:r,children:`Open Messagebox`}),(0,g.jsx)(c,{...e,open:t,onClose:i})]})}},y={args:{actions:[a.OK,`Custom Action`,a.Cancel,(0,g.jsx)(d,{id:`custom-action`,children:`Custom Button`},`0`)]},render(e){let[t,n]=(0,h.useState)(!1),r=()=>{n(!0)},i=(t,r)=>{n(!1),e.onClose(t,r)};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(d,{onClick:r,children:`Open Messagebox`}),(0,g.jsx)(c,{...e,open:t,onClose:i})]})}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  render(args) {
