import{q as p,j as e,ah as R,T as t,Q as D,O as v}from"./iframe-BFfiCRAQ.js";import{useMDXComponents as T}from"./index-CnIchwG9.js";import{M as U}from"./blocks-D8UGMoOU.js";import"./Tag-D5_wJnae.js";import{M as k}from"./index-BvMEXi75.js";import"./CommandsAndQueries-D2e25SQ4.js";import"./copy-CbWPHS6-.js";import{T as L}from"./TableOfContent-DfIS3zQ7.js";import{F as O}from"./Footer-3U2rULEI.js";import{F as H,a as j}from"./index-BSJpJKXH.js";import{D as G}from"./index-CUTNoR3-.js";import{S as N}from"./index-CRSZng-3.js";import{O as x}from"./index-DxNz8cxh.js";import{a as K,M as c}from"./index-DpuJyxUQ.js";import{S as _}from"./index-w-LiBoqy.js";import{I as W}from"./index-rwYIjJnj.js";import{F as d,d as Y}from"./index-stFY49PR.js";import{L as a}from"./index-C_tePRTa.js";import"./PageNotFound-CAIx-1qq.js";import"./preload-helper-PPVm8Dsz.js";import"./information-mHfS5cWl.js";import"./sys-enter-2-BfeK50PI.js";import"./alert-DGgnTy1o.js";import"./Link-BzXMrnu2.js";import"./index-Arv69njm.js";import"./index-BEK-Ecqi.js";import"./index-CX51hblh.js";import"./AvatarSize-BtKTMFJ5.js";import"./employee-RE3-w7CJ.js";import"./addCustomCSSWithScoping-rUi9bOzC.js";import"./index-De1oz68R.js";import"./index-BsyXKf0m.js";import"./Input-BSDYELEx.js";import"./ResponsivePopoverCommon.css-D4YzLUeU.js";import"./ValueStateMessage.css-CZS8cQna.js";import"./Suggestions.css-BRZ_skiF.js";import"./search-DgQbIxJV.js";import"./index-s3YqXnTj.js";import"./ToolbarButton-k9Tqply1.js";import"./overflow-B4VEyJtQ.js";import"./circle-task-2-BBB6z52p.js";import"./navigation-down-arrow-ByE_fRjG.js";import"./index-D4r21y2V.js";import"./index-DFvcr04P.js";import"./query-CzSBusdE.js";import"./sort-descending-5U4Cc-Io.js";import"./IconDesign-DXd8PPVF.js";import"./BarDesign-0UK-o0dt.js";import"./group-2-CcbLqHZL.js";import"./stopPropagation-CsBxLuUS.js";import"./index-uKbEsDn6.js";import"./Bar-BAmwgE1m.js";import"./index-DA8ZH5in.js";import"./Panel-B0CUK_ze.js";import"./slideUp-DNFkFHG8.js";import"./animate-JylhYHXj.js";import"./AnimationMode-W19j3IAn.js";import"./index-Yf53TJNt.js";import"./SegmentedButton-C1RsLFa5.js";import"./index-Bbc_fpFb.js";import"./TableSelectionBase-_lOmpqnm.js";import"./debounce-D7W5PopO.js";import"./DatePicker-Hkp1VMeI.js";import"./Calendar-BvIF3sAd.js";import"./Gregorian-p4SYAaZS.js";import"./getCachedLocaleDataInstance-CFxdT6Ex.js";import"./slim-arrow-left-WtZ7TAZf.js";import"./InvisibleMessage-C0rjjrR1.js";import"./appointment-2-Dhsohq0Q.js";import"./DateTimeInput-CtnfKWnz.js";import"./Select-Bn7-Juol.js";import"./Option-nJWI7L3J.js";import"./ListItemBaseTemplate-BM8be-0F.js";import"./ListBoxItemGroupTemplate-B9xYubZz.js";import"./ComboBoxItemGroup-zb3CXtQM.js";import"./Token-BROk1qEI.js";import"./ScrollEnablement-BWSWkQKK.js";import"./ListItemStandard-xVznhyAm.js";import"./ToggleButton-QD-qILMO.js";import"./multiselect-all-BI6jGZO9.js";import"./SuggestionItem-D45_KCqM.js";import"./less-C3-m2tND.js";import"./add-C_HNl7S3.js";import"./Illustrations-DMZSmuvx.js";import"./i18n-defaults-CFWtSmu6.js";const V="_filterBarDemo_cphgf_1",q={filterBarDemo:V},z={age:37,countries:{},currency:"USD",date:"",search:""};function J(o,n){switch(n.type){case"SET_AGE":return{...o,age:n.payload};case"SET_COUNTRIES":return{...o,countries:n.payload};case"SET_CURRENCY":return{...o,currency:n.payload};case"SET_DATE":return{...o,date:n.payload};case"SET_SEARCH":return{...o,search:n.payload};case"SET_STATE":return{...o,...n.payload};case"DIALOG_RESTORE":return n.payload;default:return o}}function X(){const[o,n]=p.useReducer(J,z),{age:g,countries:s,currency:l,date:m,search:w}=o,h=p.useRef({}),[b,C]=p.useState({0:!0,1:!0,2:!0}),[y,S]=p.useState(["0","1","2","3"]),F=r=>{n({type:"SET_SEARCH",payload:r.target.value})},B=r=>{const{value:i}=r.target;r.currentTarget.parentElement.dataset.inFiltersDialog?h.current.age=i:n({type:"SET_AGE",payload:i})},I=r=>{const i=r.detail.items.reduce((u,E)=>({...u,[E.getAttribute("text").toLowerCase()]:!0}),{});r.currentTarget.parentElement.dataset.inFiltersDialog?h.current.countries=i:n({type:"SET_COUNTRIES",payload:i})},M=r=>{const i=r.detail.selectedOption.textContent;r.currentTarget.parentElement.dataset.inFiltersDialog?h.current.currency=i:n({type:"SET_CURRENCY",payload:i})},P=r=>{const{value:i}=r.target;r.currentTarget.parentElement.dataset.inFiltersDialog?h.current.date=i:r.detail.valid&&n({type:"SET_DATE",payload:i})},A=r=>{S(r.detail.reorderedFilterKeys),C(r.detail.selectedFilterKeys.reduce((i,u)=>(i[u]=!0,i),{})),n({type:"SET_STATE",payload:h.current})};return e.jsx(R,{children:e.jsxs("div",{className:q.filterBarDemo,children:[e.jsx(t,{children:"The FilterBar applies filter changes inside the FilterBar immediately and inside the dialog only after ‘OK’ has been pressed."}),e.jsx(H,{header:e.jsx(D,{level:v.H2,size:v.H4,children:"Apply changes after dialog save"}),enableReordering:!0,onFiltersDialogSave:A,search:e.jsx(W,{onInput:F}),children:y.map(r=>{const i=!b[r];switch(r){case"0":return e.jsx(j,{filterKey:"0",label:"Age",required:!0,children:e.jsx(_,{value:g,onChange:B,required:!0})},0);case"1":return e.jsx(j,{filterKey:"1",label:"Countries",active:Object.keys(s).length>0,hiddenInFilterBar:i,children:e.jsxs(K,{onSelectionChange:I,children:[e.jsx(c,{text:"Argentina",selected:s.argentina}),e.jsx(c,{text:"Bulgaria",selected:s.bulgaria}),e.jsx(c,{text:"Finland",selected:s.finland}),e.jsx(c,{text:"Germany",selected:s.germany}),e.jsx(c,{text:"Ireland",selected:s.ireland}),e.jsx(c,{text:"Ukraine",selected:s.ukraine}),e.jsx(c,{text:"USA",selected:s.usa})]})},1);case"2":return e.jsx(j,{filterKey:"2",label:"Currency",active:!!l,hiddenInFilterBar:i,children:e.jsxs(N,{onChange:M,children:[e.jsx(x,{additionalText:"€",selected:l==="EUR",children:"EUR"}),e.jsx(x,{additionalText:"$",selected:l==="USD",children:"USD"}),e.jsx(x,{additionalText:"£",selected:l==="GBP",children:"GBP"}),e.jsx(x,{additionalText:"₺",selected:l==="TRY",children:"TRY"}),e.jsx(x,{additionalText:"¥",selected:l==="JPY",children:"JPY"})]})},2);case"3":return e.jsx(j,{filterKey:"3",label:"Date",active:!!m,hiddenInFilterBar:i,children:e.jsx(G,{value:m,onChange:P,style:{minWidth:"auto"}})},3);default:return null}})}),e.jsxs(d,{direction:Y.Column,children:[e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Search"}),e.jsx(t,{children:w})]}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Age"}),e.jsx(t,{children:g})]}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Countries"}),e.jsx(t,{children:JSON.stringify(s)})]}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Currency"}),e.jsx(t,{children:l})]}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Date"}),e.jsx(t,{children:m})]}),e.jsx("hr",{style:{width:"100%"}}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Visible Filters"}),e.jsx(t,{children:Object.keys(b).join(", ")})]}),e.jsxs(d,{children:[e.jsx(a,{showColon:!0,children:"Filters Order"}),e.jsx(t,{children:y.join(", ")})]})]})]})})}function f(o){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...T(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(U,{title:"Migration Guide"}),`
...
For a full list of all changes, please refer to `,e.jsx(n.a,{href:"https://github.com/UI5/webcomponents-react/releases",rel:"nofollow",children:"the list of releases"}),`
...
For migration guides for older releases, please refer to our `,e.jsx(n.a,{href:"https://github.com/UI5/webcomponents-react/blob/main/docs/MigrationGuide.archive.md",rel:"nofollow",children:"Migration Guide Archive"}),"."]}),`
`]}),`
`,e.jsx(L,{headingSelector:"h2, h3",tocOverflowHeight:1250}),`
`,e.jsx(n.h2,{id:"ui5-web-components-migration-guide",children:"UI5 Web Components Migration Guide"}),`
`,e.jsxs(n.p,{children:["The breaking changes listed here only affect our codebase. Changes related solely to the underlying web component are ",e.jsx(n.strong,{children:"not"}),` tracked here.
For a complete list of breaking changes in UI5 Web Components, please refer to their `,e.jsx(n.a,{href:"https://ui5.github.io/webcomponents/docs/migration-guides/to-version-2/",rel:"nofollow",children:"Migration Guide"}),"."]}),`
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:[e.jsx(n.strong,{children:"Note:"})," Our ",e.jsx(n.code,{children:"codemod"})," covers changes from ui5-webcomponents as well."]})}),`
`,e.jsx(n.p,{children:e.jsxs(n.em,{children:[e.jsx(n.strong,{children:"Note:"}),` Setting the scoping suffix should be done before importing any components, as they use the suffix at the top-level of the module - meaning when a component is imported, the suffix has to be known.
...
`,e.jsx(n.p,{children:`To make the migration to UI5 Web Components (for React) v2 easier,
we provide a codemod which tries to transform most of the breaking changes.`}),`
`,e.jsx(k,{hideCloseButton:!0,design:"Critical",children:e.jsxs(e.Fragment,{children:["The codemod is a best efforts attempt to help you migrate the breaking change. Please review the generated code thoroughly!",e.jsx(n.br,{}),e.jsx(n.strong,{children:"Applying the codemod might break your code formatting, so please don't forget to run prettier and/or eslint after you've applied the codemod!"})]})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-shell",children:`npx @ui5/webcomponents-react-cli codemod --transform v2 \\
    --src ./path/to/src \\
    --typescript # only if you use TypeScript in your project, omit if you use JavaScript
`})}),`
`,e.jsx(n.h3,{id:"sap-devtoberfest-2024-session",children:"SAP Devtoberfest 2024 session"}),`
`,e.jsxs(n.p,{children:["In the ",e.jsx(n.a,{href:"https://www.youtube.com/watch?v=lvpN3eK39h8",rel:"nofollow",children:"SAP Devtoberfest 2024"})," session, we showcased the most prominent new features in version 2 of UI5 Web Components and UI5 Web Components for React, and provided an example of how to migrate from version 1 to version 2 using our ",e.jsx(n.a,{href:"https://ui5.github.io/webcomponents-react/v2/?path=/docs/migration-guide--docs#codemod",rel:"nofollow",children:"Codemod"}),"."]}),`
`,e.jsx(n.h2,{id:"general-changes",children:"General changes"}),`
`,e.jsx(n.h3,{id:"minimal-react-version",children:"Minimal React Version"}),`
`,e.jsxs(n.p,{children:["The minimum required ",e.jsx(n.code,{children:"react"})," and ",e.jsx(n.code,{children:"react-dom"})," version is now ",e.jsx(n.code,{children:"18.0.0"}),"."]}),`
`,e.jsx(n.h3,{id:"ui5-web-components-enums-are-no-longer-exported",children:"UI5 Web Components Enums are no longer exported"}),`
`,e.jsx(n.p,{children:"Previously, we created enums for all props that used multiple string values to set the corresponding design, mode, etc. Since enums for web components have been exported directly by UI5 Web Components for some time, we had been proxying the imports to avoid breaking changes."}),`
`,e.jsxs(n.p,{children:["With version 2, we took the opportunity to remove all proxied enums, so they must now be imported directly from ",e.jsx(n.code,{children:"@ui5/webcomponents"})," or the corresponding package."]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note:"})," You can use our ",e.jsx(n.a,{href:"#codemod",children:"Codemod"})," to simplify the refactoring process."]}),`
`,e.jsx(n.p,{children:"For example:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`// v1
...
`})}),`
`,e.jsxs(n.h3,{id:"removed-jestsetup-file",children:["Removed ",e.jsx(n.code,{children:"jestSetup"})," file"]}),`
`,e.jsxs(n.p,{children:["We stopped recommending jest as a testing framework over a year ago, thus the ",e.jsx(n.code,{children:"jestSetup"})," file is removed. We recommend using ",e.jsx(n.a,{href:"https://ui5.github.io/webcomponents-react/?path=/docs/testing-with-cypress-setup--docs",rel:"nofollow",children:"Cypress"})," instead."]}),`
...
`,e.jsx(n.h2,{id:"removed-components",children:"Removed Components"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"TableGroupRow"})," has been removed."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"NotificationAction"})," has been removed. You can use the ",e.jsx(n.code,{children:"Menu"})," component instead."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"SelectMenu"})," and ",e.jsx(n.code,{children:"SelectMenuOption"})," have been removed. The ",e.jsx(n.code,{children:"Select"})," and ",e.jsx(n.code,{children:"Option"})," now allow custom content."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"MicroBarChart"})," has been removed (from ",e.jsx(n.code,{children:"@ui5/webcomponents-react-charts"}),") as it is not covered by design specs anymore."]}),`
`]}),`
`,e.jsx(n.h2,{id:"renamed-components",children:"Renamed Components"}),`
`,e.jsx(n.p,{children:"With the release of UI5 Web Components v2, some component names have been renamed. Because we use these web component names (class names) as React component names, the renamings are considered breaking changes in our repository."}),`
`,e.jsx(n.p,{children:e.jsxs(n.strong,{children:["The list below shows only the previous and updated component names. For details on changes concerning attributes, properties, methods, etc., please refer to the ",e.jsx(n.a,{href:"https://ui5.github.io/webcomponents/docs/migration-guides/to-version-2/",rel:"nofollow",children:"UI5 Web Components Migration Guide"}),"."]})}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Note:"})," The tag name in the parenthesis is the ",e.jsx(n.strong,{children:"old"})," tag name."]}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"StandardListItem"})," has been renamed to ",e.jsx(n.code,{children:"ListItemStandard"})," (",e.jsx(n.code,{children:"ui5-li"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"CustomListItem"})," has been renamed to ",e.jsx(n.code,{children:"ListItemCustom"})," (",e.jsx(n.code,{children:"ui5-li-custom"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"MultiComboBoxGroupItem"})," has been renamed to ",e.jsx(n.code,{children:"MultiComboBoxItemGroup"})," (",e.jsx(n.code,{children:"ui5-mcb-group-item"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"TableColumn"})," has been renamed to ",e.jsx(n.code,{children:"TableHeaderCell"})," (",e.jsx(n.code,{children:"ui5-mcb-group-item"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"Badge"})," has been renamed to ",e.jsx(n.code,{children:"Tag"})," (",e.jsx(n.code,{children:"ui5-tag"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ComboBoxGroupItem"})," has been renamed to ",e.jsx(n.code,{children:"ComboBoxItemGroup"})," (",e.jsx(n.code,{children:"ui5-cb-group-item"}),")."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"GroupHeaderListItem"})," has been renamed to ",e.jsx(n.code,{children:"ListItemGroup"})," (",e.jsx(n.code,{children:"ui5-li-groupheader"}),")."]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"footer"})," has been replaced by ",e.jsx(n.code,{children:"footerArea"})," and is now a ",e.jsx(n.code,{children:"slot"}),". To display the footer, you now have to set the ",e.jsx(n.code,{children:"showFooter"})," prop to ",e.jsx(n.code,{children:"true"}),"."]}),`
...
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"ui5-form"})," web component doesn't implement the events, attributes and properties of an HTML ",e.jsx(n.code,{children:"form"})," element. So, if you want these features to be available, we recommend wrapping the ",e.jsx(n.code,{children:"Form"})," component inside a HTML ",e.jsx(n.code,{children:"form"})," element."]}),`
...
If you encounter any issues migrating to the `,e.jsx(n.code,{children:"BusyIndicator"}),", please feel free to reach out via ",e.jsx(n.a,{href:"https://github.com/UI5/webcomponents-react/discussions",rel:"nofollow",children:"GitHub Discussions"})," or create an ",e.jsx(n.a,{href:"https://github.com/UI5/webcomponents-react/issues/new/choose",rel:"nofollow",children:"Issue"})," if the behavior seems like a bug."]}),`
...
These props are currently not supported by the new `,e.jsx(n.code,{children:"ui5-text"})," component. You can follow this ",e.jsx(n.a,{href:"https://github.com/UI5/webcomponents/issues/9244",rel:"nofollow",children:"feature request"})," for updates."]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`// v1
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"TypeScript Changes:"})}),`
`,e.jsx(n.p,{children:"The internal table instance types were updated, leading to stricter types, so depending on your implementation, you might encounter ts-errors."}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Renamed or Changed Props:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"alwaysShowSubComponent"})," has been removed, please use ",e.jsx(n.code,{children:"subComponentsBehavior"})," with ",e.jsx(n.code,{children:"AnalyticalTableSubComponentsBehavior.Visible"})," instead."]}),`
`,e.jsxs(n.li,{children:["The default value of ",e.jsx(n.code,{children:"sortable"})," (",e.jsx(n.code,{children:"true"}),") has been removed. To allow sorting in your table please set ",e.jsx(n.code,{children:"sortable"})," to ",e.jsx(n.code,{children:"true"})," yourself."]}),`
`]}),`
...
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Changed Events:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"onRowSelect"}),": Since calculating ",e.jsx(n.code,{children:"selectedFlatRows"})," was very costly, it has been removed from the ",e.jsx(n.code,{children:"detail"})," event object. If you still want to use it, you can calculate it yourself:"]}),`
`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-js",children:`const handleOnRowSelect = (event) => {
...
You can follow this `,e.jsx(n.a,{href:"https://github.com/UI5/webcomponents/issues/9244",rel:"nofollow",children:"feature request"})," for updates."]}),`
`,e.jsx(n.h3,{id:"filterbar",children:"FilterBar"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"FilterBar"}),` component has been completely overhauled, eliminating reference copying of input/filter elements as well as internal selection and reordering, which resulted in API changes for events.
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Reference Copying:"})," Previously, the ",e.jsx(n.code,{children:"FilterBar"})," copied the ",e.jsx(n.code,{children:"children"}),", ",e.jsx(n.code,{children:"values"}),", and other properties of input components like ",e.jsx(n.code,{children:"Input"})," or ",e.jsx(n.code,{children:"MultiComboBox"}),` to the filters dialog. Since this occurred outside the React lifecycle, it could be considered an anti-pattern.
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Selection & Reordering:"})," In V1, the selection and reordering features applied user changes internally to the ",e.jsx(n.code,{children:"FilterBar"}),". This meant that if a user selected a filter in the filters dialog, the change was also reflected in the ",e.jsx(n.code,{children:"FilterBar"}),`.
This approach proved problematic when the component was fully controlled externally, leading to synchronization issues between internal and external changes. Additionally, with the introduction of the V2 `,e.jsx(n.code,{children:"Table"}),` component from UI5 Web Components, which has updated API and markup, some changes to the event API were necessary.
...
`]}),`
`]}),`
`,e.jsx(n.h4,{id:"interactive-example",children:"Interactive Example"}),`
`,e.jsx(X,{}),`
`,e.jsx("br",{}),`
`,e.jsx(n.h5,{id:"code",children:"Code"}),`
`,e.jsxs("details",{children:[e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-jsx",children:`const initialState = {
  age: 37,
  countries: {},
  currency: 'USD',
  date: '',
...
`})}),e.jsx("summary",{children:"Show Code"})]}),`
`,e.jsx(n.h4,{id:"api-changes",children:"API Changes"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"portalContainer"})," has been removed as it's no longer needed due to the ",e.jsx(n.a,{href:"https://developer.mozilla.org/en-US/docs/Web/API/Popover_API",rel:"nofollow",children:"Popover API"})," used in the ",e.jsx(n.code,{children:"Popover"})," ui5 web component."]}),`
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onToggleFilters"}),": The ",e.jsx(n.code,{children:"detail"})," property of the event now only includes ",e.jsx(n.code,{children:"visible"})," and ",e.jsx(n.code,{children:"nativeDetail"})," properties. ",e.jsx(n.code,{children:"filters"})," and ",e.jsx(n.code,{children:"search"})," have been removed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogSave"}),": The ",e.jsx(n.code,{children:"detail"})," property of the event now only includes ",e.jsx(n.code,{children:"selectedFilterKeys"}),", ",e.jsx(n.code,{children:"reorderedFilterKeys"})," and ",e.jsx(n.code,{children:"nativeDetail"})," properties. ",e.jsx(n.code,{children:"elements"}),", ",e.jsx(n.code,{children:"toggledElements"}),", ",e.jsx(n.code,{children:"filters"}),", ",e.jsx(n.code,{children:"search"}),", ",e.jsx(n.code,{children:"orderIds"})," have been removed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogCancel"}),": The event is now a callback instead of a ",e.jsx(n.code,{children:"Ui5CustomEvent"}),". It implements the ",e.jsx(n.code,{children:"escPressed"})," parameter."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogClose"}),": The event is now a callback instead of a ",e.jsx(n.code,{children:"Ui5CustomEvent"}),". It implements the ",e.jsx(n.code,{children:"closeTrigger"})," parameter."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogSelectionChange"}),": The event is now a callback instead of a ",e.jsx(n.code,{children:"Ui5CustomEvent"}),". It implements a payload object as parameter."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogSearch"}),": The event is now a standard ",e.jsx(n.code,{children:"Input"})," ",e.jsx(n.code,{children:"onInput"})," event. The ",e.jsx(n.code,{children:"detail"})," properties ",e.jsx(n.code,{children:"value"})," and ",e.jsx(n.code,{children:"element"})," have been removed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onClear"}),": The event is now a standard ",e.jsx(n.code,{children:"ToolbarButton"})," ",e.jsx(n.code,{children:"onClick"})," event. The ",e.jsx(n.code,{children:"detail"})," properties ",e.jsx(n.code,{children:"filters"})," and ",e.jsx(n.code,{children:"search"})," have been removed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onGo"}),": The event is now a standard ",e.jsx(n.code,{children:"ToolbarButton"})," ",e.jsx(n.code,{children:"onClick"})," event. The ",e.jsx(n.code,{children:"detail"})," properties ",e.jsx(n.code,{children:"elements"}),", ",e.jsx(n.code,{children:"filters"}),", ",e.jsx(n.code,{children:"search"}),", ",e.jsx(n.code,{children:"nativeDetail"})," have been removed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onRestore"}),": The event is now a callback instead of a ",e.jsx(n.code,{children:"CustomEvent"}),". It implements a payload object as parameter."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
onRestore?: (
  event: CustomEvent<{
    source: string;
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"onFiltersDialogOpen"})," (TypeScript): The target of the event is now a ",e.jsx(n.code,{children:"ToolbarButton"}),"."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-ts",children:`// v1
...
`,e.jsxs(n.p,{children:["Additionally, each ",e.jsx(n.code,{children:"FilterGroupItem"})," now needs a unique ",e.jsx(n.code,{children:"filterKey"})," in scope of each ",e.jsx(n.code,{children:"FilterBar"}),". Since the ",e.jsx(n.code,{children:"orderId"})," would then be redundant, we've removed this prop."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`// v1
...
`,e.jsxs(n.p,{children:["In order to provide a place for the ",e.jsx(n.code,{children:"Modals"})," helper to mount the popovers, you have to render the new ",e.jsx(n.code,{children:"Modals"}),` component in your application tree.
In addition, the modals are now rendered as children of the `,e.jsx(n.code,{children:"<Modals>"})," component instead of ",e.jsx(n.code,{children:"document.body"})," by default."]}),`
...
`,e.jsx(n.h3,{id:"selectdialog",children:"SelectDialog"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"mode"})," has been renamed to ",e.jsx(n.code,{children:"selectionMode"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"onAfterClose"})," has been renamed to ",e.jsx(n.code,{children:"onClose"})]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"onAfterOpen"})," has been renamed to ",e.jsx(n.code,{children:"onOpen"})]}),`
`]}),`
...
`,e.jsx(n.h3,{id:"variantmanagement",children:"VariantManagement"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"portalContainer"})," prop has been removed as it is no longer needed."]}),`
...
`]}),`
`,e.jsx(O,{})]})}function Mn(o={}){const{wrapper:n}={...T(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(f,{...o})}):f(o)}export{Mn as default};
