import{w as s,o as l,j as e}from"./iframe-bPNgMO5h.js";import{a as r,M as t}from"./index-Bug9Y4_C.js";const o=s("ui5-mcb-item-group",["headerAccessibleName","headerText","wrappingType"],[],["header"],["move-over","move"]);o.displayName="MultiComboBoxItemGroup";try{o.displayName="MultiComboBoxItemGroup",o.__docgenInfo={description:"The `MultiComboBoxItemGroup` is type of suggestion item,\nthat can be used to split the `MultiComboBox` suggestions into groups.\n\n__Note:__ This is a UI5 Web Component! [MultiComboBoxItemGroup UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/MultiComboBoxItemGroup) | [Repository](https://github.com/UI5/webcomponents)",displayName:"MultiComboBoxItemGroup",props:{children:{defaultValue:null,description:"Defines the items of the <code>ui5-mcb-item-group</code>.\n\n__Supported Node Type/s:__ `Array<MultiComboBoxItem>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},header:{defaultValue:null,description:`Defines the header of the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const m={title:"Inputs / MultiComboBox",component:r,argTypes:{children:{control:{disable:!0}},icon:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:l.None},tags:["package:@ui5/webcomponents"]},n={render:i=>e.jsxs(r,{...i,children:[e.jsx(t,{text:"Item 1"}),e.jsx(t,{text:"Item 2"}),e.jsx(t,{text:"Item 3"}),e.jsx(t,{text:"Item 4"}),e.jsx(t,{text:"Item 5"})]})},a={render:i=>e.jsxs(r,{...i,children:[e.jsxs(o,{headerText:"Asia",children:[e.jsx(t,{text:"Afghanistan"}),e.jsx(t,{text:"China"}),e.jsx(t,{text:"India"}),e.jsx(t,{text:"Indonesia"})]}),e.jsxs(o,{headerText:"Europe",children:[e.jsx(t,{text:"Austria"}),e.jsx(t,{text:"Bulgaria"}),e.jsx(t,{text:"Germany"}),e.jsx(t,{text:"Italy"})]}),e.jsxs(o,{headerText:"North America",children:[e.jsx(t,{text:"Canada"}),e.jsx(t,{text:"Granada"}),e.jsx(t,{text:"Haiti"}),e.jsx(t,{text:"United States"})]})]})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...a.parameters?.docs?.source}}};const u=["Default","Grouping"],c=Object.freeze(Object.defineProperty({__proto__:null,Default:n,Grouping:a,__namedExportsOrder:u,default:m},Symbol.toStringTag,{value:"Module"}));export{c as C,n as D,a as G,o as M};
