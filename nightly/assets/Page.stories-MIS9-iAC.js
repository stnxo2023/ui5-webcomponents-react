...
@public`,tags:{public:``}},{value:`"List"`},{value:`"Solid"`}]}},fixedFooter:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Page/index.d.ts`,name:`PageAttributes`}],description:`Defines if the footer is fixed at the very bottom of the page.
