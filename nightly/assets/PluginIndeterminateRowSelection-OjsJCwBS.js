import{i as e}from"./preload-helper-usAeo7Bx.js";import{Qi as t,Zi as n,lh as r}from"./iframe-B_KIhkEp.js";import{J as i,_ as a,d as o,r as s}from"./blocks-YjR8q0XR.js";import{E as c,_ as l,g as u,t as d,u as f}from"./components-F1CBMphm.js";import{PluginIndeterminateRowSelection as p,t as m}from"./AnalyticalTableHooks.stories-Cj40NJkQ.js";function h(e){let t={code:`code`,h1:`h1`,h2:`h2`,h4:`h4`,p:`p`,pre:`pre`,strong:`strong`,...i(),...e.components};return(0,_.jsxs)(_.Fragment,{children:[(0,_.jsx)(o,{title:`Data Display / AnalyticalTable / Plugin Hooks / useIndeterminateRowSelection`}),`
...
`,(0,_.jsx)(u,{moduleName:`useIndeterminateRowSelection`,packageName:`@ui5/webcomponents-react/AnalyticalTableHooks`}),`
...
`,(0,_.jsx)(n,{hideCloseButton:!0,children:(0,_.jsxs)(_.Fragment,{children:[`The indeterminate state has a higher priority than the selected state. Therefore, a row can be selected and indeterminate at the same time. This can for example happen, if `,(0,_.jsx)(t.code,{children:`selectSubRows: true`}),` is set and a row with sub-rows is selected and then a sub-row is unselected.`]})}),`
`,(0,_.jsx)(t.h2,{id:`example`,children:`Example`}),`
`,(0,_.jsx)(s,{sourceState:`none`,of:p}),`
...
`,(0,_.jsx)(f,{})]})}function g(e={}){let{wrapper:t}={...i(),...e.components};return t?(0,_.jsx)(t,{...e,children:(0,_.jsx)(h,{...e})}):h(e)}var _;e((()=>{_=r(),c(),l(),a(),d(),t(),m()}))();export{g as default};