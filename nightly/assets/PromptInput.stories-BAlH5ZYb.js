import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$m as n,$p as r,Cm as i,Dh as a,Dm as o,Em as s,Id as c,Ld as l,Oh as u,Om as d,Op as f,Qp as p,Rh as m,Sm as h,Tm as g,Vh as _,am as v,bm as y,bp as b,ch as x,im as S,km as ee,kp as te,ng as C,nm as w,rg as T,rm as E,tm as D,vm as O,wm as k,xm as A,xp as j,ym as M}from"./iframe-BjQEXXn3.js";import{c as N,n as P,s as F,t as I,y as L}from"./parameters-bundle.css-ivWRUyAZ.js";import{n as ne,t as R}from"./paper-plane-BeNd0gfq.js";function z(){return E(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&w(p,{for:`input`,children:this.label}),E(`div`,{class:`ai-prompt-input-form-wrapper`,children:[E(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[E(c,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[w(`slot`,{}),this.valueStateMessage.length>0&&w(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&w(p,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),w(b,{icon:ne,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{D(),r(),l(),j(),R()})),V,H=t((()=>{T(),S(),I(),C(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>v),C(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})),U,W,G,K=t((()=>{u(),d(),s(),k(),te(),A(),h(),_(),L(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends a{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){m(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(N,e):W.i18nBundle.getText(F,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([o()],G.prototype,`value`,void 0),U([o()],G.prototype,`placeholder`,void 0),U([o()],G.prototype,`label`,void 0),U([o({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([o({type:Boolean})],G.prototype,`showExceededText`,void 0),U([o({type:Boolean})],G.prototype,`disabled`,void 0),U([o({type:Boolean})],G.prototype,`readonly`,void 0),U([o({type:Number})],G.prototype,`maxlength`,void 0),U([o()],G.prototype,`valueState`,void 0),U([o({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([f({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([f({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([y(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([ee({tag:`ui5-ai-prompt-input`,renderer:i,styles:V,template:z}),g(`submit`,{bubbles:!0}),g(`input`,{bubbles:!0}),g(`change`,{bubbles:!0})],G),G.define()})),q,J=t((()=>{K(),n(),q=x(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
