import{a as e,i as t}from"./preload-helper-B45gAKPr.js";import{X as n,Y as r}from"./CustomElementsScopeUtils-JR3xKyOg.js";import{I as i,q as a}from"./Keys-IKQ9WxgI.js";import{a as o,c as s,d as c,f as l,i as u,l as d,m as f,n as p,o as m,p as h,r as g,s as _,u as v}from"./jsx-runtime-HBoQMrQA.js";import{t as ee}from"./src-DpcViHth.js";import{n as y}from"./withWebComponent-DZ9c6ddo.js";import{n as b,t as x}from"./event-strict-5OBIFxQw.js";import{n as S,t as te}from"./i18n-BioFycvR.js";import{n as C,t as w}from"./ValueState-BxZVFhX3.js";import{n as T,t as E}from"./Label-BlPteeDL.js";import{n as D,t as O}from"./slot-strict-44v7diQu.js";import{n as k,t as A}from"./Button-BiTqEhdj.js";import{n as j,t as M}from"./Input-Dgx5LdM8.js";import{c as N,n as P,s as F,t as I,y as L}from"./parameters-bundle.css-DGogUVi_.js";import{n as ne,t as R}from"./paper-plane-rjtukK9t.js";function z(){return u(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&g(E,{for:`input`,children:this.label}),u(`div`,{class:`ai-prompt-input-form-wrapper`,children:[u(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[u(M,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[g(`slot`,{}),this.valueStateMessage.length>0&&g(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&g(E,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),g(A,{icon:ne,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{p(),T(),j(),k(),R()})),V,H=t((()=>{n(),o(),I(),r(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>m),r(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})),U,W,G,K=t((()=>{f(),c(),d(),x(),D(),S(),_(),a(),L(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends h{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){i(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(N,e):W.i18nBundle.getText(F,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([v()],G.prototype,`value`,void 0),U([v()],G.prototype,`placeholder`,void 0),U([v()],G.prototype,`label`,void 0),U([v({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([v({type:Boolean})],G.prototype,`showExceededText`,void 0),U([v({type:Boolean})],G.prototype,`disabled`,void 0),U([v({type:Boolean})],G.prototype,`readonly`,void 0),U([v({type:Number})],G.prototype,`maxlength`,void 0),U([v()],G.prototype,`valueState`,void 0),U([v({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([O({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([O({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([te(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([l({tag:`ui5-ai-prompt-input`,renderer:s,styles:V,template:z}),b(`submit`,{bubbles:!0}),b(`input`,{bubbles:!0}),b(`change`,{bubbles:!0})],G),G.define()})),q,J=t((()=>{K(),ee(),q=y(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-ai**.`,name:`valueState`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/PromptInput/index.d.ts`,name:`PromptInputAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`"None" | "Critical" | "Information" | ValueState | "Positive" | "Negative"`,value:[{value:`"None"`},{value:`"Critical"`},{value:`"Information"`},{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`},{value:`"Negative"`}]}},className:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`}],description:`CSS Class Name which will be appended to the most outer element of a component.
...
Furthermore, the package supports **Horizon** themes only.`}}}catch{}})),Y=e({Default:()=>Z,__namedExportsOrder:()=>Q,default:()=>X}),X,Z,Q,$=t((()=>{w(),J(),X={title:`PromptInput`,component:q,argTypes:{children:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:C.None},tags:[`package:@ui5/webcomponents-ai`,`experimental`]},Z={},Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`{}`,...Z.parameters?.docs?.source}}},Q=[`Default`]}));$();export{Z as Default,Q as __namedExportsOrder,X as default,$ as n,Y as t};