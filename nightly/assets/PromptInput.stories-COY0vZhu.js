import{a as e,i as t}from"./preload-helper-DbRxMUml.js";import{Bp as n,Dd as r,Dm as i,Ed as a,Fp as o,Hp as s,Ip as c,Km as l,Pm as u,Rp as d,Vp as f,am as p,ap as m,bh as h,cm as g,dm as _,fm as v,fp as y,im as b,ip as ee,lm as te,nm as x,oh as S,om as C,pp as w,qm as T,rh as E,rm as D,sm as O,tm as k,um as A,xh as j,zp as M}from"./iframe-YJobrol7.js";import{c as N,n as P,s as F,t as I,y as ne}from"./parameters-bundle.css-CVWygknX.js";import{n as L,t as R}from"./paper-plane-BvDTmhYZ.js";function z(){return n(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&M(o,{for:`input`,children:this.label}),n(`div`,{class:`ai-prompt-input-form-wrapper`,children:[n(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[n(a,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,children:[M(`slot`,{}),this.valueStateMessage.length>0&&M(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&M(o,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),M(ee,{icon:L,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{d(),c(),r(),m(),R()})),V,H=t((()=>{j(),f(),I(),h(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>s),h(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})),U,W,G,K=t((()=>{T(),_(),te(),O(),w(),b(),p(),S(),ne(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends l{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){E(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(N,e):W.i18nBundle.getText(F,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([A()],G.prototype,`value`,void 0),U([A()],G.prototype,`placeholder`,void 0),U([A()],G.prototype,`label`,void 0),U([A({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([A({type:Boolean})],G.prototype,`showExceededText`,void 0),U([A({type:Boolean})],G.prototype,`disabled`,void 0),U([A({type:Boolean})],G.prototype,`readonly`,void 0),U([A({type:Number})],G.prototype,`maxlength`,void 0),U([A()],G.prototype,`valueState`,void 0),U([A({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([y({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([y({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([D(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([v({tag:`ui5-ai-prompt-input`,renderer:C,styles:V,template:z}),g(`submit`,{bubbles:!0}),g(`input`,{bubbles:!0}),g(`change`,{bubbles:!0})],G),G.define()})),q,J=t((()=>{K(),i(),q=u(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
...
Furthermore, the package supports **Horizon** themes only.`}}}catch{}})),Y=e({Default:()=>Z,__namedExportsOrder:()=>Q,default:()=>X}),X,Z,Q,$=t((()=>{k(),J(),X={title:`PromptInput`,component:q,argTypes:{children:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:x.None},tags:[`package:@ui5/webcomponents-ai`,`experimental`]},Z={},Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`{}`,...Z.parameters?.docs?.source}}},Q=[`Default`]}));$();export{Z as Default,Q as __namedExportsOrder,X as default,$ as n,Y as t};