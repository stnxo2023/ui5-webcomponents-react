import{a as e,i as t}from"./preload-helper-B45gAKPr.js";import{A as n,j as r}from"./Theme-DoyVNigt.js";import{I as i,q as a}from"./Keys-IKQ9WxgI.js";import{a as o,c as s,d as c,f as l,i as u,l as d,m as f,n as p,o as m,p as h,s as g,t as _,u as v}from"./parameters-bundle.css-DXPaaUmA.js";import{n as y,t as b}from"./Button-Dhkwfv5_.js";import{t as ee}from"./src-TC4bZMcJ.js";import{n as te}from"./withWebComponent-Dg_qWubB.js";import{n as x,t as S}from"./event-strict-5OBIFxQw.js";import{n as C,t as w}from"./slot-strict-44v7diQu.js";import{n as T,t as E}from"./i18n-BioFycvR.js";import{n as D,t as O}from"./Label-DXVSY68T.js";import{n as k,t as A}from"./ValueState-BxZVFhX3.js";import{n as j,t as M}from"./Input-Dsb0NMdF.js";import{c as N,n as P,s as F,t as I,y as ne}from"./parameters-bundle.css-DGogUVi_.js";import{n as L,t as R}from"./paper-plane-CwSpbxiw.js";function z(){return m(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&o(O,{for:`input`,children:this.label}),m(`div`,{class:`ai-prompt-input-form-wrapper`,children:[m(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[m(M,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[o(`slot`,{}),this.valueStateMessage.length>0&&o(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&o(O,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),o(b,{icon:L,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{u(),D(),j(),y(),R()})),V,H=t((()=>{r(),_(),I(),n(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>p),n(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})),U,W,G,K=t((()=>{f(),c(),d(),S(),C(),T(),g(),a(),ne(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends h{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){i(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(N,e):W.i18nBundle.getText(F,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([v()],G.prototype,`value`,void 0),U([v()],G.prototype,`placeholder`,void 0),U([v()],G.prototype,`label`,void 0),U([v({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([v({type:Boolean})],G.prototype,`showExceededText`,void 0),U([v({type:Boolean})],G.prototype,`disabled`,void 0),U([v({type:Boolean})],G.prototype,`readonly`,void 0),U([v({type:Number})],G.prototype,`maxlength`,void 0),U([v()],G.prototype,`valueState`,void 0),U([v({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([w({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([w({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([E(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([l({tag:`ui5-ai-prompt-input`,renderer:s,styles:V,template:z}),x(`submit`,{bubbles:!0}),x(`input`,{bubbles:!0}),x(`change`,{bubbles:!0})],G),G.define()})),q,J=t((()=>{K(),ee(),q=te(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
