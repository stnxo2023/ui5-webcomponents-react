import{a as e,i as t}from"./preload-helper-usAeo7Bx.js";import{Am as n,Cm as r,Dm as i,Em as a,Ep as o,Hd as s,Kh as c,Mh as l,Mm as u,Nh as d,Nm as f,Om as p,Pm as m,Tm as h,Tp as g,Uh as _,Vd as v,cg as y,cm as b,ih as x,im as ee,jm as te,km as S,lm as C,nm as w,om as T,ph as E,rm as D,sg as O,sm as k,tm as A,um as j,wm as M}from"./iframe-BDbTYUx3.js";import{c as N,n as P,s as F,t as I,y as L}from"./parameters-bundle.css-ivWRUyAZ.js";import{n as ne,t as R}from"./paper-plane-BHwr2TjT.js";function z(){return b(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&k(D,{for:`input`,children:this.label}),b(`div`,{class:`ai-prompt-input-form-wrapper`,children:[b(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[b(v,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[k(`slot`,{}),this.valueStateMessage.length>0&&k(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&k(D,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),k(g,{icon:ne,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{T(),ee(),s(),o(),R()})),V,H=t((()=>{y(),C(),I(),O(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>j),O(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})),U,W,G,K=t((()=>{d(),f(),te(),S(),w(),a(),i(),c(),L(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends l{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){_(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(N,e):W.i18nBundle.getText(F,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([u()],G.prototype,`value`,void 0),U([u()],G.prototype,`placeholder`,void 0),U([u()],G.prototype,`label`,void 0),U([u({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([u({type:Boolean})],G.prototype,`showExceededText`,void 0),U([u({type:Boolean})],G.prototype,`disabled`,void 0),U([u({type:Boolean})],G.prototype,`readonly`,void 0),U([u({type:Number})],G.prototype,`maxlength`,void 0),U([u()],G.prototype,`valueState`,void 0),U([u({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([A({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([A({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([h(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([m({tag:`ui5-ai-prompt-input`,renderer:p,styles:V,template:z}),n(`submit`,{bubbles:!0}),n(`input`,{bubbles:!0}),n(`change`,{bubbles:!0})],G),G.define()})),q,J=t((()=>{K(),x(),q=E(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
...
Furthermore, the package supports **Horizon** themes only.`}}}catch{}})),Y=e({Default:()=>Z,__namedExportsOrder:()=>Q,default:()=>X}),X,Z,Q,$=t((()=>{r(),J(),X={title:`PromptInput`,component:q,argTypes:{children:{control:{disable:!0}},valueStateMessage:{control:{disable:!0}}},args:{valueState:M.None},tags:[`package:@ui5/webcomponents-ai`,`experimental`]},Z={},Z.parameters={...Z.parameters,docs:{...Z.parameters?.docs,source:{originalSource:`{}`,...Z.parameters?.docs?.source}}},Q=[`Default`]}));$();export{Z as Default,Q as __namedExportsOrder,X as default,$ as n,Y as t};