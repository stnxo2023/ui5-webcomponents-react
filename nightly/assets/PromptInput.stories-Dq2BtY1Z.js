import{a as e,i as t}from"./preload-helper-B45gAKPr.js";import{A as n,j as r}from"./Theme-DAoWBsKS.js";import{I as i,q as a}from"./Keys-IKQ9WxgI.js";import{a as o,c as s,d as c,f as l,i as u,l as d,m as f,n as p,o as m,p as h,r as g,s as _,u as v}from"./jsx-runtime-DI9ELqdM.js";import{t as ee}from"./src-B933wmuH.js";import{n as y}from"./withWebComponent-Bulhy2KK.js";import{n as b,t as x}from"./event-strict-5OBIFxQw.js";import{n as S,t as te}from"./i18n-BioFycvR.js";import{n as C,t as w}from"./ValueState-BxZVFhX3.js";import{n as T,t as E}from"./Label-C2YoR9e-.js";import{n as D,t as O}from"./slot-strict-44v7diQu.js";import{n as k,t as A}from"./Button-DoihTN3V.js";import{n as j,t as M}from"./Input-pflp_R7I.js";import{c as N,n as P,s as F,t as I,y as L}from"./parameters-bundle.css-DGogUVi_.js";import{n as ne,t as R}from"./paper-plane-KOBs7UbZ.js";function z(){return u(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&g(E,{for:`input`,children:this.label}),u(`div`,{class:`ai-prompt-input-form-wrapper`,children:[u(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[u(M,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[g(`slot`,{}),this.valueStateMessage.length>0&&g(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&g(E,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),g(A,{icon:ne,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}var B=t((()=>{p(),T(),j(),k(),R()})),V,H=t((()=>{r(),o(),I(),n(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>m),n(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>P,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
