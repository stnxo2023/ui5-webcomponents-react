import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{X as n,Y as r}from"./CustomElementsScopeUtils-CeUpht4U.js";import{a as i,c as a,d as o,f as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,u as g}from"./jsx-runtime-BpKzXHRO.js";import{I as ee,q as _}from"./Keys-DqJfIghV.js";import{n as v,t as te}from"./withWebComponent-BAGpl5gP.js";import{n as y,t as b}from"./event-strict-C4u0wMzB.js";import{n as x,t as S}from"./i18n-DHtb1CQ9.js";import{n as C,t as w}from"./ValueState-Cz7u0abQ.js";import{n as ne,t as T}from"./Label-DaV7n2sf.js";import{n as E,t as D}from"./slot-strict-BSUUcNBc.js";import{n as O,t as k}from"./Button-BneBjxlg.js";import{n as A,t as j}from"./Input-XMc4sGbe.js";import{c as M,n as N,s as P,t as F,y as I}from"./parameters-bundle.css-wyLn3OCi.js";import{n as L,t as R}from"./paper-plane-BuLNjLDl.js";function z(){return c(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&m(T,{for:`input`,children:this.label}),c(`div`,{class:`ai-prompt-input-form-wrapper`,children:[c(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[c(j,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[m(`slot`,{}),this.valueStateMessage.length>0&&m(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&m(T,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),m(k,{icon:L,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}function B(){return(B=e((()=>{d(),ne(),A(),O(),R()})))()}var V;function H(){return(H=e((()=>{n(),i(),F(),r(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>f),r(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>N,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
