import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{X as n,Y as r}from"./CustomElementsScopeUtils-DMc2l--D.js";import{a as i,c as a,d as o,f as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,u as g}from"./jsx-runtime-bFgdZ7BI.js";import{I as ee,q as _}from"./Keys-DqJfIghV.js";import{n as v,t as te}from"./withWebComponent-CAFYyfUs.js";import{n as y,t as b}from"./event-strict-C4u0wMzB.js";import{n as x,t as S}from"./i18n-DHtb1CQ9.js";import{n as C,t as w}from"./ValueState-Cz7u0abQ.js";import{n as ne,t as T}from"./Label-n6Xqji3H.js";import{n as E,t as D}from"./slot-strict-BSUUcNBc.js";import{n as O,t as k}from"./Button-DWE0LH77.js";import{n as A,t as j}from"./Input-D4TdjMuO.js";import{c as M,n as N,s as P,t as F,y as I}from"./parameters-bundle.css-wyLn3OCi.js";import{n as L,t as R}from"./paper-plane-Bw8FsIZV.js";function z(){return c(`div`,{class:`ai-prompt-input-wrapper`,children:[this.label&&m(T,{for:`input`,children:this.label}),c(`div`,{class:`ai-prompt-input-form-wrapper`,children:[c(`div`,{class:`ai-prompt-inner-input-wrapper`,children:[c(j,{id:`input`,value:this.value,placeholder:this.placeholder,valueState:this.valueState,showClearIcon:this.showClearIcon,disabled:this.disabled,readonly:this.readonly,showSuggestions:this.showSuggestions,onKeyDown:this._onkeydown,onInput:this._onInnerInput,onChange:this._onInnerChange,onTypeAhead:this._onTypeAhead,"data-sap-focus-ref":!0,children:[m(`slot`,{}),this.valueStateMessage.length>0&&m(`slot`,{name:`valueStateMessage`,slot:`valueStateMessage`})]}),this.showExceededText&&m(T,{class:`ai-prompt-input-counter`,children:this._exceededText})]}),m(k,{icon:L,disabled:this._submitButtonDisabled,class:`ai-prompt-input-button`,design:`Emphasized`,onClick:this._onButtonClick})]})]})}function B(){return(B=e((()=>{d(),ne(),A(),O(),R()})))()}var V;function H(){return(H=e((()=>{n(),i(),F(),r(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>f),r(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>N,`host`),V=`:host(:not([hidden])){display:inline-block}.ai-prompt-input-button{margin-left:.5rem;margin-top:3px}.ai-prompt-input-wrapper{display:flex;flex-direction:column;min-width:270px}.ai-prompt-input-form-wrapper{display:flex;flex:1}.ai-prompt-input-counter{font-size:.75rem;align-self:flex-end}#input{width:100%}.ai-prompt-inner-input-wrapper{display:flex;flex-direction:column;flex:1}
`})))()}var U,W,G;function K(){return(K=e((()=>{u(),o(),l(),b(),E(),x(),h(),_(),I(),B(),H(),U=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},G=W=class extends p{constructor(){super(...arguments),this.value=``,this.showClearIcon=!1,this.showExceededText=!1,this.disabled=!1,this.readonly=!1,this.valueState=`None`,this.showSuggestions=!1}_onkeydown(e){ee(e)&&this.fireDecoratorEvent(`submit`)}_onInnerInput(e){this.value=e.currentTarget.value,this.fireDecoratorEvent(`input`)}_onInnerChange(){this.fireDecoratorEvent(`change`)}_onButtonClick(){this.fireDecoratorEvent(`submit`)}_onTypeAhead(e){this.value=e.currentTarget.value}get _exceededText(){if(this.showExceededText){let e,t=this.maxlength;if(t!==void 0)return e=t-this.value.length,e>=0?W.i18nBundle.getText(M,e):W.i18nBundle.getText(P,Math.abs(e))}}get _maxLenght(){return this.maxlength||void 0}get _submitButtonDisabled(){return this.value.length<=0||this.disabled||this.readonly}},U([g()],G.prototype,`value`,void 0),U([g()],G.prototype,`placeholder`,void 0),U([g()],G.prototype,`label`,void 0),U([g({type:Boolean})],G.prototype,`showClearIcon`,void 0),U([g({type:Boolean})],G.prototype,`showExceededText`,void 0),U([g({type:Boolean})],G.prototype,`disabled`,void 0),U([g({type:Boolean})],G.prototype,`readonly`,void 0),U([g({type:Number})],G.prototype,`maxlength`,void 0),U([g()],G.prototype,`valueState`,void 0),U([g({type:Boolean})],G.prototype,`showSuggestions`,void 0),U([D({type:HTMLElement,default:!0})],G.prototype,`suggestionItems`,void 0),U([D({type:HTMLElement,invalidateOnChildChange:!0})],G.prototype,`valueStateMessage`,void 0),U([S(`@ui5/webcomponents-ai`)],G,`i18nBundle`,void 0),G=W=U([s({tag:`ui5-ai-prompt-input`,renderer:a,styles:V,template:z}),y(`submit`,{bubbles:!0}),y(`input`,{bubbles:!0}),y(`change`,{bubbles:!0})],G),G.define()})))()}var q;function J(){return(J=e((()=>{K(),te(),q=v(`ui5-ai-prompt-input`,[`label`,`maxlength`,`placeholder`,`value`,`valueState`],[`disabled`,`readonly`,`showClearIcon`,`showExceededText`,`showSuggestions`],[`valueStateMessage`],[`change`,`input`,`submit`]),q.displayName=`PromptInput`;try{q.displayName=`PromptInput`,q.__docgenInfo={description:`The \`PromptInput\` component allows the user to write custom instructions in natural language, so that AI is guided to generate content tailored to user needs.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-ai**.`,name:`valueState`,parent:{fileName:`ui5-webcomponents-react/packages/ai/dist/components/PromptInput/index.d.ts`,name:`PromptInputAttributes`},required:!1,tags:{default:`"None"`},type:{name:`enum`,raw:`ValueState | "None" | "Positive" | "Critical" | "Negative" | "Information"`,value:[{value:`"None"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Positive"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Critical"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Negative"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"Information"`,description:``,fullComment:`@public`,tags:{public:``}},{value:`"None"`},{value:`"Positive"`},{value:`"Critical"`},{value:`"Negative"`},{value:`"Information"`}]}},className:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`}],description:`CSS Class Name which will be appended to the most outer element of a component.
