import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$h as n,$i as r,$m as i,Bl as a,Jd as o,Jl as s,Qh as c,S as l,Xl as u,Zh as d,Zi as f,ah as p,ea as m,ef as h,gu as g,lh as _,of as v,r as y,t as b,u as x,zg as S}from"./iframe-C20qurPL.js";import{J as C,_ as w,d as T,f as E}from"./blocks-CHXa2FMG.js";import{E as D,m as O,t as k,u as A}from"./components-D3Gpxks0.js";var j,M,N,P,F,I,L,R,z,B,V,H,U,W=t((()=>{d(),x(),i(),j=e(S(),1),y(),M=_(),N={display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,rowGap:`1rem`,columnGap:`1rem`},P=[],F=[],I=[],L=Object.entries(p).filter(([e,t])=>e.includes(`Font`)?e.includes(`FontUrl`)?!0:(P.push([e,t]),!1):e.includes(`Color`)||e.includes(`Shadow`)||e.includes(`Background`)||e.includes(`Chart`)?(F.push([e,t]),!1):e.includes(`Space`)||e.includes(`Margin`)||e.includes(`Padding`)||e.includes(`Gap`)||e.includes(`Breakpoint`)?(I.push([e,t]),!1):!0),R=e=>{let t={};return e.includes(`Family`)||e.includes(`FontUrl`)?t.fontFamily=e:e.includes(`Size`)?t.fontSize=e:e.includes(`Weight`)&&(t.fontWeight=e),t},z=e=>{let t={};return e.includes(`Shadow`)?t.boxShadow=e:t.backgroundColor=e,t},B=({value:e,varKey:t,theme:n,style:r={}})=>{let[i,a]=(0,j.useReducer)(e=>!e,!1),[s,c]=(0,j.useState)(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`));return(0,j.useEffect)(()=>{setTimeout(()=>{c(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`))},200)},[n]),(0,M.jsxs)(h,{direction:v.Column,style:{width:`85%`},children:[(0,M.jsx)(o,{title:`Click to show CSS Variable`,style:{cursor:`pointer`,...r},onClick:a,children:i?e:t}),(0,M.jsx)(g,{children:s})]},t)},V=e=>{let{varKey:t,value:n,theme:r}=e;return(0,M.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,M.jsx)(B,{value:n,varKey:t,theme:r}),(0,M.jsx)(`div`,{style:{...z(n),borderRadius:`50%`,width:`2rem`,height:`2rem`,minWidth:`2rem`,border:`1px solid ${p.sapField_BorderColor}`}})]})},H=e=>{let{varKey:t,value:n,theme:r,style:i={}}=e;return(0,M.jsx)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:(0,M.jsx)(B,{value:n,varKey:t,style:i,them:r})})},U=()=>{let[e,t]=(0,j.useState)(n());return(0,M.jsx)(l,{children:(0,M.jsxs)(`div`,{style:{backgroundColor:p.sapBackgroundColor,padding:`1rem`,borderRadius:p.sapElement_BorderCornerRadius,boxShadow:p.sapContent_Shadow0},children:[(0,M.jsx)(a,{onChange:e=>{let n=e.detail.selectedOption.dataset.value;t(n),c(n)},children:b.map(({title:t,value:n})=>(0,M.jsx)(u,{"data-value":n,selected:n===e,children:t},n))}),(0,M.jsx)(`br`,{}),(0,M.jsx)(`br`,{}),(0,M.jsx)(s,{headerText:`Colors & Shadows`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:F.map(([t,n])=>(0,M.jsx)(V,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(s,{headerText:`Fonts`,collapsed:!0,children:(0,M.jsx)(`div`,{style:{...N,gridTemplateColumns:`repeat(1, minmax(0, 1fr))`},children:P.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,style:{...R(n)},theme:e},t))})}),(0,M.jsx)(s,{headerText:`Spacing`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:I.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(s,{headerText:`Others`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:L.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})})]})})}}));function G(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...C(),...e.components};return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(T,{title:`Public Utils`}),`
...
`,(0,q.jsx)(f,{design:r.Critical,hideCloseButton:!0,children:`Please only use the utils mentioned in this document in your application. All other exports are intended for internal
...
`,(0,q.jsx)(A,{})]})}function K(e={}){let{wrapper:t}={...C(),...e.components};return t?(0,q.jsx)(t,{...e,children:(0,q.jsx)(G,{...e})}):G(e)}var q;t((()=>{q=_(),D(),w(),m(),x(),k(),W()}))();export{K as default};