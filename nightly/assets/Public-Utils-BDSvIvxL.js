import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{Fm as n,Gi as r,Hi as i,Jd as a,Jm as o,Mh as s,Ml as c,Nh as l,Pl as u,Rm as d,Ud as f,Wi as p,eu as m,jh as h,r as g,t as _,u as v,v as y,wl as b,yg as x,zd as S}from"./iframe-tX3NbIfQ.js";import{r as C}from"./react-BLlyzMaS.js";import{_ as w,c as T,o as E,t as D}from"./components-DgxrrTt2.js";import{_ as O,d as k,f as A}from"./blocks-D-y6hqmi.js";var j,M,N,P,F,I,L,R,z,B,V,H,U,W=e((()=>{h(),v(),n(),j=t(x(),1),g(),M=o(),N={display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,rowGap:`1rem`,columnGap:`1rem`},P=[],F=[],I=[],L=Object.entries(d).filter(([e,t])=>e.includes(`Font`)?e.includes(`FontUrl`)?!0:(P.push([e,t]),!1):e.includes(`Color`)||e.includes(`Shadow`)||e.includes(`Background`)||e.includes(`Chart`)?(F.push([e,t]),!1):e.includes(`Space`)||e.includes(`Margin`)||e.includes(`Padding`)||e.includes(`Gap`)||e.includes(`Breakpoint`)?(I.push([e,t]),!1):!0),R=e=>{let t={};return e.includes(`Family`)||e.includes(`FontUrl`)?t.fontFamily=e:e.includes(`Size`)?t.fontSize=e:e.includes(`Weight`)&&(t.fontWeight=e),t},z=e=>{let t={};return e.includes(`Shadow`)?t.boxShadow=e:t.backgroundColor=e,t},B=({value:e,varKey:t,theme:n,style:r={}})=>{let[i,o]=(0,j.useReducer)(e=>!e,!1),[s,c]=(0,j.useState)(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`));return(0,j.useEffect)(()=>{setTimeout(()=>{c(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`))},200)},[n]),(0,M.jsxs)(f,{direction:a.Column,style:{width:`85%`},children:[(0,M.jsx)(S,{title:`Click to show CSS Variable`,style:{cursor:`pointer`,...r},onClick:o,children:i?e:t}),(0,M.jsx)(m,{children:s})]},t)},V=e=>{let{varKey:t,value:n,theme:r}=e;return(0,M.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,M.jsx)(B,{value:n,varKey:t,theme:r}),(0,M.jsx)(`div`,{style:{...z(n),borderRadius:`50%`,width:`2rem`,height:`2rem`,minWidth:`2rem`,border:`1px solid ${d.sapField_BorderColor}`}})]})},H=e=>{let{varKey:t,value:n,theme:r,style:i={}}=e;return(0,M.jsx)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:(0,M.jsx)(B,{value:n,varKey:t,style:i,them:r})})},U=()=>{let[e,t]=(0,j.useState)(l());return(0,M.jsx)(y,{children:(0,M.jsxs)(`div`,{style:{backgroundColor:d.sapBackgroundColor,padding:`1rem`,borderRadius:d.sapElement_BorderCornerRadius,boxShadow:d.sapContent_Shadow0},children:[(0,M.jsx)(b,{onChange:e=>{let n=e.detail.selectedOption.dataset.value;t(n),s(n)},children:_.map(({title:t,value:n})=>(0,M.jsx)(u,{"data-value":n,selected:n===e,children:t},n))}),(0,M.jsx)(`br`,{}),(0,M.jsx)(`br`,{}),(0,M.jsx)(c,{headerText:`Colors & Shadows`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:F.map(([t,n])=>(0,M.jsx)(V,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(c,{headerText:`Fonts`,collapsed:!0,children:(0,M.jsx)(`div`,{style:{...N,gridTemplateColumns:`repeat(1, minmax(0, 1fr))`},children:P.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,style:{...R(n)},theme:e},t))})}),(0,M.jsx)(c,{headerText:`Spacing`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:I.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(c,{headerText:`Others`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:L.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})})]})})}}));function G(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...C(),...e.components};return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(k,{title:`Public Utils`}),`
...
`,(0,q.jsx)(i,{design:p.Critical,hideCloseButton:!0,children:`Please only use the utils mentioned in this document in your application. All other exports are intended for internal
...
`,(0,q.jsx)(E,{})]})}function K(e={}){let{wrapper:t}={...C(),...e.components};return t?(0,q.jsx)(t,{...e,children:(0,q.jsx)(G,{...e})}):G(e)}var q;e((()=>{q=o(),w(),O(),r(),v(),D(),W()}))();export{K as default};