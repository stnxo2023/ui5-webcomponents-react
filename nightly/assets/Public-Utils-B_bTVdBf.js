import{c as e,i as t}from"./preload-helper-DbRxMUml.js";import{Dm as n,Fm as r,Hl as i,Pl as a,Rd as o,Wd as s,Wl as c,Xd as l,Xi as u,Yi as d,_h as f,gh as p,jm as m,ng as h,qi as g,r as _,t as v,u as y,uu as b,vh as x,y as S}from"./iframe-DeXKz_tp.js";import{J as C,_ as w,d as T,f as E}from"./blocks-Dqiich01.js";import{_ as D,c as O,o as k,t as A}from"./components-D4RXHfua.js";var j,M,N,P,F,I,L,R,z,B,V,H,U,W=t((()=>{p(),y(),n(),j=e(h(),1),_(),M=r(),N={display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,rowGap:`1rem`,columnGap:`1rem`},P=[],F=[],I=[],L=Object.entries(m).filter(([e,t])=>e.includes(`Font`)?e.includes(`FontUrl`)?!0:(P.push([e,t]),!1):e.includes(`Color`)||e.includes(`Shadow`)||e.includes(`Background`)||e.includes(`Chart`)?(F.push([e,t]),!1):e.includes(`Space`)||e.includes(`Margin`)||e.includes(`Padding`)||e.includes(`Gap`)||e.includes(`Breakpoint`)?(I.push([e,t]),!1):!0),R=e=>{let t={};return e.includes(`Family`)||e.includes(`FontUrl`)?t.fontFamily=e:e.includes(`Size`)?t.fontSize=e:e.includes(`Weight`)&&(t.fontWeight=e),t},z=e=>{let t={};return e.includes(`Shadow`)?t.boxShadow=e:t.backgroundColor=e,t},B=({value:e,varKey:t,theme:n,style:r={}})=>{let[i,a]=(0,j.useReducer)(e=>!e,!1),[c,u]=(0,j.useState)(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`));return(0,j.useEffect)(()=>{setTimeout(()=>{u(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`))},200)},[n]),(0,M.jsxs)(s,{direction:l.Column,style:{width:`85%`},children:[(0,M.jsx)(o,{title:`Click to show CSS Variable`,style:{cursor:`pointer`,...r},onClick:a,children:i?e:t}),(0,M.jsx)(b,{children:c})]},t)},V=e=>{let{varKey:t,value:n,theme:r}=e;return(0,M.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,M.jsx)(B,{value:n,varKey:t,theme:r}),(0,M.jsx)(`div`,{style:{...z(n),borderRadius:`50%`,width:`2rem`,height:`2rem`,minWidth:`2rem`,border:`1px solid ${m.sapField_BorderColor}`}})]})},H=e=>{let{varKey:t,value:n,theme:r,style:i={}}=e;return(0,M.jsx)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:(0,M.jsx)(B,{value:n,varKey:t,style:i,them:r})})},U=()=>{let[e,t]=(0,j.useState)(x());return(0,M.jsx)(S,{children:(0,M.jsxs)(`div`,{style:{backgroundColor:m.sapBackgroundColor,padding:`1rem`,borderRadius:m.sapElement_BorderCornerRadius,boxShadow:m.sapContent_Shadow0},children:[(0,M.jsx)(a,{onChange:e=>{let n=e.detail.selectedOption.dataset.value;t(n),f(n)},children:v.map(({title:t,value:n})=>(0,M.jsx)(c,{"data-value":n,selected:n===e,children:t},n))}),(0,M.jsx)(`br`,{}),(0,M.jsx)(`br`,{}),(0,M.jsx)(i,{headerText:`Colors & Shadows`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:F.map(([t,n])=>(0,M.jsx)(V,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(i,{headerText:`Fonts`,collapsed:!0,children:(0,M.jsx)(`div`,{style:{...N,gridTemplateColumns:`repeat(1, minmax(0, 1fr))`},children:P.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,style:{...R(n)},theme:e},t))})}),(0,M.jsx)(i,{headerText:`Spacing`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:I.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(i,{headerText:`Others`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:L.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})})]})})}}));function G(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...C(),...e.components};return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(T,{title:`Public Utils`}),`
...
`,(0,q.jsx)(g,{design:d.Critical,hideCloseButton:!0,children:`Please only use the utils mentioned in this document in your application. All other exports are intended for internal
...
`,(0,q.jsx)(k,{})]})}function K(e={}){let{wrapper:t}={...C(),...e.components};return t?(0,q.jsx)(t,{...e,children:(0,q.jsx)(G,{...e})}):G(e)}var q;t((()=>{q=r(),D(),w(),u(),y(),A(),W()}))();export{K as default};