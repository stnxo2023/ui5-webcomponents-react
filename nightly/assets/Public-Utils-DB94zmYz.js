import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$h as n,$m as r,Jd as i,Qh as a,Ql as o,S as s,Wl as c,Zh as l,ah as u,bu as d,ef as f,eu as p,ia as m,lh as h,of as g,r as _,ra as v,t as y,ta as b,u as x,zg as S}from"./iframe-7fLyI5vs.js";import{J as C,_ as w,d as T,f as E}from"./blocks-BfMz_F-Y.js";import{E as D,m as O,t as k,u as A}from"./components-By35v5dp.js";var j,M,N,P,F,I,L,R,z,B,V,H,U,W=t((()=>{l(),x(),r(),j=e(S(),1),_(),M=h(),N={display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,rowGap:`1rem`,columnGap:`1rem`},P=[],F=[],I=[],L=Object.entries(u).filter(([e,t])=>e.includes(`Font`)?e.includes(`FontUrl`)?!0:(P.push([e,t]),!1):e.includes(`Color`)||e.includes(`Shadow`)||e.includes(`Background`)||e.includes(`Chart`)?(F.push([e,t]),!1):e.includes(`Space`)||e.includes(`Margin`)||e.includes(`Padding`)||e.includes(`Gap`)||e.includes(`Breakpoint`)?(I.push([e,t]),!1):!0),R=e=>{let t={};return e.includes(`Family`)||e.includes(`FontUrl`)?t.fontFamily=e:e.includes(`Size`)?t.fontSize=e:e.includes(`Weight`)&&(t.fontWeight=e),t},z=e=>{let t={};return e.includes(`Shadow`)?t.boxShadow=e:t.backgroundColor=e,t},B=({value:e,varKey:t,theme:n,style:r={}})=>{let[a,o]=(0,j.useReducer)(e=>!e,!1),[s,c]=(0,j.useState)(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`));return(0,j.useEffect)(()=>{setTimeout(()=>{c(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`))},200)},[n]),(0,M.jsxs)(f,{direction:g.Column,style:{width:`85%`},children:[(0,M.jsx)(i,{title:`Click to show CSS Variable`,style:{cursor:`pointer`,...r},onClick:o,children:a?e:t}),(0,M.jsx)(d,{children:s})]},t)},V=e=>{let{varKey:t,value:n,theme:r}=e;return(0,M.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,M.jsx)(B,{value:n,varKey:t,theme:r}),(0,M.jsx)(`div`,{style:{...z(n),borderRadius:`50%`,width:`2rem`,height:`2rem`,minWidth:`2rem`,border:`1px solid ${u.sapField_BorderColor}`}})]})},H=e=>{let{varKey:t,value:n,theme:r,style:i={}}=e;return(0,M.jsx)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:(0,M.jsx)(B,{value:n,varKey:t,style:i,them:r})})},U=()=>{let[e,t]=(0,j.useState)(n());return(0,M.jsx)(s,{children:(0,M.jsxs)(`div`,{style:{backgroundColor:u.sapBackgroundColor,padding:`1rem`,borderRadius:u.sapElement_BorderCornerRadius,boxShadow:u.sapContent_Shadow0},children:[(0,M.jsx)(c,{onChange:e=>{let n=e.detail.selectedOption.dataset.value;t(n),a(n)},children:y.map(({title:t,value:n})=>(0,M.jsx)(p,{"data-value":n,selected:n===e,children:t},n))}),(0,M.jsx)(`br`,{}),(0,M.jsx)(`br`,{}),(0,M.jsx)(o,{headerText:`Colors & Shadows`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:F.map(([t,n])=>(0,M.jsx)(V,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(o,{headerText:`Fonts`,collapsed:!0,children:(0,M.jsx)(`div`,{style:{...N,gridTemplateColumns:`repeat(1, minmax(0, 1fr))`},children:P.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,style:{...R(n)},theme:e},t))})}),(0,M.jsx)(o,{headerText:`Spacing`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:I.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(o,{headerText:`Others`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:L.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})})]})})}}));function G(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...C(),...e.components};return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(T,{title:`Public Utils`}),`
...
`,(0,q.jsx)(b,{design:v.Critical,hideCloseButton:!0,children:`Please only use the utils mentioned in this document in your application. All other exports are intended for internal
use and are not subject to semantic versioning!`}),`
`,(0,q.jsx)(`br`,{}),`
`,(0,q.jsx)(`br`,{}),`
`,(0,q.jsx)(O,{}),`
`,(0,q.jsx)(t.h2,{id:`device`,children:`Device`}),`
`,(0,q.jsx)(E,{code:`import * as Device from '@ui5/webcomponents-react-base/Device';`}),`
...
`,(0,q.jsx)(E,{code:`import { ThemingParameters } from '@ui5/webcomponents-react-base/ThemingParameters';`}),`
...
`,(0,q.jsx)(E,{code:`import { useI18nBundle } from '@ui5/webcomponents-react-base/hooks';`}),`
...
`,(0,q.jsx)(E,{code:`import { useViewportRange } from '@ui5/webcomponents-react-base/hooks';`}),`
...
`,(0,q.jsx)(A,{})]})}function K(e={}){let{wrapper:t}={...C(),...e.components};return t?(0,q.jsx)(t,{...e,children:(0,q.jsx)(G,{...e})}):G(e)}var q;t((()=>{q=h(),D(),w(),m(),x(),k(),W()}))();export{K as default};