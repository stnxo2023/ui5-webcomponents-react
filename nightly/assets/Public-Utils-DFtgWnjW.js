import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Bd as n,Bh as r,Gi as i,Hh as a,Hi as o,Hm as s,Kd as c,Km as l,Ml as u,Og as d,Pl as f,Qd as p,Vh as m,Wi as h,Xm as g,eu as _,r as v,t as y,u as b,v as x,wl as S}from"./iframe-D_P1xdep.js";import{r as C}from"./react-C7u9R2dD.js";import{_ as w,c as T,o as E,t as D}from"./components-Bu3Pz_Bo.js";import{_ as O,d as k,f as A}from"./blocks-D-43kzqo.js";var j,M,N,P,F,I,L,R,z,B,V,H,U,W=e((()=>{r(),b(),s(),j=t(d(),1),v(),M=g(),N={display:`grid`,gridTemplateColumns:`repeat(3, minmax(0, 1fr))`,rowGap:`1rem`,columnGap:`1rem`},P=[],F=[],I=[],L=Object.entries(l).filter(([e,t])=>e.includes(`Font`)?e.includes(`FontUrl`)?!0:(P.push([e,t]),!1):e.includes(`Color`)||e.includes(`Shadow`)||e.includes(`Background`)||e.includes(`Chart`)?(F.push([e,t]),!1):e.includes(`Space`)||e.includes(`Margin`)||e.includes(`Padding`)||e.includes(`Gap`)||e.includes(`Breakpoint`)?(I.push([e,t]),!1):!0),R=e=>{let t={};return e.includes(`Family`)||e.includes(`FontUrl`)?t.fontFamily=e:e.includes(`Size`)?t.fontSize=e:e.includes(`Weight`)&&(t.fontWeight=e),t},z=e=>{let t={};return e.includes(`Shadow`)?t.boxShadow=e:t.backgroundColor=e,t},B=({value:e,varKey:t,theme:r,style:i={}})=>{let[a,o]=(0,j.useReducer)(e=>!e,!1),[s,l]=(0,j.useState)(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`));return(0,j.useEffect)(()=>{setTimeout(()=>{l(getComputedStyle(document.documentElement).getPropertyValue(`--${t}`))},200)},[r]),(0,M.jsxs)(c,{direction:p.Column,style:{width:`85%`},children:[(0,M.jsx)(n,{title:`Click to show CSS Variable`,style:{cursor:`pointer`,...i},onClick:o,children:a?e:t}),(0,M.jsx)(_,{children:s})]},t)},V=e=>{let{varKey:t,value:n,theme:r}=e;return(0,M.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,M.jsx)(B,{value:n,varKey:t,theme:r}),(0,M.jsx)(`div`,{style:{...z(n),borderRadius:`50%`,width:`2rem`,height:`2rem`,minWidth:`2rem`,border:`1px solid ${l.sapField_BorderColor}`}})]})},H=e=>{let{varKey:t,value:n,theme:r,style:i={}}=e;return(0,M.jsx)(`div`,{style:{display:`inline-flex`,alignItems:`center`,justifyContent:`space-between`},children:(0,M.jsx)(B,{value:n,varKey:t,style:i,them:r})})},U=()=>{let[e,t]=(0,j.useState)(a());return(0,M.jsx)(x,{children:(0,M.jsxs)(`div`,{style:{backgroundColor:l.sapBackgroundColor,padding:`1rem`,borderRadius:l.sapElement_BorderCornerRadius,boxShadow:l.sapContent_Shadow0},children:[(0,M.jsx)(S,{onChange:e=>{let n=e.detail.selectedOption.dataset.value;t(n),m(n)},children:y.map(({title:t,value:n})=>(0,M.jsx)(f,{"data-value":n,selected:n===e,children:t},n))}),(0,M.jsx)(`br`,{}),(0,M.jsx)(`br`,{}),(0,M.jsx)(u,{headerText:`Colors & Shadows`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:F.map(([t,n])=>(0,M.jsx)(V,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(u,{headerText:`Fonts`,collapsed:!0,children:(0,M.jsx)(`div`,{style:{...N,gridTemplateColumns:`repeat(1, minmax(0, 1fr))`},children:P.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,style:{...R(n)},theme:e},t))})}),(0,M.jsx)(u,{headerText:`Spacing`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:I.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})}),(0,M.jsx)(u,{headerText:`Others`,collapsed:!0,children:(0,M.jsx)(`div`,{style:N,children:L.map(([t,n])=>(0,M.jsx)(H,{varKey:t,value:n,theme:e},t))})})]})})}}));function G(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...C(),...e.components};return(0,q.jsxs)(q.Fragment,{children:[(0,q.jsx)(k,{title:`Public Utils`}),`
...
`,(0,q.jsx)(o,{design:h.Critical,hideCloseButton:!0,children:`Please only use the utils mentioned in this document in your application. All other exports are intended for internal
...
`,(0,q.jsx)(E,{})]})}function K(e={}){let{wrapper:t}={...C(),...e.components};return t?(0,q.jsx)(t,{...e,children:(0,q.jsx)(G,{...e})}):G(e)}var q;e((()=>{q=g(),w(),O(),i(),b(),D(),W()}))();export{K as default};