import{n as e,o as t,r as n}from"./rolldown-runtime-DAXXjFlN.js";import{t as r}from"./react-DEAHbL4P.js";import{i,r as a}from"./utils-j92WKsCf.js";import{c as o,l as s}from"./hooks-DHpnRNCg.js";import{t as c}from"./jsx-runtime-CFwixLRt.js";import{B as l,J as u,K as ee,W as te,_t as d,ft as f,n as p,r as m,t as h,u as g}from"./ChartContainer-DPOvtqnJ.js";import{a as _,d as v,i as y,m as b,s as x}from"./DemoProps-Ds9dmsld.js";import{a as S,c as C,i as w,l as T,n as E,s as D,u as ne}from"./staticProps-xCH_ZIw3.js";import{i as O,n as k,r as A,t as j}from"./ChartDataLabel-DaShtXu0.js";import{i as M,n as N,r as P,t as F}from"./useTooltipFormatter-DTia3vJ_.js";import{n as I,t as re}from"./Placeholder-C3aT7vZF.js";var L,R,z,B,V,H=e((()=>{i(),s(),L=t(r(),1),m(),A(),T(),P(),F(),p(),k(),C(),E(),I(),R=c(),z={formatter:e=>e},B={formatter:D,opacity:.5},V=(0,L.forwardRef)((e,t)=>{let{loading:n,loadingDelay:r,dataset:i,noLegend:s,noAnimation:c,tooltipConfig:p,onDataPointClick:m,onLegendClick:_,onClick:v,style:y,className:b,slot:x,ChartPlaceholder:C,children:T,...E}=e,D={legendPosition:`bottom`,legendHorizontalAlign:`center`,dataLabel:!0,polarGridType:`circle`,resizeDebounce:250,...e.chartConfig},{dimensions:k,measures:A}=M(e.dimensions,e.measures,z,B),P=N(A),F=k[0],I=O(F?.formatter),V=F?.accessor,H=ne(_),U=(0,L.useRef)(!1),W=(0,L.useCallback)((e,t)=>{typeof v==`function`&&!U.current&&v(a(t,{payload:e?.activePayload?.[0]?.payload,activePayloads:e?.activePayload})),U.current&&=!1},[v,U.current]),G=(0,L.useCallback)((e,t)=>{t.value&&m&&(m(a({},{value:t.value,dataKey:t.dataKey,name:t.payload.label,dataIndex:t.index,payload:t.payload})),U.current=!0)},[m,U.current]),{chartConfig:K,dimensions:q,measures:J,...Y}=E;return(0,R.jsx)(h,{dataset:i,ref:t,loading:n,loadingDelay:r,Placeholder:C??re,style:y,className:b,slot:x,resizeDebounce:D.resizeDebounce,...Y,children:(0,R.jsxs)(g,{onClick:W,data:i,margin:D.margin,accessibilityLayer:D.accessibilityLayer,className:typeof m==`function`?`has-click-handler`:void 0,children:[(0,R.jsx)(u,{gridType:D.polarGridType}),(0,R.jsx)(te,{dataKey:V,tickFormatter:F?.formatter,tick:{fill:o.sapContent_LabelColor}}),(0,R.jsx)(ee,{}),A.map((e,t)=>(0,R.jsx)(l,{activeDot:{onClick:G},name:e.label??e.accessor,dataKey:e.accessor,stroke:e.color??`var(--sapChart_OrderedColor_${t%12+1})`,fill:e.color??`var(--sapChart_OrderedColor_${t%12+1})`,fillOpacity:e.opacity,label:(0,R.jsx)(j,{config:e,chartType:`radar`,position:`outside`}),isAnimationActive:!c},e.reactKey)),p?.active!==!1&&(0,R.jsx)(f,{cursor:S,formatter:P,contentStyle:w,labelFormatter:I,...p}),!s&&(0,R.jsx)(d,{verticalAlign:D.legendPosition,align:D.legendHorizontalAlign,onClick:H,...D.legendConfig}),T]})})}),V.displayName=`RadarChart`;try{V.displayName=`RadarChart`,V.__docgenInfo={description:`A radar or spider or web chart is a two-dimensional chart type designed to plot one or more series of values over multiple quantitative variables.
...
Use this prop carefully, some css properties might break the component.`,name:`style`,parent:{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`},required:!1,tags:{},type:{name:`CSSProperties`}}},tags:{}}}catch{}})),U=n({Default:()=>G,LoadingPlaceholder:()=>Y,Polygon:()=>J,WithCustomColor:()=>K,WithCustomLegendConfig:()=>Z,WithCustomTooltipConfig:()=>X,WithDataLabels:()=>q,__namedExportsOrder:()=>Q,default:()=>W}),W,G,K,q,J,Y,X,Z,Q,$=e((()=>{_(),H(),W={title:`RadarChart`,component:V,tags:[`package:@ui5/webcomponents-react-charts`],args:{dimensions:[{accessor:`name`,formatter:e=>`${e} 2019`}],measures:[{accessor:`users`,label:`Users`,formatter:e=>e.toLocaleString()},{accessor:`sessions`,label:`Active Sessions`,formatter:e=>`${e} sessions`,hideDataLabel:!0},{accessor:`volume`,label:`Vol.`}],dataset:y}},G={},K={args:{dimensions:[{accessor:`name`}],measures:[{accessor:`users`,color:`red`}],dataset:v}},q={args:{dimensions:[{accessor:`name`}],measures:[{accessor:`users`},{accessor:`sessions`},{accessor:`volume`}]}},J={args:{dimensions:[{accessor:`name`,formatter:e=>e.slice(0,3)}],measures:[{accessor:`users`,formatter:e=>`${e/10}`,label:`number of users`},{accessor:`sessions`},{accessor:`volume`}],chartConfig:{polarGridType:`polygon`}}},Y={args:{dataset:[]}},X={args:b},Z={args:x},G.parameters={...G.parameters,docs:{...G.parameters?.docs,source:{originalSource:`{}`,...G.parameters?.docs?.source}}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  args: {
    dimensions: [{
      accessor: 'name'
    }],
