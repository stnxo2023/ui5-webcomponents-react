import{n as f,aI as T,p as w,j as e,T as s}from"./iframe-BXb_n64_.js";import{T as n}from"./ThemingParameters-BvhwmbYD.js";const L="@layer ui5-webcomponents-react{._container_lhhv3_1{display:grid}@media (max-width:599px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-s),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-s)}}}@media (min-width:600px) and (max-width:1023px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-m),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-m)}}}@media (min-width:1024px) and (max-width:1439px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-l),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-l)}}}@media (min-width:1440px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-xl),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-xl)}}}}",N={container:"_container_lhhv3_1"},r=f.forwardRef((l,o)=>{const{children:t,columnGap:i="0.5rem",rowGap:c="0.5rem",columnsS:m=4,columnsM:d=8,columnsL:u=12,columnsXL:p=16,columnSpanS:h=1,columnSpanM:y=1,columnSpanL:g=1,columnSpanXL:v=1,style:x,className:b,...I}=l;T(L,r.displayName);const C=w(N.container,b);return e.jsx("div",{ref:o,className:C,style:{rowGap:c,columnGap:i,"--_ui5wcr-rgl-columns-s":m,"--_ui5wcr-rgl-columns-m":d,"--_ui5wcr-rgl-columns-l":u,"--_ui5wcr-rgl-columns-xl":p,"--_ui5wcr-rgl-column-span-s":h,"--_ui5wcr-rgl-column-span-m":y,"--_ui5wcr-rgl-column-span-l":g,"--_ui5wcr-rgl-column-span-xl":v,...x},...I,children:t})});r.displayName="ResponsiveGridLayout";try{r.displayName="ResponsiveGridLayout",r.__docgenInfo={description:`The Responsive Grid Layout positions UI elements in a multi-column flow layout.
