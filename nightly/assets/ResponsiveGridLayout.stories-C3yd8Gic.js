import{q as f,aJ as T,t as w,j as e,T as s}from"./iframe-DBRigOoU.js";import{T as n}from"./ThemingParameters-BvhwmbYD.js";const L="@layer ui5-webcomponents-react{._container_lhhv3_1{display:grid}@media (max-width:599px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-s),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-s)}}}@media (min-width:600px) and (max-width:1023px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-m),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-m)}}}@media (min-width:1024px) and (max-width:1439px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-l),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-l)}}}@media (min-width:1440px){._container_lhhv3_1{grid-template-columns:repeat(var(--_ui5wcr-rgl-columns-xl),minmax(0,1fr));>*{grid-column:span var(--_ui5wcr-rgl-column-span-xl)}}}}",N={container:"_container_lhhv3_1"},r=f.forwardRef((o,l)=>{const{children:t,columnGap:i="0.5rem",rowGap:c="0.5rem",columnsS:m=4,columnsM:d=8,columnsL:u=12,columnsXL:p=16,columnSpanS:h=1,columnSpanM:y=1,columnSpanL:g=1,columnSpanXL:v=1,style:x,className:b,...I}=o;T(L,r.displayName);const C=w(N.container,b);return e.jsx("div",{ref:l,className:C,style:{rowGap:c,columnGap:i,"--_ui5wcr-rgl-columns-s":m,"--_ui5wcr-rgl-columns-m":d,"--_ui5wcr-rgl-columns-l":u,"--_ui5wcr-rgl-columns-xl":p,"--_ui5wcr-rgl-column-span-s":h,"--_ui5wcr-rgl-column-span-m":y,"--_ui5wcr-rgl-column-span-l":g,"--_ui5wcr-rgl-column-span-xl":v,...x},...I,children:t})});r.displayName="ResponsiveGridLayout";try{r.displayName="ResponsiveGridLayout",r.__docgenInfo={description:`The Responsive Grid Layout positions UI elements in a multi-column flow layout.
...
and small-sized screens, such as desktop, tablet, and mobile.`,displayName:"ResponsiveGridLayout",props:{columnsS:{defaultValue:null,description:"Number of columns to show on small screens (`max-width: 599px`)",name:"columnsS",required:!1,type:{name:"number"}},columnsM:{defaultValue:null,description:"Number of columns to show on medium screens (`width >= 600px and width <=1023px`)",name:"columnsM",required:!1,type:{name:"number"}},columnsL:{defaultValue:null,description:"Number of columns to show on large screens (`width >= 1024px and width <=1439px`)",name:"columnsL",required:!1,type:{name:"number"}},columnsXL:{defaultValue:null,description:"Number of columns to show on extra large screens (`min-width: 1440px`)",name:"columnsXL",required:!1,type:{name:"number"}},columnSpanS:{defaultValue:null,description:"Defines how many columns a single child should cover on small screens.",name:"columnSpanS",required:!1,type:{name:"number"}},columnSpanM:{defaultValue:null,description:"Defines how many columns a single child should cover on medium screens.",name:"columnSpanM",required:!1,type:{name:"number"}},columnSpanL:{defaultValue:null,description:"Defines how many columns a single child should cover on large screens.",name:"columnSpanL",required:!1,type:{name:"number"}},columnSpanXL:{defaultValue:null,description:"Defines how many columns a single child should cover on extra large.",name:"columnSpanXL",required:!1,type:{name:"number"}},columnGap:{defaultValue:null,description:"Gap between two columns of the grid",name:"columnGap",required:!1,type:{name:'"0.5rem" | "1rem"'}},rowGap:{defaultValue:null,description:"Gap between two rows of the grid",name:"rowGap",required:!1,type:{name:'"0.5rem" | "1rem"'}},children:{defaultValue:null,description:`Child elements to be placed inside the grid. In case you want to control the column span of each child independently,
...
}`,...a.parameters?.docs?.source}}};const _=["Default"],A=Object.freeze(Object.defineProperty({__proto__:null,Default:a,__namedExportsOrder:_,default:j},Symbol.toStringTag,{value:"Module"}));export{A as C,a as D};
