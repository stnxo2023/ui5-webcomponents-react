import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Gm as n,Km as r,Og as i,Qm as a,Um as o,Xm as s,Zm as c,nh as ee,qm as l}from"./iframe-DxQCPanG.js";import{R as te,V as u,_ as d,d as f,f as p,m,n as h,o as ne,p as re,r as g,t as _,v}from"./ChartContainer-DF95ZLpe.js";import{a as y,c as b,i as x,l as S,n as C,o as w,r as T,s as E,u as D}from"./staticProps-DisKIlDq.js";import{a as O,c as ie,i as k,n as A,o as ae,r as oe,s as j,t as se}from"./YAxisTicks-tR5NHEw3.js";import{i as M,n as N,r as P,t as F}from"./useTooltipFormatter-BZS01-LM.js";import{n as I,t as L}from"./react-content-loader.es-CRItSoms.js";import{n as R,t as z}from"./useLongestYAxisLabel-BlplII69.js";var B,V,H=e((()=>{l(),I(),B=s(),V=e=>(0,B.jsxs)(L,{viewBox:`0 0 165 145`,preserveAspectRatio:`xMidYMid meet`,width:`100%`,height:`100%`,speed:2,backgroundColor:r.sapContent_ImagePlaceholderBackground,foregroundColor:r.sapContent_ImagePlaceholderForegroundColor,backgroundOpacity:r.sapContent_DisabledOpacity,...e,children:[(0,B.jsx)(`rect`,{x:`10`,y:`135`,width:`135`,height:`1`}),(0,B.jsx)(`circle`,{cx:`20`,cy:`90`,r:`2`}),(0,B.jsx)(`circle`,{cx:`40`,cy:`58`,r:`3`}),(0,B.jsx)(`circle`,{cx:`60`,cy:`108`,r:`14`}),(0,B.jsx)(`circle`,{cx:`85`,cy:`87`,r:`8`}),(0,B.jsx)(`circle`,{cx:`105`,cy:`50`,r:`6`}),(0,B.jsx)(`circle`,{cx:`125`,cy:`115`,r:`4`}),(0,B.jsx)(`circle`,{cx:`78`,cy:`58`,r:`10`}),(0,B.jsx)(`circle`,{cx:`28`,cy:`115`,r:`4`})]});try{V.displayName=`ScatterChartPlaceholder`,V.__docgenInfo={description:``,displayName:`ScatterChartPlaceholder`,filePath:`/home/runner/work/ui5-webcomponents-react/ui5-webcomponents-react/packages/charts/dist/components/ScatterChart/Placeholder.d.ts`,methods:[],props:{},tags:{}}}catch{}})),U,W,G,K,q=e((()=>{o(),a(),l(),U=t(i(),1),g(),j(),S(),z(),O(),P(),F(),h(),b(),C(),k(),A(),H(),W=s(),G={formatter:E},K=(0,U.forwardRef)((e,t)=>{let{dataset:i,loading:a,loadingDelay:o,noLegend:s,noAnimation:l,tooltipConfig:h,onDataPointClick:g,onLegendClick:b,onClick:S,style:C,className:E,slot:O,ChartPlaceholder:k,children:A,...j}=e,P={yAxisVisible:!1,xAxisVisible:!0,gridStroke:r.sapList_BorderColor,gridHorizontal:!0,gridVertical:!1,legendPosition:`bottom`,legendHorizontalAlign:`left`,zoomingTool:!1,resizeDebounce:250,...e.chartConfig},{referenceLine:F,referenceLineX:I}=P,{measures:L}=M([],e.measures,{},G),z=N(L),[B,H]=ee(t),K=(0,U.useRef)(!1),q=D(b),ce=(0,U.useCallback)((e,t)=>{typeof S==`function`&&!K.current&&S(c(t,{payload:e?.activePayload?.[0]?.payload,activePayloads:e?.activePayload})),K.current&&=!1},[S,K.current]),le=(0,U.useCallback)((e,t,n)=>{e&&g&&(g(c(n,{value:e.node,dataKey:e.zAxis.dataKey,dataIndex:t,payload:e.payload})),K.current=!0)},[g,K.current]),ue=i?.length>30,J=L.find(({axis:e})=>e===`x`),Y=L.find(({axis:e})=>e===`y`),X=L.find(({axis:e})=>e===`z`),[Z,Q]=R(i?.[0]?.data,[Y],P.legendPosition),de=ae(H,1),fe=ie(P.margin,P.zoomingTool),{chartConfig:pe,measures:me,...he}=j,$=n(H);return(0,W.jsx)(_,{dataset:i,loading:a,loadingDelay:o,Placeholder:k??V,ref:B,style:C,className:E,slot:O,resizeDebounce:P.resizeDebounce,...he,children:(0,W.jsxs)(ne,{onClick:ce,margin:fe,accessibilityLayer:P.accessibilityLayer,className:typeof g==`function`?`has-click-handler`:void 0,children:[(0,W.jsx)(d,{vertical:P.gridVertical,horizontal:P.gridHorizontal,stroke:P.gridStroke}),P.xAxisVisible&&(0,W.jsx)(p,{type:`number`,name:J?.label,dataKey:J?.accessor,xAxisId:0,interval:J?.interval??(ue?`preserveStart`:0),tick:(0,W.jsx)(oe,{formatter:J?.formatter}),padding:w,height:de[0],reversed:$,label:J?.label?{value:J?.label,dy:15,position:`insideRight`}:0},typeof J?.accessor==`function`?J?.label:J?.accessor),(0,W.jsx)(f,{label:Y?.label?{value:Y?.label,angle:-90,position:$?`insideRight`:`insideLeft`}:null,type:`number`,name:Y?.label,axisLine:P.yAxisVisible,tickLine:T,dataKey:Y?.accessor,interval:0,tick:(0,W.jsx)(se,{formatter:Y?.formatter}),width:Y?.label?Z+10:Z,orientation:$===!0?`right`:`left`},typeof Y?.accessor==`function`?Y?.label:Y?.accessor),(0,W.jsx)(m,{name:X?.label,dataKey:X?.accessor,range:[0,5e3]},typeof X?.accessor==`function`?X?.label:X?.accessor),i?.map((e,t)=>(0,W.jsx)(re,{className:typeof g==`function`?`has-click-handler`:void 0,onMouseDown:le,opacity:e.opacity,data:e?.data,name:e?.label,fill:e?.color??`var(--sapChart_OrderedColor_${t%12+1})`,isAnimationActive:!l},e?.label)),!s&&(0,W.jsx)(u,{verticalAlign:P.legendPosition,align:P.legendHorizontalAlign,onClick:q,wrapperStyle:Q,...P.legendConfig}),F&&(0,W.jsx)(v,{...F,stroke:F?.color??F?.stroke,y:F?.value??F?.y,label:F?.label}),I&&(0,W.jsx)(v,{...I,stroke:I?.color??I?.stroke,x:I?.value??I?.x,label:I?.label}),h?.active!==!1&&(0,W.jsx)(te,{cursor:y,formatter:z,contentStyle:x,...h}),A]})})}),K.displayName=`ScatterChart`;try{K.displayName=`ScatterChart`,K.__docgenInfo={description:`
...
This can either be a skeleton placeholder shimmer (in case the chart has no data yet) or a \`BusyIndicator\` on top of the chart (in case the chart has already some data to display).`,name:`loading`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},loadingDelay:{defaultValue:{value:`1000`},declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:"Defines the delay in milliseconds, after which the `BusyIndicator` will be visible on the screen.",name:`loadingDelay`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{default:`1000`},type:{name:`number`}},noAnimation:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:"`noAnimation` disables all chart animations when set to `true`.",name:`noAnimation`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},syncId:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:`A string which defines an id to synchronize two separate charts. Charts with the same syncId synchronize the position
of the tooltips, the startIndex and the endIndex of the zooming tool.`,name:`syncId`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`string`}},noLegend:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:"`noLegend` toggles the visibility of the legend below the chart. If this prop is `true`, no legend will be rendered.",name:`noLegend`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},onDataPointClick:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:"The `onDataPointClick` event fires whenever the user clicks on e.g. a  bar in `BarChart` or a point the `LineChart`.\n\nYou can use this event to trigger e.g. navigations or set filters based on the last clicked data point.",name:`onDataPointClick`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`(event: CustomEvent<any>) => void`}},onLegendClick:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:`The \`onLegendClick\` event fires when the user clicks on a label of the legend.
...
__Note:__ It is possible to override internally used tooltip props, so please use with caution!`,name:`tooltipConfig`,parent:{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`},required:!1,tags:{},type:{name:`TooltipProps<string | number | (string | number)[], string | number>`}},ChartPlaceholder:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/charts/dist/interfaces/IChartBaseProps.d.ts`,name:`IChartBaseProps`}],description:`Injects a custom loading placeholder which is used when no data are available. If the property isn't set the
...
\`\`\``}}]}}},tags:{}}}catch{}}));export{q as n,K as t};