import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,t as n}from"./withWebComponent-ChZTq3hz.js";import{n as r}from"./Search-B4gWmyHT.js";var i;function a(){return(a=e((()=>{r(),n(),i=t(`ui5-search`,[`accessibleDescription`,`accessibleName`,`placeholder`,`scopeValue`,`value`],[`fieldLoading`,`loading`,`noTypeahead`,`open`,`showClearIcon`],[`action`,`filterButton`,`illustration`,`messageArea`,`scopes`],[`close`,`input`,`open`,`scope-change`,`search`]),i.displayName=`Search`;try{i.displayName=`Search`,i.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
