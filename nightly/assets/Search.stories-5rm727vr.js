import{w as N,p as y,d as x,m as U,E as M,c as C,s as q,aq as R,b6 as E,b1 as V,ai as G,b8 as H,b9 as F,j as r,r as W}from"./iframe-GIjPgZz_.js";import"./globe-Dpa94dPq.js";import{h as g}from"./history-CUL5bJqe.js";import{s as T}from"./search-BdG3qoE6.js";import{b as O,S as h,a as _}from"./index-CMI0_6ld.js";import{d as A}from"./parameters-bundle.css-7Zy0dxyD.js";import{L as z}from"./ListBoxItemGroupTemplate-C8z3ly7J.js";import{as as j,at as B}from"./i18n-defaults-k5o3Svb4.js";import"./Search-BwZ1OOaA.js";const l=N("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);l.displayName="Search";try{l.displayName="Search",l.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function K(){return C("li",{class:"ui5-li-root ui5-li--focusable ui5-search-item-show-more",role:"option",tabindex:this._effectiveTabIndex,"aria-selected":this.selected,onFocusIn:this._onfocusin,onFocusOut:this._onfocusout,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:C("span",{class:"ui5-search-item-show-more-text",children:this.showMoreTextCount})})}y("@ui5/webcomponents-theming","sap_horizon",async()=>x);y("@ui5/webcomponents-fiori","sap_horizon",async()=>A);const J=`.ui5-search-item-show-more-text{color:var(--sapLinkColor)}.ui5-search-item-show-more-text:active{color:var(--sapList_Active_TextColor)}
`;var v=function(t,e,a,n){var s=arguments.length,o=s<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,a):n,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,a,n);else for(var p=t.length-1;p>=0;p--)(i=t[p])&&(o=(s<3?i(o):s>3?i(e,a,o):i(e,a))||o);return s>3&&o&&Object.defineProperty(e,a,o),o},w;let u=w=class extends V{constructor(){super(...arguments),this.selected=!1}get showMoreTextCount(){return this.itemsToShowCount?w.i18nBundle.getText(j,this.itemsToShowCount):w.i18nBundle.getText(B)}_onfocusin(e){super._onfocusin(e),this.selected=!0}_onfocusout(){this.selected=!1}_onclick(e,a=!1){e.stopImmediatePropagation(),this.fireDecoratorEvent("click",{fromKeyboard:a})}_onkeydown(e){H(e)&&(this._onclick(e,!0),e.preventDefault())}_onkeyup(e){F(e)&&(this._onclick(e,!0),e.preventDefault())}};v([q()],u.prototype,"itemsToShowCount",void 0);v([q({type:Boolean})],u.prototype,"selected",void 0);v([R("@ui5/webcomponents-fiori")],u,"i18nBundle",void 0);u=w=v([U({tag:"ui5-search-item-show-more",languageAware:!0,renderer:G,template:K,styles:[V.styles,O,J]}),E("click",{bubbles:!0,cancelable:!0})],u);u.define();const d=N("ui5-search-item-show-more",["itemsToShowCount"],["selected"],[],["click"]);d.displayName="SearchItemShowMore";try{d.displayName="SearchItemShowMore",d.__docgenInfo={description:`A \`SearchItemShowMore\` is a special type of ui5-li that acts as a button to progressively reveal additional (overflow) items within a group.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const k="globe",Q={title:"Inputs / Search",component:l,argTypes:{children:{control:{disable:!0}},illustration:{control:{disable:!0}},scopes:{control:{disable:!0}},messageArea:{control:{disable:!0}},action:{control:{disable:!0}}},tags:["package:@ui5/webcomponents-fiori","experimental"]},m={},S=[{name:"Laptop",scope:"products"},{name:"Leave Requests",scope:"apps"},{name:"Log work",scope:"apps"},{name:"Manage Products",scope:"apps"},{name:"Mobile Phones",scope:"products"},{name:"Tablet",scope:"products"}],f={args:{showClearIcon:!0,placeholder:"Search Apps, Products",scopes:r.jsxs(r.Fragment,{children:[r.jsx(_,{selected:!0,text:"All"}),r.jsx(_,{text:"Apps"}),r.jsx(_,{text:"Products"})]})},render(t){const[e,a]=W.useState(S),n=s=>{t.onScopeChange(s);const{scope:o}=s.detail;o.text==="All"?a(S):a(S.filter(i=>i.scope===o.text.toLowerCase()))};return r.jsx(l,{...t,onScopeChange:n,children:e.map(s=>r.jsx(h,{text:s.name,scopeName:s.scope},s.name))})}},L=[{text:"Search Item 1",icon:g},{text:"Search Item 2",icon:T},{text:"Search Item 3",icon:g},{text:"Search Item 4",icon:g},{text:"Search Item 5",icon:T},{text:"Search Item 6",icon:k}],X=L.slice(0,3),D=L.slice(3),b={args:{showClearIcon:!0,placeholder:"Placeholder"},render(t){const[e,a]=W.useState(!1);return r.jsxs(l,{...t,children:[r.jsxs(c,{headerText:"Group Header 1",children:[X.map(n=>r.jsx(h,{text:n.text,icon:n.icon},n.text)),!e&&r.jsx(d,{itemsToShowCount:D.length,onClick:()=>{a(!0)}}),e&&D.map(n=>r.jsx(h,{text:n.text,icon:n.icon},n.text))]}),r.jsxs(c,{headerText:"Group Header 2",children:[r.jsx(h,{text:"Search Item 1",icon:g}),r.jsx(h,{text:"Search Item 2",icon:g}),r.jsx(h,{text:"Search Item 3",icon:k})]})]})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:"{}",...m.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    showClearIcon: true,
...
}`,...b.parameters?.docs?.source}}};const Y=["Default","WithScopeAndItems","ShowMoreItem"],ce=Object.freeze(Object.defineProperty({__proto__:null,Default:m,ShowMoreItem:b,WithScopeAndItems:f,__namedExportsOrder:Y,default:Q},Symbol.toStringTag,{value:"Module"}));export{ce as C,m as D,b as S,f as W,c as a,d as b};
