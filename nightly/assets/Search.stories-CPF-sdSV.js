import{a as e,c as t,i as n}from"./preload-helper-usAeo7Bx.js";import{Bu as r,St as i,Wg as a,_i as o,ai as s,ci as c,di as l,fi as u,gi as d,ii as f,li as p,mh as m,pi as h,ui as g,xt as _,zu as v}from"./iframe-BDbTYUx3.js";import{n as y,t as b}from"./history-BpMa9IU9.js";var x=e({Default:()=>T,ShowMoreItem:()=>j,WithScopeAndItems:()=>D,__namedExportsOrder:()=>M,default:()=>w}),S,C,w,T,E,D,O,k,A,j,M,N=n((()=>{i(),y(),v(),S=t(a(),1),h(),l(),p(),s(),o(),C=m(),w={title:`Inputs / Search`,component:d,argTypes:{children:{control:{disable:!0}},illustration:{control:{disable:!0}},scopes:{control:{disable:!0}},messageArea:{control:{disable:!0}},action:{control:{disable:!0}}},tags:[`package:@ui5/webcomponents-fiori`,`experimental`]},T={},E=[{name:`Laptop`,scope:`products`},{name:`Leave Requests`,scope:`apps`},{name:`Log work`,scope:`apps`},{name:`Manage Products`,scope:`apps`},{name:`Mobile Phones`,scope:`products`},{name:`Tablet`,scope:`products`}],D={args:{showClearIcon:!0,placeholder:`Search Apps, Products`,scopeValue:`all`,scopes:(0,C.jsxs)(C.Fragment,{children:[(0,C.jsx)(f,{text:`All`,value:`all`}),(0,C.jsx)(f,{text:`Apps`,value:`apps`}),(0,C.jsx)(f,{text:`Products`,value:`products`})]})},render(e){let[t,n]=(0,S.useState)(E),r=t=>{e.onScopeChange(t);let{scope:r}=t.detail;r.text===`All`?n(E):n(E.filter(e=>e.scope===r.text.toLowerCase()))};return(0,C.jsx)(d,{...e,onScopeChange:r,children:t.map(e=>(0,C.jsx)(u,{text:e.name,scopeName:e.scope},e.name))})}},O=[{text:`Search Item 1`,icon:b},{text:`Search Item 2`,icon:r},{text:`Search Item 3`,icon:b},{text:`Search Item 4`,icon:b},{text:`Search Item 5`,icon:r},{text:`Search Item 6`,icon:_}],k=O.slice(0,3),A=O.slice(3),j={args:{showClearIcon:!0,placeholder:`Placeholder`},render(e){let[t,n]=(0,S.useState)(!1);return(0,C.jsxs)(d,{...e,children:[(0,C.jsxs)(g,{headerText:`Group Header 1`,children:[k.map(e=>(0,C.jsx)(u,{text:e.text,icon:e.icon},e.text)),!t&&(0,C.jsx)(c,{itemsToShowCount:A.length,onClick:()=>{n(!0)}}),t&&A.map(e=>(0,C.jsx)(u,{text:e.text,icon:e.icon},e.text))]}),(0,C.jsxs)(g,{headerText:`Group Header 2`,children:[(0,C.jsx)(u,{text:`Search Item 1`,icon:b}),(0,C.jsx)(u,{text:`Search Item 2`,icon:b}),(0,C.jsx)(u,{text:`Search Item 3`,icon:_})]})]})}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{}`,...T.parameters?.docs?.source}}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    showClearIcon: true,
