import{w as x,f as S,d as D,c as M,P as U,W as G,b as C,s as A,bj as R,be as V,av as E,az as H,bl as j,bm as O,n as W,j as r}from"./iframe-J46VriOb.js";import"./globe-CzLH40G8.js";import{h as f}from"./history-VeuuVx2I.js";import{s as N}from"./search-CcUfWfnc.js";import{b as F,S as c,a as v}from"./index-BVivXAkB.js";import{d as q}from"./parameters-bundle.css-DMPIvP1N.js";import{L as z}from"./ListBoxItemGroupTemplate-CJFWume4.js";import{as as P,at as B}from"./i18n-defaults-CFWtSmu6.js";import"./Search-D_sEhtzY.js";const p=x("ui5-search",["accessibleDescription","accessibleName","placeholder","scopeValue","value"],["fieldLoading","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);p.displayName="Search";try{p.displayName="Search",p.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
**Note:** Available since [v2.15.0](https://github.com/UI5/webcomponents/releases/tag/v2.15.0) of **@ui5/webcomponents-fiori**.`,name:"wrappingType",required:!1,type:{name:'"None" | WrappingType | "Normal"'}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
...
`;var y=function(a,e,n,o){var s=arguments.length,t=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,n):o,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(a,e,n,o);else for(var l=a.length-1;l>=0;l--)(i=a[l])&&(t=(s<3?i(t):s>3?i(e,n,t):i(e,n))||t);return s>3&&t&&Object.defineProperty(e,n,t),t},g;let h=g=class extends V{constructor(){super(...arguments),this.selected=!1}get showMoreTextCount(){return this.itemsToShowCount?g.i18nBundle.getText(P,this.itemsToShowCount):g.i18nBundle.getText(B)}_onfocusin(e){super._onfocusin(e),this.selected=!0}_onfocusout(){this.selected=!1}_onclick(e,n=!1){e.stopImmediatePropagation(),this.fireDecoratorEvent("click",{fromKeyboard:n})}_onkeydown(e){j(e)&&(this._onclick(e,!0),e.preventDefault())}_onkeyup(e){O(e)&&(this._onclick(e,!0),e.preventDefault())}};y([A()],h.prototype,"itemsToShowCount",void 0);y([A({type:Boolean})],h.prototype,"selected",void 0);y([R("@ui5/webcomponents-fiori")],h,"i18nBundle",void 0);h=g=y([M({tag:"ui5-search-item-show-more",languageAware:!0,renderer:E,template:J,styles:[V.styles,F,Q]}),H("click",{bubbles:!0,cancelable:!0})],h);h.define();const w=x("ui5-search-item-show-more",["itemsToShowCount"],["selected"],[],["click"]);w.displayName="SearchItemShowMore";try{w.displayName="SearchItemShowMore",w.__docgenInfo={description:`A \`SearchItemShowMore\` is a special type of ui5-li that acts as a button to progressively reveal additional (overflow) items within a group.
