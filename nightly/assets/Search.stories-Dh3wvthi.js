import{w as x,f as S,d as D,e as M,U,W as G,c as C,s as A,bk as R,bf as V,aw as E,aA as H,bm as O,bn as j,q,j as r}from"./iframe-1PJgHZTG.js";import"./globe-C__1z22B.js";import{h as f}from"./history-D5tlMkxO.js";import{s as N}from"./search-Cp6ZXHxj.js";import{b as F,S as c,a as y}from"./index-CP3MJeCk.js";import{d as W}from"./parameters-bundle.css-DMPIvP1N.js";import{L as z}from"./ListBoxItemGroupTemplate-D5VYXEPs.js";import{as as B,at as P}from"./i18n-defaults-CFWtSmu6.js";import"./Search-lyGCpBz9.js";const p=x("ui5-search",["accessibleDescription","accessibleName","placeholder","scopeValue","value"],["fieldLoading","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);p.displayName="Search";try{p.displayName="Search",p.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function J(){return C("li",{class:"ui5-li-root ui5-li--focusable ui5-search-item-show-more",role:"option",tabindex:this._effectiveTabIndex,"aria-selected":this.selected,onFocusIn:this._onfocusin,onFocusOut:this._onfocusout,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:C("span",{class:"ui5-search-item-show-more-text",children:this.showMoreTextCount})})}S("@ui5/webcomponents-theming","sap_horizon",async()=>D);S("@ui5/webcomponents-fiori","sap_horizon",async()=>W,"host");const Q=`.ui5-search-item-show-more-text{color:var(--sapLinkColor)}.ui5-search-item-show-more-text:active{color:var(--sapList_Active_TextColor)}
