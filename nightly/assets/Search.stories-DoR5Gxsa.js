import{w as N,p as v,d as D,m as U,B as q,c as C,s as M,ar as E,b3 as V,ai as G,j as r,r as W}from"./iframe-sceg0YFv.js";import"./globe-DCWs0y6A.js";import{h as g}from"./history-cNeMXtNe.js";import{s as T}from"./search-BCZbvt-3.js";import{b as k,S as h,a as S}from"./index-CQkLOWpd.js";import{d as R}from"./parameters-bundle.css-MDhRcvbE.js";import{L as H}from"./ListBoxItemGroupTemplate-BqRj3VE-.js";import{as as F,at as O}from"./i18n-defaults-BS8OTJAB.js";import"./Search-DzNIbQAP.js";const l=N("ui5-search",["accessibleDescription","accessibleName","placeholder","value"],["loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);l.displayName="Search";try{l.displayName="Search",l.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"Search",props:{action:{defaultValue:null,description:`Defines the popup footer action button.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}v("@ui5/webcomponents-theming","sap_horizon",async()=>D);v("@ui5/webcomponents-fiori","sap_horizon",async()=>R);const z=`:host{height:2.75rem;background:var(--sapList_GroupHeaderBackground);color:var(--sapList_TableGroupHeaderTextColor)}.ui5-group-li-root{width:100%;height:100%;position:relative;box-sizing:border-box;padding:0;margin:0;list-style-type:none}[ui5-li-group-header]{border-bottom:var(--sapList_BorderWidth) solid var(--sapList_GroupHeaderBorderColor)}
`;var j=function(e,t,a,n){var s=arguments.length,o=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,a):n,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,a,n);else for(var c=e.length-1;c>=0;c--)(i=e[c])&&(o=(s<3?i(o):s>3?i(t,a,o):i(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o};let I=class extends q{get isGroupItem(){return!0}};I=j([U({tag:"ui5-search-item-group",styles:[q.styles,z],template:H})],I);I.define();const p=N("ui5-search-item-group",["headerAccessibleName","headerText","wrappingType"],[],["header"],["move-over","move"]);p.displayName="SearchItemGroup";try{p.displayName="SearchItemGroup",p.__docgenInfo={description:"The `SearchItemGroup` is type of suggestion item,\nthat can be used to split the `SearchItem` suggestions into groups.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)",displayName:"SearchItemGroup",props:{children:{defaultValue:null,description:"Defines the items of the <code>ui5-li-group</code>.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},header:{defaultValue:null,description:`Defines the header of the component.
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},onMove:{defaultValue:null,description:`Fired when a movable list item is dropped onto a drop target.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{p.displayName="SearchItemGroup",p.__docgenInfo={description:"The `SearchItemGroup` is type of suggestion item,\nthat can be used to split the `SearchItem` suggestions into groups.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)",displayName:"SearchItemGroup",props:{children:{defaultValue:null,description:"Defines the items of the <code>ui5-li-group</code>.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},header:{defaultValue:null,description:`Defines the header of the component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function P(){return C("li",{class:"ui5-li-root ui5-li--focusable ui5-search-item-show-more",role:"option",tabindex:this._effectiveTabIndex,"aria-selected":this.selected,onFocusIn:this._onfocusin,onFocusOut:this._onfocusout,children:C("span",{class:"ui5-search-item-show-more-text",children:this.showMoreTextCount})})}v("@ui5/webcomponents-theming","sap_horizon",async()=>D);v("@ui5/webcomponents-fiori","sap_horizon",async()=>R);const B=`.ui5-search-item-show-more-text{color:var(--sapLinkColor)}.ui5-search-item-show-more-text:active{color:var(--sapList_Active_TextColor)}
`;var y=function(e,t,a,n){var s=arguments.length,o=s<3?t:n===null?n=Object.getOwnPropertyDescriptor(t,a):n,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,a,n);else for(var c=e.length-1;c>=0;c--)(i=e[c])&&(o=(s<3?i(o):s>3?i(t,a,o):i(t,a))||o);return s>3&&o&&Object.defineProperty(t,a,o),o},w;let u=w=class extends V{constructor(){super(...arguments),this.selected=!1}get showMoreTextCount(){return this.itemsToShowCount?w.i18nBundle.getText(F,this.itemsToShowCount):w.i18nBundle.getText(O)}_onfocusin(t){super._onfocusin(t),this.selected=!0}_onfocusout(){this.selected=!1}};y([M()],u.prototype,"itemsToShowCount",void 0);y([M({type:Boolean})],u.prototype,"selected",void 0);y([E("@ui5/webcomponents-fiori")],u,"i18nBundle",void 0);u=w=y([U({tag:"ui5-search-item-show-more",languageAware:!0,renderer:G,template:P,styles:[V.styles,k,B]})],u);u.define();const d=N("ui5-search-item-show-more",["itemsToShowCount"],["selected"],[],[]);d.displayName="SearchItemShowMore";try{d.displayName="SearchItemShowMore",d.__docgenInfo={description:`A \`SearchItemShowMore\` is a special type of ui5-li that acts as a button to progressively reveal additional (overflow) items within a group.



__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"SearchItemShowMore",props:{itemsToShowCount:{defaultValue:{value:"undefined"},description:`Specifies the number of additional items available to show.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const L="globe",$={title:"Inputs / Search",component:l,argTypes:{children:{control:{disable:!0}},illustration:{control:{disable:!0}},scopes:{control:{disable:!0}},messageArea:{control:{disable:!0}},action:{control:{disable:!0}}},tags:["package:@ui5/webcomponents-fiori","experimental"]},m={},_=[{name:"Laptop",scope:"products"},{name:"Leave Requests",scope:"apps"},{name:"Log work",scope:"apps"},{name:"Manage Products",scope:"apps"},{name:"Mobile Phones",scope:"products"},{name:"Tablet",scope:"products"}],f={args:{showClearIcon:!0,placeholder:"Search Apps, Products",scopes:r.jsxs(r.Fragment,{children:[r.jsx(S,{selected:!0,text:"All"}),r.jsx(S,{text:"Apps"}),r.jsx(S,{text:"Products"})]})},render(e){const[t,a]=W.useState(_),n=s=>{e.onScopeChange(s);const{scope:o}=s.detail;o.text==="All"?a(_):a(_.filter(i=>i.scope===o.text.toLowerCase()))};return r.jsx(l,{...e,onScopeChange:n,children:t.map(s=>r.jsx(h,{text:s.name,scopeName:s.scope},s.name))})}},A=[{text:"Search Item 1",icon:g},{text:"Search Item 2",icon:T},{text:"Search Item 3",icon:g},{text:"Search Item 4",icon:g},{text:"Search Item 5",icon:T},{text:"Search Item 6",icon:L}],J=A.slice(0,3),x=A.slice(3),b={args:{showClearIcon:!0,placeholder:"Placeholder"},render(e){const[t,a]=W.useState(!1);return r.jsxs(l,{...e,children:[r.jsxs(p,{headerText:"Group Header 1",children:[J.map(n=>r.jsx(h,{text:n.text,icon:n.icon},n.text)),!t&&r.jsx(d,{itemsToShowCount:x.length,onClick:()=>{a(!0)}}),t&&x.map(n=>r.jsx(h,{text:n.text,icon:n.icon},n.text))]}),r.jsxs(p,{headerText:"Group Header 2",children:[r.jsx(h,{text:"Search Item 1",icon:g}),r.jsx(h,{text:"Search Item 2",icon:g}),r.jsx(h,{text:"Search Item 3",icon:L})]})]})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:"{}",...m.parameters?.docs?.source}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    showClearIcon: true,
...
}`,...b.parameters?.docs?.source}}};const K=["Default","WithScopeAndItems","ShowMoreItem"],ie=Object.freeze(Object.defineProperty({__proto__:null,Default:m,ShowMoreItem:b,WithScopeAndItems:f,__namedExportsOrder:K,default:$},Symbol.toStringTag,{value:"Module"}));export{ie as C,m as D,b as S,f as W,p as a,d as b};
