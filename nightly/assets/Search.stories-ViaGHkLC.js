import{w as x,f as S,d as D,e as M,U,W as G,c as C,s as A,bk as R,bf as V,aw as E,aA as H,bm as O,bn as j,q as W,j as r}from"./iframe-DpyqAETS.js";import"./globe-BzQWq8g2.js";import{h as f}from"./history-Bn8C3VPl.js";import{s as N}from"./search-CIIKeKjg.js";import{b as F,S as c,a as v}from"./index-Cg66BHiD.js";import{d as q}from"./parameters-bundle.css-DMPIvP1N.js";import{L as z}from"./ListBoxItemGroupTemplate-dNP8oHGP.js";import{as as B,at as P}from"./i18n-defaults-CFWtSmu6.js";import"./Search-CMcC54KR.js";const p=x("ui5-search",["accessibleDescription","accessibleName","placeholder","scopeValue","value"],["fieldLoading","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);p.displayName="Search";try{p.displayName="Search",p.__docgenInfo={description:`A \`Search\` is an input with suggestions, used for user search.
...
**Note:** Available since [v2.15.0](https://github.com/UI5/webcomponents/releases/tag/v2.15.0) of **@ui5/webcomponents-fiori**.`,name:"wrappingType",required:!1,type:{name:'"None" | "Normal" | WrappingType'}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.
