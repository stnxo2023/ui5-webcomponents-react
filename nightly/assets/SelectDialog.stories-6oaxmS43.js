import{a as e,c as t,i as n}from"./preload-helper-DbRxMUml.js";import{Fm as r,Gd as i,Gu as a,Rd as o,T as s,Wd as c,Wu as l,du as u,fd as d,ng as f,np as p,pd as m,r as h,rp as g,uu as _,w as v,zd as y}from"./iframe-DeXKz_tp.js";var b,x=n((()=>{b=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})),S,C=n((()=>{S=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})),w,T=n((()=>{w=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})),E,D=n((()=>{E=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})),O=e({Default:()=>N,MultiSelect:()=>P,__namedExportsOrder:()=>F,default:()=>j}),k,A,j,M,N,P,F,I=n((()=>{x(),C(),T(),D(),h(),m(),k=t(f(),1),g(),u(),a(),y(),i(),s(),A=r(),j={title:`Modals & Popovers / SelectDialog`,component:v,argTypes:{children:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},M=[{img:b,description:`LT-10`,text:`Gaming Laptop`},{img:S,description:`LT-20`,text:`Business Laptop`},{img:E,description:`HT-10`,text:`Gaming PC`},{img:w,description:`HT-20`,text:`Business PC`}],N={render:e=>{let[t,n]=(0,k.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,k.useEffect)(()=>{n(e.open)},[e.open]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(p,{onClick:r,children:`Open SelectDialog`}),(0,A.jsx)(v,{...e,open:t,onClose:i,children:Array(40).fill(``).map((e,t)=>{let n=M[t%4];return(0,A.jsx)(l,{selected:t===1,image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},P={render:()=>{let[e,t]=(0,k.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,i]=(0,k.useState)(n),a=(0,k.useRef)(r),[s,u]=(0,k.useState)(),[f,m]=(0,k.useState)(Object.keys(n)),h=()=>{a.current=r},g=()=>{t(!0)},y=()=>{t(!1)},b=e=>{u(e.detail.value)};return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(p,{onClick:g,children:`Open Dialog`}),(0,A.jsx)(v,{open:e,selectionMode:d.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;i(e=>{if(e[t]){let{[t]:n,...r}=e;return r}else return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{i({})},onConfirm:()=>{m(Object.keys(r))},onClose:y,onSearchInput:b,onSearch:b,onSearchReset:()=>{u(void 0)},onBeforeOpen:h,onCancel:()=>{i(a.current)},children:Array(40).fill(``).map((e,t)=>{let n=M[t%4],i=`${n.description}${t}`,a=s?.toLowerCase();return s&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,A.jsx)(l,{image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,A.jsxs)(c,{children:[(0,A.jsx)(_,{children:`Selected: `}),(0,A.jsx)(o,{children:f.join(`, `)})]})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: args => {
