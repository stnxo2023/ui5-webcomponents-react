import{a as e,c as t,i as n}from"./preload-helper-B45gAKPr.js";import{t as r}from"./react-CymAsZIc.js";import{t as i}from"./jsx-runtime-BBQGix-2.js";import{n as a,t as o}from"./Button-B3PpRo9D.js";import{t as s}from"./react-dom-DVh4H5r5.js";import{n as c,t as l}from"./Text-Ck86kKhL.js";import{c as u,s as d}from"./List-CgmuoDUS.js";import{n as f,t as p}from"./ListItemStandard-Cw2g_KVK.js";import{n as m,t as h}from"./Label-BfvYnfMV.js";import{Mt as g,O as _,jt as v,k as y,r as b}from"./iframe-SB1L8Psi.js";var x,S=n((()=>{x=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})),C,w=n((()=>{C=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})),T,E=n((()=>{T=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})),D,O=n((()=>{D=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})),k=e({Default:()=>F,MultiSelect:()=>I,SearchResultAnnouncement:()=>z,__namedExportsOrder:()=>B,default:()=>N}),A,j,M,N,P,F,I,L,R,z,B,V=n((()=>{S(),w(),E(),O(),b(),u(),A=t(r(),1),j=t(s(),1),a(),m(),f(),c(),g(),y(),M=i(),N={title:`Modals & Popovers / SelectDialog`,component:_,argTypes:{children:{control:{disable:!0}},onSearch:{control:{disable:!0}},onCancel:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},P=[{img:x,description:`LT-10`,text:`Gaming Laptop`},{img:C,description:`LT-20`,text:`Business Laptop`},{img:D,description:`HT-10`,text:`Gaming PC`},{img:T,description:`HT-20`,text:`Business PC`}],F={render:e=>{let[t,n]=(0,A.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,A.useEffect)(()=>{n(e.open)},[e.open]),(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:r,children:`Open SelectDialog`}),(0,M.jsx)(_,{...e,open:t,onClose:i,children:Array(40).fill(``).map((e,t)=>{let n=P[t%4];return(0,M.jsx)(p,{selected:t===1,image:(0,M.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},I={render:()=>{let[e,t]=(0,A.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,i]=(0,A.useState)(n),a=(0,A.useRef)(r),[s,c]=(0,A.useState)(),[u,f]=(0,A.useState)(Object.keys(n)),m=()=>{a.current=r},g=()=>{t(!0)},y=()=>{t(!1)},b=e=>{c(e.detail.value)};return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:g,children:`Open Dialog`}),(0,M.jsx)(_,{open:e,selectionMode:d.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;i(e=>{if(e[t]){let{[t]:n,...r}=e;return r}else return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{i({})},onConfirm:()=>{f(Object.keys(r))},onClose:y,onSearchInput:b,onSearch:b,onSearchReset:()=>{c(void 0)},onBeforeOpen:m,onCancel:()=>{i(a.current)},children:Array(40).fill(``).map((e,t)=>{let n=P[t%4],i=`${n.description}${t}`,a=s?.toLowerCase();return s&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,M.jsx)(p,{image:(0,M.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,M.jsxs)(v,{children:[(0,M.jsx)(h,{children:`Selected: `}),(0,M.jsx)(l,{children:u.join(`, `)})]})]})}},L=Array.from({length:40},(e,t)=>({id:`P-${t.toString().padStart(3,`0`)}`,text:[`Gaming Laptop`,`Business Laptop`,`Gaming PC`,`Business PC`][t%4]})),R={position:`absolute`,clip:`rect(1px,1px,1px,1px)`,userSelect:`none`,left:`-1000px`,top:`-1000px`,pointerEvents:`none`},z={render:()=>{let[e,t]=(0,A.useState)(null),n=(0,A.useRef)(null),[r,i]=(0,A.useState)(!1),[a,s]=(0,A.useState)(``),c=(0,A.useMemo)(()=>{let e=a.trim().toLowerCase();return e?L.filter(t=>t.id.toLowerCase().includes(e)||t.text.toLowerCase().includes(e)):L},[a]),l=e=>{let t=n.current;t&&(t.textContent=e===0?`No results found`:`${e} results available`)};return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:()=>i(!0),children:`Open SelectDialog`}),(0,M.jsx)(_,{ref:t,headerText:`Select Product`,open:r,onClose:()=>i(!1),onSearch:e=>{s(e.detail.value),l(c.length)},onSearchReset:()=>{s(``),l(L.length)},children:c.map(e=>(0,M.jsx)(p,{description:e.id,text:e.text},e.id))}),e&&(0,j.createPortal)((0,M.jsx)(`span`,{ref:n,"aria-live":`polite`,style:R}),e)]})}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  render: args => {
