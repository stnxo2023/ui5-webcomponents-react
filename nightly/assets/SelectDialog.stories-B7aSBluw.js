import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{i as r,r as i}from"./Icon-DMhQ4MY0.js";import{n as a,t as o}from"./useI18nBundle-DySpA6fU.js";import{n as s,t as c}from"./useStylesheet-BnjJbIc6.js";import{a as l,i as ee,o as te,r as u}from"./withWebComponent-P_MKyY2B.js";import{t as d}from"./jsx-runtime-BdxMnOeJ.js";import{$t as ne,Fn as f,Xt as re,Zt as ie,g as ae,h as oe,qt as p}from"./i18n-defaults-DGg6ckGl.js";import{l as m,u as se}from"./Button-CYKpg6zM.js";import{n as ce,t as le}from"./clsx-BB58Nicv.js";import{n as h,t as g}from"./Button-ByEikLQw.js";import{i as _,r as ue}from"./Title-DSVhdNr8.js";import{n as v,t as de}from"./Icon-D3Xt-uo2.js";import{t as fe}from"./react-dom-2o2phaJG.js";import{l as pe,n as y,t as me,u as b}from"./FlexBox-Chf1fWuq.js";import{n as x,t as he}from"./Text-DJOzsV4K.js";import{d as ge,f as S}from"./Input-D9etqMcj.js";import{n as C,t as _e}from"./Input-BPUDKUhW.js";import{_ as w,v as T}from"./List-CbXa6LlL.js";import{i as E,n as ve,r as ye,t as D}from"./InvisibleMessage-CP7uKnuD.js";import{n as O,t as be}from"./List-Fp2HnsNk.js";import{n as k,t as A}from"./ListItemStandard-DVnGpkEN.js";import{n as j,t as xe}from"./Title-DPKrj0tw.js";import{n as Se,t as M}from"./search-Re8ps-V4.js";import{n as Ce,t as N}from"./Label-oG7ucA8S.js";import{n as P,t as we}from"./Dialog-DUMHhZd5.js";import{i as F}from"./iframe-V4MPM22m.js";var Te,I;function L(){return(L=e((()=>{Te=`@layer ui5-webcomponents-react{._dialog_3uhsn_1{&::part(header){padding-block-end:.25rem;flex-direction:column;margin-block-end:0}&::part(content){padding:0}}._headerContent_3uhsn_13{display:grid;grid-template-columns:fit-content(100px) minmax(0,1fr) fit-content(100px);grid-template-areas:"titleStart titleCenter cancel" "input input input";grid-template-rows:var(--_ui5wcr-DialogHeaderHeight) var(--_ui5wcr-DialogSubHeaderHeight);width:100%;align-items:center}._title_3uhsn_24{font-size:var(--sapFontLargeSize);font-family:var(--sapFontHeaderFamily);grid-column-start:titleStart;grid-column-end:titleCenter;max-width:100%;overflow:hidden;text-overflow:ellipsis}._titleCenterAlign_3uhsn_34{grid-area:titleCenter;justify-self:center}._hiddenClearBtn_3uhsn_39{grid-area:titleStart;visibility:hidden}._clearBtn_3uhsn_44{grid-area:cancel;justify-self:end}._input_3uhsn_49{grid-area:input;width:100%}._footer_3uhsn_54{display:flex;align-items:center;justify-content:flex-end;width:100%;box-sizing:border-box;>*{margin-inline-start:.5rem}}._inputIcon_3uhsn_66{cursor:pointer;color:var(--sapField_TextColor);&:hover{box-shadow:var(--sapField_Hover_Shadow);background-color:var(--_ui5_input_icon_hover_bg)}&:active{box-shadow:var(--sapField_Hover_Shadow);color:var(--sapButton_Active_TextColor);background-color:var(--sapButton_Active_Background)}}._infoBar_3uhsn_82{height:2rem;background-color:var(--sapInfobar_NonInteractive_Background);color:var(--sapList_TextColor);padding-inline-start:var(--_ui5wcr-CheckBoxPaddingInline);border-block-end:.0625rem solid var(--sapGroup_TitleBorderColor);overflow:hidden;position:sticky;top:0;z-index:1}}`,I={dialog:`_dialog_3uhsn_1`,headerContent:`_headerContent_3uhsn_13`,title:`_title_3uhsn_24`,titleCenterAlign:`_titleCenterAlign_3uhsn_34`,hiddenClearBtn:`_hiddenClearBtn_3uhsn_39`,clearBtn:`_clearBtn_3uhsn_44`,input:`_input_3uhsn_49`,footer:`_footer_3uhsn_54`,inputIcon:`_inputIcon_3uhsn_66`,infoBar:`_infoBar_3uhsn_82`}})))()}var R,z,B;function V(){return(V=e((()=>{se(),r(),S(),T(),_(),E(),D(),M(),ee(),o(),c(),l(),ce(),R=n(),b(),f(),h(),P(),v(),C(),O(),x(),j(),y(),L(),z=d(),B=(0,R.forwardRef)((e,t)=>{let{accessibleName:n,open:r,children:o,className:c,confirmButtonText:l,confirmButtonProps:ee,growing:d,headerText:f,headerTextAlignCenter:se,headerTextLevel:ce=ue.H1,listProps:h={},selectionMode:_=w.Single,numberOfSelectedItems:v,rememberSelections:fe,searchPlaceholder:y,showClearButton:b,onClose:x,onClear:S,onConfirm:C,onLoadMore:T,onSearch:E,onSearchInput:D,onSearchReset:O,onBeforeOpen:k,onBeforeClose:A,onOpen:j,onCancel:M,...Ce}=e;s(Te,B.displayName);let N=a(`@ui5/webcomponents-react`),[P,F]=(0,R.useState)(``),[L,V]=(0,R.useState)([]),[H,U]=te(h.ref),[W,G]=(0,R.useState)(r);(0,R.useEffect)(()=>{G(r)},[r]);let Ee=e=>{let t=U.current?.getSelectedItems()??[];typeof k==`function`&&k(e),_===w.Multiple&&U.current?.hasData&&V(t)},De=e=>{typeof j==`function`&&j(e),U.current?.focusFirstItem()},Oe=e=>{!e.target.value&&e.detail.inputType===``&&ke(e),typeof D==`function`&&D(u(e,{value:e.target.value})),F(e.target.value)},K=e=>{typeof E==`function`&&(e.type===`keyup`&&e.code===`Enter`&&E(u(e,{value:e.target.value})),e.type===`click`&&E(u(e,{value:P})))},ke=e=>{typeof O==`function`&&O(u(e,{prevValue:P})),F(``)},q=e=>{let{selectedItems:t}=e.detail;typeof h?.onSelectionChange==`function`&&h.onSelectionChange(e),_===w.Multiple?(V(t),t.length&&ve(N.getText(ne,t.length),ye.Polite)):(typeof C==`function`&&C(e),G(!1))},Ae=e=>{G(!1),typeof M==`function`&&M(e)},J=e=>{typeof S==`function`&&S(u(e,{prevSelectedItems:L})),V([]),U.current?.deselectSelectedItems()},je=e=>{typeof C==`function`&&C(u(e,{selectedItems:L})),G(!1)},Y=e=>{G(!1),typeof x==`function`&&x(e),typeof O==`function`&&O(u(e,{prevValue:P})),F(``),fe||U.current?.deselectSelectedItems()},X=e=>{typeof A==`function`&&A(e),typeof M==`function`&&e.detail.escPressed&&M(e)};return(0,z.jsxs)(we,{...Ce,open:W,"data-component-name":`SelectDialog`,ref:t,className:le(I.dialog,c),onClose:Y,onBeforeOpen:Ee,onOpen:De,onBeforeClose:X,accessibleName:n??f,children:[(0,z.jsxs)(`div`,{className:I.headerContent,slot:`header`,"data-sap-ui-fastnavgroup":`true`,children:[b&&se&&(0,z.jsx)(g,{onClick:J,design:m.Transparent,className:I.hiddenClearBtn,tabIndex:-1,"aria-hidden":`true`,children:N.getText(ae)}),(0,z.jsx)(xe,{className:le(I.title,se&&I.titleCenterAlign),level:ce,children:f}),b&&(0,z.jsx)(g,{onClick:J,design:m.Transparent,className:I.clearBtn,children:N.getText(ae)}),(0,z.jsx)(_e,{className:I.input,accessibleName:y??N.getText(p),value:P,placeholder:y??N.getText(p),onInput:Oe,onKeyUp:K,type:ge.Search,showClearIcon:!0,icon:(0,z.jsx)(z.Fragment,{children:(0,z.jsx)(de,{mode:i.Decorative,name:Se,className:I.inputIcon,onClick:K,accessibleName:N.getText(p),title:N.getText(p)})})})]}),_===w.Multiple&&(!!L.length||v>0)&&(0,z.jsx)(me,{alignItems:pe.Center,className:I.infoBar,children:(0,z.jsx)(he,{children:`${N.getText(ie)}: ${v??L.length}`})}),(0,z.jsx)(be,{...h,ref:H,growing:d,onLoadMore:T,selectionMode:_,onSelectionChange:q,"data-sap-ui-fastnavgroup":`true`,children:o}),(0,z.jsxs)(`div`,{slot:`footer`,className:I.footer,"data-sap-ui-fastnavgroup":`true`,children:[_===w.Multiple&&(0,z.jsx)(g,{...ee,onClick:je,design:m.Emphasized,children:l??N.getText(re)}),(0,z.jsx)(g,{onClick:Ae,design:m.Transparent,children:N.getText(oe)})]})]})}),B.displayName=`SelectDialog`;try{B.displayName=`SelectDialog`,B.__docgenInfo={description:`The SelectDialog enables users to filter a comprehensive list via a search field and to select one or more items.`,displayName:`SelectDialog`,filePath:`/home/runner/work/ui5-webcomponents-react/ui5-webcomponents-react/packages/main/dist/components/SelectDialog/index.d.ts`,methods:[],props:{accessibleName:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/components/SelectDialog/index.d.ts`,name:`SelectDialogPropTypes`}],description:`Defines the accessible name of the component.
...
Use this prop carefully, some css properties might break the component.`,name:`style`,parent:{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`},required:!1,tags:{},type:{name:`CSSProperties`}},accessibleRole:{defaultValue:{value:`"Dialog"`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`}],description:`Allows setting a custom role.

**Note:** Available since [v1.10.0](https://github.com/UI5/webcomponents/releases/tag/v1.10.0) of **@ui5/webcomponents**.`,name:`accessibleRole`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`},required:!1,tags:{default:`"Dialog"`},type:{name:`enum`,raw:`"None" | PopupAccessibleRole | "Dialog" | "AlertDialog"`,value:[{value:`"None"`},{value:`"None"`,description:`Represents no ARIA role.`,fullComment:`Represents no ARIA role.
...
@public`,tags:{public:``}},{value:`"Dialog"`},{value:`"AlertDialog"`}]}},accessibleDescription:{defaultValue:{value:`undefined`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`}],description:`Defines the accessible description of the component.
...
**Note:** Available since [v1.1.0](https://github.com/UI5/webcomponents/releases/tag/v1.1.0) of **@ui5/webcomponents**.`,name:`accessibleNameRef`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`},required:!1,tags:{default:`undefined`},type:{name:`string`}},open:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`}],description:`Indicates if the element is open

**Note:** Available since [v1.2.0](https://github.com/UI5/webcomponents/releases/tag/v1.2.0) of **@ui5/webcomponents**.`,name:`open`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},onOpen:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogPropTypes`}],description:`Fired after the component is opened.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:`onOpen`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogPropTypes`},required:!1,tags:{},type:{name:`(event: Ui5CustomEvent<DialogDomRef, never>) => void`}},onBeforeClose:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogPropTypes`}],description:`Fired before the component is closed. This event can be cancelled, which will prevent the popup from closing.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents**.`,name:`preventInitialFocus`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},resizable:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`}],description:`Configures the component to be resizable.
If this property is set to true, the Dialog will have a resize handle in its bottom right corner in LTR languages.
In RTL languages, the resize handle will be placed in the bottom left corner.

**Note:** The component can be resizable only in desktop mode.

**Note:** Upon resizing, externally defined height and width styling will be ignored.`,name:`resizable`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},showFullscreenButton:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Dialog/index.d.ts`,name:`DialogAttributes`}],description:`Defines whether a fullscreen toggle button is shown in the dialog header.
...
@public`,tags:{public:``}}]}}},tags:{}}}catch{}})))()}var H;function U(){return(U=e((()=>{H=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})))()}var W;function G(){return(G=e((()=>{W=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})))()}var Ee;function De(){return(De=e((()=>{Ee=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})))()}var Oe;function K(){return(K=e((()=>{Oe=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})))()}var ke=t({Default:()=>X,MultiSelect:()=>Z,SearchResultAnnouncement:()=>$,__namedExportsOrder:()=>Ne,default:()=>je}),q,Ae,J,je,Y,X,Z,Q,Me,$,Ne;function Pe(){return(Pe=e((()=>{U(),G(),De(),K(),F(),T(),q=n(),Ae=fe(),h(),Ce(),k(),x(),y(),V(),J=d(),je={title:`Modals & Popovers / SelectDialog`,component:B,argTypes:{children:{control:{disable:!0}},onSearch:{control:{disable:!0}},onCancel:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},Y=[{img:H,description:`LT-10`,text:`Gaming Laptop`},{img:W,description:`LT-20`,text:`Business Laptop`},{img:Oe,description:`HT-10`,text:`Gaming PC`},{img:Ee,description:`HT-20`,text:`Business PC`}],X={render:e=>{let[t,n]=(0,q.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,q.useEffect)(()=>{n(e.open)},[e.open]),(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)(g,{onClick:r,children:`Open SelectDialog`}),(0,J.jsx)(B,{...e,open:t,onClose:i,children:Array(40).fill(``).map((e,t)=>{let n=Y[t%4];return(0,J.jsx)(A,{selected:t===1,image:(0,J.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},Z={render:()=>{let[e,t]=(0,q.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,i]=(0,q.useState)(n),a=(0,q.useRef)(r),[o,s]=(0,q.useState)(),[c,l]=(0,q.useState)(Object.keys(n)),ee=()=>{a.current=r},te=()=>{t(!0)},u=()=>{t(!1)},d=e=>{s(e.detail.value)};return(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)(g,{onClick:te,children:`Open Dialog`}),(0,J.jsx)(B,{open:e,selectionMode:w.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;i(e=>{if(e[t]){let{[t]:n,...r}=e;return r}return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{i({})},onConfirm:()=>{l(Object.keys(r))},onClose:u,onSearchInput:d,onSearch:d,onSearchReset:()=>{s(void 0)},onBeforeOpen:ee,onCancel:()=>{i(a.current)},children:Array(40).fill(``).map((e,t)=>{let n=Y[t%4],i=`${n.description}${t}`,a=o?.toLowerCase();return o&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,J.jsx)(A,{image:(0,J.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,J.jsxs)(me,{children:[(0,J.jsx)(N,{children:`Selected: `}),(0,J.jsx)(he,{children:c.join(`, `)})]})]})}},Q=Array.from({length:40},(e,t)=>({id:`P-${t.toString().padStart(3,`0`)}`,text:[`Gaming Laptop`,`Business Laptop`,`Gaming PC`,`Business PC`][t%4]})),Me={position:`absolute`,clip:`rect(1px,1px,1px,1px)`,userSelect:`none`,left:`-1000px`,top:`-1000px`,pointerEvents:`none`},$={render:()=>{let[e,t]=(0,q.useState)(null),n=(0,q.useRef)(null),[r,i]=(0,q.useState)(!1),[a,o]=(0,q.useState)(``),s=(0,q.useMemo)(()=>{let e=a.trim().toLowerCase();return e?Q.filter(t=>t.id.toLowerCase().includes(e)||t.text.toLowerCase().includes(e)):Q},[a]),c=e=>{let t=n.current;t&&(t.textContent=e===0?`No results found`:`${e} results available`)};return(0,J.jsxs)(J.Fragment,{children:[(0,J.jsx)(g,{onClick:()=>i(!0),children:`Open SelectDialog`}),(0,J.jsx)(B,{ref:t,headerText:`Select Product`,open:r,onClose:()=>i(!1),onSearch:e=>{o(e.detail.value),c(s.length)},onSearchReset:()=>{o(``),c(Q.length)},children:s.map(e=>(0,J.jsx)(A,{description:e.id,text:e.text},e.id))}),e&&(0,Ae.createPortal)((0,J.jsx)(`span`,{ref:n,"aria-live":`polite`,style:Me}),e)]})}},X.parameters={...X.parameters,docs:{...X.parameters?.docs,source:{originalSource:`{
  render: args => {
