...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}},growing:{defaultValue:{value:'"None"'},description:'Defines whether the component will have growing capability either by pressing a `More` button,\nor via user scroll. In both cases `load-more` event is fired.\n\n**Restrictions:** `growing="Scroll"` is not supported for Internet Explorer,\non IE the component will fallback to `growing="Button"`.',name:"growing",required:!1,type:{name:'"None" | ListGrowingMode | "Button" | "Scroll"'}}}}}catch{}const Pe=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,je=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,qe=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,Me=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,Ae={title:"Modals & Popovers / SelectDialog",component:v,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:De},parameters:{chromatic:{delay:1e3}},tags:["extends:@ui5/webcomponents","cem-module:Dialog","package:@ui5/webcomponents-react"]},te=[{img:Pe,description:"LT-10",text:"Gaming Laptop"},{img:je,description:"LT-20",text:"Business Laptop"},{img:Me,description:"HT-10",text:"Gaming PC"},{img:qe,description:"HT-20",text:"Business PC"}],T={render:i=>{const[C,m]=o.useState(i.open),s=()=>{m(!0)},f=g=>{m(!1),i.onClose(g)};return o.useEffect(()=>{m(i.open)},[i.open]),t.jsxs(t.Fragment,{children:[t.jsx(w,{onClick:s,children:"Open SelectDialog"}),t.jsx(v,{...i,open:C,onClose:f,children:new Array(40).fill("").map((g,c)=>{const d=te[c%4];return t.jsx(Q,{selected:c===1,image:t.jsx("img",{src:d.img,alt:"Example Image"}),description:`${d.description}${c}`,text:d.text},`${d.text}${c}`)})})]})}},B={render:()=>{const[i,C]=o.useState(!1),m={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[s,f]=o.useState(m),g=o.useRef(s),[c,d]=o.useState(),[A,L]=o.useState(Object.keys(m)),N=()=>{g.current=s},H=()=>{C(!0)},S=()=>{C(!1)},h=u=>{d(u.detail.value)},O=()=>{d(void 0)},F=u=>{const a=u.detail.targetItem.dataset.description;f(n=>{if(n[a]){const{[a]:y,...p}=n;return p}else return{...n,[a]:!0}})},k=()=>{f({})},V=()=>{L(Object.keys(s))},R=()=>{f(g.current)};return t.jsxs(t.Fragment,{children:[t.jsx(w,{onClick:H,children:"Open Dialog"}),t.jsx(v,{open:i,selectionMode:_.Multiple,numberOfSelectedItems:Object.keys(s).length,listProps:{onSelectionChange:F},showClearButton:!0,rememberSelections:!0,onClear:k,onConfirm:V,onClose:S,onSearchInput:h,onSearch:h,onSearchReset:O,onBeforeOpen:N,onCancel:R,children:new Array(40).fill("").map((u,a)=>{const n=te[a%4],y=`${n.description}${a}`,p=c?.toLowerCase();return c&&!y.toLowerCase().includes(p)&&!n.text.toLowerCase().includes(p)?null:t.jsx(Q,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${a}`,"data-description":`${n.description}${a}`,selected:s[y],text:n.text},`${n.text}${a}`)}).filter(Boolean)}),t.jsxs(ee,{children:[t.jsx(Te,{children:"Selected: "}),t.jsx(Z,{children:A.join(", ")})]})]})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...B.parameters?.docs?.source}}};const He=["Default","MultiSelect"],Ye=Object.freeze(Object.defineProperty({__proto__:null,Default:T,MultiSelect:B,__namedExportsOrder:He,default:Ae},Symbol.toStringTag,{value:"Module"}));export{Ye as C,T as D,B as M};
