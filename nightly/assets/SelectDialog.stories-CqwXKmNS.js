import{n as e,o as t,r as n}from"./chunk-jRWAZmH_.js";import{Bd as r,C as i,Dg as a,Fu as o,Gd as s,Iu as c,Kd as l,Ym as u,dd as d,eu as f,fd as p,op as m,r as h,sp as g,tu as _,w as v,zd as y}from"./iframe-dJJqxMUh.js";var b,x=e((()=>{b=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})),S,C=e((()=>{S=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})),w,T=e((()=>{w=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})),E,D=e((()=>{E=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})),O=n({Default:()=>N,MultiSelect:()=>P,__namedExportsOrder:()=>F,default:()=>j}),k,A,j,M,N,P,F,I=e((()=>{x(),C(),T(),D(),h(),p(),k=t(a(),1),g(),_(),c(),r(),l(),v(),A=u(),j={title:`Modals & Popovers / SelectDialog`,component:i,argTypes:{children:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},M=[{img:b,description:`LT-10`,text:`Gaming Laptop`},{img:S,description:`LT-20`,text:`Business Laptop`},{img:E,description:`HT-10`,text:`Gaming PC`},{img:w,description:`HT-20`,text:`Business PC`}],N={render:e=>{let[t,n]=(0,k.useState)(e.open),r=()=>{n(!0)},a=t=>{n(!1),e.onClose(t)};return(0,k.useEffect)(()=>{n(e.open)},[e.open]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(m,{onClick:r,children:`Open SelectDialog`}),(0,A.jsx)(i,{...e,open:t,onClose:a,children:Array(40).fill(``).map((e,t)=>{let n=M[t%4];return(0,A.jsx)(o,{selected:t===1,image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},P={render:()=>{let[e,t]=(0,k.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,a]=(0,k.useState)(n),c=(0,k.useRef)(r),[l,u]=(0,k.useState)(),[p,h]=(0,k.useState)(Object.keys(n)),g=()=>{c.current=r},_=()=>{t(!0)},v=()=>{t(!1)},b=e=>{u(e.detail.value)};return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(m,{onClick:_,children:`Open Dialog`}),(0,A.jsx)(i,{open:e,selectionMode:d.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;a(e=>{if(e[t]){let{[t]:n,...r}=e;return r}else return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{a({})},onConfirm:()=>{h(Object.keys(r))},onClose:v,onSearchInput:b,onSearch:b,onSearchReset:()=>{u(void 0)},onBeforeOpen:g,onCancel:()=>{a(c.current)},children:Array(40).fill(``).map((e,t)=>{let n=M[t%4],i=`${n.description}${t}`,a=l?.toLowerCase();return l&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,A.jsx)(o,{image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,A.jsxs)(s,{children:[(0,A.jsx)(f,{children:`Selected: `}),(0,A.jsx)(y,{children:p.join(`, `)})]})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: args => {
