import{a as e,c as t,i as n}from"./preload-helper-B45gAKPr.js";import{t as r}from"./react-CymAsZIc.js";import{t as i}from"./jsx-runtime-BBQGix-2.js";import{n as a,t as o}from"./Button-Fa3xyL90.js";import{n as s,t as c}from"./Text-Ck86kKhL.js";import{c as l,s as u}from"./List-CgmuoDUS.js";import{n as d,t as f}from"./ListItemStandard-Cw2g_KVK.js";import{n as p,t as m}from"./Label-BfvYnfMV.js";import{Mt as h,O as g,jt as _,k as v,r as y}from"./iframe-CdEp8TUR.js";var b,x=n((()=>{b=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})),S,C=n((()=>{S=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})),w,T=n((()=>{w=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})),E,D=n((()=>{E=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})),O=e({Default:()=>N,MultiSelect:()=>P,__namedExportsOrder:()=>F,default:()=>j}),k,A,j,M,N,P,F,I=n((()=>{x(),C(),T(),D(),y(),l(),k=t(r(),1),a(),p(),d(),s(),h(),v(),A=i(),j={title:`Modals & Popovers / SelectDialog`,component:g,argTypes:{children:{control:{disable:!0}},onSearch:{control:{disable:!0}},onCancel:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},M=[{img:b,description:`LT-10`,text:`Gaming Laptop`},{img:S,description:`LT-20`,text:`Business Laptop`},{img:E,description:`HT-10`,text:`Gaming PC`},{img:w,description:`HT-20`,text:`Business PC`}],N={render:e=>{let[t,n]=(0,k.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,k.useEffect)(()=>{n(e.open)},[e.open]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(o,{onClick:r,children:`Open SelectDialog`}),(0,A.jsx)(g,{...e,open:t,onClose:i,children:Array(40).fill(``).map((e,t)=>{let n=M[t%4];return(0,A.jsx)(f,{selected:t===1,image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},P={render:()=>{let[e,t]=(0,k.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,i]=(0,k.useState)(n),a=(0,k.useRef)(r),[s,l]=(0,k.useState)(),[d,p]=(0,k.useState)(Object.keys(n)),h=()=>{a.current=r},v=()=>{t(!0)},y=()=>{t(!1)},b=e=>{l(e.detail.value)};return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(o,{onClick:v,children:`Open Dialog`}),(0,A.jsx)(g,{open:e,selectionMode:u.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;i(e=>{if(e[t]){let{[t]:n,...r}=e;return r}else return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{i({})},onConfirm:()=>{p(Object.keys(r))},onClose:y,onSearchInput:b,onSearch:b,onSearchReset:()=>{l(void 0)},onBeforeOpen:h,onCancel:()=>{i(a.current)},children:Array(40).fill(``).map((e,t)=>{let n=M[t%4],i=`${n.description}${t}`,a=s?.toLowerCase();return s&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,A.jsx)(f,{image:(0,A.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,A.jsxs)(_,{children:[(0,A.jsx)(m,{children:`Selected: `}),(0,A.jsx)(c,{children:d.join(`, `)})]})]})}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: args => {
