...
**Note:** Available since [v1.10.0](https://github.com/UI5/webcomponents/releases/tag/v1.10.0) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"None"'},{value:'"Dialog"'},{value:'"AlertDialog"'},{value:'"Dialog"'},{value:'"AlertDialog"'}]}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},accessibleDescriptionRef:{defaultValue:{value:"undefined"},description:`Receives id(or many ids) of the elements that describe the component.

**Note:** Available since [v2.11.0](https://github.com/UI5/webcomponents/releases/tag/v2.11.0) of **@ui5/webcomponents**.`,name:"accessibleDescriptionRef",required:!1,type:{name:"string"}},initialFocus:{defaultValue:{value:"undefined"},description:"Defines the ID of the HTML Element, which will get the initial focus.\n\n**Note:** If an element with `autofocus` attribute is added inside the component,\n`initialFocus` won't take effect.",name:"initialFocus",required:!1,type:{name:"string"}},open:{defaultValue:{value:"false"},description:`Indicates if the element is open
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}}}}}catch{}const Oe=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,Pe=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,Me=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,He=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,Ue={title:"Modals & Popovers / SelectDialog",component:m,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:Ie},parameters:{chromatic:{delay:1e3}},tags:["extends:@ui5/webcomponents","cem-module:Dialog","package:@ui5/webcomponents-react"]},te=[{img:Oe,description:"LT-10",text:"Gaming Laptop"},{img:Pe,description:"LT-20",text:"Business Laptop"},{img:He,description:"HT-10",text:"Gaming PC"},{img:Me,description:"HT-20",text:"Business PC"}],T={render:l=>{const[y,h]=o.useState(l.open),a=()=>{h(!0)},g=v=>{h(!1),l.onClose(v)};return o.useEffect(()=>{h(l.open)},[l.open]),t.jsxs(t.Fragment,{children:[t.jsx(_,{onClick:a,children:"Open SelectDialog"}),t.jsx(m,{...l,open:y,onClose:g,children:new Array(40).fill("").map((v,c)=>{const u=te[c%4];return t.jsx(Q,{selected:c===1,image:t.jsx("img",{src:u.img,alt:"Example Image"}),description:`${u.description}${c}`,text:u.text},`${u.text}${c}`)})})]})}},B={render:()=>{const[l,y]=o.useState(!1),h={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[a,g]=o.useState(h),v=o.useRef(a),[c,u]=o.useState(),[U,N]=o.useState(Object.keys(h)),V=()=>{v.current=a},A=()=>{y(!0)},C=()=>{y(!1)},f=d=>{u(d.detail.value)},R=()=>{u(void 0)},j=d=>{const i=d.detail.targetItem.dataset.description;g(n=>{if(n[i]){const{[i]:w,...p}=n;return p}else return{...n,[i]:!0}})},L=()=>{g({})},q=()=>{N(Object.keys(a))},E=()=>{g(v.current)};return t.jsxs(t.Fragment,{children:[t.jsx(_,{onClick:A,children:"Open Dialog"}),t.jsx(m,{open:l,selectionMode:S.Multiple,numberOfSelectedItems:Object.keys(a).length,listProps:{onSelectionChange:j},showClearButton:!0,rememberSelections:!0,onClear:L,onConfirm:q,onClose:C,onSearchInput:f,onSearch:f,onSearchReset:R,onBeforeOpen:V,onCancel:E,children:new Array(40).fill("").map((d,i)=>{const n=te[i%4],w=`${n.description}${i}`,p=c?.toLowerCase();return c&&!w.toLowerCase().includes(p)&&!n.text.toLowerCase().includes(p)?null:t.jsx(Q,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${i}`,"data-description":`${n.description}${i}`,selected:a[w],text:n.text},`${n.text}${i}`)}).filter(Boolean)}),t.jsxs(ee,{children:[t.jsx(Te,{children:"Selected: "}),t.jsx(Y,{children:U.join(", ")})]})]})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...B.parameters?.docs?.source}}};const Ae=["Default","MultiSelect"],Xe=Object.freeze(Object.defineProperty({__proto__:null,Default:T,MultiSelect:B,__namedExportsOrder:Ae,default:Ue},Symbol.toStringTag,{value:"Module"}));export{Xe as C,T as D,B as M};
