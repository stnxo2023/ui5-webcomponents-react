...
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},accessibleNameRef:{defaultValue:{value:"undefined"},description:`Defines the IDs of the elements that label the component.

**Note:** Available since [v1.1.0](https://github.com/UI5/webcomponents/releases/tag/v1.1.0) of **@ui5/webcomponents**.`,name:"accessibleNameRef",required:!1,type:{name:"string"}},onOpen:{defaultValue:null,description:`Fired after the component is opened.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onOpen",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}},accessibleDescription:{defaultValue:{value:"undefined"},description:`Defines the accessible description of the component.
...
**Note:** Available since [v2.11.0](https://github.com/UI5/webcomponents/releases/tag/v2.11.0) of **@ui5/webcomponents**.`,name:"accessibleDescriptionRef",required:!1,type:{name:"string"}},accessibleRole:{defaultValue:{value:'"Dialog"'},description:`Allows setting a custom role.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|❌|`,name:"onClose",required:!1,type:{name:"(event: Ui5CustomEvent<DialogDomRef, never>) => void"}},growing:{defaultValue:{value:'"None"'},description:'Defines whether the component will have growing capability either by pressing a `More` button,\nor via user scroll. In both cases `load-more` event is fired.\n\n**Restrictions:** `growing="Scroll"` is not supported for Internet Explorer,\non IE the component will fallback to `growing="Button"`.',name:"growing",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Button"'},{value:'"Scroll"'},{value:'"None"'},{value:'"Button"'},{value:'"Scroll"'}]}},onLoadMore:{defaultValue:null,description:`Fired when the user scrolls to the bottom of the list.

**Note:** The event is fired when the \`growing='Scroll'\` property is enabled.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onLoadMore",required:!1,type:{name:"(event: Ui5CustomEvent<ListDomRef, never>) => void"}}}}}catch{}const Pe=""+new URL("Laptop1-BiqZozDV.jpg",import.meta.url).href,je=""+new URL("Laptop2-CLTht4yo.jpg",import.meta.url).href,qe=""+new URL("PC1-BekXrNHY.jpg",import.meta.url).href,Me=""+new URL("PC2-DZLCUDFz.jpg",import.meta.url).href,He={title:"Modals & Popovers / SelectDialog",component:b,argTypes:{children:{control:{disable:!0}}},args:{headerText:"Select Product",open:De},parameters:{chromatic:{delay:1e3}},tags:["extends:@ui5/webcomponents","cem-module:Dialog","package:@ui5/webcomponents-react"]},te=[{img:Pe,description:"LT-10",text:"Gaming Laptop"},{img:je,description:"LT-20",text:"Business Laptop"},{img:Me,description:"HT-10",text:"Gaming PC"},{img:qe,description:"HT-20",text:"Business PC"}],T={render:s=>{const[C,m]=o.useState(s.open),a=()=>{m(!0)},f=g=>{m(!1),s.onClose(g)};return o.useEffect(()=>{m(s.open)},[s.open]),t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:a,children:"Open SelectDialog"}),t.jsx(b,{...s,open:C,onClose:f,children:new Array(40).fill("").map((g,c)=>{const d=te[c%4];return t.jsx(Q,{selected:c===1,image:t.jsx("img",{src:d.img,alt:"Example Image"}),description:`${d.description}${c}`,text:d.text},`${d.text}${c}`)})})]})}},B={render:()=>{const[s,C]=o.useState(!1),m={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[a,f]=o.useState(m),g=o.useRef(a),[c,d]=o.useState(),[H,L]=o.useState(Object.keys(m)),N=()=>{g.current=a},A=()=>{C(!0)},S=()=>{C(!1)},h=u=>{d(u.detail.value)},O=()=>{d(void 0)},F=u=>{const l=u.detail.targetItem.dataset.description;f(n=>{if(n[l]){const{[l]:y,...p}=n;return p}else return{...n,[l]:!0}})},k=()=>{f({})},V=()=>{L(Object.keys(a))},R=()=>{f(g.current)};return t.jsxs(t.Fragment,{children:[t.jsx(x,{onClick:A,children:"Open Dialog"}),t.jsx(b,{open:s,selectionMode:_.Multiple,numberOfSelectedItems:Object.keys(a).length,listProps:{onSelectionChange:F},showClearButton:!0,rememberSelections:!0,onClear:k,onConfirm:V,onClose:S,onSearchInput:h,onSearch:h,onSearchReset:O,onBeforeOpen:N,onCancel:R,children:new Array(40).fill("").map((u,l)=>{const n=te[l%4],y=`${n.description}${l}`,p=c?.toLowerCase();return c&&!y.toLowerCase().includes(p)&&!n.text.toLowerCase().includes(p)?null:t.jsx(Q,{image:t.jsx("img",{src:n.img,alt:"Example Image"}),description:`${n.description}${l}`,"data-description":`${n.description}${l}`,selected:a[y],text:n.text},`${n.text}${l}`)}).filter(Boolean)}),t.jsxs(ee,{children:[t.jsx(Te,{children:"Selected: "}),t.jsx(J,{children:H.join(", ")})]})]})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...B.parameters?.docs?.source}}};const Ae=["Default","MultiSelect"],Ye=Object.freeze(Object.defineProperty({__proto__:null,Default:T,MultiSelect:B,__namedExportsOrder:Ae,default:He},Symbol.toStringTag,{value:"Module"}));export{Ye as C,T as D,B as M};
