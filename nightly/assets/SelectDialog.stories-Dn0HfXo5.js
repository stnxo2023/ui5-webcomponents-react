import{n as e,o as t,r as n}from"./rolldown-runtime-DAXXjFlN.js";import{t as r}from"./react-DEAHbL4P.js";import{t as i}from"./jsx-runtime-CFwixLRt.js";import{n as a,t as o}from"./Button-CzSSf-bv.js";import{t as s}from"./react-dom-BVlgzAaY.js";import{n as c,t as l}from"./FlexBox-CxtRJm8x.js";import{n as u,t as d}from"./Text-CO1c46QX.js";import{_ as f,v as p}from"./List-Di-7tuEV.js";import{n as m,t as h}from"./ListItemStandard-BNJ34vlB.js";import{n as g,t as _}from"./Label-CC-aoGlQ.js";import{S as v,r as y,x as b}from"./iframe-CcDL8gjb.js";var x,S=e((()=>{x=``+new URL(`Laptop1-BiqZozDV.jpg`,import.meta.url).href})),C,w=e((()=>{C=``+new URL(`Laptop2-CLTht4yo.jpg`,import.meta.url).href})),T,E=e((()=>{T=``+new URL(`PC1-BekXrNHY.jpg`,import.meta.url).href})),D,O=e((()=>{D=``+new URL(`PC2-DZLCUDFz.jpg`,import.meta.url).href})),k=n({Default:()=>F,MultiSelect:()=>I,SearchResultAnnouncement:()=>z,__namedExportsOrder:()=>B,default:()=>N}),A,j,M,N,P,F,I,L,R,z,B,V=e((()=>{S(),w(),E(),O(),y(),p(),A=t(r(),1),j=t(s(),1),a(),g(),m(),u(),c(),v(),M=i(),N={title:`Modals & Popovers / SelectDialog`,component:b,argTypes:{children:{control:{disable:!0}},onSearch:{control:{disable:!0}},onCancel:{control:{disable:!0}}},args:{headerText:`Select Product`,open:!1},parameters:{chromatic:{delay:1e3}},tags:[`extends:@ui5/webcomponents`,`cem-module:Dialog`,`package:@ui5/webcomponents-react`]},P=[{img:x,description:`LT-10`,text:`Gaming Laptop`},{img:C,description:`LT-20`,text:`Business Laptop`},{img:D,description:`HT-10`,text:`Gaming PC`},{img:T,description:`HT-20`,text:`Business PC`}],F={render:e=>{let[t,n]=(0,A.useState)(e.open),r=()=>{n(!0)},i=t=>{n(!1),e.onClose(t)};return(0,A.useEffect)(()=>{n(e.open)},[e.open]),(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:r,children:`Open SelectDialog`}),(0,M.jsx)(b,{...e,open:t,onClose:i,children:Array(40).fill(``).map((e,t)=>{let n=P[t%4];return(0,M.jsx)(h,{selected:t===1,image:(0,M.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,text:n.text},`${n.text}${t}`)})})]})}},I={render:()=>{let[e,t]=(0,A.useState)(!1),n={"HT-102":!0,"HT-203":!0,"HT-1038":!0},[r,i]=(0,A.useState)(n),a=(0,A.useRef)(r),[s,c]=(0,A.useState)(),[u,p]=(0,A.useState)(Object.keys(n)),m=()=>{a.current=r},g=()=>{t(!0)},v=()=>{t(!1)},y=e=>{c(e.detail.value)};return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:g,children:`Open Dialog`}),(0,M.jsx)(b,{open:e,selectionMode:f.Multiple,numberOfSelectedItems:Object.keys(r).length,listProps:{onSelectionChange:e=>{let t=e.detail.targetItem.dataset.description;i(e=>{if(e[t]){let{[t]:n,...r}=e;return r}else return{...e,[t]:!0}})}},showClearButton:!0,rememberSelections:!0,onClear:()=>{i({})},onConfirm:()=>{p(Object.keys(r))},onClose:v,onSearchInput:y,onSearch:y,onSearchReset:()=>{c(void 0)},onBeforeOpen:m,onCancel:()=>{i(a.current)},children:Array(40).fill(``).map((e,t)=>{let n=P[t%4],i=`${n.description}${t}`,a=s?.toLowerCase();return s&&!i.toLowerCase().includes(a)&&!n.text.toLowerCase().includes(a)?null:(0,M.jsx)(h,{image:(0,M.jsx)(`img`,{src:n.img,alt:`Example Image`}),description:`${n.description}${t}`,"data-description":`${n.description}${t}`,selected:r[i],text:n.text},`${n.text}${t}`)}).filter(Boolean)}),(0,M.jsxs)(l,{children:[(0,M.jsx)(_,{children:`Selected: `}),(0,M.jsx)(d,{children:u.join(`, `)})]})]})}},L=Array.from({length:40},(e,t)=>({id:`P-${t.toString().padStart(3,`0`)}`,text:[`Gaming Laptop`,`Business Laptop`,`Gaming PC`,`Business PC`][t%4]})),R={position:`absolute`,clip:`rect(1px,1px,1px,1px)`,userSelect:`none`,left:`-1000px`,top:`-1000px`,pointerEvents:`none`},z={render:()=>{let[e,t]=(0,A.useState)(null),n=(0,A.useRef)(null),[r,i]=(0,A.useState)(!1),[a,s]=(0,A.useState)(``),c=(0,A.useMemo)(()=>{let e=a.trim().toLowerCase();return e?L.filter(t=>t.id.toLowerCase().includes(e)||t.text.toLowerCase().includes(e)):L},[a]),l=e=>{let t=n.current;t&&(t.textContent=e===0?`No results found`:`${e} results available`)};return(0,M.jsxs)(M.Fragment,{children:[(0,M.jsx)(o,{onClick:()=>i(!0),children:`Open SelectDialog`}),(0,M.jsx)(b,{ref:t,headerText:`Select Product`,open:r,onClose:()=>i(!1),onSearch:e=>{s(e.detail.value),l(c.length)},onSearchReset:()=>{s(``),l(L.length)},children:c.map(e=>(0,M.jsx)(h,{description:e.id,text:e.text},e.id))}),e&&(0,j.createPortal)((0,M.jsx)(`span`,{ref:n,"aria-live":`polite`,style:R}),e)]})}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  render: args => {
