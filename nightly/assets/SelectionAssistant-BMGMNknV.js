import{c as e,i as t}from"./preload-helper-B45gAKPr.js";import{t as n}from"./react-CymAsZIc.js";import{t as r}from"./jsx-runtime-BBQGix-2.js";import{t as i}from"./Button-AhxrIfwv.js";import{t as a}from"./Input-B8nrIH1X.js";import{t as o}from"./Label-Dh49kFYh.js";import{b as s}from"./webComponents-8x-jks0f.js";import{t as c}from"./Card-BlR5sTpX.js";import{t as l}from"./TextArea-QBKgmb8L.js";import{t as u}from"./Toast-Cd-jD72F.js";import{u as d,vt as f}from"./iframe-CKIhzmu4.js";import{A as p,_ as m,d as h}from"./blocks-CmeXRRjx.js";import{E as g,g as _,t as v,u as y,v as b,y as x}from"./components-BUGkhleK.js";var S,C,w,T,E,D,O,k=t((()=>{S=(e,t)=>{let n=getComputedStyle(e);for(let e=0;e<n.length;e++){let r=n[e];t.style.setProperty(r,n.getPropertyValue(r))}e.tagName===`INPUT`&&w(t),t.style.position=`absolute`,t.style.left=`${e.getBoundingClientRect().left}px`,t.style.top=`${e.getBoundingClientRect().top}px`,C(t),document.body.appendChild(t)},C=e=>{e.style.position=`absolute`,e.style.userSelect=`none`,e.style.pointerEvents=`none`,e.style.zIndex=`-1`,e.style.opacity=`0`},w=e=>{e.style.whiteSpace=`nowrap`,e.style.overflowX=`auto`,e.style.overflowY=`hidden`},T=()=>{let e=document.createElement(`div`);e.id=`ui5-selection-mirror`,e.contentEditable=`true`,document.body.appendChild(e)},E=(e,t)=>{t.scrollTop=e.scrollTop,t.scrollLeft=e.scrollLeft},D=(e,t)=>{let{selectionStart:n,selectionEnd:r}=e,i=e.value.slice(n,e.selectionEnd),a=document.createRange();a.setStart(t.firstChild,r-1),a.setEnd(t.firstChild,r),E(e,t);let o=a.getBoundingClientRect(),s={x:o.x,y:o.y,width:o.width,height:o.height,top:o.top,right:o.right,bottom:o.bottom,left:o.left};return document.body.removeChild(t),{...s,selectedText:i}},O=e=>{let t=e.shadowRoot.querySelector(`textarea`)||e.shadowRoot.querySelector(`input`);document.getElementById(`ui5-selection-mirror`)||T();let n=document.getElementById(`ui5-selection-mirror`);return n.textContent=t.value,t&&S(t,n),D(t,n)}})),A,j,M,N=t((()=>{d(),A=e(n(),1),j=r(),M=(0,A.forwardRef)(({children:e},t)=>(0,j.jsx)(c,{children:(0,j.jsx)(f,{ref:t,style:{padding:`1rem`,position:`relative`},direction:`Column`,children:e})})),M.displayName=`SelectionAssistantContainer`}));function P(){let e=(0,F.useRef)(null),t=(0,F.useRef)(null),[n,r]=(0,F.useState)(!1),[s,c]=(0,F.useState)({}),[l,d]=(0,F.useState)(``),[f,p]=(0,F.useState)(!1),m=(e,t)=>{c({left:`${e.left-t.left+e.width+4}px`,top:`${e.top-t.top}px`}),r(!0)},h=(e,t)=>{c({left:`${e.left-t.left+e.width}px`,top:`${e.top-t.top+e.height}px`}),r(!0)},g=t=>{let n=t.currentTarget,r=O(n),i=n.getBoundingClientRect(),a=e.current?.getBoundingClientRect();a&&(r.bottom>i.bottom||r.right>i.right?m(i,a):h(r,a))},_=t=>{let n=t.currentTarget.getBoundingClientRect(),r=e.current?.getBoundingClientRect();m(n,r)},v=()=>{let e=`The selected text equals to: "${document.getSelection().toString()}"`;d(e),p(!0)};return(0,I.jsxs)(M,{ref:e,children:[(0,I.jsx)(o,{for:`ai-input`,showColon:!0,children:`Input with Selection Assistant`}),(0,I.jsx)(a,{id:`ai-input`,value:`Ipsum enim esse ipsum cupidatat ex veniam labore quis irure. Eiusmod labore anim anim nulla aute ut.`,onSelect:g,onMouseDown:()=>{r(!1)},onScroll:()=>{r(!1)},onBlur:e=>{e.relatedTarget!==t.current&&r(!1)}}),(0,I.jsx)(`br`,{}),(0,I.jsx)(o,{for:`ai-native-input`,showColon:!0,children:`Input with native API`}),(0,I.jsx)(a,{id:`ai-native-input`,value:`Ipsum enim esse ipsum cupidatat ex veniam labore quis irure. Eiusmod labore anim anim nulla aute ut.`,onSelect:_}),n&&(0,I.jsx)(i,{style:{position:`absolute`,zIndex:2,...s},ref:t,icon:`ai`,onClick:v,onBlur:()=>{r(!1)}}),(0,I.jsx)(u,{open:f,onClose:()=>{p(!1)},children:l})]})}var F,I,L=t((()=>{k(),s(),d(),F=e(n(),1),N(),I=r(),P.displayName=`InputSelectionAssistant`}));function R(){let e=(0,z.useRef)(null),t=(0,z.useRef)(null),[n,r]=(0,z.useState)(!1),[a,s]=(0,z.useState)({}),[c,d]=(0,z.useState)(``),[f,p]=(0,z.useState)(!1),m=(e,t)=>{s({left:`${e.left-t.left+e.width+4}px`,top:`${e.top-t.top}px`}),r(!0)},h=(e,t)=>{s({left:`${e.left-t.left+e.width}px`,top:`${e.top-t.top+e.height}px`}),r(!0)},g=t=>{let n=t.currentTarget,r=O(n),i=n.getBoundingClientRect(),a=e.current?.getBoundingClientRect();a&&(r.bottom>i.bottom||r.right>i.right?m(i,a):h(r,a))},_=()=>{let e=`The selected text equals to: "${document.getSelection().toString()}"`;d(e),p(!0)};return(0,B.jsxs)(M,{ref:e,children:[(0,B.jsx)(o,{for:`ai-textarea`,showColon:!0,children:`TextArea with Selection Assistant`}),(0,B.jsx)(l,{id:`ai-textarea`,value:`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus vehicula blandit. Morbi suscipit nunc a quam ultrices consequat. Phasellus a dapibus est. Praesent leo libero, aliquet et imperdiet et, tincidunt non enim. Aliquam et nibh efficitur libero finibus rutrum in mattis ante. Morbi convallis aliquam leo id sagittis. Morbi tempor tellus ut dictum luctus. Pellentesque viverra quam sapien, et pharetra odio viverra vitae. Vivamus mollis ac purus quis tempus. Curabitur suscipit feugiat ante a iaculis. Aliquam ut metus magna. Praesent quis pharetra tortor, tristique rhoncus ante. Curabitur quis lorem nec ligula venenatis porta. Vivamus consequat, mi tincidunt tempor dapibus, urna ipsum ultricies dolor, sit amet aliquet eros erat vitae metus. Vivamus molestie, arcu id laoreet auctor, tortor urna suscipit ex, in ultricies leo tortor in nulla. In justo neque, hendrerit et neque fermentum, ultrices aliquam enim. Morbi quis urna cursus, varius massa at, ornare neque. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dapibus dolor vitae bibendum bibendum. Curabitur ullamcorper magna sem, in dignissim velit fermentum vel. In vel ipsum tristique, sodales enim ac, tristique tellus. Curabitur eget lectus sapien. Praesent sit amet sagittis diam. Pellentesque quis scelerisque leo. Phasellus a arcu volutpat, ullamcorper risus vel, gravida justo. Nullam blandit turpis ligula, et faucibus dolor venenatis vitae. Donec at odio ut libero imperdiet tristique sed id erat. In sed sapien a ligula porta porta eget in justo. In dictum rhoncus mattis. Pellentesque eu feugiat ante. Phasellus in imperdiet eros. Aliquam eget luctus augue. Vestibulum posuere mattis tincidunt. Pellentesque congue laoreet purus, in commodo dui porttitor vel. Phasellus neque ipsum, tristique eu ornare quis, semper nec arcu. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Phasellus velit lorem, fermentum tristique enim eu, pretium pulvinar justo. Cras vel porttitor nisi. Nam eleifend purus tortor, ac sollicitudin dolor rhoncus nec.`,onSelect:g,style:{width:`80%`,marginBlockEnd:`3rem`},rows:5}),n&&(0,B.jsx)(i,{style:{position:`absolute`,zIndex:2,...a},ref:t,icon:`ai`,onClick:_,onBlur:()=>{r(!1)}}),(0,B.jsx)(u,{open:f,onClose:()=>{p(!1)},children:c})]})}var z,B,V=t((()=>{k(),s(),d(),z=e(n(),1),N(),B=r()}));function H(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,strong:`strong`,...p(),...e.components};return(0,W.jsxs)(W.Fragment,{children:[(0,W.jsx)(t.h1,{id:`selection-assistant`,children:`Selection Assistant`}),`
`,(0,W.jsx)(`table`,{style:{width:`550px`},children:(0,W.jsx)(`thead`,{children:(0,W.jsxs)(`tr`,{children:[(0,W.jsx)(`th`,{children:`Usage`}),(0,W.jsx)(`th`,{children:(0,W.jsx)(b,{moduleName:`getElementSelection`,packageName:`@ui5/webcomponents-base/dist/util/SelectionAssistant.js`,defaultImport:!0})})]})})}),`
`,(0,W.jsx)(_,{}),`
`,(0,W.jsx)(h,{title:`SelectionAssistant`,tags:[`experimental`]}),`
...
`})})]}),`
`,(0,W.jsx)(y,{})]})}function U(e={}){let{wrapper:t}={...p(),...e.components};return t?(0,W.jsx)(t,{...e,children:(0,W.jsx)(H,{...e})}):H(e)}var W;t((()=>{W=r(),g(),v(),m(),x(),L(),V()}))();export{U as default};