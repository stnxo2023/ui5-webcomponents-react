import{n as l,j as e,U as C,a6 as q}from"./iframe-DNJyEiMc.js";import{useMDXComponents as A}from"./index-Buf0tSMZ.js";import{M as E}from"./blocks-Cd1leuxf.js";import"./Tag-D8I94QaD.js";import"./index-BGa7wgQo.js";import{I as N}from"./CommandsAndQueries-Buhz4vLI.js";import"./copy-DriogBoE.js";import{T as M}from"./TableOfContent-Cp2ISJUt.js";import{F as D}from"./Footer-DsUhWQr2.js";import"./PageNotFound-CGNJPiuA.js";import{a as j}from"./ai-ubbXaFCU.js";import{C as $}from"./index-bWFHrqMY.js";import{F as k}from"./index-DbBWaCWe.js";import{L as T}from"./index-DfQ2RFhn.js";import{I as B}from"./index-BHlBOYOF.js";import{T as L}from"./index-BDXBs3uw.js";import"./preload-helper-PPVm8Dsz.js";import"./information-CKmAqDt9.js";import"./sys-enter-2-D1jYlQdI.js";import"./alert-BbM4Afj3.js";import"./Link-CHa9FW0P.js";import"./index-DcpLgbSq.js";import"./index-BNiXpovA.js";import"./AvatarSize-BtKTMFJ5.js";import"./employee-Cm_sH4gX.js";import"./addCustomCSSWithScoping-QHxNEQro.js";import"./index-CRk1MYZt.js";import"./index-C8jwJsjc.js";import"./Illustrations-8c1koKlL.js";import"./i18n-defaults-CFWtSmu6.js";import"./ai-N7ehqNT2.js";import"./Input-BwK_QO9m.js";import"./ResponsivePopoverCommon.css-DxGEQbl-.js";import"./ValueStateMessage.css-CgtkZrlq.js";import"./Suggestions.css-BOqaBsuR.js";import"./TextArea-DRrsScFS.js";const O=(t,n)=>{const r=getComputedStyle(t);for(let o=0;o<r.length;o++){const d=r[o];n.style.setProperty(d,r.getPropertyValue(d))}t.tagName==="INPUT"&&V(n),n.style.position="absolute",n.style.left=`${t.getBoundingClientRect().left}px`,n.style.top=`${t.getBoundingClientRect().top}px`,F(n),document.body.appendChild(n)},F=t=>{t.style.position="absolute",t.style.userSelect="none",t.style.pointerEvents="none",t.style.zIndex="-1",t.style.opacity="0"},V=t=>{t.style.whiteSpace="nowrap",t.style.overflowX="auto",t.style.overflowY="hidden"},_=()=>{const t=document.createElement("div");t.id="ui5-selection-mirror",t.contentEditable="true",document.body.appendChild(t)},z=(t,n)=>{n.scrollTop=t.scrollTop,n.scrollLeft=t.scrollLeft},U=(t,n)=>{const{selectionStart:r,selectionEnd:o}=t,d=t.value.slice(r,t.selectionEnd),c=document.createRange();c.setStart(n.firstChild,o-1),c.setEnd(n.firstChild,o),z(t,n);const u=c.getBoundingClientRect(),h={x:u.x,y:u.y,width:u.width,height:u.height,top:u.top,right:u.right,bottom:u.bottom,left:u.left};return document.body.removeChild(n),{...h,selectedText:d}},I=t=>{const n=t.shadowRoot.querySelector("textarea")||t.shadowRoot.querySelector("input");document.getElementById("ui5-selection-mirror")||_();const r=document.getElementById("ui5-selection-mirror");return r.textContent=n.value,n&&O(n,r),U(n,r)},x=l.forwardRef(({children:t},n)=>e.jsx($,{children:e.jsx(k,{ref:n,style:{padding:"1rem",position:"relative"},direction:"Column",children:t})}));x.displayName="SelectionAssistantContainer";try{x.displayName="SelectionAssistantContainer",x.__docgenInfo={description:"",displayName:"SelectionAssistantContainer",props:{}}}catch{}function P(){const t=l.useRef(null),n=l.useRef(null),[r,o]=l.useState(!1),[d,c]=l.useState({}),[u,h]=l.useState(""),[S,f]=l.useState(!1),g=(i,s)=>{c({left:`${i.left-s.left+i.width+4}px`,top:`${i.top-s.top}px`}),o(!0)},b=(i,s)=>{c({left:`${i.left-s.left+i.width}px`,top:`${i.top-s.top+i.height}px`}),o(!0)},R=i=>{const s=i.currentTarget,p=I(s),m=s.getBoundingClientRect(),y=t.current?.getBoundingClientRect();y&&(p.bottom>m.bottom||p.right>m.right?g(m,y):b(p,y))},v=i=>{const p=i.currentTarget.getBoundingClientRect(),m=t.current?.getBoundingClientRect();g(p,m)},a=()=>{const s=`The selected text equals to: "${document.getSelection().toString()}"`;h(s),f(!0)};return e.jsxs(x,{ref:t,children:[e.jsx(T,{for:"ai-input",showColon:!0,children:"Input with Selection Assistant"}),e.jsx(B,{id:"ai-input",value:"Ipsum enim esse ipsum cupidatat ex veniam labore quis irure. Eiusmod labore anim anim nulla aute ut.",onSelect:R,onMouseDown:()=>{o(!1)},onScroll:()=>{o(!1)},onBlur:i=>{i.relatedTarget!==n.current&&o(!1)}}),e.jsx("br",{}),e.jsx(T,{for:"ai-native-input",showColon:!0,children:"Input with native API"}),e.jsx(B,{id:"ai-native-input",value:"Ipsum enim esse ipsum cupidatat ex veniam labore quis irure. Eiusmod labore anim anim nulla aute ut.",onSelect:v}),r&&e.jsx(C,{style:{position:"absolute",zIndex:2,...d},ref:n,icon:j,onClick:a,onBlur:()=>{o(!1)}}),e.jsx(q,{open:S,onClose:()=>{f(!1)},children:u})]})}P.displayName="InputSelectionAssistant";function H(){const t=l.useRef(null),n=l.useRef(null),[r,o]=l.useState(!1),[d,c]=l.useState({}),[u,h]=l.useState(""),[S,f]=l.useState(!1),g=(a,i)=>{c({left:`${a.left-i.left+a.width+4}px`,top:`${a.top-i.top}px`}),o(!0)},b=(a,i)=>{c({left:`${a.left-i.left+a.width}px`,top:`${a.top-i.top+a.height}px`}),o(!0)},R=a=>{const i=a.currentTarget,s=I(i),p=i.getBoundingClientRect(),m=t.current?.getBoundingClientRect();m&&(s.bottom>p.bottom||s.right>p.right?g(p,m):b(s,m))},v=()=>{const i=`The selected text equals to: "${document.getSelection().toString()}"`;h(i),f(!0)};return e.jsxs(x,{ref:t,children:[e.jsx(T,{for:"ai-textarea",showColon:!0,children:"TextArea with Selection Assistant"}),e.jsx(L,{id:"ai-textarea",value:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec luctus vehicula blandit. Morbi suscipit nunc a quam ultrices consequat. Phasellus a dapibus est. Praesent leo libero, aliquet et imperdiet et, tincidunt non enim. Aliquam et nibh efficitur libero finibus rutrum in mattis ante. Morbi convallis aliquam leo id sagittis. Morbi tempor tellus ut dictum luctus. Pellentesque viverra quam sapien, et pharetra odio viverra vitae. Vivamus mollis ac purus quis tempus. Curabitur suscipit feugiat ante a iaculis. Aliquam ut metus magna. Praesent quis pharetra tortor, tristique rhoncus ante. Curabitur quis lorem nec ligula venenatis porta. Vivamus consequat, mi tincidunt tempor dapibus, urna ipsum ultricies dolor, sit amet aliquet eros erat vitae metus. Vivamus molestie, arcu id laoreet auctor, tortor urna suscipit ex, in ultricies leo tortor in nulla. In justo neque, hendrerit et neque fermentum, ultrices aliquam enim. Morbi quis urna cursus, varius massa at, ornare neque. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut dapibus dolor vitae bibendum bibendum. Curabitur ullamcorper magna sem, in dignissim velit fermentum vel. In vel ipsum tristique, sodales enim ac, tristique tellus. Curabitur eget lectus sapien. Praesent sit amet sagittis diam. Pellentesque quis scelerisque leo. Phasellus a arcu volutpat, ullamcorper risus vel, gravida justo. Nullam blandit turpis ligula, et faucibus dolor venenatis vitae. Donec at odio ut libero imperdiet tristique sed id erat. In sed sapien a ligula porta porta eget in justo. In dictum rhoncus mattis. Pellentesque eu feugiat ante. Phasellus in imperdiet eros. Aliquam eget luctus augue. Vestibulum posuere mattis tincidunt. Pellentesque congue laoreet purus, in commodo dui porttitor vel. Phasellus neque ipsum, tristique eu ornare quis, semper nec arcu. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Phasellus velit lorem, fermentum tristique enim eu, pretium pulvinar justo. Cras vel porttitor nisi. Nam eleifend purus tortor, ac sollicitudin dolor rhoncus nec.",onSelect:R,style:{width:"80%",marginBlockEnd:"3rem"},rows:5}),r&&e.jsx(C,{style:{position:"absolute",zIndex:2,...d},ref:n,icon:j,onClick:v,onBlur:()=>{o(!1)}}),e.jsx(q,{open:S,onClose:()=>{f(!1)},children:u})]})}function w(t){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",strong:"strong",...A(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"selection-assistant",children:"Selection Assistant"}),`
...
`})})]}),`
`,e.jsx(D,{})]})}function Ae(t={}){const{wrapper:n}={...A(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(w,{...t})}):w(t)}export{Ae as default};
