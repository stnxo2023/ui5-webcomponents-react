import{i as e}from"./preload-helper-usAeo7Bx.js";import{$i as t,Zi as n,ea as r,lh as i,u as a}from"./iframe-CP9oww6z.js";import{J as o,_ as s,d as c}from"./blocks-Caf_gAfH.js";import{E as l,m as u,t as d,u as f}from"./components-CHqBBfWF.js";function p(){return(0,m.jsx)(n,{design:t.Information,hideCloseButton:!0,children:(0,m.jsxs)(m.Fragment,{children:[(0,m.jsx)(`strong`,{children:`Known Limitations`}),(0,m.jsxs)(`ul`,{children:[(0,m.jsx)(`li`,{children:`As custom elements need to be defined on the client, UI5 Web Components for React is only rendering the outer markup of the UI5 Web Component on the server. The rendering of the Web Component is still happening on the client.`}),(0,m.jsxs)(`li`,{children:[`The Next.js `,(0,m.jsx)(`code`,{children:`app`}),` directory shows some hydration warnings on the client. These warnings seem not to affect the runtime.`]})]})]})})}var m,h=e((()=>{r(),a(),m=i()}));function g(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,h4:`h4`,p:`p`,pre:`pre`,strong:`strong`,...o(),...e.components};return(0,v.jsxs)(v.Fragment,{children:[(0,v.jsx)(c,{title:`Server Side Rendering`}),`
`,(0,v.jsx)(u,{}),`
...
`,(0,v.jsx)(f,{})]})}function _(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,v.jsx)(t,{...e,children:(0,v.jsx)(g,{...e})}):g(e)}var v;e((()=>{v=i(),l(),d(),s(),h()}))();export{_ as default};