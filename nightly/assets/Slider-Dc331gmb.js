...
**Note:** In order for the component to comply with the accessibility standard, it is recommended to set the editableTooltip property to true.`,name:`editableTooltip`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},labelInterval:{defaultValue:{value:`0`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`}],description:`Displays a label with a value on every N-th step.
...
**Note:** The step must be a positive number.`,name:`showTickmarks`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},showTooltip:{defaultValue:{value:`false`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`}],description:`Enables handle tooltip displaying the current value.`,name:`showTooltip`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`false`},type:{name:`enum`,raw:`boolean`,value:[{value:`false`},{value:`true`}]}},step:{defaultValue:{value:`1`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`}],description:`Defines the size of the slider's selection intervals (e.g. min = 0, max = 10, step = 5 would result in possible selection of the values 0, 5, 10).

**Note:** If set to 0 the slider handle movement is disabled.`,name:`step`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`1`},type:{name:`number`}},tickmarks:{defaultValue:{value:`[]`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`}],description:"Defines custom tickmarks with labels on the slider scale.\nEach tickmark object has a numeric `value` and an optional `label` string.\nTickmarks are purely visual — they display labeled markers at specific positions\nbut do not affect the slider's movement behavior. The slider still moves\naccording to `min`, `max`, and `step`.\n\nWhen the current value matches a tickmark value, the tickmark's label\nis shown in the tooltip and announced via `aria-valuetext`.\n\n**Note:** When `tickmarks` is provided, the scale is automatically shown\n(equivalent to `showTickmarks`), and `labelInterval` is ignored - every\ncustom tickmark is rendered with its own `label`.\n\n**Note:** Available since [v2.23.0](https://github.com/UI5/webcomponents/releases/tag/v2.23.0) of **@ui5/webcomponents**.",name:`tickmarks`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`[]`},type:{name:`enum`,raw:`Tickmark[] | unique symbol | "isArray" | "prototype" | "from" | "of" | "fromAsync"`,value:[{value:`Tickmark[]`,description:``,fullComment:``,tags:{}},{value:`unique symbol`,description:`A function valued property that is the constructor function that is used to create
derived objects.`,fullComment:`A function valued property that is the constructor function that is used to create
derived objects.`,tags:{}},{value:`"isArray"`},{value:`"prototype"`},{value:`"from"`},{value:`"of"`},{value:`"fromAsync"`}]}},value:{defaultValue:{value:`0`},declarations:[{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`}],description:`Current value of the slider`,name:`value`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Slider/index.d.ts`,name:`SliderAttributes`},required:!1,tags:{default:`0`},type:{name:`number`}},className:{defaultValue:null,declarations:[{fileName:`ui5-webcomponents-react/packages/base/dist/internal/types/CommonProps.d.ts`,name:`CommonProps`}],description:`CSS Class Name which will be appended to the most outer element of a component.
