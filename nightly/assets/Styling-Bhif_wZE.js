import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{$h as n,Cg as r,Gi as i,Gm as a,Hi as o,Lm as s,Qh as c,Sg as l,Vm as u,Wi as d,Zh as f,bg as p,u as m,v as h,vg as g,xg as _,yg as v}from"./iframe-SiYJ5RKc.js";import{r as y}from"./react-Dqig3Z07.js";import{_ as b,c as x,o as S,t as C}from"./components-_tELz8RA.js";import{_ as w,d as T}from"./blocks-BaesIhyX.js";import{i as E,t as D}from"./Card.stories-B-In01VT.js";var O=e((()=>{p(),n(),f()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=e((()=>{O(),p(),n(),f(),l(),g(),j=t(r(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([v,c,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return _(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:a}=i(j.createElement(r,{...n}),{container:n.canvasElement});return a}}])})),V=e((()=>{})),H,U,W,G=e((()=>{B(),E(),V(),H=a(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=e((()=>{})),q,J,Y=e((()=>{s(),K(),q=a(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:u.sapNegativeColor,fontSize:u.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(T,{title:`Styling`}),`
...
`,(0,Q.jsx)(S,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;e((()=>{Q=a(),b(),C(),w(),m(),i(),G(),Y()}))();export{Z as default};