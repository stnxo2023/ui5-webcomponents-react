import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$m as n,Fg as r,Ig as i,Lg as a,Pg as o,Rg as s,S as c,ah as l,fg as u,ia as d,lh as f,mg as p,pg as m,ra as h,ta as g,u as _,zg as v}from"./iframe-BjQEXXn3.js";import{J as y,_ as b,d as x}from"./blocks-B0T9nwSL.js";import{E as S,m as C,t as w,u as T}from"./components-V_sO6A2h.js";import{i as E,t as D}from"./Card.stories-C639_pl3.js";var O=t((()=>{i(),p(),u()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=t((()=>{O(),i(),p(),u(),s(),o(),j=e(v(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([r,m,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return a(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:o}=i(j.createElement(r,{...n}),{container:n.canvasElement});return o}}])})),V=t((()=>{})),H,U,W,G=t((()=>{B(),E(),V(),H=f(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=t((()=>{})),q,J,Y=t((()=>{n(),K(),q=f(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:l.sapNegativeColor,fontSize:l.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(x,{title:`Styling`}),`
...
`,(0,Q.jsx)(g,{design:h.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(g,{design:h.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(T,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;t((()=>{Q=f(),S(),w(),b(),_(),d(),G(),Y()}))();export{Z as default};