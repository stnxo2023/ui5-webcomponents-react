import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{$i as n,$m as r,Fg as i,Ig as a,Lg as o,Pg as s,Rg as c,S as l,Zi as u,ah as d,ea as f,fg as p,lh as m,mg as h,pg as g,u as _,zg as v}from"./iframe-nChxGDNm.js";import{J as y,_ as b,d as x}from"./blocks-CaylsL4V.js";import{E as S,m as C,t as w,u as T}from"./components-CDNYHhkB.js";import{i as E,t as D}from"./Card.stories-CJQ3NL_7.js";var O=t((()=>{a(),h(),p()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=t((()=>{O(),a(),h(),p(),c(),s(),j=e(v(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([i,g,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return o(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:a}=i(j.createElement(r,{...n}),{container:n.canvasElement});return a}}])})),V=t((()=>{})),H,U,W,G=t((()=>{B(),E(),V(),H=m(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=t((()=>{})),q,J,Y=t((()=>{r(),K(),q=m(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:d.sapNegativeColor,fontSize:d.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(x,{title:`Styling`}),`
...
`,(0,Q.jsx)(u,{design:n.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(u,{design:n.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(T,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;t((()=>{Q=m(),S(),w(),b(),_(),f(),G(),Y()}))();export{Z as default};