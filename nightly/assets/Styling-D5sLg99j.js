import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{Fm as n,Gi as r,Hi as i,Jh as a,Jm as o,Rm as s,Wi as c,Yh as l,_g as u,gg as d,hg as f,mg as p,qh as m,u as h,v as g,vg as _,yg as v}from"./iframe-8omsyga4.js";import{r as y}from"./react-XCx-583W.js";import{_ as b,c as x,o as S,t as C}from"./components-HyiSUBKC.js";import{_ as w,d as T}from"./blocks-C3rN6920.js";import{i as E,t as D}from"./Card.stories-CfS41w6y.js";var O=e((()=>{d(),l(),m()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=e((()=>{O(),d(),l(),m(),_(),p(),j=t(v(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([f,a,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return u(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:a}=i(j.createElement(r,{...n}),{container:n.canvasElement});return a}}])})),V=e((()=>{})),H,U,W,G=e((()=>{B(),E(),V(),H=o(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=e((()=>{})),q,J,Y=e((()=>{n(),K(),q=o(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:s.sapNegativeColor,fontSize:s.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(T,{title:`Styling`}),`
...
`,(0,Q.jsx)(S,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;e((()=>{Q=o(),b(),C(),w(),h(),r(),G(),Y()}))();export{Z as default};