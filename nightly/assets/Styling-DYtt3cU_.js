import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{t as n}from"./react-IGKVQItS.js";import{c as r}from"./hooks-D22rlZKV.js";import{t as i}from"./src-Gav-45Oq.js";import{t as a}from"./jsx-runtime-O9QVJvLM.js";import{i as o,r as s,t as c}from"./MessageStrip-BJ04gffT.js";import{$t as l,Cn as u,S as d,Sn as f,Tn as p,en as m,tn as h,u as g,wn as _,xn as v}from"./iframe-CkFIdUqc.js";import{A as y,_ as b,d as x}from"./blocks-CPeRNyGc.js";import{E as S,m as C,t as w,u as T}from"./components-u94k_Ttd.js";import{i as E,t as D}from"./Card.stories-CeQDWf6W.js";var O=t((()=>{u(),h(),l()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=t((()=>{O(),u(),h(),l(),p(),v(),j=e(n(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([f,m,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return _(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:a}=i(j.createElement(r,{...n}),{container:n.canvasElement});return a}}])})),V=t((()=>{})),H,U,W,G=t((()=>{B(),E(),V(),H=a(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=t((()=>{})),q,J,Y=t((()=>{i(),K(),q=a(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:r.sapNegativeColor,fontSize:r.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(x,{title:`Styling`}),`
...
`,(0,Q.jsx)(c,{design:s.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(c,{design:s.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(T,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;t((()=>{Q=a(),S(),w(),b(),g(),o(),G(),Y()}))();export{Z as default};