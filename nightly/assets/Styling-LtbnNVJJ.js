import{c as e,i as t}from"./preload-helper-usAeo7Bx.js";import{Bg as n,Hg as r,S as i,Ug as a,Vg as o,Wg as s,_g as c,ea as l,ih as u,mh as d,na as f,ra as p,u as m,uh as h,vg as g,yg as _,zg as v}from"./iframe-BDbTYUx3.js";import{J as y,_ as b,d as x}from"./blocks-CEUs4uB9.js";import{E as S,m as C,t as w,u as T}from"./components-DRvxsiZQ.js";import{i as E,t as D}from"./Card.stories-U_2EUand.js";var O=t((()=>{o(),_(),c()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=t((()=>{O(),o(),_(),c(),a(),v(),j=e(s(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([n,g,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return r(e,t);let{storyContext:{context:n,unboundStoryFn:i,testingLibraryRender:a}}=e,{unmount:o}=a(j.createElement(i,{...n}),{container:n.canvasElement});return o}}])})),V=t((()=>{})),H,U,W,G=t((()=>{B(),E(),V(),H=d(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=t((()=>{})),q,J,Y=t((()=>{u(),K(),q=d(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:h.sapNegativeColor,fontSize:h.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(x,{title:`Styling`}),`
...
`,(0,Q.jsx)(l,{design:f.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(l,{design:f.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(T,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;t((()=>{Q=d(),S(),w(),b(),m(),p(),G(),Y()}))();export{Z as default};