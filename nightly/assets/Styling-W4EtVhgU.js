import{c as e,i as t}from"./preload-helper-DbRxMUml.js";import{$h as n,Ah as r,Dm as i,Fm as a,Mh as o,Qh as s,Xi as c,Yi as l,Zh as u,eg as d,jh as f,jm as p,ng as m,qi as h,tg as g,u as _,y as v}from"./iframe-X7avqMno.js";import{J as y,_ as b,d as x}from"./blocks-Cl71TAIj.js";import{_ as S,c as C,o as w,t as T}from"./components-BU33mAmR.js";import{i as E,t as D}from"./Card.stories-c9P7nsYM.js";var O=t((()=>{n(),o(),r()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=t((()=>{O(),n(),o(),r(),g(),u(),j=e(m(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([s,f,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return d(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:i}}=e,{unmount:a}=i(j.createElement(r,{...n}),{container:n.canvasElement});return a}}])})),V=t((()=>{})),H,U,W,G=t((()=>{B(),E(),V(),H=a(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=t((()=>{})),q,J,Y=t((()=>{i(),K(),q=a(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:p.sapNegativeColor,fontSize:p.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(x,{title:`Styling`}),`
...
`,(0,Q.jsx)(h,{design:l.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(h,{design:l.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(w,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;t((()=>{Q=a(),S(),T(),b(),_(),c(),G(),Y()}))();export{Z as default};