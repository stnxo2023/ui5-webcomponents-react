import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Cg as n,Dg as r,Eg as i,Gi as a,Hi as o,Hm as s,Km as c,Og as l,Tg as u,Wi as d,Xm as f,ig as p,ng as m,rg as h,u as g,v as _,wg as v}from"./iframe-D_P1xdep.js";import{r as y}from"./react-C7u9R2dD.js";import{_ as b,c as x,o as S,t as C}from"./components-Bu3Pz_Bo.js";import{_ as w,d as T}from"./blocks-D-43kzqo.js";import{i as E,t as D}from"./Card.stories-DrydQHSb.js";var O=e((()=>{u(),p(),m()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=e((()=>{O(),u(),p(),m(),r(),n(),j=t(l(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([v,h,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return i(e,t);let{storyContext:{context:n,unboundStoryFn:r,testingLibraryRender:a}}=e,{unmount:o}=a(j.createElement(r,{...n}),{container:n.canvasElement});return o}}])})),V=e((()=>{})),H,U,W,G=e((()=>{B(),E(),V(),H=f(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=e((()=>{})),q,J,Y=e((()=>{s(),K(),q=f(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:c.sapNegativeColor,fontSize:c.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(T,{title:`Styling`}),`
...
`,(0,Q.jsx)(o,{design:d.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(o,{design:d.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(S,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;e((()=>{Q=f(),b(),C(),w(),g(),a(),G(),Y()}))();export{Z as default};