import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{t as n}from"./react-C184PLS3.js";import{_ as r,f as i,l as a,o,p as s,r as c,s as l,y as u}from"./chunk-CMP5DLKH-DjBTuel4.js";import{a as d}from"./hooks-C4NH65M_.js";import{t as f}from"./src-DY6fv84P.js";import{t as p}from"./jsx-runtime-CNp2Ms8r.js";import{n as m,t as h}from"./src-C9Vl6CeF.js";import{i as g,r as _,t as v}from"./MessageStrip-BSgCRzfP.js";import{r as y}from"./react-CSLkFeD8.js";import{_ as b,c as x,o as S,t as C}from"./components-BN7dHnjB.js";import{_ as w,d as T}from"./blocks-BObCibHN.js";import{a as E,t as D}from"./Card.stories-Cj9bv4zQ.js";var O=e((()=>{s(),l(),c()}));function k(e,t,n,r){return I(e,t,n,globalThis.globalProjectAnnotations??z,r)}function A(e,t){return F(e,t,k)}var j,M,N,P,F,I,L,R,z,B=e((()=>{O(),s(),l(),c(),u(),a(),j=t(n(),1),{global:M}=__STORYBOOK_MODULE_GLOBAL__,{window:N}=M,N&&(N.STORYBOOK_ENV=`react`),{composeConfigs:P,composeStories:F,composeStory:I,setProjectAnnotations:L,setDefaultProjectAnnotations:R}=__STORYBOOK_MODULE_PREVIEW_API__,z=P([i,o,{renderToCanvas:async(e,t)=>{if(e.storyContext.testingLibraryRender==null)return r(e,t);let{storyContext:{context:n,unboundStoryFn:i,testingLibraryRender:a}}=e,{unmount:o}=a(j.createElement(i,{...n}),{container:n.canvasElement});return o}}])})),V=e((()=>{})),H,U,W,G=e((()=>{B(),E(),V(),H=p(),{Default:U}=A(D),W=()=>(0,H.jsx)(`div`,{children:(0,H.jsx)(U,{className:`card`})})})),K=e((()=>{})),q,J,Y=e((()=>{f(),K(),q=p(),J=()=>(0,q.jsx)(`div`,{className:`containerCustomElement`,children:(0,q.jsx)(`span`,{style:{color:d.sapNegativeColor,fontSize:d.sapFontLargeSize},children:`My Text`})})}));function X(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,li:`li`,p:`p`,pre:`pre`,strong:`strong`,ul:`ul`,...y(),...e.components};return(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(T,{title:`Styling`}),`
...
`,(0,Q.jsx)(v,{design:_.Critical,hideCloseButton:!0,children:`While it's easily possible targeting DOM elements and CSS classes of components without a shadow root, modifying internal structures or styles is not officially supported and may break with future updates. Use such changes carefully.`}),`
...
`})}),`
`,(0,Q.jsx)(v,{design:_.Information,hideCloseButton:!0,children:`Whenever possible, override CSS variables through the SAP UI Theme Designer for consistent updates across all components.`}),`
...
`,(0,Q.jsx)(S,{})]})}function Z(e={}){let{wrapper:t}={...y(),...e.components};return t?(0,Q.jsx)(t,{...e,children:(0,Q.jsx)(X,{...e})}):X(e)}var Q;e((()=>{Q=p(),b(),C(),w(),h(),g(),G(),Y()}))();export{Z as default};