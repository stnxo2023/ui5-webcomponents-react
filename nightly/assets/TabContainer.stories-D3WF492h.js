import{b as _,gh as q,f as u,d as S,a as w,c as I,av as O,aA as z,fX as g,w as D,ah as v,j as e}from"./iframe-J46VriOb.js";import{T as y,a as N}from"./Tab-B79-2LKa.js";import{a as R}from"./add-BrxnNVRL.js";import{e as F}from"./employee-t7NEZrh2.js";import{m as C}from"./menu-COxktLq8.js";import{s as $}from"./settings-BtEdrxh5.js";import{a as h,T as t}from"./index-DF6_Ed-H.js";function L(){return _("div",{id:this._id,role:"separator",class:"ui5-tc__separator",ref:this.captureRef.bind(this)})}function P(){return _(q,{id:this._id,class:"ui5-tc__separator",disabled:!0,style:this._forcedStyleInOverflow,ref:this.captureRef.bind(this)})}u("@ui5/webcomponents-theming","sap_horizon",async()=>S);u("@ui5/webcomponents","sap_horizon",async()=>w,"host");const W=`div.ui5-tc__separator{position:relative;width:.5625rem}div.ui5-tc__separator:before{content:" ";position:absolute;width:.0625rem;left:.25rem;top:.5rem;bottom:.5rem;background:var(--sapGroup_TitleBorderColor)}
`;u("@ui5/webcomponents-theming","sap_horizon",async()=>S);u("@ui5/webcomponents","sap_horizon",async()=>w,"host");const H=`[ui5-li-custom].ui5-tc__separator{min-height:.25rem;border-bottom:.0625rem solid var(--sapGroup_TitleBorderColor);margin-inline-start:calc(var(--_ui5-tab-indentation-level) * .5rem);margin-inline-end:.5rem}[ui5-list]>[ui5-li-custom].ui5-tc__separator:first-child{min-height:.5rem}
...
}`,...c.parameters?.docs?.source}}};const Y=["Default","WithTabSeparator","WithNestedTabs"],ie=Object.freeze(Object.defineProperty({__proto__:null,Default:s,WithNestedTabs:c,WithTabSeparator:i,__namedExportsOrder:Y,default:Q},Symbol.toStringTag,{value:"Module"}));export{ie as C,s as D,l as T,i as W,c as a};
