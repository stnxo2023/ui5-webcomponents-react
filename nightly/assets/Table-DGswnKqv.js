import{b as $,Q as X,B as Q,f as k,d as Y,a as J,az as K,c as _,av as Z,aA as O,ap as U,bj as ee,fG as ne,w as L,s as V,aq as te,j as n}from"./iframe-DNJyEiMc.js";import{useMDXComponents as G}from"./index-Buf0tSMZ.js";import{M as oe,C as b,a as ie,D as c,A as d}from"./blocks-Cd1leuxf.js";import"./Tag-D8I94QaD.js";import"./index-BGa7wgQo.js";import{C as le}from"./ControlsWithNote-N22c85bk.js";import{D as se}from"./DocsHeader-DCzU-m5M.js";import{F as ae}from"./Footer-DsUhWQr2.js";import"./CommandsAndQueries-Buhz4vLI.js";import"./PageNotFound-CGNJPiuA.js";import{S as re}from"./SubcomponentsSection-BVy4lpQe.js";import{i as ce,a as de,f as he,e as R,g as y,c as j,d as v}from"./index-BoQvMEQt.js";import{C as A,D as M,G as pe,W as be,V as ue,w as me,d as fe,T as I,a as D,b as N}from"./Table.stories-CjS0XTWF.js";import{T as B}from"./index-BK83oT7F.js";import"./ai-N7ehqNT2.js";import{T as H}from"./index-DvUSfBTI.js";import{T as E}from"./index-DafIFDOE.js";import"./preload-helper-PPVm8Dsz.js";import"./information-CKmAqDt9.js";import"./sys-enter-2-D1jYlQdI.js";import"./alert-BbM4Afj3.js";import"./index-C8jwJsjc.js";import"./index-CRk1MYZt.js";import"./Link-CHa9FW0P.js";import"./copy-DoBoCPeV.js";import"./copy-DriogBoE.js";import"./GitHub-Mark-B_5l0O_V.js";import"./TableOfContent-Cp2ISJUt.js";import"./index-DbBWaCWe.js";import"./index-DfQ2RFhn.js";import"./index-bWFHrqMY.js";import"./index-DcpLgbSq.js";import"./index-BNiXpovA.js";import"./AvatarSize-BtKTMFJ5.js";import"./employee-Cm_sH4gX.js";import"./addCustomCSSWithScoping-QHxNEQro.js";import"./Illustrations-8c1koKlL.js";import"./i18n-defaults-CFWtSmu6.js";import"./query-CzSBusdE.js";import"./overflow-o05Wpc5P.js";import"./sort-descending-24nWTAR8.js";import"./IconDesign-DXd8PPVF.js";import"./Friends500-CRbR9XAn.js";import"./index-CKPijgn-.js";import"./SegmentedButton-BIM0H3kM.js";import"./navigation-right-arrow-e5CJ7iL-.js";import"./TableSelectionBase-JrOXeGqs.js";function we(){return $(Q,{icon:this._icon,tooltip:this._tooltip,onClick:this._onClick,design:X.Transparent})}k("@ui5/webcomponents-theming","sap_horizon",async()=>Y);k("@ui5/webcomponents","sap_horizon",async()=>J,"host");const ge=`:host{flex-shrink:0}:host([_popin]){margin-inline:.0625rem 0}[ui5-button]{min-width:1.625rem;width:1.625rem;height:1.625rem}[ui5-button]::part(icon){width:1rem;height:1rem}:host([_popin]) [ui5-button]::part(icon){width:.75rem;height:.75rem}
`;var Te=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var r=l.length-1;r>=0;r--)(a=l[r])&&(i=(s<3?a(i):s>3?a(e,t,i):a(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};let T=class extends O{onBeforeRendering(){this.toggleAttribute("_popin",!this.parentElement)}_onClick(e){(this.parentElement?.hasAttribute("ui5-table-header-cell")?this:this.getRootNode().host._headerCell.action[0]).fireDecoratorEvent("click",{targetRef:e.target}),e.stopPropagation()}get accessibilityInfo(){return{description:U()?.hasAttribute("ui5-table-cell-base")?this._tooltip:""}}get _tooltip(){return this.getRenderInfo().tooltip}get _icon(){return this.getRenderInfo().icon}};T=Te([K("click",{bubbles:!1}),_({renderer:Z,styles:ge,template:we})],T);const xe=T;var z=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var r=l.length-1;r>=0;r--)(a=l[r])&&(i=(s<3?a(i):s>3?a(e,t,i):a(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i},x;let w=x=class extends xe{onAfterRendering(){super.onAfterRendering(),this.toggleAttribute("_popin",!this.parentElement?.hasAttribute("ui5-table-header-cell"))}getRenderInfo(){return{icon:"ai",tooltip:x.i18nBundle.getText(ne)}}};z([ee("@ui5/webcomponents")],w,"i18nBundle",void 0);w=x=z([_({tag:"ui5-table-header-cell-action-ai"})],w);w.define();const u=L("ui5-table-header-cell-action-ai",[],[],[],["click"]);u.displayName="TableHeaderCellActionAI";try{u.displayName="TableHeaderCellActionAI",u.__docgenInfo={description:`The \`TableHeaderCellActionAI\` component defines a dedicated AI action for the table column.



__Note:__ This is a UI5 Web Component! [TableHeaderCellActionAI UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/TableHeaderCellActionAI) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"TableHeaderCellActionAI",props:{onClick:{defaultValue:null,description:`Fired when a header cell action is clicked.
...
`,n.jsx(c,{of:f}),`
`,n.jsx(d,{of:f}),`
`,n.jsx(ae,{})]})}function gn(l={}){const{wrapper:e}={...G(),...l.components};return e?n.jsx(e,{...l,children:n.jsx(P,{...l})}):P(l)}export{gn as default};
