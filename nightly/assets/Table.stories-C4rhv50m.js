...
__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"TableGrowing",props:{onLoadMore:{defaultValue:null,description:`Fired when the growing button is pressed or the user scrolls to the end of the table.
...
__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"TableVirtualizer",props:{onRangeChange:{defaultValue:null,description:`Fired when the virtualizer is changed by user interaction e.g. on scrolling.
...
}`,...q.parameters?.docs?.source}}};const Ye=["Default","GrowingTable","WithSelection","VirtualizedTableRows","withRowActions","dragAndDropRows"],ct=Object.freeze(Object.defineProperty({__proto__:null,Default:N,GrowingTable:I,VirtualizedTableRows:B,WithSelection:D,__namedExportsOrder:Ye,default:Je,dragAndDropRows:q,withRowActions:V},Symbol.toStringTag,{value:"Module"}));export{ct as C,N as D,I as G,S as T,B as V,D as W,x as a,C as b,j as c,q as d,V as w};
