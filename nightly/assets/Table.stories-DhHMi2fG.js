...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var $=function(a,t,o,s){var l=arguments.length,n=l<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,o):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,t,o,s);else for(var r=a.length-1;r>=0;r--)(i=a[r])&&(n=(l<3?i(n):l>3?i(t,o,n):i(t,o))||n);return l>3&&n&&Object.defineProperty(t,o,n),n},W;let M=W=class extends De{constructor(){super(...arguments),this.interactive=!1}isFixedAction(){return!0}getRenderInfo(){return{text:this._i18nNavigation,icon:"navigation-right-arrow",interactive:this.interactive}}get _i18nNavigation(){return W.i18nBundle.getText(be)}};$([p({type:Boolean})],M.prototype,"interactive",void 0);$([Z("@ui5/webcomponents")],M,"i18nBundle",void 0);M=W=$([z({tag:"ui5-table-row-action-navigation"})],M);M.define();const S=G("ui5-table-row-action-navigation",[],["interactive","invisible"],[],["click"]);S.displayName="TableRowActionNavigation";try{S.displayName="TableRowActionNavigation",S.__docgenInfo={description:`The \`TableRowActionNavigation\` component defines a navigation action for table rows.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var H=function(a,t,o,s){var l=arguments.length,n=l<3?t:s===null?s=Object.getOwnPropertyDescriptor(t,o):s,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(a,t,o,s);else for(var r=a.length-1;r>=0;r--)(i=a[r])&&(n=(l<3?i(n):l>3?i(t,o,n):i(t,o))||n);return l>3&&n&&Object.defineProperty(t,o,n),n},u;(function(a){a[a.None=0]="None",a[a.Next=1]="Next",a[a.Previous=2]="Previous",a[a.Released=4]="Released",a[a.NextReleased=5]="NextReleased",a[a.PreviousReleased=6]="PreviousReleased"})(u||(u={}));let R=class extends te{constructor(){super(),this.rowHeight=45,this.rowCount=100,this.extraRows=0,this.identifier="TableVirtualizer",this._lastRowPosition=0,this._firstRowPosition=0,this._visibleRowCount=0,this._tabBlockingState=u.None,this._onScrollBound=Ie(this._onScroll.bind(this)),this._onRowInvalidateBound=this._onRowInvalidate.bind(this)}onAfterRendering(){this._table&&this._table._invalidate++}onTableAfterRendering(t){if(this._table?this._updateRowsHeight():(this._table=t,this._scrollContainer.addEventListener("scroll",this._onScrollBound,{passive:!0}),this._updateRowsHeight(),this._onScroll()),this._tabBlockingState&u.Released){const o=this._table.rows.at(this._tabBlockingState&u.Next?-1:0),s=k(o).at(this._tabBlockingState&u.Next?0:-1);this._tabBlockingState=u.None,(s||o).focus()}}onExitDOM(){this._table&&(this._scrollContainer.removeEventListener("scroll",this._onScrollBound),this._table=void 0)}reset(){this._lastRowPosition=-1,this._firstRowPosition=-1,this._table&&(this._scrollContainer.scrollTop>0?this._scrollContainer.scrollTop=0:this._onScroll())}get _scrollContainer(){return this._table._tableElement}get _rowsContainer(){return this._table.shadowRoot.getElementById("rows")}_onScroll(){const t=this._table.headerRow[0],o=t.offsetHeight;let s=this._scrollContainer.scrollTop,l=this._scrollContainer.clientHeight;t.sticky?l=Math.max(0,l-o):s=Math.max(0,s-o),this._visibleRowCount=Math.ceil(l/this.rowHeight);let n=Math.floor(s/this.rowHeight)-this.extraRows;n=Math.max(0,n);let i=Math.max(0,n+this._visibleRowCount+2*this.extraRows);i=Math.min(i,this.rowCount),!(this._firstRowPosition===n&&this._lastRowPosition===i)&&(this._lastRowPosition=i,this._firstRowPosition=n,this.fireDecoratorEvent("range-change",{first:n,last:i}))}_updateRowsHeight(){const t=this.rowCount*this.rowHeight;this._rowsContainer.style.height=`${t}px`}_getTransform(){if(!this._table)return;const t=this._table.rows[0];if(t&&t.position!==void 0&&t.position>0)return`translateY(${t.position*this.rowHeight}px)`}_onRowInvalidate(t){t.name==="position"&&(t.target.detachInvalidate(this._onRowInvalidateBound),this._tabBlockingState|=u.Released)}_onKeyDown(t){if(!this._table)return;let o=0;const s=this._table.rows,l=s[0],n=s[s.length-1],i=l.position!==0,r=n.position!==this.rowCount-1,h=this._table._tableNavigation,d=fe();if(ge(t)&&r&&k(this._rowsContainer).pop()===d?(this._tabBlockingState=u.Next,n.attachInvalidate(this._onRowInvalidateBound),o=this.rowHeight):we(t)&&i&&k(this._rowsContainer).shift()===d?(this._tabBlockingState=u.Previous,l.attachInvalidate(this._onRowInvalidateBound),o=this.rowHeight*-1):r&&h._getNavigationItemsOfRow(n).includes(d)?ve(t)||Te(t)?o=this.rowHeight:ye(t)?o=this._visibleRowCount*this.rowHeight:_e(t)&&d===n&&(o=this.rowCount*this.rowHeight):i&&h._getNavigationItemsOfRow(l).includes(d)&&(xe(t)||Se(t)?o=this.rowHeight*-1:Ce(t)?o=this._visibleRowCount*this.rowHeight*-1:Re(t)&&d===l&&(o=this.rowCount*this.rowHeight*-1)),o){const v=this._table.scrollTop;this._scrollContainer.scrollTop+=o,this._scrollContainer.scrollTop!==v&&t.preventDefault()}}};H([p({type:Number})],R.prototype,"rowHeight",void 0);H([p({type:Number})],R.prototype,"rowCount",void 0);H([p({type:Number})],R.prototype,"extraRows",void 0);R=H([z({tag:"ui5-table-virtualizer"}),ee("range-change")],R);R.define();const j=G("ui5-table-virtualizer",["extraRows","rowCount","rowHeight"],[],[],["range-change"]);j.displayName="TableVirtualizer";try{j.displayName="TableVirtualizer",j.__docgenInfo={description:`The \`TableVirtualizer\` component is used inside the \`Table\` to virtualize the table rows, if the \`overflowMode\` property of the table is set to 'Scroll'.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const Ue="save",Ee="M32 363V86q0-23 15.5-38.5T86 32h340q22 0 38 15.5T480 86v340q0 23-16 38.5T426 480H149q-5 0-13-5L37 375q-5-5-5-12zm32-6l91 91h5V320q0-14 9-23t23-9h128q13 0 22.5 9t9.5 23v128h74q9 0 15.5-6.5T448 426V86q0-9-6.5-15.5T426 64h-42v128q0 14-9.5 23t-22.5 9H160q-14 0-23-9t-9-23V64H86q-9 0-15.5 6.5T64 86v271zm96-293v128h192V64H160zm160 384V320H192v128h128zm-96-56v-48q0-8 7-8h17q8 0 8 8v48q0 8-8 8h-17q-7 0-7-8z",Ae=!1,Pe=oe,ze="SAP-icons-v4",Ge="@ui5/webcomponents-icons";ne(Ue,{pathData:Ee,ltr:Ae,accData:Pe,collection:ze,packageName:Ge});const He="save",Fe="M505 151q7 9 7 19v252q0 38-26 64t-64 26H90q-38 0-64-26T0 422V90q0-38 26-64T90 0h252q10 0 19 7zm-44 29L332 51H179v90h147q11 0 18.5 7.5T352 167t-7.5 18-18.5 7H153q-11 0-18-7t-7-18V51H90q-17 0-28 11T51 90v332q0 17 11 28t28 11h38V314q0-11 7-18.5t18-7.5h206q11 0 18 7.5t7 18.5v147h38q17 0 28-11t11-28V180zM333 339H179v122h154V339z",Oe=!1,ke=oe,Le="SAP-icons-v5",We="@ui5/webcomponents-icons";ne(He,{pathData:Fe,ltr:Oe,accData:ke,collection:Le,packageName:We});const $e="save",Ke=e.jsxs(se,{sticky:!0,children:[e.jsx(m,{width:"200px",minWidth:"200px",children:e.jsx("span",{children:"Product"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Supplier"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Dimensions"})}),e.jsx(m,{minWidth:"100px",children:e.jsx("span",{children:"Weight"})}),e.jsx(m,{minWidth:"200px",children:e.jsx("span",{children:"Price"})})]}),K=e.jsxs(se,{sticky:!0,children:[e.jsx(m,{children:"Name"}),e.jsx(m,{children:"Age"}),e.jsx(m,{children:"Friend Name"}),e.jsx(m,{children:"Friend Age"})]}),Ye={title:"Data Display / Table",component:y,argTypes:{headerRow:{control:{disable:!0}},features:{control:{disable:!0}},children:{control:{disable:!0}}},args:{headerRow:Ke},tags:["package:@ui5/webcomponents"]},N={render:a=>e.jsxs(y,{...a,children:[e.jsxs(w,{rowKey:"0",children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(c,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(w,{rowKey:"1",children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(c,{children:e.jsx("span",{children:"1249EUR"})})]})]})},I={render:a=>{const[t,o]=f.useState(g.Button),s=r=>new Array(25).fill("").map((h,d)=>e.jsxs(w,{children:[e.jsx(c,{children:e.jsx("span",{children:d+r})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 2"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 3"})}),e.jsx(c,{children:e.jsx("span",{children:"Placeholder 4"})})]},`${d+r}-row`)),[l,n]=f.useState(s(1)),i=()=>{n(r=>[...r,...s(r.length+1)])};return e.jsxs(e.Fragment,{children:[e.jsxs(ie,{showColon:!0,style:{marginInlineEnd:"0.5rem"},children:["Growing ",e.jsx("code",{children:"mode"})]}),e.jsxs(L,{style:{marginBlockEnd:"0.5rem"},onSelectionChange:r=>{o(r.detail.selectedItems[0].textContent)},children:[e.jsx(T,{selected:t===g.Scroll,children:"Scroll"}),e.jsx(T,{selected:t===g.Button,children:"Button"})]}),e.jsx("div",{style:{height:"250px",overflow:"auto"},children:e.jsx(y,{...a,features:e.jsx(x,{onLoadMore:i,mode:t}),children:l})})]})}},D={render(a){const[t,o]=f.useState("Single"),[s,l]=f.useState("RowSelector");return e.jsxs(e.Fragment,{children:[e.jsxs(L,{onSelectionChange:n=>{o(n.detail.selectedItems[0].textContent)},children:[e.jsx(T,{selected:t==="None",children:"None"}),e.jsx(T,{selected:t==="Single",children:"Single"}),e.jsx(T,{selected:t==="Multi",children:"Multi"})]}),e.jsx(ie,{"aria-hidden":!0,style:{marginInline:"0.25rem"},children:"|"}),e.jsxs(L,{onSelectionChange:n=>{l(n.detail.selectedItems[0].textContent)},children:[e.jsx(T,{selected:s==="RowSelector",children:"RowSelector"}),e.jsx(T,{selected:s==="RowOnly",children:"RowOnly"})]}),e.jsxs(y,{...a,features:e.jsxs(e.Fragment,{children:[t==="Single"&&e.jsx(C,{behavior:s}),t==="Multi"&&e.jsx(Ve,{behavior:s})]}),children:[e.jsxs(w,{rowKey:"0",children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(c,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(w,{rowKey:"1",children:[e.jsx(c,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(c,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(c,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(c,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(c,{children:e.jsx("span",{children:"1249EUR"})})]})]})]})}},A=ae.map((a,t)=>({...a,position:t})),B={args:{className:"tableHeightContentDensity",headerRow:K},render(a){const[t,o]=f.useState(A.slice(0,9)),[s,l]=f.useState(!0),n=i=>{const{first:r,last:h}=i.detail,d=Math.max(r-2,0),v=Math.min(h+2,A.length);o(A.slice(d,v))};return f.useEffect(()=>{const i=document.body;if(!i)return;const r=new MutationObserver(h=>{h.forEach(d=>{d.type==="attributes"&&d.attributeName==="class"&&l(!i.classList.contains("ui5-content-density-compact"))})});return r.observe(i,{attributes:!0,attributeFilter:["class"]}),()=>{r.disconnect()}},[]),e.jsx(y,{...a,features:e.jsx(j,{rowCount:500,rowHeight:s?44:32,onRangeChange:n}),children:t.map(i=>e.jsxs(w,{position:i.position,children:[e.jsx(c,{children:e.jsx("span",{children:i.name})}),e.jsx(c,{children:e.jsx("span",{children:i.age})}),e.jsx(c,{children:e.jsx("span",{children:i.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:i.friend.age})})]},i.position))})}},V={args:{headerRow:K,rowActionCount:3},render(a){return e.jsx(y,{...a,children:ae.slice(0,10).map((t,o)=>e.jsxs(w,{actions:e.jsxs(e.Fragment,{children:[e.jsx(Q,{icon:je,text:"Edit"}),e.jsx(Q,{icon:$e,text:"Save"}),e.jsx(S,{interactive:!!(o%2)})]}),children:[e.jsx(c,{children:e.jsx("span",{children:t.name})}),e.jsx(c,{children:e.jsx("span",{children:t.age})}),e.jsx(c,{children:e.jsx("span",{children:t.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:t.friend.age})})]},`${t.name}-${t.age}`))})}},q={args:{headerRow:K},render(a){const[t,o]=f.useState(A.slice(0,10)),s=n=>{const{source:i,destination:r}=n.detail;o(h=>{const d=h.findIndex(F=>`${F.position}`===i.element.dataset.id),v=h.findIndex(F=>`${F.position}`===r.element.dataset.id);if(d===-1||v===-1)return h;const U=[...h],[Y]=U.splice(d,1);return r.placement==="Before"?U.splice(v,0,Y):r.placement==="After"&&U.splice(v+1,0,Y),U})},l=n=>{const{source:i,destination:r}=n.detail;i.element.hasAttribute("ui5-table-row")&&r.element.hasAttribute("ui5-table-row")&&r.placement!=="On"&&n.preventDefault()};return e.jsx(y,{...a,onMove:s,onMoveOver:l,children:t.map(n=>e.jsxs(w,{movable:!0,"data-id":n.position,children:[e.jsx(c,{children:e.jsx("span",{children:n.name})}),e.jsx(c,{children:e.jsx("span",{children:n.age})}),e.jsx(c,{children:e.jsx("span",{children:n.friend.name})}),e.jsx(c,{children:e.jsx("span",{children:n.friend.age})})]},n.position))})}};N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  render: args => {
    return <Table {...args}>
        <TableRow rowKey={'0'}>
          <TableCell>
...
}`,...q.parameters?.docs?.source}}};const Je=["Default","GrowingTable","WithSelection","VirtualizedTableRows","withRowActions","dragAndDropRows"],ct=Object.freeze(Object.defineProperty({__proto__:null,Default:N,GrowingTable:I,VirtualizedTableRows:B,WithSelection:D,__namedExportsOrder:Je,default:Ye,dragAndDropRows:q,withRowActions:V},Symbol.toStringTag,{value:"Module"}));export{ct as C,N as D,I as G,S as T,B as V,D as W,x as a,C as b,j as c,q as d,V as w};
