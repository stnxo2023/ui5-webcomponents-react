...
a growing button will be rendered instead to ensure growing functionality.`,name:"mode",required:!1,type:{name:'"Button" | "Scroll" | TableGrowingMode'}},subtext:{defaultValue:{value:"undefined"},description:"Defines the text that will be displayed below the `text` inside the growing button.\nHas no effect when mode is set to Scroll.",name:"subtext",required:!1,type:{name:"string"}},text:{defaultValue:{value:"undefined"},description:`Defines the text that will be displayed inside the growing button.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var U=function(o,t,s,r){var c=arguments.length,n=c<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,s):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,t,s,r);else for(var l=o.length-1;l>=0;l--)(a=o[l])&&(n=(c<3?a(n):c>3?a(t,s,n):a(t,s))||n);return c>3&&n&&Object.defineProperty(t,s,n),n},L;let I=L=class extends je{constructor(){super(...arguments),this.interactive=!1}isFixedAction(){return!0}getRenderInfo(){return{text:this._i18nNavigation,icon:"navigation-right-arrow",interactive:this.interactive}}get _i18nNavigation(){return L.i18nBundle.getText(ue)}};U([m({type:Boolean})],I.prototype,"interactive",void 0);U([Q("@ui5/webcomponents")],I,"i18nBundle",void 0);I=L=U([F({tag:"ui5-table-row-action-navigation"})],I);I.define();const E=k("ui5-table-row-action-navigation",[],["interactive","invisible"],[],["click"]);E.displayName="TableRowActionNavigation";try{E.displayName="TableRowActionNavigation",E.__docgenInfo={description:`The \`TableRowActionNavigation\` component defines a navigation action for table rows.
...
| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onClick",required:!1,type:{name:"(event: Ui5CustomEvent<TableRowActionNavigationDomRef, never>) => void"}},interactive:{defaultValue:{value:"false"},description:"Defines the interactive state of the navigation action.\n@deprecated As of version 2.20.0, the navigation icon is deprecated.\nFor better accessibility, the interactive mode which renders a button, must be used instead. To handle the action, attach a listener to the `click` event.\nIf the navigation should be triggered when a row is pressed, set the row's `interactive` property and use the `row-click` event of the `ui5-table`.\nThis property will be removed in a future release.",name:"interactive",required:!1,type:{name:"boolean"}},invisible:{defaultValue:{value:"false"},description:`Defines the visibility of the row action.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var H=function(o,t,s,r){var c=arguments.length,n=c<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,s):r,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(o,t,s,r);else for(var l=o.length-1;l>=0;l--)(a=o[l])&&(n=(c<3?a(n):c>3?a(t,s,n):a(t,s))||n);return c>3&&n&&Object.defineProperty(t,s,n),n},u;(function(o){o[o.None=0]="None",o[o.Next=1]="Next",o[o.Previous=2]="Previous",o[o.Released=4]="Released",o[o.NextReleased=5]="NextReleased",o[o.PreviousReleased=6]="PreviousReleased"})(u||(u={}));let C=class extends Z{constructor(){super(),this.rowHeight=45,this.rowCount=100,this.extraRows=0,this.identifier="TableVirtualizer",this._lastRowPosition=0,this._firstRowPosition=0,this._visibleRowCount=0,this._tabBlockingState=u.None,this._onScrollBound=Se(this._onScroll.bind(this)),this._onRowInvalidateBound=this._onRowInvalidate.bind(this)}onAfterRendering(){this._table&&this._table._invalidate++}onTableAfterRendering(t){if(this._table?this._updateRowsHeight():(this._table=t,this._scrollContainer.addEventListener("scroll",this._onScrollBound,{passive:!0}),this._updateRowsHeight(),this._onScroll()),this._tabBlockingState&u.Released){const s=this._table.rows.at(this._tabBlockingState&u.Next?-1:0),r=O(s).at(this._tabBlockingState&u.Next?0:-1);this._tabBlockingState=u.None,(r||s).focus()}}onExitDOM(){this._table&&(this._scrollContainer.removeEventListener("scroll",this._onScrollBound),this._table=void 0)}reset(){this._lastRowPosition=-1,this._firstRowPosition=-1,this._table&&(this._scrollContainer.scrollTop>0?this._scrollContainer.scrollTop=0:this._onScroll())}get _scrollContainer(){return this._table._tableElement}get _rowsContainer(){return this._table.shadowRoot.getElementById("rows")}_onScroll(){const t=this._table.headerRow[0],s=t.offsetHeight;let r=this._scrollContainer.scrollTop,c=this._scrollContainer.clientHeight;t.sticky?c=Math.max(0,c-s):r=Math.max(0,r-s),this._visibleRowCount=Math.ceil(c/this.rowHeight);let n=Math.floor(r/this.rowHeight)-this.extraRows;n=Math.max(0,n);let a=Math.max(0,n+this._visibleRowCount+2*this.extraRows);a=Math.min(a,this.rowCount),!(this._firstRowPosition===n&&this._lastRowPosition===a)&&(this._lastRowPosition=a,this._firstRowPosition=n,this.fireDecoratorEvent("range-change",{first:n,last:a}))}_updateRowsHeight(){const t=this.rowCount*this.rowHeight;this._rowsContainer.style.height=`${t}px`}_getTransform(){if(!this._table)return;const t=this._table.rows[0];if(t&&t.position!==void 0&&t.position>0)return`translateY(${t.position*this.rowHeight}px)`}_onRowInvalidate(t){t.name==="position"&&(t.target.detachInvalidate(this._onRowInvalidateBound),this._tabBlockingState|=u.Released)}_onKeyDown(t){if(!this._table)return;let s=0;const r=this._table.rows,c=r[0],n=r[r.length-1],a=c.position!==0,l=n.position!==this.rowCount-1,h=this._table._tableNavigation,d=pe();if(be(t)&&l&&O(this._rowsContainer).pop()===d?(this._tabBlockingState=u.Next,n.attachInvalidate(this._onRowInvalidateBound),s=this.rowHeight):me(t)&&a&&O(this._rowsContainer).shift()===d?(this._tabBlockingState=u.Previous,c.attachInvalidate(this._onRowInvalidateBound),s=this.rowHeight*-1):l&&h._getNavigationItemsOfRow(n).includes(d)?ge(t)||we(t)?s=this.rowHeight:fe(t)?s=this._visibleRowCount*this.rowHeight:ve(t)&&d===n&&(s=this.rowCount*this.rowHeight):a&&h._getNavigationItemsOfRow(c).includes(d)&&(xe(t)||Te(t)?s=this.rowHeight*-1:_e(t)?s=this._visibleRowCount*this.rowHeight*-1:Ce(t)&&d===c&&(s=this.rowCount*this.rowHeight*-1)),s){const v=this._table.scrollTop;this._scrollContainer.scrollTop+=s,this._scrollContainer.scrollTop!==v&&t.preventDefault()}}};H([m({type:Number})],C.prototype,"rowHeight",void 0);H([m({type:Number})],C.prototype,"rowCount",void 0);H([m({type:Number})],C.prototype,"extraRows",void 0);C=H([F({tag:"ui5-table-virtualizer"}),X("range-change")],C);C.define();const q=k("ui5-table-virtualizer",["extraRows","rowCount","rowHeight"],[],[],["range-change"]);q.displayName="TableVirtualizer";try{q.displayName="TableVirtualizer",q.__docgenInfo={description:`The \`TableVirtualizer\` component is used inside the \`Table\` to virtualize the table rows, if the \`overflowMode\` property of the table is set to 'Scroll'.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const De="save",Ve="M32 363V86q0-23 15.5-38.5T86 32h340q22 0 38 15.5T480 86v340q0 23-16 38.5T426 480H149q-5 0-13-5L37 375q-5-5-5-12zm32-6l91 91h5V320q0-14 9-23t23-9h128q13 0 22.5 9t9.5 23v128h74q9 0 15.5-6.5T448 426V86q0-9-6.5-15.5T426 64h-42v128q0 14-9.5 23t-22.5 9H160q-14 0-23-9t-9-23V64H86q-9 0-15.5 6.5T64 86v271zm96-293v128h192V64H160zm160 384V320H192v128h128zm-96-56v-48q0-8 7-8h17q8 0 8 8v48q0 8-8 8h-17q-7 0-7-8z",Ae=!1,Ee=te,qe="SAP-icons-v4",He="@ui5/webcomponents-icons";ee(De,{pathData:Ve,ltr:Ae,accData:Ee,collection:qe,packageName:He});const Pe="save",Ge="M505 151q7 9 7 19v252q0 38-26 64t-64 26H90q-38 0-64-26T0 422V90q0-38 26-64T90 0h252q10 0 19 7zm-44 29L332 51H179v90h147q11 0 18.5 7.5T352 167t-7.5 18-18.5 7H153q-11 0-18-7t-7-18V51H90q-17 0-28 11T51 90v332q0 17 11 28t28 11h38V314q0-11 7-18.5t18-7.5h206q11 0 18 7.5t7 18.5v147h38q17 0 28-11t11-28V180zM333 339H179v122h154V339z",Oe=!1,ze=te,Le="SAP-icons-v5",Fe="@ui5/webcomponents-icons";ee(Pe,{pathData:Ge,ltr:Oe,accData:ze,collection:Le,packageName:Fe});const ke="save",Ue=e.jsxs(se,{sticky:!0,children:[e.jsx(p,{width:"200px",minWidth:"200px",children:e.jsx("span",{children:"Product"})}),e.jsx(p,{minWidth:"200px",children:e.jsx("span",{children:"Supplier"})}),e.jsx(p,{minWidth:"200px",children:e.jsx("span",{children:"Dimensions"})}),e.jsx(p,{minWidth:"100px",children:e.jsx("span",{children:"Weight"})}),e.jsx(p,{minWidth:"200px",children:e.jsx("span",{children:"Price"})})]}),$=e.jsxs(se,{sticky:!0,children:[e.jsx(p,{children:"Name"}),e.jsx(p,{children:"Age"}),e.jsx(p,{children:"Friend Name"}),e.jsx(p,{children:"Friend Age"})]}),$e={title:"Data Display / Table",component:T,argTypes:{headerRow:{control:{disable:!0}},features:{control:{disable:!0}},children:{control:{disable:!0}}},args:{headerRow:Ue},tags:["package:@ui5/webcomponents"]},y={render:o=>e.jsxs(T,{...o,children:[e.jsxs(f,{rowKey:"0",children:[e.jsx(i,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(i,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(i,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(i,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(i,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(f,{rowKey:"1",children:[e.jsx(i,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(i,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(i,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(i,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(i,{children:e.jsx("span",{children:"1249EUR"})})]})]})},R={render:o=>{const[t,s]=g.useState(w.Button),r=l=>new Array(25).fill("").map((h,d)=>e.jsxs(f,{children:[e.jsx(i,{children:e.jsx("span",{children:d+l})}),e.jsx(i,{children:e.jsx("span",{children:"Placeholder"})}),e.jsx(i,{children:e.jsx("span",{children:"Placeholder 2"})}),e.jsx(i,{children:e.jsx("span",{children:"Placeholder 3"})}),e.jsx(i,{children:e.jsx("span",{children:"Placeholder 4"})})]},`${d+l}-row`)),[c,n]=g.useState(r(1)),a=()=>{n(l=>[...l,...r(l.length+1)])};return e.jsxs(e.Fragment,{children:[e.jsxs(oe,{showColon:!0,style:{marginInlineEnd:"0.5rem"},children:["Growing ",e.jsx("code",{children:"mode"})]}),e.jsxs(z,{style:{marginBlockEnd:"0.5rem"},onSelectionChange:l=>{s(l.detail.selectedItems[0].textContent)},children:[e.jsx(x,{selected:t===w.Scroll,children:"Scroll"}),e.jsx(x,{selected:t===w.Button,children:"Button"})]}),e.jsx("div",{style:{height:"250px",overflow:"auto"},children:e.jsx(T,{...o,features:e.jsx(A,{onLoadMore:a,mode:t}),children:c})})]})}},S={render(o){const[t,s]=g.useState("Single"),[r,c]=g.useState("RowSelector");return e.jsxs(e.Fragment,{children:[e.jsxs(z,{onSelectionChange:n=>{s(n.detail.selectedItems[0].textContent)},children:[e.jsx(x,{selected:t==="None",children:"None"}),e.jsx(x,{selected:t==="Single",children:"Single"}),e.jsx(x,{selected:t==="Multi",children:"Multi"})]}),e.jsx(oe,{"aria-hidden":!0,style:{marginInline:"0.25rem"},children:"|"}),e.jsxs(z,{onSelectionChange:n=>{c(n.detail.selectedItems[0].textContent)},children:[e.jsx(x,{selected:r==="RowSelector",children:"RowSelector"}),e.jsx(x,{selected:r==="RowOnly",children:"RowOnly"})]}),e.jsxs(T,{...o,features:e.jsxs(e.Fragment,{children:[t==="Single"&&e.jsx(Be,{behavior:r}),t==="Multi"&&e.jsx(Ne,{behavior:r})]}),children:[e.jsxs(f,{rowKey:"0",children:[e.jsx(i,{children:e.jsx("span",{children:"Notebook Basic"})}),e.jsx(i,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(i,{children:e.jsx("span",{children:"30 x 18 x 3cm"})}),e.jsx(i,{children:e.jsx("span",{children:"4.2KG"})}),e.jsx(i,{children:e.jsx("span",{children:"956EUR"})})]}),e.jsxs(f,{rowKey:"1",children:[e.jsx(i,{children:e.jsx("span",{children:"Notebook Basic 17HT-1001"})}),e.jsx(i,{children:e.jsx("span",{children:"Very Best Screens"})}),e.jsx(i,{children:e.jsx("span",{children:"29 x 17 x 3.1cm"})}),e.jsx(i,{children:e.jsx("span",{children:"4.5KG"})}),e.jsx(i,{children:e.jsx("span",{children:"1249EUR"})})]})]})]})}},V=ne.map((o,t)=>({...o,position:t})),j={args:{className:"tableHeightContentDensity",headerRow:$},render(o){const[t,s]=g.useState(V.slice(0,9)),[r,c]=g.useState(!0),n=a=>{const{first:l,last:h}=a.detail,d=Math.max(l-2,0),v=Math.min(h+2,V.length);s(V.slice(d,v))};return g.useEffect(()=>{const a=document.body;if(!a)return;const l=new MutationObserver(h=>{h.forEach(d=>{d.type==="attributes"&&d.attributeName==="class"&&c(!a.classList.contains("ui5-content-density-compact"))})});return l.observe(a,{attributes:!0,attributeFilter:["class"]}),()=>{l.disconnect()}},[]),e.jsx(T,{...o,features:e.jsx(q,{rowCount:500,rowHeight:r?44:32,onRangeChange:n}),children:t.map(a=>e.jsxs(f,{position:a.position,children:[e.jsx(i,{children:e.jsx("span",{children:a.name})}),e.jsx(i,{children:e.jsx("span",{children:a.age})}),e.jsx(i,{children:e.jsx("span",{children:a.friend.name})}),e.jsx(i,{children:e.jsx("span",{children:a.friend.age})})]},a.position))})}},N={args:{headerRow:$,rowActionCount:3},render(o){return e.jsx(T,{...o,children:ne.slice(0,10).map((t,s)=>e.jsxs(f,{actions:e.jsxs(e.Fragment,{children:[e.jsx(J,{icon:ye,text:"Edit"}),e.jsx(J,{icon:ke,text:"Save"}),e.jsx(E,{interactive:!!(s%2)})]}),children:[e.jsx(i,{children:e.jsx("span",{children:t.name})}),e.jsx(i,{children:e.jsx("span",{children:t.age})}),e.jsx(i,{children:e.jsx("span",{children:t.friend.name})}),e.jsx(i,{children:e.jsx("span",{children:t.friend.age})})]},`${t.name}-${t.age}`))})}},B={args:{headerRow:$},render(o){const[t,s]=g.useState(V.slice(0,10)),r=n=>{const{source:a,destination:l}=n.detail;s(h=>{const d=h.findIndex(P=>`${P.position}`===a.element.dataset.id),v=h.findIndex(P=>`${P.position}`===l.element.dataset.id);if(d===-1||v===-1)return h;const M=[...h],[K]=M.splice(d,1);return l.placement==="Before"?M.splice(v,0,K):l.placement==="After"&&M.splice(v+1,0,K),M})},c=n=>{const{source:a,destination:l}=n.detail;a.element.hasAttribute("ui5-table-row")&&l.element.hasAttribute("ui5-table-row")&&l.placement!=="On"&&n.preventDefault()};return e.jsx(T,{...o,onMove:r,onMoveOver:c,children:t.map(n=>e.jsxs(f,{movable:!0,"data-id":n.position,children:[e.jsx(i,{children:e.jsx("span",{children:n.name})}),e.jsx(i,{children:e.jsx("span",{children:n.age})}),e.jsx(i,{children:e.jsx("span",{children:n.friend.name})}),e.jsx(i,{children:e.jsx("span",{children:n.friend.age})})]},n.position))})}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: args => {
    return <Table {...args}>
        <TableRow rowKey={'0'}>
          <TableCell>
...
}`,...B.parameters?.docs?.source}}};const Ke=["Default","GrowingTable","WithSelection","VirtualizedTableRows","withRowActions","dragAndDropRows"],it=Object.freeze(Object.defineProperty({__proto__:null,Default:y,GrowingTable:R,VirtualizedTableRows:j,WithSelection:S,__namedExportsOrder:Ke,default:$e,dragAndDropRows:B,withRowActions:N},Symbol.toStringTag,{value:"Module"}));export{it as C,y as D,R as G,E as T,j as V,S as W,A as a,q as b,B as d,N as w};
