import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{n as t,t as n}from"./withWebComponent-CAFYyfUs.js";import{n as r}from"./Tag-BVV5uxXb.js";var i;function a(){return(a=e((()=>{r(),n(),i=t(`ui5-tag`,[`colorScheme`,`design`,`size`,`wrappingType`],[`hideStateIcon`,`interactive`],[`icon`],[`click`]),i.displayName=`Tag`;try{i.displayName=`Tag`,i.__docgenInfo={description:`The \`Tag\` is a component which serves
...
**Note:** Available since [v1.22.0](https://github.com/UI5/webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Tag/index.d.ts`,name:`TagAttributes`},required:!1,tags:{default:`"Neutral"`},type:{name:`enum`,raw:`"Positive" | "Critical" | "Negative" | "Information" | "Neutral" | TagDesign | "Set1" | "Set2"`,value:[{value:`"Positive"`},{value:`"Critical"`},{value:`"Negative"`},{value:`"Information"`},{value:`"Neutral"`},{value:`"Set1"`,description:`Set1 of generic indication colors that are intended for industry-specific use cases`,fullComment:`Set1 of generic indication colors that are intended for industry-specific use cases
