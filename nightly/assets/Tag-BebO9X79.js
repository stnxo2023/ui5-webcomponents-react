import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./src-DJCtxxWg.js";import{n}from"./withWebComponent-CbYRtXps.js";import{n as r}from"./Tag-BL2z3FPm.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tag`,[`colorScheme`,`design`,`size`,`wrappingType`],[`hideStateIcon`,`interactive`],[`icon`],[`click`]),i.displayName=`Tag`;try{i.displayName=`Tag`,i.__docgenInfo={description:`The \`Tag\` is a component which serves
...
**Note:** Available since [v1.22.0](https://github.com/UI5/webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:`design`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Tag/index.d.ts`,name:`TagAttributes`},required:!1,tags:{default:`"Neutral"`},type:{name:`enum`,raw:`"Critical" | "Neutral" | "Information" | "Positive" | "Negative" | TagDesign | "Set1" | "Set2"`,value:[{value:`"Critical"`},{value:`"Neutral"`},{value:`"Information"`},{value:`"Positive"`},{value:`"Negative"`},{value:`"Set1"`,description:`Set1 of generic indication colors that are intended for industry-specific use cases`,fullComment:`Set1 of generic indication colors that are intended for industry-specific use cases
...
**Note:** Available since [v1.22.0](https://github.com/UI5/webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:`wrappingType`,parent:{fileName:`ui5-webcomponents-react/packages/main/dist/webComponents/Tag/index.d.ts`,name:`TagAttributes`},required:!1,tags:{default:`"Normal"`},type:{name:`enum`,raw:`"None" | "Normal" | WrappingType`,value:[{value:`"None"`},{value:`"Normal"`},{value:`"None"`,description:`The text will be truncated with an ellipsis.`,fullComment:`The text will be truncated with an ellipsis.
