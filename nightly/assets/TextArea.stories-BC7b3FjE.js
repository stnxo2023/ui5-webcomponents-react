import{p as x,d as L,c as r,s as c,m as D,ai as R,l as v,ag as j,b6 as y,a1 as re,cC as le,gM as O,aq as ue,b4 as ce,bC as de,B as pe,w as he,cB as me,r as C,gN as fe,j as M,X as ge}from"./iframe-CJIrZBlB.js";import{T as be,t as ve,a as ye}from"./TextArea-DMxqE92z.js";import{d as U,V as $,e as K,f as we,g as xe,W as _e,h as X,i as Te,j as Se,k as Ne,l as Ve}from"./parameters-bundle.css-LNoaTEUu.js";import{v as Ae}from"./ValueStateMessage.css-MyCATZT_.js";import{p as Ce}from"./InvisibleMessage-PB9O_FfW.js";import{T as J,b as V,c as Q}from"./ToolbarButton-4vP3Ae18.js";import"./navigation-left-arrow-CclpnnLM.js";import"./navigation-right-arrow-CrzwDQrl.js";import{T as Y}from"./ToolbarSpacer-4-WQrz8_.js";import"./ai-B4D7vg74.js";import"./stop-D_ZL6Z2q.js";import{M as Ie}from"./index-CrPsJfJo.js";x("@ui5/webcomponents-theming","sap_horizon",async()=>L);x("@ui5/webcomponents-ai","sap_horizon",async()=>U);const De=`.ui5-ai-textarea-root{position:relative;display:flex;flex-direction:column;width:100%;height:100%}.ui5-ai-textarea-root .ui5-textarea-wrapper{display:flex;flex-direction:column;flex:1;position:relative}.ui5-ai-textarea-root [part=footer]{position:relative;width:100%;margin-top:auto;flex-shrink:0}.ui5-ai-writing-assistant-footer-bar{background:var(--_ui5-v2-16-1_texteditor_toolbar_background, var(--sapPageFooter_Background));width:100%;box-sizing:border-box;box-shadow:none;border-bottom:none;border-top:none}.ui5-ai-writing-assistant-footer-bar--with-border{border-top:1px solid var(--sapPageFooter_BorderColor)}.ui5-ai-writing-assistant-action-label{margin-left:.5rem;color:var(--sapContent_LabelColor);font-size:var(--sapFontSmallSize)}#ai-menu-wrapper{position:relative;z-index:1000}
...
In this case, only the "Negative" state is considered and can be applied.`,name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Critical"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Information"'}]}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
