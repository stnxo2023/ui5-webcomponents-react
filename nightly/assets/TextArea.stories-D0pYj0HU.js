import{a as e,c as t,i as n}from"./preload-helper-DbRxMUml.js";import{Bp as r,Dm as i,Fm as a,Fn as o,Fp as s,Fu as c,Hp as l,Ht as u,In as ee,Ip as d,Km as f,Ln as p,Lp as m,Od as te,Pm as h,Pn as ne,Pu as re,Rn as ie,Rp as g,Ru as ae,Vp as _,_u as v,am as y,an as oe,ap as se,bh as b,bu as ce,cm as x,cp as le,dm as S,fm as C,fp as ue,gu as w,hh as T,hn as de,i as fe,in as pe,ip as me,kd as he,lm as E,lp as ge,mh as _e,mn as ve,ng as ye,nr as be,om as D,pp as xe,qm as Se,r as Ce,ra as we,rm as Te,s as Ee,sd as De,sm as Oe,ta as ke,u as Ae,um as O,xh as k,xu as je,zn as Me,zp as A}from"./iframe-YJobrol7.js";import{_ as Ne,d as Pe,f as Fe,g as Ie,h as Le,l as Re,m as ze,n as j,p as Be,t as M,u as Ve,v as He,y as N}from"./parameters-bundle.css-CVWygknX.js";import{t as Ue}from"./navigation-left-arrow-D5uUhvQp.js";var We,Ge=n((()=>{k(),_(),M(),b(`@ui5/webcomponents-theming`,`sap_horizon`,async()=>l),b(`@ui5/webcomponents-ai`,`sap_horizon`,async()=>j,`host`),We=`.ui5-ai-textarea-root{position:relative;display:flex;flex-direction:column;width:100%;height:100%}.ui5-ai-textarea-root .ui5-textarea-wrapper{display:flex;flex-direction:column;flex:1;position:relative}.ui5-ai-textarea-root [part=footer]{position:relative;width:100%;margin-top:auto;flex-shrink:0}.ui5-ai-writing-assistant-footer-bar{background:var(--_ui5_texteditor_toolbar_background, var(--sapPageFooter_Background));width:100%;box-sizing:border-box;box-shadow:none;border-bottom:none;border-top:none}.ui5-ai-writing-assistant-footer-bar--with-border{border-top:1px solid var(--sapPageFooter_BorderColor)}.ui5-ai-writing-assistant-action-label{margin-left:.5rem;color:var(--sapContent_LabelColor);font-size:var(--sapFontSmallSize)}#ai-menu-wrapper{position:relative;z-index:1000}
