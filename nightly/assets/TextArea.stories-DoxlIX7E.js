...
In this case, only the "Negative" state is considered and can be applied.`,name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
}`,...N.parameters?.docs?.source}}};const Ue=["Default","WithFakeStream"],ot=Object.freeze(Object.defineProperty({__proto__:null,Default:S,WithFakeStream:N,__namedExportsOrder:Ue,default:Me},Symbol.toStringTag,{value:"Module"}));export{ot as C,S as D,N as W};
