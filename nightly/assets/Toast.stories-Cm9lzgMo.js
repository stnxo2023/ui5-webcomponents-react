import{a as e,c as t,i as n}from"./preload-helper-B45gAKPr.js";import{t as r}from"./react-CymAsZIc.js";import{t as i}from"./jsx-runtime-BBQGix-2.js";import{n as a,t as o}from"./Button-lNskOv91.js";import{n as s,t as c}from"./Toast-BwI89bdL.js";import{r as l}from"./iframe-hQ-XLCGZ.js";var u,d,f=n((()=>{(function(e){e.TopStart=`TopStart`,e.TopCenter=`TopCenter`,e.TopEnd=`TopEnd`,e.MiddleStart=`MiddleStart`,e.MiddleCenter=`MiddleCenter`,e.MiddleEnd=`MiddleEnd`,e.BottomStart=`BottomStart`,e.BottomCenter=`BottomCenter`,e.BottomEnd=`BottomEnd`})(u||={}),d=u})),p=e({Default:()=>_,__namedExportsOrder:()=>v,default:()=>g}),m,h,g,_,v,y=n((()=>{l(),f(),m=t(r(),1),a(),s(),h=i(),g={title:`Modals & Popovers / Toast`,component:c,args:{placement:d.BottomCenter,children:`Toast Text`,open:!1},argTypes:{children:{control:`text`}},parameters:{chromatic:{delay:1e3}},tags:[`package:@ui5/webcomponents`]},_={render(e){let[t,n]=(0,m.useState)(e.open);return(0,m.useEffect)(()=>{n(e.open)},[e.open]),(0,h.jsxs)(`div`,{style:{height:`300px`},children:[(0,h.jsx)(c,{open:t,duration:e.duration,placement:e.placement,onClose:t=>{n(!1),e.onClose(t)},children:e.children}),(0,h.jsx)(o,{onClick:()=>{n(!0)},children:`Show Toast`})]})}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  render(args) {
