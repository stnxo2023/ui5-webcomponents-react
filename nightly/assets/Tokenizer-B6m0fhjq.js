import{i as e}from"./preload-helper-B45gAKPr.js";import{t}from"./src-TC4bZMcJ.js";import{n}from"./withWebComponent-Dg_qWubB.js";import{a as r}from"./Token-DOZ_Cx5E.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),i.displayName=`Tokenizer`;try{i.displayName=`Tokenizer`,i.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
