import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{t}from"./src-8Es5XSt4.js";import{n}from"./withWebComponent-BMwd7QDs.js";import{a as r}from"./Token-DjFwaTiM.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),i.displayName=`Tokenizer`;try{i.displayName=`Tokenizer`,i.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
