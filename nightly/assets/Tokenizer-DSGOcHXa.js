import{i as e}from"./preload-helper-usAeo7Bx.js";import{t}from"./src-Cm81QuNH.js";import{n}from"./withWebComponent-CbYRtXps.js";import{a as r}from"./Token-DGMqqV59.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),i.displayName=`Tokenizer`;try{i.displayName=`Tokenizer`,i.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
