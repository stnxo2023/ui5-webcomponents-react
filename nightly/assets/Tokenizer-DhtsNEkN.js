import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{t}from"./src-gAF68HEc.js";import{n}from"./withWebComponent-Bq8vFkn_.js";import{a as r}from"./Token-D1m99lPa.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),i.displayName=`Tokenizer`;try{i.displayName=`Tokenizer`,i.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
