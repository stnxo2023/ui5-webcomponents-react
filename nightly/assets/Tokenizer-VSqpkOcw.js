import{n as e}from"./chunk-jRWAZmH_.js";import{t}from"./src-Cxylm8f2.js";import{n}from"./withWebComponent-CitBpRh4.js";import{a as r}from"./Token-DOsh_2jX.js";var i,a=e((()=>{r(),t(),i=n(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),i.displayName=`Tokenizer`;try{i.displayName=`Tokenizer`,i.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
