import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{t as n}from"./react-C21x__mS.js";import{n as r,t as i}from"./withWebComponent-CAFYyfUs.js";import{t as a}from"./jsx-runtime-BdxMnOeJ.js";import{n as o,t as s}from"./Text-r9UpFKWI.js";import{n as c,t as l}from"./Label-CJrRnX6Q.js";import{a as u}from"./Token-S2m2x_wB.js";import{n as d,t as f}from"./Token-CcCHjzfM.js";var p;function m(){return(m=e((()=>{u(),i(),p=r(`ui5-tokenizer`,[`accessibleName`,`accessibleNameRef`,`name`],[`disabled`,`multiLine`,`readonly`,`showClearAll`],[],[`selection-change`,`token-delete`]),p.displayName=`Tokenizer`;try{p.displayName=`Tokenizer`,p.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
