import{w as g,j as e,r as u,J as y}from"./iframe-B-pj6tCi.js";import{L as T}from"./index-CBj2QVaO.js";import{T as n}from"./index-BRUZ6ifM.js";import"./Token-CxMiOAAC.js";const o=g("ui5-tokenizer",["accessibleName","accessibleNameRef"],["disabled","multiLine","readonly","showClearAll"],[],["selection-change","token-delete"]);o.displayName="Tokenizer";try{o.displayName="Tokenizer",o.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
...
__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"Tokenizer",props:{children:{defaultValue:null,description:"Defines the tokens to be displayed.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},onSelectionChange:{defaultValue:null,description:`Fired when token selection is changed by user interaction
