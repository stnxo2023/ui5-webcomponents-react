import{w as y,j as e,r as u,K as g}from"./iframe-HT1spLTi.js";import{L as T}from"./index-gqzRfHPw.js";import{T as n}from"./index-a66Z2aLL.js";import"./Token-CJWVjFqm.js";const o=y("ui5-tokenizer",["accessibleName","accessibleNameRef","name"],["disabled","multiLine","readonly","showClearAll"],[],["selection-change","token-delete"]);o.displayName="Tokenizer";try{o.displayName="Tokenizer",o.__docgenInfo={description:`A \`Tokenizer\` is an invisible container for \`Token\`s that supports keyboard navigation and token selection.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const x={title:"Inputs / Tokenizer",component:o,args:{style:{width:"250px"}},tags:["package:@ui5/webcomponents","experimental"]},l={render(a){return e.jsxs(o,{...a,children:[e.jsx(n,{text:"Andorra"}),e.jsx(n,{text:"Bulgaria"}),e.jsx(n,{text:"Canada"}),e.jsx(n,{text:"Denmark"}),e.jsx(n,{text:"Estonia"}),e.jsx(n,{text:"Fiji"}),e.jsx(n,{text:"Ghana"}),e.jsx(n,{text:"India"}),e.jsx(n,{text:"Japan"}),e.jsx(n,{text:"Kenya"}),e.jsx(n,{text:"Luxembourg"}),e.jsx(n,{text:"Mexico"}),e.jsx(n,{text:"Nepal"}),e.jsx(n,{text:"Qatar"}),e.jsx(n,{text:"Uganda"})]})}},r={render(a){const[p,m]=u.useState(["Andorra","Bulgaria","Canada","Denmark","Estonia","Fiji","Ghana","India","Japan","Kenya","Luxembourg","Mexico","Nepal","Qatar","Uganda"]),[h,c]=u.useState([]),f=t=>{a.onTokenDelete(t);const{tokens:i}=t.detail;if(i){const d=i.map(s=>s.text);m(s=>s.filter(k=>!d.includes(k))),c([])}},b=t=>{a.onSelectionChange(t);const{tokens:i}=t.detail;if(i){const d=i.map(s=>s.text);c(d)}};return e.jsxs(e.Fragment,{children:[e.jsx(o,{...a,onTokenDelete:f,onSelectionChange:b,children:p.map(t=>e.jsx(n,{text:t},t))}),e.jsx("br",{}),e.jsxs("div",{style:{display:"flex",gap:"0.2rem"},children:[e.jsx(T,{showColon:!0,children:"Selected countries"}),e.jsx(g,{children:h.join(", ")})]})]})}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render(args) {
