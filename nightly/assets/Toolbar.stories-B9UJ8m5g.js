import{p as g,d as I,b as j,k as E,c as _,s as d,Q as N,m as D,az as T,av as q,w as S,aA as A,j as l,r as R,a4 as B}from"./iframe-DtD6gRbB.js";import{a as x,T as O}from"./index-BC65U3em.js";import{S as F}from"./Select-DTxOAyO4.js";import{O as W}from"./Option-CDh-ocF3.js";import{T as V}from"./ToolbarButton-DOADH3dv.js";import"./ToolbarSpacer-C7WQhzbw.js";g("@ui5/webcomponents-theming","sap_horizon",async()=>I);g("@ui5/webcomponents","sap_horizon",async()=>j);const k=`:host(:not([hidden])){width:100%}:host([is-overflowed]) .ui5-tb-popover-item{align-items:inherit;width:100%}
...
**Note:** Available since [v2.15.0](https://github.com/UI5/webcomponents/releases/tag/v2.15.0) of **@ui5/webcomponents**.`,name:"value",required:!1,type:{name:"string"}},valueState:{defaultValue:{value:'"None"'},description:"Defines the value state of the component.",name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Information"'},{value:'"Critical"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'}]}},width:{defaultValue:{value:"undefined"},description:`Defines the width of the select.
