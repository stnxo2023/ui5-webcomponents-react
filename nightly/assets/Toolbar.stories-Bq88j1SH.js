import{p as g,d as V,b as R,l as E,c as T,s as d,B as C,m as D,at as S,ap as x,w as _,au as j,j as l,r as q,V as W}from"./iframe-C4t4IgBC.js";import{a as P,T as N}from"./index-BPkvO0TI.js";import{S as k}from"./Select-C-ie4pXP.js";import{O as F}from"./Option-BqPc7Xaz.js";import{T as U}from"./ToolbarButton-Dk7VXe3U.js";import"./ToolbarSpacer-Wj_z_xhm.js";g("@ui5/webcomponents-theming","sap_horizon",async()=>V);g("@ui5/webcomponents","sap_horizon",async()=>R);const L=`:host(:not([hidden])){width:100%}:host([is-overflowed]) .ui5-tb-popover-item{align-items:inherit;width:100%}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function z(){return T("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}g("@ui5/webcomponents-theming","sap_horizon",async()=>V);g("@ui5/webcomponents","sap_horizon",async()=>R);const M=`.ui5-tb-separator{height:var(--_ui5-v2-17-0-rc-5-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
