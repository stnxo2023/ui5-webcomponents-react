...
**Note:** Available since [v2.15.0](https://github.com/UI5/webcomponents/releases/tag/v2.15.0) of **@ui5/webcomponents**.`,name:"value",required:!1,type:{name:"string"}},valueState:{defaultValue:{value:'"None"'},description:"Defines the value state of the component.",name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Information"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'}]}},width:{defaultValue:{value:"undefined"},description:`Defines the width of the select.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function L(){return _("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}g("@ui5/webcomponents-theming","sap_horizon",async()=>I);g("@ui5/webcomponents","sap_horizon",async()=>j,"host");const M=`.ui5-tb-separator{height:var(--_ui5-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
`;var U=function(t,e,o,a){var l=arguments.length,n=l<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,i;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,o,a);else for(var s=t.length-1;s>=0;s--)(i=t[s])&&(n=(l<3?i(n):l>3?i(e,o,n):i(e,o))||n);return l>3&&n&&Object.defineProperty(e,o,n),n};let y=class extends V{constructor(){super(...arguments),this.visible=!1}get isSeparator(){return!0}get isInteractive(){return!1}};U([d({type:Boolean})],y.prototype,"visible",void 0);y=U([D({tag:"ui5-toolbar-separator",template:L,renderer:q,styles:[M]})],y);y.define();const v=S("ui5-toolbar-separator",["overflowPriority"],["preventOverflowClosing"],[],[]);v.displayName="ToolbarSeparator";try{v.displayName="ToolbarSeparator",v.__docgenInfo={description:`The \`ToolbarSeparator\` is an element, used for visual separation between two elements.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var C;(function(t){t.Start="Start",t.End="End"})(C||(C={}));const H={title:"Layouts & Floorplans / Toolbar",component:x,argTypes:{children:{control:{disable:!0}}},args:{alignContent:C.Start},tags:["package:@ui5/webcomponents"]},m={render:t=>r.jsxs(x,{...t,children:[r.jsx(O,{text:"Button 1"}),r.jsxs(h,{children:[r.jsx(c,{children:"Option 1"}),r.jsx(c,{children:"Option 2"}),r.jsx(c,{children:"Option 3"})]}),r.jsx(v,{}),r.jsx(w,{}),r.jsx(v,{}),r.jsx(O,{text:"Button 2"}),r.jsxs(h,{children:[r.jsx(c,{children:"Option 1"}),r.jsx(c,{children:"Option 2"}),r.jsx(c,{children:"Option 3"})]})]})},f={name:"Opening Popovers via ToolbarButton",render(t){const[e,o]=R.useState(!1),a=R.useRef(null);return r.jsxs(r.Fragment,{children:[r.jsx(x,{...t,children:r.jsx(O,{onClick:l=>{l.preventDefault();const{targetRef:n}=l.detail;a.current&&(a.current.opener=n,o(!0))},text:"Open Popover"})}),r.jsx(B,{open:e,ref:a,onClose:()=>{o(!1)},children:"Content"})]})}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
