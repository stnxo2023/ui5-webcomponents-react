import{q as d,j as e,Y as o,aJ as P,t as R,ak as _,fD as j,T as c,V as t,I as D,cH as h,N as E}from"./iframe-DBRigOoU.js";import{f as b}from"./favorite-DZG44Kql.js";import{s as A}from"./settings-sLC0oi5G.js";import{D as L}from"./index-lJFxwh7M.js";import{I as k}from"./index-rB7yhNqF.js";import{M as O}from"./index-N9inh6fu.js";import{S as M}from"./index-DWQUGHoP.js";import{S as F}from"./index-Cw4I0T_w.js";import{S as q}from"./index-C4eTaivo.js";import{T as I}from"./index-BSmsbgeq.js";import{u as C,a as H,b as W,c as i,T as S}from"./index-w9CGiUKW.js";const u=d.forwardRef((n,a)=>{const{children:s,...r}=n,{inPopover:l}=C();return e.jsx(o,{...r,ref:a,children:l?s:""})});u.displayName="OverflowToolbarButton";try{u.displayName="OverflowToolbarButton",u.__docgenInfo={description:"The `OverflowToolbarButton` represents a push button that shows its text only when in the overflow area of a `Toolbar`.\n\n__Note:__ This component is only compatible with the `Toolbar` component from the `@ui5/webcomponents-react-compat` package.",displayName:"OverflowToolbarButton",props:{children:{defaultValue:null,description:"Defines the text of the component which is only visible in the overflow area of a `Toolbar`.\n\n**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed as graphical element within the component. The SAP-icons font provides numerous options.
...
**Note:** Available since [v1.23](https://github.com/UI5/webcomponents/releases/tag/v1.23) of **@ui5/webcomponents**.`,name:"accessibleRole",required:!1,type:{name:'ButtonAccessibleRole | "Button" | "Link"'}},accessibilityAttributes:{defaultValue:{value:"{}"},description:`Defines the additional accessibility attributes that will be applied to the component.
