import{w as g,f as O,d as k,a as A,k as F,b as j,s as m,O as q,c as B,av as E,az as _,aA as z,j as t,n as V,a2 as L}from"./iframe-D-ZP0dY4.js";import{C}from"./index-D-CbqEME.js";import{a as H,C as N}from"./index-oQ1x7q8r.js";import{D as $}from"./index-DJtlL8zy.js";import{I as G}from"./index-B4X1hHJn.js";import{a as J,M as I}from"./index-Dg-UkN-_.js";import{R as D}from"./index-9BBQsiLZ.js";import{S as K}from"./index-BRgqeqc7.js";import{a as x,T as P}from"./index-BXJ-Fig3.js";import"./ToolbarSpacer-hroIDuCY.js";import{S as Q}from"./Select-BtxIe5EO.js";import{O as X}from"./Option-CY78tL2o.js";import{T as W}from"./ToolbarButton-C8bStjA0.js";const c=g("ui5-toolbar-item",["overflowPriority"],["preventOverflowClosing"],[],[]);c.displayName="ToolbarItem";try{c.displayName="ToolbarItem",c.__docgenInfo={description:`The \`ToolbarItem\` is a wrapper component used to integrate UI5 Web Components into the \`Toolbar\`.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}O("@ui5/webcomponents-theming","sap_horizon",async()=>k);O("@ui5/webcomponents","sap_horizon",async()=>A,"host");const Y=`:host(:not([hidden])){width:100%}:host([is-overflowed]) .ui5-tb-popover-item{align-items:inherit;width:100%}
...
**Note:** Available since [v2.15.0](https://github.com/UI5/webcomponents/releases/tag/v2.15.0) of **@ui5/webcomponents**.`,name:"value",required:!1,type:{name:"string"}},valueState:{defaultValue:{value:'"None"'},description:"Defines the value state of the component.",name:"valueState",required:!1,type:{name:"enum",value:[{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'},{value:'"None"'},{value:'"Positive"'},{value:'"Critical"'},{value:'"Negative"'},{value:'"Information"'}]}},width:{defaultValue:{value:"undefined"},description:`Defines the width of the select.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function ee(){return j("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}O("@ui5/webcomponents-theming","sap_horizon",async()=>k);O("@ui5/webcomponents","sap_horizon",async()=>A,"host");const te=`.ui5-tb-separator{height:var(--_ui5-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var R;(function(o){o.Start="Start",o.End="End"})(R||(R={}));const oe={title:"Layouts & Floorplans / Toolbar",component:x,argTypes:{children:{control:{disable:!0}}},args:{alignContent:R.Start},tags:["package:@ui5/webcomponents"]},h={render:o=>t.jsxs(x,{...o,children:[t.jsx(P,{text:"Button 1"}),t.jsxs(v,{children:[t.jsx(u,{children:"Option 1"}),t.jsx(u,{children:"Option 2"}),t.jsx(u,{children:"Option 3"})]}),t.jsx(y,{}),t.jsx(S,{}),t.jsx(y,{}),t.jsx(P,{text:"Button 2"}),t.jsxs(v,{children:[t.jsx(u,{children:"Option 1"}),t.jsx(u,{children:"Option 2"}),t.jsx(u,{children:"Option 3"})]})]})},f={name:"Opening Popovers via ToolbarButton",render(o){const[e,n]=V.useState(!1),r=V.useRef(null);return t.jsxs(t.Fragment,{children:[t.jsx(x,{...o,children:t.jsx(P,{onClick:l=>{l.preventDefault();const{targetRef:a}=l.detail;r.current&&(r.current.opener=a,n(!0))},text:"Open Popover"})}),t.jsx(L,{open:e,ref:r,onClose:()=>{n(!1)},children:"Content"})]})}},b={render(o){return t.jsxs(x,{...o,children:[t.jsx(c,{children:t.jsxs("div",{role:"radiogroup","aria-label":"Options",className:"toolbar-item-group",children:[t.jsx(D,{name:"group1",text:"Option 1",checked:!0}),t.jsx(D,{name:"group1",text:"Option 2"}),t.jsx(D,{name:"group1",text:"Option 3"})]})}),t.jsx(c,{children:t.jsxs("div",{role:"group","aria-label":"Checkboxes",className:"toolbar-item-group",children:[t.jsx(C,{text:"Checkbox 1"}),t.jsx(C,{text:"Checkbox 2",checked:!0}),t.jsx(C,{text:"Checkbox 3"})]})}),t.jsx(c,{children:t.jsx(G,{placeholder:"Enter text"})}),t.jsx(c,{children:t.jsxs(H,{placeholder:"Select an option",children:[t.jsx(N,{text:"Option 1"}),t.jsx(N,{text:"Option 2"}),t.jsx(N,{text:"Option 3"})]})}),t.jsx(c,{children:t.jsxs(J,{placeholder:"Select options",children:[t.jsx(I,{text:"Item 1"}),t.jsx(I,{text:"Item 2"}),t.jsx(I,{text:"Item 3"})]})}),t.jsx(c,{children:t.jsx(K,{textOn:"On",textOff:"Off"})}),t.jsx(c,{children:t.jsx($,{placeholder:"Select a date"})})]})}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
