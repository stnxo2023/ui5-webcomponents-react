import{p as g,d as I,b as j,l as E,c as _,s as d,A as N,m as D,az as T,av as q,w as S,aA as A,j as l,r as R,V as B}from"./iframe-BSil-P7u.js";import{a as x,T as O}from"./index-DDLpO6B8.js";import{S as F}from"./Select-DIzgGRIh.js";import{O as W}from"./Option-D_fhd8yQ.js";import{T as V}from"./ToolbarButton-CTvutsjB.js";import"./ToolbarSpacer-CvXPACh_.js";g("@ui5/webcomponents-theming","sap_horizon",async()=>I);g("@ui5/webcomponents","sap_horizon",async()=>j);const z=`:host(:not([hidden])){width:100%}:host([is-overflowed]) .ui5-tb-popover-item{align-items:inherit;width:100%}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function L(){return _("div",{class:"ui5-tb-separator ui5-tb-item","data-ui5-external-action-item-id":this._id})}g("@ui5/webcomponents-theming","sap_horizon",async()=>I);g("@ui5/webcomponents","sap_horizon",async()=>j);const M=`.ui5-tb-separator{height:var(--_ui5-v2-18-0-rc-3-toolbar-separator-height);width:.0625rem;background:var(--sapToolbar_SeparatorColor);box-sizing:border-box}
