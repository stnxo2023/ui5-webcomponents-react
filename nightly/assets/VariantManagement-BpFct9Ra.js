import{i as e}from"./preload-helper-usAeo7Bx.js";import{b as t,it as n,lh as r,ta as i,x as a}from"./iframe-BjQEXXn3.js";import{J as o,_ as s,d as c,n as l,o as u,r as d,u as f}from"./blocks-B0T9nwSL.js";import{E as p,b as m,f as h,t as g,u as _}from"./components-V_sO6A2h.js";import{n as v,t as y}from"./SubcomponentsSection-Da9yr5rF.js";import{Default as b,WithCustomValidation as x,WithFilterBarImplementation as S,n as C,t as w}from"./VariantManagement.stories-BDy5rHg5.js";function T(e){let n={a:`a`,code:`code`,h1:`h1`,h2:`h2`,h3:`h3`,p:`p`,pre:`pre`,strong:`strong`,...o(),...e.components};return(0,D.jsxs)(D.Fragment,{children:[(0,D.jsx)(c,{of:w}),`
...
`,(0,D.jsx)(m,{of:b}),`
`,(0,D.jsx)(n.h1,{id:`more-examples`,children:`More Examples`}),`
`,(0,D.jsx)(n.h2,{id:`variantmanagement-with-custom-input`,children:`VariantManagement with custom Input`}),`
`,(0,D.jsxs)(n.p,{children:[`You can customize the inputs inside the configuration dialogs ("Save View" and "Manage Views") by leveraging the corresponding `,(0,D.jsx)(n.code,{children:`inputProps`}),` prop (`,(0,D.jsx)(n.code,{children:`saveViewInputProps`}),` and `,(0,D.jsx)(n.code,{children:`manageViewsInputProps`}),`) of the `,(0,D.jsx)(n.code,{children:`VariantItem`}),` component.
These props accept props of the `,(0,D.jsx)(n.code,{children:`Input`}),` component with which you are able to overwrite internal implementations. E.g. `,(0,D.jsx)(n.code,{children:`valueState`}),` and `,(0,D.jsx)(n.code,{children:`valueState`}),` message.`]}),`
`,(0,D.jsxs)(n.p,{children:[(0,D.jsx)(n.strong,{children:`Note:`}),` To prevent internal logic from being executed on save click, you can mark the `,(0,D.jsx)(n.code,{children:`onInput`}),` event of the corresponding `,(0,D.jsx)(n.code,{children:`Input`}),` component as invalid by setting `,(0,D.jsx)(n.code,{children:`event.isInvalid = true`}),` inside the respective handler.`]}),`
`,(0,D.jsx)(i,{hideCloseButton:!0,children:`It is possible to overwrite internally used props. Please use with caution!`}),`
`,(0,D.jsx)(d,{of:x,sourceState:`none`}),`
`,(0,D.jsx)(n.h3,{id:`code-example`,children:`Code Example`}),`
`,(0,D.jsxs)(`details`,{style:{marginBlockEnd:`2rem`},children:[(0,D.jsx)(`summary`,{children:`Show Code`}),(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-jsx`,children:`const VariantManagementWithCustomValidation = ({ selectedByIndex = 1 }) => {
...
`})})]}),`
`,(0,D.jsx)(n.h2,{id:`basic-variantmanagement-implementation`,children:`Basic VariantManagement Implementation`}),`
`,(0,D.jsxs)(n.p,{children:[`This example shows how a basic implementation of the `,(0,D.jsx)(n.code,{children:`VariantManagement`}),` inside a `,(0,D.jsx)(n.code,{children:`FilterBar`}),` could look like. For a more in depth documentation you can take a look at the official `,(0,D.jsx)(n.a,{href:`https://experience.sap.com/fiori-design-web/variant-management/`,rel:`nofollow`,children:`Fiori for Web Design Guidelines`}),`.`]}),`
`,(0,D.jsxs)(n.p,{children:[(0,D.jsx)(n.strong,{children:`Note:`}),` All views are applied automatically, so the "Apply Automatically" checkboxes in both dialogs won't be visible.`]}),`
`,(0,D.jsx)(d,{of:S,sourceState:`none`}),`
`,(0,D.jsx)(n.h3,{id:`code-example-1`,children:`Code Example`}),`
`,(0,D.jsxs)(`details`,{style:{marginBlockEnd:`2rem`},children:[(0,D.jsx)(`summary`,{children:`Show Code`}),(0,D.jsx)(n.pre,{children:(0,D.jsx)(n.code,{className:`language-tsx`,children:`function FilterBarWithVariantManagement() {
...
`,(0,D.jsx)(n.h2,{id:`variantitem`,children:`VariantItem`}),`
`,(0,D.jsx)(u,{of:t}),`
`,(0,D.jsx)(l,{of:t}),`
`,(0,D.jsx)(_,{})]})}function E(e={}){let{wrapper:t}={...o(),...e.components};return t?(0,D.jsx)(t,{...e,children:(0,D.jsx)(T,{...e})}):T(e)}var D;e((()=>{D=r(),p(),g(),v(),s(),n(),a(),C()}))();export{E as default};