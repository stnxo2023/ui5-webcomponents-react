import{a as e,c as t,i as n}from"./preload-helper-usAeo7Bx.js";import{$i as r,Bf as i,Fo as a,Ga as o,Gl as s,Io as c,Ja as l,Jd as u,Ka as d,Qi as f,Wl as p,Xa as m,Ya as h,Yd as g,Zi as _,b as v,bu as y,ea as b,et as x,eu as S,f as C,fu as w,ip as T,lh as E,p as D,pu as O,qa as k,rp as A,tt as j,tu as M,vm as N,x as P,xu as F,ym as I,zf as L,zg as R}from"./iframe-BjQEXXn3.js";var z=e({Default:()=>U,WithCustomValidation:()=>W,WithFilterBarImplementation:()=>G,__namedExportsOrder:()=>K,default:()=>H}),B,V,H,U,W,G,K,q=n((()=>{i(),T(),N(),B=t(R(),1),c(),m(),l(),d(),F(),b(),f(),M(),s(),g(),j(),O(),P(),D(),V=E(),H={title:`Inputs / VariantManagement`,component:C,args:{placement:L.Bottom,level:A.H4},tags:[`package:@ui5/webcomponents-react`]},U={render:e=>(0,V.jsxs)(C,{...e,children:[(0,V.jsx)(v,{children:`Default VariantItem`}),(0,V.jsx)(v,{selected:!0,children:`Selected`}),(0,V.jsx)(v,{author:`SAP`,children:`Author`}),(0,V.jsx)(v,{favorite:!0,children:`Favorite`}),(0,V.jsx)(v,{isDefault:!0,children:`IsDefault`}),(0,V.jsx)(v,{favorite:!0,labelReadOnly:!0,children:`Favorite & labelReadOnly`}),(0,V.jsx)(v,{applyAutomatically:!0,children:`ApplyAutomatically`}),(0,V.jsx)(v,{applyAutomatically:!0,applyAutomaticallyText:`Describe your exceptions that deviate from the standard behavior here.`,children:`applyAutomatically & applyAutomaticallyText`}),(0,V.jsx)(v,{readOnly:!0,children:`ReadOnly`}),(0,V.jsx)(v,{global:!0,children:`Global`}),(0,V.jsx)(v,{global:!0,readOnly:!0,children:`Global & readOnly`}),(0,V.jsx)(v,{global:!0,children:`Not deletable -> global`}),(0,V.jsx)(v,{hideDelete:!0,children:`Not deletable -> hideDelete`}),(0,V.jsx)(v,{hideDelete:!1,global:!0,children:`Deletable -> hideDelete: false, global: true`})]})},W={render:({selectedByIndex:e=1})=>{let[t,n]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(void 0),[a,o]=(0,B.useState)({1:`Only alphanumeric chars in Save View input`,2:`Max 12 chars`});return(0,V.jsxs)(C,{onSaveAs:e=>{o(t=>({...t,[e.detail[`data-id`]]:e.detail.children}))},onSaveManageViews:e=>{let t=e.detail.updatedVariants.find(e=>e[`data-custom-manage-views`]);!r&&t&&o(e=>({...e,[t[`data-id`]]:t.children}))},onManageViewsCancel:()=>{i(void 0)},onSaveViewCancel:()=>{n(void 0)},children:[(0,V.jsx)(v,{"data-id":1,selected:e===0,saveViewInputProps:{valueState:t,valueStateMessage:t?(0,V.jsx)(`div`,{children:`Only alphanumeric and space characters allowed!`}):void 0,onInput:e=>{e.target.value.match(/^[a-z0-9\s]+$/i)?(e.isInvalid=!1,n(void 0)):(e.isInvalid=!0,n(I.Negative))},"data-testid":`alphanumeric`},children:a[1]}),(0,V.jsx)(v,{"data-custom-manage-views":!0,"data-id":2,selected:e===1,manageViewsInputProps:{valueState:r,valueStateMessage:r?(0,V.jsx)(`div`,{children:`No more than 12 characters allowed!`}):void 0,onInput:e=>{e.target.value.length>12?(e.isInvalid=!0,i(I.Negative)):(e.isInvalid=!1,i(void 0))},"data-testid":`12chars`},children:a[2]})]})}},G={name:`in FilterBar`,render:()=>{let[e,t]=(0,B.useState)(`Standard`),[n,i]=(0,B.useState)(`Standard`),[s,c]=(0,B.useState)([]),[l,d]=(0,B.useState)(!1),[f,m]=(0,B.useState)(!1),g=(0,B.useRef)({Standard:{selectedCountry:`Indonesia`,date:``,selectedCodes:{}}}),[b,T]=(0,B.useReducer)((e,t)=>{let{payload:n,type:r}=t;switch(m(!0),r){case`selectedCountry`:return{...e,selectedCountry:n};case`date`:return{...e,date:n};case`selectedCodes`:return{...e,selectedCodes:n};case`changeVariant`:return n;default:return console.warn(`Unknown action type!`),e}},g.current.Standard),{selectedCountry:E,date:D,selectedCodes:O}=b;return(0,B.useEffect)(()=>{if(f){let t=Object.entries(g.current[e]).some(([e,t])=>{if(e===`selectedCodes`){let e=Object.keys(b.selectedCodes).length;return Object.keys(t).length===e?Object.entries(b.selectedCodes).some(([e,n])=>t?.[e]!==n):!0}return b[e]!==t});m(!1),d(t)}},[f,e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(x,{header:(0,V.jsxs)(C,{hideApplyAutomatically:!0,dirtyState:l,onSaveAs:e=>{let{variantItem:n,selected:r,readOnly:a,labelReadOnly:o,...s}=e.detail;s.isDefault&&i(s.children),c(e=>[...e,{...s,author:`Current User`}]),g.current[s.children]=b,t(s.children),d(!1)},onSave:e=>{let{variantItem:t,selected:n,...r}=e.detail;g.current[r.children]=b,d(!1)},onSelect:e=>{let n=e.detail.selectedVariant.children;T({type:`changeVariant`,payload:g.current[n]}),t(n)},onSaveManageViews:e=>{let{deletedVariants:n,updatedVariants:r}=e.detail;n.forEach(e=>{delete g.current[e.children],c(t=>t.filter(t=>t.children!==e.children))}),r.forEach(e=>{let{variantItem:n,selected:r,...a}=e;g.current[e.children]=a,e.isDefault&&i(e.children),e.selected&&t(e.children),c(t=>t.map(t=>t.children===e.prevVariant.children?a:t))})},children:[(0,V.jsx)(v,{selected:e===`Standard`,global:!0,isDefault:n===`Standard`,author:`SAP`,readOnly:!0,labelReadOnly:!0,children:`Standard`}),s.map(t=>(0,V.jsx)(v,{...t,selected:e===t.children,isDefault:n===t.children,children:t.children},t.children))]}),children:[(0,V.jsx)(w,{label:`Countries`,filterKey:0,children:(0,V.jsxs)(p,{onChange:e=>{let{selectedOption:t}=e.detail;T({type:`selectedCountry`,payload:t.textContent})},children:[(0,V.jsx)(S,{selected:E===`Indonesia`,children:`Indonesia`}),(0,V.jsx)(S,{selected:E===`Costa Rica`,children:`Costa Rica`}),(0,V.jsx)(S,{selected:E===`Slovakia`,children:`Slovakia`}),(0,V.jsx)(S,{selected:E===`Iceland`,children:`Iceland`}),(0,V.jsx)(S,{selected:E===`Malta`,children:`Malta`}),(0,V.jsx)(S,{selected:E===`Guyana`,children:`Guyana`}),(0,V.jsx)(S,{selected:E===`Spain`,children:`Spain`}),(0,V.jsx)(S,{selected:E===`Austria`,children:`Austria`})]})}),(0,V.jsx)(w,{label:`Date`,filterKey:1,children:(0,V.jsx)(a,{value:D,onChange:e=>{T({type:`date`,payload:e.detail.value})}})}),(0,V.jsx)(w,{label:`Company Code`,filterKey:2,children:(0,V.jsxs)(r,{onSelectionChange:e=>{T({type:`selectedCodes`,payload:e.detail.items.reduce((e,t)=>(e[t.dataset.code]=!0,e),{})})},children:[(0,V.jsx)(_,{text:`001`,selected:O[`001`],"data-code":`001`}),(0,V.jsx)(_,{text:`002`,selected:O[`002`],"data-code":`002`}),(0,V.jsx)(_,{text:`003`,selected:O[`003`],"data-code":`003`}),(0,V.jsx)(_,{text:`004`,selected:O[`004`],"data-code":`004`}),(0,V.jsx)(_,{text:`005`,selected:O[`005`],"data-code":`005`})]})})]}),(0,V.jsxs)(h,{style:{marginBlockStart:`2rem`},layout:`S1 M1 L1 XL1`,labelSpan:`S3 M3 L3 XL3`,children:[(0,V.jsx)(k,{headerText:`Variant`,children:(0,V.jsx)(o,{labelContent:(0,V.jsx)(y,{showColon:!0,children:`Current View`}),children:(0,V.jsx)(u,{children:e})})}),(0,V.jsxs)(k,{headerText:`Filters`,children:[(0,V.jsx)(o,{labelContent:(0,V.jsx)(y,{showColon:!0,children:`Selected Country`}),children:(0,V.jsx)(u,{children:E})}),(0,V.jsx)(o,{labelContent:(0,V.jsx)(y,{showColon:!0,children:`Selected Date`}),children:(0,V.jsx)(u,{children:D})}),(0,V.jsx)(o,{labelContent:(0,V.jsx)(y,{showColon:!0,children:`Selected Company Codes`}),children:(0,V.jsx)(u,{children:Object.keys(O).join(`, `)})})]})]})]})}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  render: args => {
