import{n as e,o as t,r as n}from"./rolldown-runtime-DAXXjFlN.js";import{t as r}from"./react-DEAHbL4P.js";import{c as i,s as a}from"./Popover-Dg-b-4Os.js";import{t as o}from"./jsx-runtime-CFwixLRt.js";import{n as s,t as c}from"./ValueState-D2NAsvuR.js";import{i as l,r as u}from"./Title-CADLdHI1.js";import{n as d,t as f}from"./Text-CO1c46QX.js";import{n as p,t as m}from"./Label-CC-aoGlQ.js";import{n as h,t as g}from"./Option-Ck7h5EAw.js";import{B as _,F as v,I as y,L as b,R as x,z as S}from"./webComponents-BcaeM9G6.js";import{n as C,t as w}from"./Select-D20h_5xr.js";import{n as T,t as E}from"./DatePicker-CaWGYtsn.js";import{i as D,n as O,r as k,t as A}from"./MultiComboBoxItem-BZXN9luR.js";import{J as j,U as M,W as N,d as P,f as F,m as I,p as L,q as R}from"./iframe-DB_r2er9.js";var z=n({Default:()=>U,WithCustomValidation:()=>W,WithFilterBarImplementation:()=>G,__namedExportsOrder:()=>K,default:()=>H}),B,V,H,U,W,G,K,q=e((()=>{i(),l(),c(),B=t(r(),1),T(),_(),x(),y(),p(),D(),O(),h(),C(),d(),N(),j(),I(),F(),V=o(),H={title:`Inputs / VariantManagement`,component:P,args:{placement:a.Bottom,level:u.H4},tags:[`package:@ui5/webcomponents-react`]},U={render:e=>(0,V.jsxs)(P,{...e,children:[(0,V.jsx)(L,{children:`Default VariantItem`}),(0,V.jsx)(L,{selected:!0,children:`Selected`}),(0,V.jsx)(L,{author:`SAP`,children:`Author`}),(0,V.jsx)(L,{favorite:!0,children:`Favorite`}),(0,V.jsx)(L,{isDefault:!0,children:`IsDefault`}),(0,V.jsx)(L,{favorite:!0,labelReadOnly:!0,children:`Favorite & labelReadOnly`}),(0,V.jsx)(L,{applyAutomatically:!0,children:`ApplyAutomatically`}),(0,V.jsx)(L,{applyAutomatically:!0,applyAutomaticallyText:`Describe your exceptions that deviate from the standard behavior here.`,children:`applyAutomatically & applyAutomaticallyText`}),(0,V.jsx)(L,{readOnly:!0,children:`ReadOnly`}),(0,V.jsx)(L,{global:!0,children:`Global`}),(0,V.jsx)(L,{global:!0,readOnly:!0,children:`Global & readOnly`}),(0,V.jsx)(L,{global:!0,children:`Not deletable -> global`}),(0,V.jsx)(L,{hideDelete:!0,children:`Not deletable -> hideDelete`}),(0,V.jsx)(L,{hideDelete:!1,global:!0,children:`Deletable -> hideDelete: false, global: true`})]})},W={render:({selectedByIndex:e=1})=>{let[t,n]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(void 0),[a,o]=(0,B.useState)({1:`Only alphanumeric chars in Save View input`,2:`Max 12 chars`});return(0,V.jsxs)(P,{onSaveAs:e=>{o(t=>({...t,[e.detail[`data-id`]]:e.detail.children}))},onSaveManageViews:e=>{let t=e.detail.updatedVariants.find(e=>e[`data-custom-manage-views`]);!r&&t&&o(e=>({...e,[t[`data-id`]]:t.children}))},onManageViewsCancel:()=>{i(void 0)},onSaveViewCancel:()=>{n(void 0)},children:[(0,V.jsx)(L,{"data-id":1,selected:e===0,saveViewInputProps:{valueState:t,valueStateMessage:t?(0,V.jsx)(`div`,{children:`Only alphanumeric and space characters allowed!`}):void 0,onInput:e=>{e.target.value.match(/^[a-z0-9\s]+$/i)?(e.isInvalid=!1,n(void 0)):(e.isInvalid=!0,n(s.Negative))},"data-testid":`alphanumeric`},children:a[1]}),(0,V.jsx)(L,{"data-custom-manage-views":!0,"data-id":2,selected:e===1,manageViewsInputProps:{valueState:r,valueStateMessage:r?(0,V.jsx)(`div`,{children:`No more than 12 characters allowed!`}):void 0,onInput:e=>{e.target.value.length>12?(e.isInvalid=!0,i(s.Negative)):(e.isInvalid=!1,i(void 0))},"data-testid":`12chars`},children:a[2]})]})}},G={name:`in FilterBar`,render:()=>{let[e,t]=(0,B.useState)(`Standard`),[n,r]=(0,B.useState)(`Standard`),[i,a]=(0,B.useState)([]),[o,s]=(0,B.useState)(!1),[c,l]=(0,B.useState)(!1),u=(0,B.useRef)({Standard:{selectedCountry:`Indonesia`,date:``,selectedCodes:{}}}),[d,p]=(0,B.useReducer)((e,t)=>{let{payload:n,type:r}=t;switch(l(!0),r){case`selectedCountry`:return{...e,selectedCountry:n};case`date`:return{...e,date:n};case`selectedCodes`:return{...e,selectedCodes:n};case`changeVariant`:return n;default:return console.warn(`Unknown action type!`),e}},u.current.Standard),{selectedCountry:h,date:_,selectedCodes:y}=d;return(0,B.useEffect)(()=>{if(c){let t=Object.entries(u.current[e]).some(([e,t])=>{if(e===`selectedCodes`){let e=Object.keys(d.selectedCodes).length;return Object.keys(t).length!==e||Object.entries(d.selectedCodes).some(([e,n])=>t?.[e]!==n)}return d[e]!==t});l(!1),s(t)}},[c,e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(M,{header:(0,V.jsxs)(P,{hideApplyAutomatically:!0,dirtyState:o,onSaveAs:e=>{let{variantItem:n,selected:i,readOnly:o,labelReadOnly:c,...l}=e.detail;l.isDefault&&r(l.children),a(e=>[...e,{...l,author:`Current User`}]),u.current[l.children]=d,t(l.children),s(!1)},onSave:e=>{let{variantItem:t,selected:n,...r}=e.detail;u.current[r.children]=d,s(!1)},onSelect:e=>{let n=e.detail.selectedVariant.children;p({type:`changeVariant`,payload:u.current[n]}),t(n)},onSaveManageViews:e=>{let{deletedVariants:n,updatedVariants:i}=e.detail;n.forEach(e=>{delete u.current[e.children],a(t=>t.filter(t=>t.children!==e.children))}),i.forEach(e=>{let{variantItem:n,selected:i,...o}=e;u.current[e.children]=o,e.isDefault&&r(e.children),e.selected&&t(e.children),a(t=>t.map(t=>t.children===e.prevVariant.children?o:t))})},children:[(0,V.jsx)(L,{selected:e===`Standard`,global:!0,isDefault:n===`Standard`,author:`SAP`,readOnly:!0,labelReadOnly:!0,children:`Standard`}),i.map(t=>(0,V.jsx)(L,{...t,selected:e===t.children,isDefault:n===t.children,children:t.children},t.children))]}),children:[(0,V.jsx)(R,{label:`Countries`,filterKey:0,children:(0,V.jsxs)(w,{onChange:e=>{let{selectedOption:t}=e.detail;p({type:`selectedCountry`,payload:t.textContent})},children:[(0,V.jsx)(g,{selected:h===`Indonesia`,children:`Indonesia`}),(0,V.jsx)(g,{selected:h===`Costa Rica`,children:`Costa Rica`}),(0,V.jsx)(g,{selected:h===`Slovakia`,children:`Slovakia`}),(0,V.jsx)(g,{selected:h===`Iceland`,children:`Iceland`}),(0,V.jsx)(g,{selected:h===`Malta`,children:`Malta`}),(0,V.jsx)(g,{selected:h===`Guyana`,children:`Guyana`}),(0,V.jsx)(g,{selected:h===`Spain`,children:`Spain`}),(0,V.jsx)(g,{selected:h===`Austria`,children:`Austria`})]})}),(0,V.jsx)(R,{label:`Date`,filterKey:1,children:(0,V.jsx)(E,{value:_,onChange:e=>{p({type:`date`,payload:e.detail.value})}})}),(0,V.jsx)(R,{label:`Company Code`,filterKey:2,children:(0,V.jsxs)(k,{onSelectionChange:e=>{p({type:`selectedCodes`,payload:e.detail.items.reduce((e,t)=>(e[t.dataset.code]=!0,e),{})})},children:[(0,V.jsx)(A,{text:`001`,selected:y[`001`],"data-code":`001`}),(0,V.jsx)(A,{text:`002`,selected:y[`002`],"data-code":`002`}),(0,V.jsx)(A,{text:`003`,selected:y[`003`],"data-code":`003`}),(0,V.jsx)(A,{text:`004`,selected:y[`004`],"data-code":`004`}),(0,V.jsx)(A,{text:`005`,selected:y[`005`],"data-code":`005`})]})})]}),(0,V.jsxs)(S,{style:{marginBlockStart:`2rem`},layout:`S1 M1 L1 XL1`,labelSpan:`S3 M3 L3 XL3`,children:[(0,V.jsx)(b,{headerText:`Variant`,children:(0,V.jsx)(v,{labelContent:(0,V.jsx)(m,{showColon:!0,children:`Current View`}),children:(0,V.jsx)(f,{children:e})})}),(0,V.jsxs)(b,{headerText:`Filters`,children:[(0,V.jsx)(v,{labelContent:(0,V.jsx)(m,{showColon:!0,children:`Selected Country`}),children:(0,V.jsx)(f,{children:h})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(m,{showColon:!0,children:`Selected Date`}),children:(0,V.jsx)(f,{children:_})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(m,{showColon:!0,children:`Selected Company Codes`}),children:(0,V.jsx)(f,{children:Object.keys(y).join(`, `)})})]})]})]})}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  render: args => {
