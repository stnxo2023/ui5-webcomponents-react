import{n as e,o as t,r as n}from"./chunk-jRWAZmH_.js";import{Aa as r,Bd as i,Bi as a,Cg as o,Da as s,Ea as c,Fl as l,Gm as u,Hf as d,J as f,Kl as p,Oa as m,Pl as h,Ri as g,Sf as _,Ta as v,Tl as y,Vf as b,Vi as x,Y as S,_ as C,eu as w,f as T,fm as E,g as D,go as O,ho as k,ka as A,p as j,pm as M,ql as N,tu as P,wl as F,xf as I,zd as L,zi as R}from"./iframe-CgCbEUVp.js";var z=n({Default:()=>U,WithCustomValidation:()=>W,WithFilterBarImplementation:()=>G,__namedExportsOrder:()=>K,default:()=>H}),B,V,H,U,W,G,K,q=e((()=>{_(),d(),E(),B=t(o(),1),O(),r(),m(),c(),P(),x(),R(),l(),y(),i(),S(),N(),C(),j(),V=u(),H={title:`Inputs / VariantManagement`,component:T,args:{placement:I.Bottom,level:b.H4},tags:[`package:@ui5/webcomponents-react`]},U={render:e=>(0,V.jsxs)(T,{...e,children:[(0,V.jsx)(D,{children:`Default VariantItem`}),(0,V.jsx)(D,{selected:!0,children:`Selected`}),(0,V.jsx)(D,{author:`SAP`,children:`Author`}),(0,V.jsx)(D,{favorite:!0,children:`Favorite`}),(0,V.jsx)(D,{isDefault:!0,children:`IsDefault`}),(0,V.jsx)(D,{favorite:!0,labelReadOnly:!0,children:`Favorite & labelReadOnly`}),(0,V.jsx)(D,{applyAutomatically:!0,children:`ApplyAutomatically`}),(0,V.jsx)(D,{applyAutomatically:!0,applyAutomaticallyText:`Describe your exceptions that deviate from the standard behavior here.`,children:`applyAutomatically & applyAutomaticallyText`}),(0,V.jsx)(D,{readOnly:!0,children:`ReadOnly`}),(0,V.jsx)(D,{global:!0,children:`Global`}),(0,V.jsx)(D,{global:!0,readOnly:!0,children:`Global & readOnly`}),(0,V.jsx)(D,{global:!0,children:`Not deletable -> global`}),(0,V.jsx)(D,{hideDelete:!0,children:`Not deletable -> hideDelete`}),(0,V.jsx)(D,{hideDelete:!1,global:!0,children:`Deletable -> hideDelete: false, global: true`})]})},W={render:({selectedByIndex:e=1})=>{let[t,n]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(void 0),[a,o]=(0,B.useState)({1:`Only alphanumeric chars in Save View input`,2:`Max 12 chars`});return(0,V.jsxs)(T,{onSaveAs:e=>{o(t=>({...t,[e.detail[`data-id`]]:e.detail.children}))},onSaveManageViews:e=>{let t=e.detail.updatedVariants.find(e=>e[`data-custom-manage-views`]);!r&&t&&o(e=>({...e,[t[`data-id`]]:t.children}))},onManageViewsCancel:()=>{i(void 0)},onSaveViewCancel:()=>{n(void 0)},children:[(0,V.jsx)(D,{"data-id":1,selected:e===0,saveViewInputProps:{valueState:t,valueStateMessage:t?(0,V.jsx)(`div`,{children:`Only alphanumeric and space characters allowed!`}):void 0,onInput:e=>{e.target.value.match(/^[a-z0-9\s]+$/i)?(e.isInvalid=!1,n(void 0)):(e.isInvalid=!0,n(M.Negative))},"data-testid":`alphanumeric`},children:a[1]}),(0,V.jsx)(D,{"data-custom-manage-views":!0,"data-id":2,selected:e===1,manageViewsInputProps:{valueState:r,valueStateMessage:r?(0,V.jsx)(`div`,{children:`No more than 12 characters allowed!`}):void 0,onInput:e=>{e.target.value.length>12?(e.isInvalid=!0,i(M.Negative)):(e.isInvalid=!1,i(void 0))},"data-testid":`12chars`},children:a[2]})]})}},G={name:`in FilterBar`,render:()=>{let[e,t]=(0,B.useState)(`Standard`),[n,r]=(0,B.useState)(`Standard`),[i,o]=(0,B.useState)([]),[c,l]=(0,B.useState)(!1),[u,d]=(0,B.useState)(!1),m=(0,B.useRef)({Standard:{selectedCountry:`Indonesia`,date:``,selectedCodes:{}}}),[_,y]=(0,B.useReducer)((e,t)=>{let{payload:n,type:r}=t;switch(d(!0),r){case`selectedCountry`:return{...e,selectedCountry:n};case`date`:return{...e,date:n};case`selectedCodes`:return{...e,selectedCodes:n};case`changeVariant`:return n;default:return console.warn(`Unknown action type!`),e}},m.current.Standard),{selectedCountry:b,date:x,selectedCodes:S}=_;return(0,B.useEffect)(()=>{if(u){let t=Object.entries(m.current[e]).some(([e,t])=>{if(e===`selectedCodes`){let e=Object.keys(_.selectedCodes).length;return Object.keys(t).length===e?Object.entries(_.selectedCodes).some(([e,n])=>t?.[e]!==n):!0}return _[e]!==t});d(!1),l(t)}},[u,e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(f,{header:(0,V.jsxs)(T,{hideApplyAutomatically:!0,dirtyState:c,onSaveAs:e=>{let{variantItem:n,selected:i,readOnly:a,labelReadOnly:s,...c}=e.detail;c.isDefault&&r(c.children),o(e=>[...e,{...c,author:`Current User`}]),m.current[c.children]=_,t(c.children),l(!1)},onSave:e=>{let{variantItem:t,selected:n,...r}=e.detail;m.current[r.children]=_,l(!1)},onSelect:e=>{let n=e.detail.selectedVariant.children;y({type:`changeVariant`,payload:m.current[n]}),t(n)},onSaveManageViews:e=>{let{deletedVariants:n,updatedVariants:i}=e.detail;n.forEach(e=>{delete m.current[e.children],o(t=>t.filter(t=>t.children!==e.children))}),i.forEach(e=>{let{variantItem:n,selected:i,...a}=e;m.current[e.children]=a,e.isDefault&&r(e.children),e.selected&&t(e.children),o(t=>t.map(t=>t.children===e.prevVariant.children?a:t))})},children:[(0,V.jsx)(D,{selected:e===`Standard`,global:!0,isDefault:n===`Standard`,author:`SAP`,readOnly:!0,labelReadOnly:!0,children:`Standard`}),i.map(t=>(0,V.jsx)(D,{...t,selected:e===t.children,isDefault:n===t.children,children:t.children},t.children))]}),children:[(0,V.jsx)(p,{label:`Countries`,filterKey:0,children:(0,V.jsxs)(F,{onChange:e=>{let{selectedOption:t}=e.detail;y({type:`selectedCountry`,payload:t.textContent})},children:[(0,V.jsx)(h,{selected:b===`Indonesia`,children:`Indonesia`}),(0,V.jsx)(h,{selected:b===`Costa Rica`,children:`Costa Rica`}),(0,V.jsx)(h,{selected:b===`Slovakia`,children:`Slovakia`}),(0,V.jsx)(h,{selected:b===`Iceland`,children:`Iceland`}),(0,V.jsx)(h,{selected:b===`Malta`,children:`Malta`}),(0,V.jsx)(h,{selected:b===`Guyana`,children:`Guyana`}),(0,V.jsx)(h,{selected:b===`Spain`,children:`Spain`}),(0,V.jsx)(h,{selected:b===`Austria`,children:`Austria`})]})}),(0,V.jsx)(p,{label:`Date`,filterKey:1,children:(0,V.jsx)(k,{value:x,onChange:e=>{y({type:`date`,payload:e.detail.value})}})}),(0,V.jsx)(p,{label:`Company Code`,filterKey:2,children:(0,V.jsxs)(a,{onSelectionChange:e=>{y({type:`selectedCodes`,payload:e.detail.items.reduce((e,t)=>(e[t.dataset.code]=!0,e),{})})},children:[(0,V.jsx)(g,{text:`001`,selected:S[`001`],"data-code":`001`}),(0,V.jsx)(g,{text:`002`,selected:S[`002`],"data-code":`002`}),(0,V.jsx)(g,{text:`003`,selected:S[`003`],"data-code":`003`}),(0,V.jsx)(g,{text:`004`,selected:S[`004`],"data-code":`004`}),(0,V.jsx)(g,{text:`005`,selected:S[`005`],"data-code":`005`})]})})]}),(0,V.jsxs)(A,{style:{marginBlockStart:`2rem`},layout:`S1 M1 L1 XL1`,labelSpan:`S3 M3 L3 XL3`,children:[(0,V.jsx)(s,{headerText:`Variant`,children:(0,V.jsx)(v,{labelContent:(0,V.jsx)(w,{showColon:!0,children:`Current View`}),children:(0,V.jsx)(L,{children:e})})}),(0,V.jsxs)(s,{headerText:`Filters`,children:[(0,V.jsx)(v,{labelContent:(0,V.jsx)(w,{showColon:!0,children:`Selected Country`}),children:(0,V.jsx)(L,{children:b})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(w,{showColon:!0,children:`Selected Date`}),children:(0,V.jsx)(L,{children:x})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(w,{showColon:!0,children:`Selected Company Codes`}),children:(0,V.jsx)(L,{children:Object.keys(S).join(`, `)})})]})]})]})}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  render: args => {
