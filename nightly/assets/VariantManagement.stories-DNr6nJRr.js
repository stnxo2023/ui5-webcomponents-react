import{H as $,Z as J,j as e,r as d,J as A,R as G}from"./iframe-DJ3L9Q7k.js";import{D as Z}from"./index-D5A4Hxvt.js";import{F as q,a as T,b as k}from"./index-BF-eSR-p.js";import{L as P}from"./index-4H2gG8m_.js";import{M as Q,a as x}from"./index-DHWps5pX.js";import{O as h}from"./index-DuEKvhcf.js";import{S as Y}from"./index-B_gzg89D.js";import{a as ee,F as _}from"./index-B5UJYZGi.js";import{V as R,a}from"./VariantItem-C7UaXDij.js";const te={title:"Inputs / VariantManagement",component:R,args:{placement:J.Bottom,level:$.H4},tags:["package:@ui5/webcomponents-react"]},b={render:o=>e.jsxs(R,{...o,children:[e.jsx(a,{children:"Default VariantItem"}),e.jsx(a,{selected:!0,children:"Selected"}),e.jsx(a,{author:"SAP",children:"Author"}),e.jsx(a,{favorite:!0,children:"Favorite"}),e.jsx(a,{isDefault:!0,children:"IsDefault"}),e.jsx(a,{favorite:!0,labelReadOnly:!0,children:"Favorite & labelReadOnly"}),e.jsx(a,{applyAutomatically:!0,children:"ApplyAutomatically"}),e.jsx(a,{applyAutomatically:!0,applyAutomaticallyText:"Describe your exceptions that deviate from the standard behavior here.",children:"applyAutomatically & applyAutomaticallyText"}),e.jsx(a,{readOnly:!0,children:"ReadOnly"}),e.jsx(a,{global:!0,children:"Global"}),e.jsx(a,{global:!0,readOnly:!0,children:"Global & readOnly"}),e.jsx(a,{global:!0,children:"Not deletable -> global"}),e.jsx(a,{hideDelete:!0,children:"Not deletable -> hideDelete"}),e.jsx(a,{hideDelete:!1,global:!0,children:"Deletable -> hideDelete: false, global: true"})]})},w={render:({selectedByIndex:o=1})=>{const[p,V]=d.useState(void 0),[v,I]=d.useState(void 0),[S,M]=d.useState({1:"Only alphanumeric chars in Save View input",2:"Max 12 chars"}),f=n=>{n.target.value.match(/^[a-z0-9\s]+$/i)?(n.isInvalid=!1,V(void 0)):(n.isInvalid=!0,V(G.Negative))},D=n=>{M(s=>({...s,[n.detail["data-id"]]:n.detail.children}))},O=n=>{n.target.value.length>12?(n.isInvalid=!0,I(G.Negative)):(n.isInvalid=!1,I(void 0))},u=n=>{const s=n.detail.updatedVariants.find(y=>y["data-custom-manage-views"]);!v&&s&&M(y=>({...y,[s["data-id"]]:s.children}))},L=()=>{I(void 0)},m=()=>{V(void 0)};return e.jsxs(R,{onSaveAs:D,onSaveManageViews:u,onManageViewsCancel:L,onSaveViewCancel:m,children:[e.jsx(a,{"data-id":1,selected:o===0,saveViewInputProps:{valueState:p,valueStateMessage:p?e.jsx("div",{children:"Only alphanumeric and space characters allowed!"}):void 0,onInput:f,"data-testid":"alphanumeric"},children:S[1]}),e.jsx(a,{"data-custom-manage-views":!0,"data-id":2,selected:o===1,manageViewsInputProps:{valueState:v,valueStateMessage:v?e.jsx("div",{children:"No more than 12 characters allowed!"}):void 0,onInput:O,"data-testid":"12chars"},children:S[2]})]})}},j={name:"in FilterBar",render:()=>{const[o,p]=d.useState("Standard"),[V,v]=d.useState("Standard"),[I,S]=d.useState([]),[M,f]=d.useState(!1),[D,O]=d.useState(!1),u=d.useRef({Standard:{selectedCountry:"Indonesia",date:"",selectedCodes:{}}}),L=(t,l)=>{const{payload:i,type:r}=l;switch(O(!0),r){case"selectedCountry":return{...t,selectedCountry:i};case"date":return{...t,date:i};case"selectedCodes":return{...t,selectedCodes:i};case"changeVariant":return i;default:return console.warn("Unknown action type!"),t}},[m,n]=d.useReducer(L,u.current.Standard),{selectedCountry:s,date:y,selectedCodes:C}=m,E=t=>{const{selectedOption:l}=t.detail;n({type:"selectedCountry",payload:l.textContent})},N=t=>{n({type:"date",payload:t.detail.value})},K=t=>{n({type:"selectedCodes",payload:t.detail.items.reduce((l,i)=>(l[i.dataset.code]=!0,l),{})})},W=t=>{const{variantItem:l,selected:i,readOnly:r,labelReadOnly:g,...c}=t.detail;c.isDefault&&v(c.children),S(F=>[...F,{...c,author:"Current User"}]),u.current[c.children]=m,p(c.children),f(!1)},U=t=>{const{variantItem:l,selected:i,...r}=t.detail;u.current[r.children]=m,f(!1)},X=t=>{const{deletedVariants:l,updatedVariants:i}=t.detail;l.forEach(r=>{delete u.current[r.children],S(g=>g.filter(c=>c.children!==r.children))}),i.forEach(r=>{const{variantItem:g,selected:c,...F}=r;u.current[r.children]=F,r.isDefault&&v(r.children),r.selected&&p(r.children),S(H=>H.map(B=>B.children===r.prevVariant.children?F:B))})},z=t=>{const l=t.detail.selectedVariant.children;n({type:"changeVariant",payload:u.current[l]}),p(l)};return d.useEffect(()=>{if(D){const t=Object.entries(u.current[o]).some(([l,i])=>{if(l==="selectedCodes"){const r=Object.keys(m.selectedCodes).length;return Object.keys(i).length!==r?!0:Object.entries(m.selectedCodes).some(([g,c])=>i?.[g]!==c)}return m[l]!==i});O(!1),f(t)}},[D,o]),e.jsxs(e.Fragment,{children:[e.jsxs(ee,{header:e.jsxs(R,{hideApplyAutomatically:!0,dirtyState:M,onSaveAs:W,onSave:U,onSelect:z,onSaveManageViews:X,children:[e.jsx(a,{selected:o==="Standard",global:!0,isDefault:V==="Standard",author:"SAP",readOnly:!0,labelReadOnly:!0,children:"Standard"}),I.map(t=>e.jsx(a,{...t,selected:o===t.children,isDefault:V===t.children,children:t.children},t.children))]}),children:[e.jsx(_,{label:"Countries",filterKey:0,children:e.jsxs(Y,{onChange:E,children:[e.jsx(h,{selected:s==="Indonesia",children:"Indonesia"}),e.jsx(h,{selected:s==="Costa Rica",children:"Costa Rica"}),e.jsx(h,{selected:s==="Slovakia",children:"Slovakia"}),e.jsx(h,{selected:s==="Iceland",children:"Iceland"}),e.jsx(h,{selected:s==="Malta",children:"Malta"}),e.jsx(h,{selected:s==="Guyana",children:"Guyana"}),e.jsx(h,{selected:s==="Spain",children:"Spain"}),e.jsx(h,{selected:s==="Austria",children:"Austria"})]})}),e.jsx(_,{label:"Date",filterKey:1,children:e.jsx(Z,{value:y,onChange:N})}),e.jsx(_,{label:"Company Code",filterKey:2,children:e.jsxs(Q,{onSelectionChange:K,children:[e.jsx(x,{text:"001",selected:C["001"],"data-code":"001"}),e.jsx(x,{text:"002",selected:C["002"],"data-code":"002"}),e.jsx(x,{text:"003",selected:C["003"],"data-code":"003"}),e.jsx(x,{text:"004",selected:C["004"],"data-code":"004"}),e.jsx(x,{text:"005",selected:C["005"],"data-code":"005"})]})})]}),e.jsxs(q,{style:{marginBlockStart:"2rem"},layout:"S1 M1 L1 XL1",labelSpan:"S3 M3 L3 XL3",children:[e.jsx(T,{headerText:"Variant",children:e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Current View"}),children:e.jsx(A,{children:o})})}),e.jsxs(T,{headerText:"Filters",children:[e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Country"}),children:e.jsx(A,{children:s})}),e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Date"}),children:e.jsx(A,{children:y})}),e.jsx(k,{labelContent:e.jsx(P,{showColon:!0,children:"Selected Company Codes"}),children:e.jsx(A,{children:Object.keys(C).join(", ")})})]})]})]})}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: args => {
...
}`,...j.parameters?.docs?.source}}};const ae=["Default","WithCustomValidation","WithFilterBarImplementation"],me=Object.freeze(Object.defineProperty({__proto__:null,Default:b,WithCustomValidation:w,WithFilterBarImplementation:j,__namedExportsOrder:ae,default:te},Symbol.toStringTag,{value:"Module"}));export{me as C,b as D,w as W,j as a};
