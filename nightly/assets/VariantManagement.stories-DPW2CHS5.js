import{a as e,c as t,i as n}from"./preload-helper-DbRxMUml.js";import{Ba as r,Cf as i,Eo as a,Fa as o,Fl as s,Fm as c,Gi as l,Gl as u,Hf as d,Ia as f,Ki as p,La as m,Pl as h,Ra as g,Rd as _,To as v,Ui as y,Vf as b,Wi as x,Wl as S,X as C,Y as w,_ as T,du as E,f as D,ng as O,nm as k,nu as A,p as j,ru as M,tm as N,uu as P,v as F,wf as I,za as L,zd as R}from"./iframe-DClK4JzX.js";var z=e({Default:()=>U,WithCustomValidation:()=>W,WithFilterBarImplementation:()=>G,__namedExportsOrder:()=>K,default:()=>H}),B,V,H,U,W,G,K,q=n((()=>{I(),d(),N(),B=t(O(),1),a(),r(),g(),f(),E(),p(),x(),u(),s(),R(),C(),M(),F(),j(),V=c(),H={title:`Inputs / VariantManagement`,component:D,args:{placement:i.Bottom,level:b.H4},tags:[`package:@ui5/webcomponents-react`]},U={render:e=>(0,V.jsxs)(D,{...e,children:[(0,V.jsx)(T,{children:`Default VariantItem`}),(0,V.jsx)(T,{selected:!0,children:`Selected`}),(0,V.jsx)(T,{author:`SAP`,children:`Author`}),(0,V.jsx)(T,{favorite:!0,children:`Favorite`}),(0,V.jsx)(T,{isDefault:!0,children:`IsDefault`}),(0,V.jsx)(T,{favorite:!0,labelReadOnly:!0,children:`Favorite & labelReadOnly`}),(0,V.jsx)(T,{applyAutomatically:!0,children:`ApplyAutomatically`}),(0,V.jsx)(T,{applyAutomatically:!0,applyAutomaticallyText:`Describe your exceptions that deviate from the standard behavior here.`,children:`applyAutomatically & applyAutomaticallyText`}),(0,V.jsx)(T,{readOnly:!0,children:`ReadOnly`}),(0,V.jsx)(T,{global:!0,children:`Global`}),(0,V.jsx)(T,{global:!0,readOnly:!0,children:`Global & readOnly`}),(0,V.jsx)(T,{global:!0,children:`Not deletable -> global`}),(0,V.jsx)(T,{hideDelete:!0,children:`Not deletable -> hideDelete`}),(0,V.jsx)(T,{hideDelete:!1,global:!0,children:`Deletable -> hideDelete: false, global: true`})]})},W={render:({selectedByIndex:e=1})=>{let[t,n]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(void 0),[a,o]=(0,B.useState)({1:`Only alphanumeric chars in Save View input`,2:`Max 12 chars`});return(0,V.jsxs)(D,{onSaveAs:e=>{o(t=>({...t,[e.detail[`data-id`]]:e.detail.children}))},onSaveManageViews:e=>{let t=e.detail.updatedVariants.find(e=>e[`data-custom-manage-views`]);!r&&t&&o(e=>({...e,[t[`data-id`]]:t.children}))},onManageViewsCancel:()=>{i(void 0)},onSaveViewCancel:()=>{n(void 0)},children:[(0,V.jsx)(T,{"data-id":1,selected:e===0,saveViewInputProps:{valueState:t,valueStateMessage:t?(0,V.jsx)(`div`,{children:`Only alphanumeric and space characters allowed!`}):void 0,onInput:e=>{e.target.value.match(/^[a-z0-9\s]+$/i)?(e.isInvalid=!1,n(void 0)):(e.isInvalid=!0,n(k.Negative))},"data-testid":`alphanumeric`},children:a[1]}),(0,V.jsx)(T,{"data-custom-manage-views":!0,"data-id":2,selected:e===1,manageViewsInputProps:{valueState:r,valueStateMessage:r?(0,V.jsx)(`div`,{children:`No more than 12 characters allowed!`}):void 0,onInput:e=>{e.target.value.length>12?(e.isInvalid=!0,i(k.Negative)):(e.isInvalid=!1,i(void 0))},"data-testid":`12chars`},children:a[2]})]})}},G={name:`in FilterBar`,render:()=>{let[e,t]=(0,B.useState)(`Standard`),[n,r]=(0,B.useState)(`Standard`),[i,a]=(0,B.useState)([]),[s,c]=(0,B.useState)(!1),[u,d]=(0,B.useState)(!1),f=(0,B.useRef)({Standard:{selectedCountry:`Indonesia`,date:``,selectedCodes:{}}}),[p,g]=(0,B.useReducer)((e,t)=>{let{payload:n,type:r}=t;switch(d(!0),r){case`selectedCountry`:return{...e,selectedCountry:n};case`date`:return{...e,date:n};case`selectedCodes`:return{...e,selectedCodes:n};case`changeVariant`:return n;default:return console.warn(`Unknown action type!`),e}},f.current.Standard),{selectedCountry:b,date:x,selectedCodes:C}=p;return(0,B.useEffect)(()=>{if(u){let t=Object.entries(f.current[e]).some(([e,t])=>{if(e===`selectedCodes`){let e=Object.keys(p.selectedCodes).length;return Object.keys(t).length===e?Object.entries(p.selectedCodes).some(([e,n])=>t?.[e]!==n):!0}return p[e]!==t});d(!1),c(t)}},[u,e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(w,{header:(0,V.jsxs)(D,{hideApplyAutomatically:!0,dirtyState:s,onSaveAs:e=>{let{variantItem:n,selected:i,readOnly:o,labelReadOnly:s,...l}=e.detail;l.isDefault&&r(l.children),a(e=>[...e,{...l,author:`Current User`}]),f.current[l.children]=p,t(l.children),c(!1)},onSave:e=>{let{variantItem:t,selected:n,...r}=e.detail;f.current[r.children]=p,c(!1)},onSelect:e=>{let n=e.detail.selectedVariant.children;g({type:`changeVariant`,payload:f.current[n]}),t(n)},onSaveManageViews:e=>{let{deletedVariants:n,updatedVariants:i}=e.detail;n.forEach(e=>{delete f.current[e.children],a(t=>t.filter(t=>t.children!==e.children))}),i.forEach(e=>{let{variantItem:n,selected:i,...o}=e;f.current[e.children]=o,e.isDefault&&r(e.children),e.selected&&t(e.children),a(t=>t.map(t=>t.children===e.prevVariant.children?o:t))})},children:[(0,V.jsx)(T,{selected:e===`Standard`,global:!0,isDefault:n===`Standard`,author:`SAP`,readOnly:!0,labelReadOnly:!0,children:`Standard`}),i.map(t=>(0,V.jsx)(T,{...t,selected:e===t.children,isDefault:n===t.children,children:t.children},t.children))]}),children:[(0,V.jsx)(A,{label:`Countries`,filterKey:0,children:(0,V.jsxs)(h,{onChange:e=>{let{selectedOption:t}=e.detail;g({type:`selectedCountry`,payload:t.textContent})},children:[(0,V.jsx)(S,{selected:b===`Indonesia`,children:`Indonesia`}),(0,V.jsx)(S,{selected:b===`Costa Rica`,children:`Costa Rica`}),(0,V.jsx)(S,{selected:b===`Slovakia`,children:`Slovakia`}),(0,V.jsx)(S,{selected:b===`Iceland`,children:`Iceland`}),(0,V.jsx)(S,{selected:b===`Malta`,children:`Malta`}),(0,V.jsx)(S,{selected:b===`Guyana`,children:`Guyana`}),(0,V.jsx)(S,{selected:b===`Spain`,children:`Spain`}),(0,V.jsx)(S,{selected:b===`Austria`,children:`Austria`})]})}),(0,V.jsx)(A,{label:`Date`,filterKey:1,children:(0,V.jsx)(v,{value:x,onChange:e=>{g({type:`date`,payload:e.detail.value})}})}),(0,V.jsx)(A,{label:`Company Code`,filterKey:2,children:(0,V.jsxs)(l,{onSelectionChange:e=>{g({type:`selectedCodes`,payload:e.detail.items.reduce((e,t)=>(e[t.dataset.code]=!0,e),{})})},children:[(0,V.jsx)(y,{text:`001`,selected:C[`001`],"data-code":`001`}),(0,V.jsx)(y,{text:`002`,selected:C[`002`],"data-code":`002`}),(0,V.jsx)(y,{text:`003`,selected:C[`003`],"data-code":`003`}),(0,V.jsx)(y,{text:`004`,selected:C[`004`],"data-code":`004`}),(0,V.jsx)(y,{text:`005`,selected:C[`005`],"data-code":`005`})]})})]}),(0,V.jsxs)(L,{style:{marginBlockStart:`2rem`},layout:`S1 M1 L1 XL1`,labelSpan:`S3 M3 L3 XL3`,children:[(0,V.jsx)(m,{headerText:`Variant`,children:(0,V.jsx)(o,{labelContent:(0,V.jsx)(P,{showColon:!0,children:`Current View`}),children:(0,V.jsx)(_,{children:e})})}),(0,V.jsxs)(m,{headerText:`Filters`,children:[(0,V.jsx)(o,{labelContent:(0,V.jsx)(P,{showColon:!0,children:`Selected Country`}),children:(0,V.jsx)(_,{children:b})}),(0,V.jsx)(o,{labelContent:(0,V.jsx)(P,{showColon:!0,children:`Selected Date`}),children:(0,V.jsx)(_,{children:x})}),(0,V.jsx)(o,{labelContent:(0,V.jsx)(P,{showColon:!0,children:`Selected Company Codes`}),children:(0,V.jsx)(_,{children:Object.keys(C).join(`, `)})})]})]})]})}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  render: args => {
