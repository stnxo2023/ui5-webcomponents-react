import{n as e,o as t,r as n}from"./chunk-jRWAZmH_.js";import{Aa as r,Bd as i,Bi as a,Da as o,Ea as s,Ef as c,Fl as l,Gf as u,J as d,Kf as f,Kl as p,Oa as m,Og as h,Pl as g,Ri as _,Ta as v,Tf as y,Tl as b,Vd as x,Vi as S,Xm as C,Y as w,_ as T,_m as E,eu as D,f as O,g as k,gm as A,go as j,ho as M,ka as N,p as P,ql as F,tu as I,wl as L,zi as R}from"./iframe-DxQCPanG.js";var z=n({Default:()=>U,WithCustomValidation:()=>W,WithFilterBarImplementation:()=>G,__namedExportsOrder:()=>K,default:()=>H}),B,V,H,U,W,G,K,q=e((()=>{c(),f(),A(),B=t(h(),1),j(),r(),m(),s(),I(),S(),R(),l(),b(),x(),w(),F(),T(),P(),V=C(),H={title:`Inputs / VariantManagement`,component:O,args:{placement:y.Bottom,level:u.H4},tags:[`package:@ui5/webcomponents-react`]},U={render:e=>(0,V.jsxs)(O,{...e,children:[(0,V.jsx)(k,{children:`Default VariantItem`}),(0,V.jsx)(k,{selected:!0,children:`Selected`}),(0,V.jsx)(k,{author:`SAP`,children:`Author`}),(0,V.jsx)(k,{favorite:!0,children:`Favorite`}),(0,V.jsx)(k,{isDefault:!0,children:`IsDefault`}),(0,V.jsx)(k,{favorite:!0,labelReadOnly:!0,children:`Favorite & labelReadOnly`}),(0,V.jsx)(k,{applyAutomatically:!0,children:`ApplyAutomatically`}),(0,V.jsx)(k,{applyAutomatically:!0,applyAutomaticallyText:`Describe your exceptions that deviate from the standard behavior here.`,children:`applyAutomatically & applyAutomaticallyText`}),(0,V.jsx)(k,{readOnly:!0,children:`ReadOnly`}),(0,V.jsx)(k,{global:!0,children:`Global`}),(0,V.jsx)(k,{global:!0,readOnly:!0,children:`Global & readOnly`}),(0,V.jsx)(k,{global:!0,children:`Not deletable -> global`}),(0,V.jsx)(k,{hideDelete:!0,children:`Not deletable -> hideDelete`}),(0,V.jsx)(k,{hideDelete:!1,global:!0,children:`Deletable -> hideDelete: false, global: true`})]})},W={render:({selectedByIndex:e=1})=>{let[t,n]=(0,B.useState)(void 0),[r,i]=(0,B.useState)(void 0),[a,o]=(0,B.useState)({1:`Only alphanumeric chars in Save View input`,2:`Max 12 chars`});return(0,V.jsxs)(O,{onSaveAs:e=>{o(t=>({...t,[e.detail[`data-id`]]:e.detail.children}))},onSaveManageViews:e=>{let t=e.detail.updatedVariants.find(e=>e[`data-custom-manage-views`]);!r&&t&&o(e=>({...e,[t[`data-id`]]:t.children}))},onManageViewsCancel:()=>{i(void 0)},onSaveViewCancel:()=>{n(void 0)},children:[(0,V.jsx)(k,{"data-id":1,selected:e===0,saveViewInputProps:{valueState:t,valueStateMessage:t?(0,V.jsx)(`div`,{children:`Only alphanumeric and space characters allowed!`}):void 0,onInput:e=>{e.target.value.match(/^[a-z0-9\s]+$/i)?(e.isInvalid=!1,n(void 0)):(e.isInvalid=!0,n(E.Negative))},"data-testid":`alphanumeric`},children:a[1]}),(0,V.jsx)(k,{"data-custom-manage-views":!0,"data-id":2,selected:e===1,manageViewsInputProps:{valueState:r,valueStateMessage:r?(0,V.jsx)(`div`,{children:`No more than 12 characters allowed!`}):void 0,onInput:e=>{e.target.value.length>12?(e.isInvalid=!0,i(E.Negative)):(e.isInvalid=!1,i(void 0))},"data-testid":`12chars`},children:a[2]})]})}},G={name:`in FilterBar`,render:()=>{let[e,t]=(0,B.useState)(`Standard`),[n,r]=(0,B.useState)(`Standard`),[s,c]=(0,B.useState)([]),[l,u]=(0,B.useState)(!1),[f,m]=(0,B.useState)(!1),h=(0,B.useRef)({Standard:{selectedCountry:`Indonesia`,date:``,selectedCodes:{}}}),[y,b]=(0,B.useReducer)((e,t)=>{let{payload:n,type:r}=t;switch(m(!0),r){case`selectedCountry`:return{...e,selectedCountry:n};case`date`:return{...e,date:n};case`selectedCodes`:return{...e,selectedCodes:n};case`changeVariant`:return n;default:return console.warn(`Unknown action type!`),e}},h.current.Standard),{selectedCountry:x,date:S,selectedCodes:C}=y;return(0,B.useEffect)(()=>{if(f){let t=Object.entries(h.current[e]).some(([e,t])=>{if(e===`selectedCodes`){let e=Object.keys(y.selectedCodes).length;return Object.keys(t).length===e?Object.entries(y.selectedCodes).some(([e,n])=>t?.[e]!==n):!0}return y[e]!==t});m(!1),u(t)}},[f,e]),(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(d,{header:(0,V.jsxs)(O,{hideApplyAutomatically:!0,dirtyState:l,onSaveAs:e=>{let{variantItem:n,selected:i,readOnly:a,labelReadOnly:o,...s}=e.detail;s.isDefault&&r(s.children),c(e=>[...e,{...s,author:`Current User`}]),h.current[s.children]=y,t(s.children),u(!1)},onSave:e=>{let{variantItem:t,selected:n,...r}=e.detail;h.current[r.children]=y,u(!1)},onSelect:e=>{let n=e.detail.selectedVariant.children;b({type:`changeVariant`,payload:h.current[n]}),t(n)},onSaveManageViews:e=>{let{deletedVariants:n,updatedVariants:i}=e.detail;n.forEach(e=>{delete h.current[e.children],c(t=>t.filter(t=>t.children!==e.children))}),i.forEach(e=>{let{variantItem:n,selected:i,...a}=e;h.current[e.children]=a,e.isDefault&&r(e.children),e.selected&&t(e.children),c(t=>t.map(t=>t.children===e.prevVariant.children?a:t))})},children:[(0,V.jsx)(k,{selected:e===`Standard`,global:!0,isDefault:n===`Standard`,author:`SAP`,readOnly:!0,labelReadOnly:!0,children:`Standard`}),s.map(t=>(0,V.jsx)(k,{...t,selected:e===t.children,isDefault:n===t.children,children:t.children},t.children))]}),children:[(0,V.jsx)(p,{label:`Countries`,filterKey:0,children:(0,V.jsxs)(L,{onChange:e=>{let{selectedOption:t}=e.detail;b({type:`selectedCountry`,payload:t.textContent})},children:[(0,V.jsx)(g,{selected:x===`Indonesia`,children:`Indonesia`}),(0,V.jsx)(g,{selected:x===`Costa Rica`,children:`Costa Rica`}),(0,V.jsx)(g,{selected:x===`Slovakia`,children:`Slovakia`}),(0,V.jsx)(g,{selected:x===`Iceland`,children:`Iceland`}),(0,V.jsx)(g,{selected:x===`Malta`,children:`Malta`}),(0,V.jsx)(g,{selected:x===`Guyana`,children:`Guyana`}),(0,V.jsx)(g,{selected:x===`Spain`,children:`Spain`}),(0,V.jsx)(g,{selected:x===`Austria`,children:`Austria`})]})}),(0,V.jsx)(p,{label:`Date`,filterKey:1,children:(0,V.jsx)(M,{value:S,onChange:e=>{b({type:`date`,payload:e.detail.value})}})}),(0,V.jsx)(p,{label:`Company Code`,filterKey:2,children:(0,V.jsxs)(a,{onSelectionChange:e=>{b({type:`selectedCodes`,payload:e.detail.items.reduce((e,t)=>(e[t.dataset.code]=!0,e),{})})},children:[(0,V.jsx)(_,{text:`001`,selected:C[`001`],"data-code":`001`}),(0,V.jsx)(_,{text:`002`,selected:C[`002`],"data-code":`002`}),(0,V.jsx)(_,{text:`003`,selected:C[`003`],"data-code":`003`}),(0,V.jsx)(_,{text:`004`,selected:C[`004`],"data-code":`004`}),(0,V.jsx)(_,{text:`005`,selected:C[`005`],"data-code":`005`})]})})]}),(0,V.jsxs)(N,{style:{marginBlockStart:`2rem`},layout:`S1 M1 L1 XL1`,labelSpan:`S3 M3 L3 XL3`,children:[(0,V.jsx)(o,{headerText:`Variant`,children:(0,V.jsx)(v,{labelContent:(0,V.jsx)(D,{showColon:!0,children:`Current View`}),children:(0,V.jsx)(i,{children:e})})}),(0,V.jsxs)(o,{headerText:`Filters`,children:[(0,V.jsx)(v,{labelContent:(0,V.jsx)(D,{showColon:!0,children:`Selected Country`}),children:(0,V.jsx)(i,{children:x})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(D,{showColon:!0,children:`Selected Date`}),children:(0,V.jsx)(i,{children:S})}),(0,V.jsx)(v,{labelContent:(0,V.jsx)(D,{showColon:!0,children:`Selected Company Codes`}),children:(0,V.jsx)(i,{children:Object.keys(C).join(`, `)})})]})]})]})}},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  render: args => {
