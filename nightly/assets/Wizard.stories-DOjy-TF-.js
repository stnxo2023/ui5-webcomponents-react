...
__Note:__ This is a UI5 Web Component! [Wizard UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/Wizard) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"Wizard",props:{children:{defaultValue:null,description:"Defines the steps.\n\n**Note:** Use the available `WizardStep` component.\n\n__Supported Node Type/s:__ `Array<WizardStep>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},onStepChange:{defaultValue:null,description:`Fired when the step is changed by user interaction - either with scrolling,
or by clicking on the steps within the component header.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onStepChange",required:!1,type:{name:"(event: Ui5CustomEvent<WizardDomRef, WizardStepChangeEventDetail>) => void"}},contentLayout:{defaultValue:{value:'"MultipleSteps"'},description:"Defines how the content of the `Wizard` would be visualized.\n\n**Note:** Available since [v1.14.0](https://github.com/UI5/webcomponents/releases/tag/v1.14.0) of **@ui5/webcomponents-fiori**.",name:"contentLayout",required:!1,type:{name:"enum",value:[{value:'"MultipleSteps"'},{value:'"SingleStep"'},{value:'"MultipleSteps"'},{value:'"SingleStep"'}]}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{S.displayName="WizardStep",S.__docgenInfo={description:"A component that represents a logical step as part of the `Wizard`.\nIt is meant to aggregate arbitrary HTML elements that form the content of a single step.\n\n### Structure\n\n- Each wizard step has arbitrary content.\n- Each wizard step might have texts - defined by the `titleText` and `subtitleText` properties.\n- Each wizard step might have an icon - defined by the `icon` property.\n- Each wizard step might display a number in place of the `icon`, when it's missing.\n\n### Usage\nThe `WizardStep` component should be used only as slot of the `Wizard` component\nand should not be used standalone.\n\n__Note:__ This is a UI5 Web Component! [WizardStep UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/WizardStep) | [Repository](https://github.com/UI5/webcomponents)",displayName:"WizardStep",props:{children:{defaultValue:null,description:"Defines the step content.\n\n__Supported Node Type/s:__ `Array<Node>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},branching:{defaultValue:{value:"false"},description:"When `branching` is enabled a dashed line would be displayed after the step,\nmeant to indicate that the next step is not yet known and depends on user choice in the current step.\n\n**Note:** It is recommended to use `branching` on the last known step\nand later add new steps when it becomes clear how the wizard flow should continue.",name:"branching",required:!1,type:{name:"boolean"}},disabled:{defaultValue:{value:"false"},description:"Defines if the step is `disabled`. When disabled the step is displayed,\nbut the user can't select the step by clicking or navigate to it with scrolling.\n\n**Note:** Step can't be `selected` and `disabled` at the same time.\nIn this case the `selected` property would take precedence.",name:"disabled",required:!1,type:{name:"boolean"}},icon:{defaultValue:{value:"undefined"},description:`Defines the \`icon\` of the step.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const ke="hint",Pe="M192 449h33V225h-32v-34h95v258h32v31H192v-31zm15-369q0-20 14-34t34-14 34 14 14 34-14 34-34 14-34-14-14-34z",Le=!0,Fe="SAP-icons-v4",He="@ui5/webcomponents-icons";I(ke,{pathData:Pe,ltr:Le,collection:Fe,packageName:He});const Me="hint",$e="M256 0q53 0 100 20t81.5 54.5T492 156t20 100-20 100-54.5 81.5T356 492t-100 20-100-20-81.5-54.5T20 356 0 256t20-100 54.5-81.5T156 20 256 0zm0 461q43 0 80.5-16t65-44 43.5-65 16-80-16-80.5-43.5-65-65-43.5T256 51t-80 16-65 43.5-44 65T51 256t16 80 44 65 65 44 80 16zm0-333q13 0 22.5 9.5T288 160t-9.5 22.5T256 192t-22.5-9.5T224 160t9.5-22.5T256 128zm0 115q11 0 18 7.5t7 18.5v102q0 11-7 18.5t-18 7.5-18.5-7.5T230 371V269q0-11 7.5-18.5T256 243z",je=!0,Ue="SAP-icons-v5",Ve="@ui5/webcomponents-icons";I(Me,{pathData:$e,ltr:je,collection:Ue,packageName:Ve});const Ge="hint",Ze="lead",Ke="M0 256q0-53 20-99.5T75 75t81.5-55T256 0t100 20 81.5 55 54.5 81.5 20 99.5-20 100-54.5 81.5T356 492t-100 20-99.5-20T75 437.5 20 356 0 256zm32 0q0 46 17.5 87t48 71.5 71.5 48 87 17.5q47 0 87.5-17.5t71-48 48-71.5 17.5-87q0-47-17.5-87.5t-48-71-71-48T256 32q-46 0-87 17.5t-71.5 48-48 71T32 256zm138 61l41-5q3 14 12 25t19 15v-73q-32-11-51.5-32.5T171 202q0-12 5-25t14.5-24 22.5-18.5 29-8.5v-21h25v21q58 4 70 62l-36 6q-2-12-11-20t-23-9v76q42 9 59 31t17 46q0 28-20.5 50.5T267 393v33h-25v-32q-26-1-47-20t-25-57zm97 39q14-4 23.5-14.5T300 319q0-25-33-35v72zm-25-128v-64q-11 4-18 13t-7 19q0 20 25 32z",Xe=!0,Ye="SAP-icons-v4",Je="@ui5/webcomponents-icons";I(Ze,{pathData:Ke,ltr:Xe,collection:Ye,packageName:Je});const Qe="lead",et="M256 0q53 0 100 20t81.5 54.5T492 156t20 100-20 100-54.5 81.5T356 492t-100 20-100-20-81.5-54.5T20 356 0 256t20-100 54.5-81.5T156 20 256 0zm0 461q43 0 80.5-16t65-44 43.5-65 16-80-16-80.5-43.5-65-65-43.5T256 51t-80 16-65 43.5-44 65T51 256t16 80 44 65 65 44 80 16zm-13-256q-5 0-9 4t-4 9 4 8.5 9 3.5h26q26 0 45 19t19 45q0 23-15 40.5T282 357v34q0 11-7.5 18.5T256 417t-18.5-7.5T230 391v-33h-25q-11 0-18.5-7t-7.5-18 7.5-18.5T205 307h64q5 0 9-4t4-9-4-8.5-9-3.5h-26q-26 0-45-19t-19-45q0-23 15-40.5t36-22.5v-33q0-11 7.5-18.5T256 96t18.5 7.5T282 122v32h25q11 0 18.5 7t7.5 18-7.5 18.5T307 205h-64z",tt=!0,it="SAP-icons-v5",nt="@ui5/webcomponents-icons";I(Qe,{pathData:et,ltr:tt,collection:it,packageName:nt});const st="lead",at="product",ot="M474.5 110v290l-218 110-218-110V110l109-55 219 109v109l-37 18V186l-182-90-73 35v248l182 90 182-90V131l-182-90-28 14-41-21 69-34zm-363 200l108 54v45l-108-53v-46z",rt=!1,lt="SAP-icons-v4",dt="@ui5/webcomponents-icons";I(at,{pathData:ot,ltr:rt,collection:lt,packageName:dt});const pt="product",ct="M257 512q-7 0-13-3L45 393q-13-7-13-22V160q0-14 11-22l102-69q8-5 15-5 8 0 13 4l167 104q12 6 12 22v101q0 11-7.5 18t-18.5 7-18-7.5-7-18.5v-86l-140-88-78 53v184l174 100 172-100V156L243 48q-13-8-13-22 0-11 7.5-18.5T256 0q7 0 13 3l198 116q13 8 13 22v230q0 15-13 22L270 509q-6 3-13 3zm-37-147q-7 0-12-4l-67-38q-13-8-13-22 0-11 7.5-18.5T154 275q6 0 13 3l66 39q13 8 13 22 0 11-7.5 18.5T220 365z",ut=!1,ht="SAP-icons-v5",mt="@ui5/webcomponents-icons";I(pt,{pathData:ct,ltr:ut,collection:ht,packageName:mt});const ft="product",bt={title:"Layouts & Floorplans / Wizard",component:y,argTypes:{children:{control:{disable:!0}}},args:{style:{height:"400px"}},tags:["package:@ui5/webcomponents-fiori"]},C={render(s){const[e,t]=B.useState("1"),[i,r]=B.useState({2:!0,3:!0,4:!0}),[n,o]=B.useState({step3Btn:!0,finalizeBtn:!0}),a=()=>{r(f=>{const{"2":_,...q}=f;return q}),t("2")},h=()=>{r(f=>{const{"3":_,...q}=f;return q}),t("3")},A=f=>{f.target.checked&&o(_=>{const{step3Btn:q,...E}=_;return E})},N=()=>{alert("Wizard is now completed!")},W=f=>{f.target.value&&o(_=>{const{finalizeBtn:q,...E}=_;return E})},D=f=>{t(f.detail.step.dataset.step),s.onStepChange(f)};return p.jsxs(y,{...s,onStepChange:D,children:[p.jsxs(S,{icon:ft,titleText:"Product Type",selected:e==="1","data-step":"1",children:[p.jsx(O,{children:"1. Product Type"}),p.jsx(me,{design:fe.Information,children:"The Wizard control is supposed to break down large tasks, into smaller steps, easier for the user to work with."}),p.jsx(F,{wrappingType:k.None,children:"Sed fermentum, mi et tristique ullamcorper, sapien sapien faucibus sem, quis pretium nibh lorem malesuada diam. Nulla quis arcu aliquet, feugiat massa semper, volutpat diam. Nam vitae ante posuere, molestie neque sit amet, dapibus velit. Maecenas eleifend tempor lorem. Mauris vitae elementum mi, sed eleifend ligula. Nulla tempor vulputate dolor, nec dignissim quam convallis ut. Praesent vitae commodo felis, ut iaculis felis. Fusce quis eleifend sapien, eget facilisis nibh. Suspendisse est velit, scelerisque ut commodo eget, dignissim quis metus. Cras faucibus consequat gravida. Curabitur vitae quam felis. Phasellus ac leo eleifend, commodo tortor et, varius quam. Aliquam erat volutpat"}),p.jsx(P,{design:L.Emphasized,onClick:a,children:"Step 2"})]}),p.jsxs(S,{icon:Ge,titleText:"Product Information",disabled:i[2],selected:e==="2","data-step":"2",children:[p.jsx(O,{children:"2. Product Information"}),p.jsx(F,{wrappingType:k.None,children:"Integer pellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec ppellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec pulvinar, sapien corper eu, posuere malesuada nisl. Integer pellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec pulvinar, sapien"}),p.jsx(be,{onChange:A,text:"Step Completed"}),p.jsx("br",{}),!n.step3Btn&&p.jsx(P,{design:L.Emphasized,onClick:h,children:"Step 3"})]}),p.jsxs(S,{icon:st,titleText:"Pricing",disabled:i[3],selected:e==="3","data-step":"3",children:[p.jsx(O,{children:"3. Pricing"}),p.jsx(F,{wrappingType:k.None,children:"Integer pellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec ppellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec pulvinar, sapien corper eu, posuere malesuada nisl. Integer pellentesque leo sit amet dui vehicula, quis ullamcorper est pulvinar. Nam in libero sem. Suspendisse arcu metus, molestie a turpis a, molestie aliquet dui. Donec pulvinar, sapien"}),p.jsx(ge,{placeholder:"Item Price",onInput:W}),p.jsx("br",{}),!n.finalizeBtn&&p.jsx(P,{design:L.Emphasized,onClick:N,children:"Finalize"})]})]})}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  render(args) {
...
}`,...C.parameters?.docs?.source}}};const gt=["Default"],Ct=Object.freeze(Object.defineProperty({__proto__:null,Default:C,__namedExportsOrder:gt,default:bt},Symbol.toStringTag,{value:"Module"}));export{Ct as C,C as D,S as W};
