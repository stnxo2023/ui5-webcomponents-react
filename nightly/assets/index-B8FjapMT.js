import"./Tag-CeuATfsT.js";import{w as n}from"./iframe-sceg0YFv.js";const e=n("ui5-tag",["colorScheme","design","size","wrappingType"],["hideStateIcon","interactive"],["icon"],["click"]);e.displayName="Tag";try{e.displayName="Tag",e.__docgenInfo={description:`The \`Tag\` is a component which serves
...
__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"Tag",props:{children:{defaultValue:null,description:`Defines the text of the component.
...
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"icon",required:!1,type:{name:"UI5WCSlotsNode"}},onClick:{defaultValue:null,description:`Fired when the user clicks on an interactive tag.
