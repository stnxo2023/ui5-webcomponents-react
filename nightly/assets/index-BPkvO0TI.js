import"./ToolbarButton-Dk7VXe3U.js";import{w as o}from"./iframe-C4t4IgBC.js";const e=o("ui5-toolbar",["accessibleName","accessibleNameRef","alignContent","design"],[],[],[]);e.displayName="Toolbar";try{e.displayName="Toolbar",e.__docgenInfo={description:`The \`Toolbar\` component is used to create a horizontal layout with items.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const t=o("ui5-toolbar-button",["accessibilityAttributes","accessibleName","accessibleNameRef","design","endIcon","icon","overflowPriority","text","tooltip","width"],["disabled","preventOverflowClosing","showOverflowText"],[],["click"]);t.displayName="ToolbarButton";try{t.displayName="ToolbarButton",t.__docgenInfo={description:`The \`ToolbarButton\` represents an abstract action,
used in the \`Toolbar\`.
