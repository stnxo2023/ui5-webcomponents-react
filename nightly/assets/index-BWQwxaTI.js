import{c as r,ah as b,ag as f,l as _,p as v,d as y,b as w,s as h,B as k,m as I,b6 as m,ai as T,c6 as N,b8 as D,c4 as S,cc as C,cd as M,ce as V,c5 as R,bd as U,c7 as q,A as x,cf as A,cg as E,ch as H,w as z}from"./iframe-D9-3X0JI.js";import{b as L,I as g}from"./Input-DADAhjMq.js";import{T as O,g as P}from"./Token-D4ouf1p4.js";import{v as W}from"./value-help-Cm1YqngL.js";function F(){return[L.call(this,{preContent:B,postContent:G})]}function B(){return _(f,{children:[r("span",{id:"hiddenText-nMore",class:"ui5-hidden-text",children:this._tokensCountText}),this.showValueHelpIcon&&r("span",{id:"hiddenText-value-help",class:"ui5-hidden-text",children:this._valueHelpText}),r(O,{class:"ui5-multi-input-tokenizer",opener:this.morePopoverOpener,popoverMinWidth:this._inputWidth,hidePopoverArrow:!0,expanded:this.tokenizerExpanded,onKeyDown:this._onTokenizerKeydown,onTokenDelete:this.tokenDelete,onFocusOut:this._tokenizerFocusOut,onShowMoreItemsPress:this._showMoreItemsPress,children:this.tokens.map(s=>r("slot",{name:s._individualSlot}))})]})}function G(){return r(f,{children:this.showValueHelpIcon&&r(b,{class:"inputIcon",name:W,accessibleName:this.valueHelpLabel,onMouseUp:this.valueHelpMouseUp,onMouseDown:this.valueHelpMouseDown,onClick:this.valueHelpPress})})}v("@ui5/webcomponents-theming","sap_horizon",async()=>y);v("@ui5/webcomponents","sap_horizon",async()=>w);const $=`.inputIcon{color:var(--_ui5-v2-16-1_input_icon_color);cursor:pointer;outline:none;padding:var(--_ui5-v2-16-1_input_icon_padding);border-inline-start:var(--_ui5-v2-16-1_input_icon_border);min-width:1rem;min-height:1rem;border-radius:var(--_ui5-v2-16-1_input_icon_border_radius)}.inputIcon.inputIcon--pressed{background:var(--_ui5-v2-16-1_input_icon_pressed_bg);box-shadow:var(--_ui5-v2-16-1_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-16-1_select_hover_icon_left_border);color:var(--_ui5-v2-16-1_input_icon_pressed_color)}.inputIcon:active{background-color:var(--sapButton_Active_Background);box-shadow:var(--_ui5-v2-16-1_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-16-1_select_hover_icon_left_border);color:var(--_ui5-v2-16-1_input_icon_pressed_color)}.inputIcon:not(.inputIcon--pressed):not(:active):hover{background:var(--_ui5-v2-16-1_input_icon_hover_bg);box-shadow:var(--_ui5-v2-16-1_input_icon_box_shadow)}.inputIcon:hover{border-inline-start:var(--_ui5-v2-16-1_select_hover_icon_left_border);box-shadow:var(--_ui5-v2-16-1_input_icon_box_shadow)}:host{min-width:calc(var(--_ui5-v2-16-1_input_min_width) + (var(--_ui5-v2-16-1-input-icons-count)*var(--_ui5-v2-16-1_input_icon_width)))}:host([tokenizer-available]){min-width:calc(var(--_ui5-v2-16-1_input_min_width) + (var(--_ui5-v2-16-1-input-icons-count)*var(--_ui5-v2-16-1_input_icon_width)) + var(--_ui5-v2-16-1_input_tokenizer_min_width))}.ui5-multi-input-tokenizer{min-width:var(--_ui5-v2-16-1_input_tokenizer_min_width);max-width:calc(100% - 3rem - var(--_ui5-v2-16-1-input-icons-count) * var(--_ui5-v2-16-1_input_icon_min_width));border:none;width:auto;height:100%}:host([readonly]) .ui5-multi-input-tokenizer::part(n-more-text){color:var(--sapLinkColor)}.ui5-multi-input-tokenizer::part(n-more-text){padding-inline-end:var(--_ui5-v2-16-1_input_inner_space_to_n_more_text)}[inner-input][inner-input-with-icon]{padding:var(--_ui5-v2-16-1_input_inner_padding_with_icon)}:host([tokenizer-available]) [inner-input]{padding-inline-start:var(--_ui5-v2-16-1_input_inner_space_to_tokenizer)}:host(:not([tokenizer-available])) .ui5-multi-input-tokenizer{--_ui5-v2-16-1_input_tokenizer_min_width: 0px;width:var(--_ui5-v2-16-1_input_tokenizer_min_width)}
`;var c=function(s,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,n);else for(var d=s.length-1;d>=0;d--)(a=s[d])&&(i=(o<3?a(i):o>3?a(e,t,i):a(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},u;let l=u=class extends g{get formValidity(){const e=this.tokens||[];return{valueMissing:this.required&&!this.value&&!e.length}}get formFormattedValue(){const e=this.tokens||[];if(e.length&&this.name){const t=new FormData;t.append(this.name,this.value);for(let n=0;n<e.length;n++)t.append(this.name,e[n].text||"");return t}return this.value}constructor(){super(),this.showValueHelpIcon=!1,this.tokenizerAvailable=!1,this._skipOpenSuggestions=!1,this._valueHelpIconPressed=!1}valueHelpPress(){this.closeValueStatePopover(),this.fireDecoratorEvent("value-help-trigger")}tokenDelete(e){const t=e.detail.tokens,n=this.tokens.filter(i=>i.selected),o=this.tokens.length-1===0||this.tokens.length===n.length;this._readonly||t&&(this.fireDecoratorEvent("token-delete",{tokens:t}),o&&this.focus())}valueHelpMouseDown(e){const t=e.target;this.closeValueStatePopover(),this.tokenizer.open=!1,this._valueHelpIconPressed=!0,t.focus()}_tokenizerFocusOut(e){!this.contains(e.relatedTarget)&&!this.shadowRoot.contains(e.relatedTarget)&&this.tokenizer._tokens.forEach(t=>{t.selected=!1})}valueHelpMouseUp(){setTimeout(()=>{this._valueHelpIconPressed=!1},0)}innerFocusIn(){this.tokenizer._scrollToEndOnExpand=!0,this.tokenizer.expanded=!0,this.focused=!0,this.tokens.forEach(e=>{e.selected=!1})}_showMoreItemsPress(){this.tokenizer._scrollToEndOnExpand=!0}_onkeydown(e){!this._isComposing&&super._onkeydown(e);const t=e.target;if(N(e)&&t.selectionStart===0)return this._skipOpenSuggestions=!0,this._focusFirstToken(e);if(D(e)&&this._internals.form&&e.preventDefault(),S(e))return this._skipOpenSuggestions=!0,this._handleLeft(e);if(C(e))return this._skipOpenSuggestions=!0,this._handleBackspace(e);this._skipOpenSuggestions=!1,M(e)&&this.valueHelpPress()}_onTokenizerKeydown(e){const t=V(e);if(R(e)||U(e)||q(e)||t){e.preventDefault();const n=this.tokens.length-1;e.target===this.tokens[n]&&this.tokens[n]===document.activeElement&&setTimeout(()=>{this.focus()},0)}}_handleLeft(e){const t=this.getDomRef().querySelector("input").selectionStart,n=this.tokens,o=n.length&&n[n.length-1];(t===null&&!this.value||t===0)&&o&&(e.preventDefault(),o.focus(),this.tokenizer._itemNav.setCurrentItem(o))}_handleBackspace(e){const t=this.getDomRef().querySelector("input").selectionStart,n=this.getDomRef().querySelector("input").selectionEnd,o=t===0&&n===this.value.length,i=this.tokens,a=i.length&&i[i.length-1];(!this.value||this.value&&t===0&&!o)&&a&&(e.preventDefault(),a.focus(),this.tokenizer._itemNav.setCurrentItem(a))}_focusFirstToken(e){const t=this.tokens,n=t.length&&t[0];n&&(e.preventDefault(),n.focus(),this.tokenizer._itemNav.setCurrentItem(n))}_onfocusout(e){super._onfocusout(e);const t=e.relatedTarget,n=this.contains(t),o=this.shadowRoot.contains(t);!n&&!o&&(this.tokenizer.expanded=!1),this.contains(t)&&t.hasAttribute("ui5-token")&&(this.focused=!1)}_onfocusin(e){const t=this.getInputDOMRef();e.target===t&&super._onfocusin(e)}onBeforeRendering(){super.onBeforeRendering(),this.style.setProperty(x("--_ui5-input-icons-count"),`${this.iconsCount}`),this.tokenizerAvailable=this.tokens&&this.tokens.length>0,this.tokenizer&&(this.tokenizer.readonly=this.readonly)}onAfterRendering(){super.onAfterRendering(),this.tokenizer.preventInitialFocus=!0}get iconsCount(){return super.iconsCount+(this.showValueHelpIcon?1:0)}get tokenizer(){return this.shadowRoot.querySelector("[ui5-tokenizer]")}get tokenizerExpanded(){return this.tokenizer&&this.tokenizer.expanded}get _tokensCountText(){return P(this.tokens.length)}get _valueHelpText(){return u.i18nBundle.getText(A)}get _tokensCountTextId(){return"hiddenText-nMore"}get _valueHelpTextId(){return this.showValueHelpIcon?"hiddenText-value-help":""}get _placeholder(){return this.tokens.length?"":this.placeholder}get accInfo(){const e=`${this._tokensCountTextId} ${this.suggestionsTextId} ${this.valueStateTextId} ${this._valueStateLinksShortcutsTextAccId} ${this._valueHelpTextId}`.trim();return{...super.accInfo,ariaRoledescription:this.ariaRoleDescription,ariaDescribedBy:e}}get valueHelpLabel(){return u.i18nBundle.getText(E)}get ariaRoleDescription(){return u.i18nBundle.getText(H)}get morePopoverOpener(){return this.tokens.length===1&&this.tokens[0].isTruncatable?this.tokens[0]:this}get shouldDisplayOnlyValueStateMessage(){return this.hasValueStateMessage&&!this.readonly&&!this.open&&this.focused&&!this.tokenizer.open}};c([h({type:Boolean})],l.prototype,"showValueHelpIcon",void 0);c([h({type:Boolean})],l.prototype,"tokenizerAvailable",void 0);c([h()],l.prototype,"name",void 0);c([k({type:HTMLElement,individualSlots:!0})],l.prototype,"tokens",void 0);l=u=c([I({tag:"ui5-multi-input",renderer:T,formAssociated:!0,template:F,styles:[g.styles,$]}),m("value-help-trigger",{bubbles:!0}),m("token-delete",{bubbles:!0})],l);l.define();const p=z("ui5-multi-input",["accessibleDescription","accessibleDescriptionRef","accessibleName","accessibleNameRef","maxlength","name","placeholder","type","value","valueState"],["disabled","noTypeahead","open","readonly","required","showClearIcon","showSuggestions","showValueHelpIcon"],["icon","tokens","valueStateMessage"],["change","close","input","open","select","selection-change","token-delete","value-help-trigger"]);p.displayName="MultiInput";try{p.displayName="MultiInput",p.__docgenInfo={description:"A `MultiInput` field allows the user to enter multiple values, which are displayed as `Token`.\n\nUser can choose interaction for creating tokens.\nFiori Guidelines say that user should create tokens when:\n\n- Type a value in the input and press enter or focus out the input field (`change` event is fired)\n- Move between suggestion items (`selection-change` event is fired)\n- Clicking on a suggestion item (`selection-change` event is fired if the clicked item is different than the current value. Also `change` event is fired )\n\n\n\n__Note:__ This is a UI5 Web Component! [MultiInput UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/MultiInput) | [Repository](https://github.com/UI5/webcomponents)",displayName:"MultiInput",props:{children:{defaultValue:null,description:"Defines the suggestion items.\n\n**Note:** The suggestions would be displayed only if the `showSuggestions`\nproperty is set to `true`.\n\n**Note:** The `<SuggestionItem>`, `<SuggestionItemGroup>` and `SuggestionItemCustom` are recommended to be used as suggestion items.\n\n__Supported Node Type/s:__ `Array<IInputSuggestionItem>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},icon:{defaultValue:null,description:`Defines the icon to be displayed in the component.
