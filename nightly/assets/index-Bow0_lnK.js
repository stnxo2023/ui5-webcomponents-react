import"./IllustratedMessage-Cf-o6GMJ.js";import{w as t}from"./iframe-BvHqSIyK.js";const e=t("ui5-illustrated-message",["accessibleNameRef","design","name","subtitleText","titleText"],["decorative"],["subtitle","title"],[]);e.displayName="IllustratedMessage";try{e.displayName="IllustratedMessage",e.__docgenInfo={description:`An IllustratedMessage is a recommended combination of a solution-oriented message, an engaging
...
__Note:__ This is a UI5 Web Component! [IllustratedMessage UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/IllustratedMessage) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"IllustratedMessage",props:{children:{defaultValue:null,description:"Defines the component actions.\n\n**Note:** Not displayed when the `design` property is set to `Base`.\n\n__Supported Node Type/s:__ `Array<IButton>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},subtitle:{defaultValue:null,description:`Defines the subtitle of the component.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"subtitle",required:!1,type:{name:"UI5WCSlotsNode"}},title:{defaultValue:null,description:`Defines the title of the component.
...
__Supported Node Type/s:__ \`Array<HTMLElement> & string\``,name:"title",required:!1,type:{name:"UI5WCSlotsNode"}},accessibleNameRef:{defaultValue:{value:"undefined"},description:`Receives id(or many ids) of the elements that label the component.
...
**Note:** Available since [v2.0.0](https://github.com/UI5/webcomponents/releases/tag/v2.0.0) of **@ui5/webcomponents-fiori**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Dialog"'},{value:'"Auto"'},{value:'"Large"'},{value:'"Auto"'},{value:'"Base"'},{value:'"Dot"'},{value:'"Spot"'},{value:'"Dialog"'},{value:'"Scene"'},{value:'"ExtraSmall"'},{value:'"Small"'},{value:'"Medium"'},{value:'"Large"'},{value:'"Base"'},{value:'"Dot"'},{value:'"Spot"'},{value:'"Scene"'},{value:'"ExtraSmall"'},{value:'"Small"'},{value:'"Medium"'}]}},name:{defaultValue:{value:'"BeforeSearch"'},description:`Defines the illustration name that will be displayed in the component.
