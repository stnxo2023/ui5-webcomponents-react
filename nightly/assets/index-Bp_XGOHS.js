import{k as y,c as i,p as b,d as _,s as l,Q as f,m as w,av as C,aA as N,e as c,f as g,d4 as v,w as S}from"./iframe-Qn10Vv46.js";import{d as x}from"./parameters-bundle.css-BZkrnAIc.js";var h;(function(o){o.Auto="Auto",o.Collapsed="Collapsed",o.Expanded="Expanded"})(h||(h={}));function T(){return y("div",{class:"ui5-nl-root",children:[i("header",{class:"ui5-nl-header",children:i("slot",{name:"header"})}),y("section",{class:"ui5-nl-section",children:[i("aside",{class:"ui5-nl-aside",children:i("slot",{name:"sideContent"})}),i("div",{class:"ui5-nl-content",children:i("slot",{})})]})]})}b("@ui5/webcomponents-theming","sap_horizon",async()=>_);b("@ui5/webcomponents-fiori","sap_horizon",async()=>x);const L=`:host(:not([hidden])){position:absolute;inset:0;display:block;background:var(--sapBackgroundColor);box-sizing:border-box;overflow:hidden}.ui5-nl-root{width:100%;height:100%;display:flex;flex-direction:column;box-sizing:border-box}.ui5-nl-header{z-index:3}.ui5-nl-section{display:flex;flex:1;min-height:0;position:relative}.ui5-nl-aside{transition:transform .3s;z-index:2}:host([is-phone]) .ui5-nl-aside{position:absolute;top:0;left:0;bottom:0;width:100%}:host([is-phone]) ::slotted([ui5-side-navigation][slot="sideContent"]){width:100%;box-shadow:none}.ui5-nl-content{flex:1;min-width:0;overflow:auto}:host([side-collapsed][is-phone]) .ui5-nl-aside{transform:translate(-100%)}:host([side-collapsed][is-phone]) :dir(rtl) .ui5-nl-aside{transform:translate(100%)}:host([has-side-navigation]) ::slotted([ui5-shellbar][slot="header"]){padding-inline:.875rem 1rem}
`;var n=function(o,t,s,d){var r=arguments.length,a=r<3?t:d===null?d=Object.getOwnPropertyDescriptor(t,s):d,p;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(o,t,s,d);else for(var u=o.length-1;u>=0;u--)(p=o[u])&&(a=(r<3?p(a):r>3?p(t,s,a):p(t,s))||a);return r>3&&a&&Object.defineProperty(t,s,a),a};let e=class extends N{constructor(){super(...arguments),this._defaultSideCollapsed=c()||g()&&!v(),this.mode="Auto",this.sideCollapsed=this._defaultSideCollapsed,this.hasSideNavigation=!1,this.isPhone=c(),this.isTablet=g()&&!v()}isSideCollapsed(){return this.calcSideCollapsed(),this.sideCollapsed}onBeforeRendering(){if(this.calcSideCollapsed(),c())return;const t=this.sideContent[0];this.hasSideNavigation=!!t,t&&(t.collapsed=this.isSideCollapsed())}calcSideCollapsed(){this.mode===h.Auto?this.sideCollapsed=this._defaultSideCollapsed:this.sideCollapsed=this.mode===h.Collapsed}};n([l()],e.prototype,"mode",void 0);n([l({type:Boolean})],e.prototype,"sideCollapsed",void 0);n([l({type:Boolean})],e.prototype,"hasSideNavigation",void 0);n([l({type:Boolean})],e.prototype,"isPhone",void 0);n([l({type:Boolean})],e.prototype,"isTablet",void 0);n([f()],e.prototype,"header",void 0);n([f()],e.prototype,"sideContent",void 0);n([f({type:HTMLElement,default:!0})],e.prototype,"content",void 0);e=n([w({tag:"ui5-navigation-layout",languageAware:!0,renderer:C,styles:[L],template:T})],e);e.define();const m=S("ui5-navigation-layout",["mode"],[],["header","sideContent"],[]);m.displayName="NavigationLayout";try{m.displayName="NavigationLayout",m.__docgenInfo={description:`The \`NavigationLayout\` is a container component that can be used to
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{h as N,m as a};
