...
`;var p=function(n,e,t,a){var i=arguments.length,o=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,a);else for(var u=n.length-1;u>=0;u--)(s=n[u])&&(o=(i<3?s(o):i>3?s(e,t,o):s(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o},_;const L=new Map,f={S:1,M:2,L:3,XL:6},K=["S","M","L","Xl"],v=12,J="4fr 8fr 0fr",Z="1fr";let m=_=class extends T{constructor(){super(...arguments),this.accessibleMode="Display",this.layout="S1 M1 L2 XL3",this.labelSpan="S12 M4 L4 XL4",this.emptySpan="S0 M0 L0 XL0",this.headerLevel="H2",this.itemSpacing="Normal",this.columnsS=1,this.labelSpanS=12,this.emptySpanS=0,this.columnsM=1,this.labelSpanM=4,this.emptySpanM=0,this.columnsL=2,this.labelSpanL=4,this.emptySpanL=0,this.columnsXl=3,this.labelSpanXl=4,this.emptySpanXl=0}onBeforeRendering(){this.setColumnLayout(),this.setFormItemLayout(),this.setGroupsColSpan(),this.setItemsState()}onAfterRendering(){this.createAdditionalCSSStyleSheet(),this.setFastNavGroup()}setColumnLayout(){this.layout.split(" ").forEach(t=>{t.startsWith("S")?this.columnsS=parseInt(t.slice(1)):t.startsWith("M")?this.columnsM=parseInt(t.slice(1)):t.startsWith("L")?this.columnsL=parseInt(t.slice(1)):t.startsWith("XL")&&(this.columnsXl=parseInt(t.slice(2)))})}parseFormItemSpan(){this.labelSpan.split(" ").forEach(e=>{e.startsWith("S")?this.labelSpanS=parseInt(e.slice(1)):e.startsWith("M")?this.labelSpanM=parseInt(e.slice(1)):e.startsWith("L")?this.labelSpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.labelSpanXl=parseInt(e.slice(2)))}),this.emptySpan.split(" ").forEach(e=>{e.startsWith("S")?this.emptySpanS=parseInt(e.slice(1)):e.startsWith("M")?this.emptySpanM=parseInt(e.slice(1)):e.startsWith("L")?this.emptySpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.emptySpanXl=parseInt(e.slice(2)))})}setFormItemLayout(){this.parseFormItemSpan(),[{breakpoint:"S",labelSpan:this.labelSpanS,emptySpan:this.emptySpanS},{breakpoint:"M",labelSpan:this.labelSpanM,emptySpan:this.emptySpanM},{breakpoint:"L",labelSpan:this.labelSpanL,emptySpan:this.emptySpanL},{breakpoint:"XL",labelSpan:this.labelSpanXl,emptySpan:this.emptySpanXl}].forEach(e=>{if(this.isValidFormItemLayout(e.labelSpan,e.emptySpan)){const t=e.labelSpan===v?"1fr":`${e.labelSpan}fr ${v-(e.labelSpan+e.emptySpan)}fr ${e.emptySpan}fr`;this.style.setProperty(`--ui5-form-item-layout-${e.breakpoint}`,t)}else console.warn(`Form :: invalid usage of emptySpan and/or labelSpan in ${e.breakpoint} size. The labelSpan must be <=12 and when emptySpace is used - their combined values must not exceed 11.`),this.style.setProperty(`--ui5-form-item-layout-${e.breakpoint}`,e.breakpoint==="S"?Z:J)})}isValidFormItemLayout(e,t){return t===0?e<=v:e+t<=v-1}setFastNavGroup(){this.hasGroupItems?this.removeAttribute("data-sap-ui-fastnavgroup"):this.setAttribute("data-sap-ui-fastnavgroup","true")}setGroupsColSpan(){if(!this.hasGroupItems)return;const e=this.items.length;[...this.items].sort((a,i)=>i?.items.length-a?.items.length).forEach((a,i)=>{a.colsXl=this.getGroupsColSpan(this.columnsXl,e,i,a),a.colsL=this.getGroupsColSpan(this.columnsL,e,i,a),a.colsM=this.getGroupsColSpan(this.columnsM,e,i,a),a.colsS=this.getGroupsColSpan(this.columnsS,e,i,a)})}getGroupsColSpan(e,t,a,i){if(i.columnSpan)return i.columnSpan;if(e===1||e<=t)return 1;if(e%t===0)return e/t;const o=1,s=e-t;return s<=t?a<s?o+1:o:a===0?o+(s-t)+1:o+1}setItemsState(){this.items.forEach(e=>{e.itemSpacing=this.itemSpacing,e.accessibleMode=this.accessibleMode})}get hasGroupItems(){return this.items.some(e=>e.isGroup)}get hasHeader(){return this.hasCustomHeader||this.hasHeaderText}get hasHeaderText(){return!!this.headerText}get hasCustomHeader(){return!!this.header.length}get effectiveAccessibleName(){return this.accessibleName||this.accessibleNameRef?U(this):this.hasHeader?void 0:_.i18nBundle.getText(z)}get effectiveАccessibleNameRef(){if(!(this.accessibleName||this.accessibleNameRef))return this.hasHeaderText&&!this.hasCustomHeader?`${this._id}-header-text`:void 0}get effectiveAccessibleRole(){return this.hasGroupItems?"region":"form"}get groupItemsInfo(){return this.items.map((e,t)=>{const a=this.getItemsInfo(Array.from(e.children));K.forEach(o=>{const s=e[`cols${o}`]||1,u=Math.ceil(a.length/s),b=s*u,W=s-(b-a.length)-1;let E=0;for(let g=0;g<b;g++){const A=Math.floor(g/u),H=g%u;H===u-1&&A>W||(a[E].item.style.setProperty(`--ui5-form-item-order-${o}`,`${A+H*s}`),E++)}});const i=e.effectiveAccessibleNameRef;return{groupItem:e,accessibleName:this.accessibleMode==="Edit"?e.getEffectiveAccessibleName(t):void 0,accessibleNameInner:this.accessibleMode==="Edit"?void 0:e.getEffectiveAccessibleName(t),accessibleNameRef:this.accessibleMode==="Edit"?i:void 0,accessibleNameRefInner:this.accessibleMode==="Edit"?void 0:i,items:this.getItemsInfo(Array.from(e.children)),role:this.accessibleMode==="Edit"?"form":void 0}})}get itemsInfo(){return this.getItemsInfo()}getItemsInfo(e){return(e||this.items).map(t=>({item:t,classes:t.columnSpan?`ui5-form-item-span-${t.columnSpan}`:"",classMap:{[`ui5-form-item-span-${t.columnSpan}`]:t.columnSpan!==void 0}}))}createAdditionalCSSStyleSheet(){[{breakpoint:"S",columns:this.columnsS},{breakpoint:"M",columns:this.columnsM},{breakpoint:"L",columns:this.columnsL},{breakpoint:"XL",columns:this.columnsXl}].forEach(e=>{const t=this.getAdditionalCSS(e.breakpoint,e.columns);t&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.getCSSStyleSheet(t)])})}getAdditionalCSS(e,t){if(f[e]>=t)return;const a=`${e}-${t}`;if(!L.has(a)){let i,o=f.S,s="",u=t;for(e==="S"?(o=f.S,i="@container (max-width: 599px) {"):e==="M"?(o=f.M,i="@container (width > 599px) and (width < 1024px) {"):e==="L"?(o=f.L,i="@container (width > 1023px) and (width < 1439px) {"):e==="XL"&&(i="@container (min-width: 1440px) {",o=f.XL);u>o;)s+=`
				...
				`,u--;const b=`${i}${s}}`;L.set(a,b)}return L.get(a)}getCSSStyleSheet(e){const t=new CSSStyleSheet;return t.replaceSync(e),t}};p([r()],m.prototype,"accessibleName",void 0);p([r()],m.prototype,"accessibleNameRef",void 0);p([r()],m.prototype,"accessibleMode",void 0);p([r()],m.prototype,"layout",void 0);p([r()],m.prototype,"labelSpan",void 0);p([r()],m.prototype,"emptySpan",void 0);p([r()],m.prototype,"headerText",void 0);p([r()],m.prototype,"headerLevel",void 0);p([r()],m.prototype,"itemSpacing",void 0);p([O()],m.prototype,"header",void 0);p([O({type:HTMLElement,default:!0,individualSlots:!0,invalidateOnChildChange:!0})],m.prototype,"items",void 0);p([r({type:Number})],m.prototype,"columnsS",void 0);p([r({type:Number})],m.prototype,"labelSpanS",void 0);p([r({type:Number})],m.prototype,"emptySpanS",void 0);p([r({type:Number})],m.prototype,"columnsM",void 0);p([r({type:Number})],m.prototype,"labelSpanM",void 0);p([r({type:Number})],m.prototype,"emptySpanM",void 0);p([r({type:Number})],m.prototype,"columnsL",void 0);p([r({type:Number})],m.prototype,"labelSpanL",void 0);p([r({type:Number})],m.prototype,"emptySpanL",void 0);p([r({type:Number})],m.prototype,"columnsXl",void 0);p([r({type:Number})],m.prototype,"labelSpanXl",void 0);p([r({type:Number})],m.prototype,"emptySpanXl",void 0);p([V("@ui5/webcomponents")],m,"i18nBundle",void 0);m=_=p([M({tag:"ui5-form",renderer:q,styles:Q,template:P})],m);m.define();const F=C("ui5-form",["accessibleMode","accessibleName","accessibleNameRef","emptySpan","headerLevel","headerText","itemSpacing","labelSpan","layout"],[],["header"],[]);F.displayName="Form";try{F.displayName="Form",F.__docgenInfo={description:`The Form is a layout component that arranges labels and form fields (like input fields) pairs
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function ee(){return l("div",{class:"ui5-form-item-root",children:l("div",{class:"ui5-form-item-layout",part:"layout",children:this.accessibleMode==="Edit"?te.call(this):oe.call(this)})})}function te(){return S(j,{children:[l("div",{class:"ui5-form-item-label",part:"label",children:l("slot",{name:"labelContent"})}),l("div",{class:"ui5-form-item-content",part:"content",children:this.content.map(n=>l("div",{class:"ui5-form-item-content-child",children:l("slot",{name:n._individualSlot})}))})]})}function oe(){return S(j,{children:[l("dt",{class:"ui5-form-item-label",part:"label",children:l("slot",{name:"labelContent"})}),l("dd",{class:"ui5-form-item-content",part:"content",children:this.content.map(n=>l("div",{class:"ui5-form-item-content-child",children:l("slot",{name:n._individualSlot})}))})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>D);w("@ui5/webcomponents","sap_horizon",async()=>$,"host");const ne=`:host(:not([hidden])){display:block;width:100%}:host([column-span="1"]){grid-column:span 1}:host([column-span="2"]){grid-column:span 2}:host([column-span="3"]){grid-column:span 3}:host([column-span="4"]){grid-column:span 4}:host([column-span="5"]){grid-column:span 5}:host([column-span="6"]){grid-column:span 6}.ui5-form-item-root{background-color:inherit;color:inherit}.ui5-form-item-layout{display:grid;grid-template-columns:var(--ui5-form-item-layout, 4fr 8fr 0fr);align-items:center}.ui5-form-item-label{padding:var(--ui5-form-item-label-padding, .125rem 0);padding-inline-end:.85rem;justify-self:var(--ui5-form-item-label-justify, end)}.ui5-form-item-content{overflow:hidden;width:100%;display:flex;padding:0 .25rem}.ui5-form-item-content-child{padding-inline-end:.5rem;box-sizing:border-box;width:100%}:host([item-spacing="Large"]) .ui5-form-item-layout{min-height:var(--_ui5_form_item_min_height);padding-top:var(--_ui5_form_item_padding);padding-bottom:var(--_ui5_form_item_padding);box-sizing:border-box}::slotted(*){width:100%}@container (max-width: 600px){:host{order:var(--ui5-form-item-order-S, unset)}}@container (width > 600px) and (width <= 1024px){:host{order:var(--ui5-form-item-order-M, unset)}}@container (width > 1024px) and (width <= 1440px){:host{order:var(--ui5-form-item-order-L, unset)}}@container (min-width: 1441px){:host{order:var(--ui5-form-item-order-Xl, unset)}}dd{all:unset}
`;var y=function(n,e,t,a){var i=arguments.length,o=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,e,t,a);else for(var u=n.length-1;u>=0;u--)(s=n[u])&&(o=(i<3?s(o):i>3?s(e,t,o):s(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let h=class extends T{constructor(){super(...arguments),this.itemSpacing="Normal",this.accessibleMode="Display"}get isGroup(){return!1}};y([r({type:Number})],h.prototype,"columnSpan",void 0);y([G()],h.prototype,"labelContent",void 0);y([G({type:HTMLElement,default:!0,individualSlots:!0})],h.prototype,"content",void 0);y([r()],h.prototype,"itemSpacing",void 0);y([r()],h.prototype,"accessibleMode",void 0);h=y([M({tag:"ui5-form-item",renderer:q,styles:ne,template:ee})],h);h.define();const I=C("ui5-form-item",["columnSpan"],[],["labelContent"],[]);I.displayName="FormItem";try{I.displayName="FormItem",I.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{F,x as a,I as b};
