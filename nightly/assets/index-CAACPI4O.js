...
`;var p=function(r,e,t,n){var a=arguments.length,o=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,n);else for(var u=r.length-1;u>=0;u--)(m=r[u])&&(o=(a<3?m(o):a>3?m(e,t,o):m(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o},L;const F=new Map,f={S:1,M:2,L:3,XL:6},Q=["S","M","L","Xl"],S=12,J="4fr 8fr 0fr",Z="1fr";let l=L=class extends T{constructor(){super(...arguments),this.accessibleMode="Display",this.layout="S1 M1 L2 XL3",this.labelSpan="S12 M4 L4 XL4",this.emptySpan="S0 M0 L0 XL0",this.headerLevel="H2",this.itemSpacing="Normal",this.columnsS=1,this.labelSpanS=12,this.emptySpanS=0,this.columnsM=1,this.labelSpanM=4,this.emptySpanM=0,this.columnsL=2,this.labelSpanL=4,this.emptySpanL=0,this.columnsXl=3,this.labelSpanXl=4,this.emptySpanXl=0}onBeforeRendering(){this.setColumnLayout(),this.setFormItemLayout(),this.setGroupsColSpan(),this.setItemsState()}onAfterRendering(){this.createAdditionalCSSStyleSheet(),this.setFastNavGroup()}setColumnLayout(){this.layout.split(" ").forEach(t=>{t.startsWith("S")?this.columnsS=parseInt(t.slice(1)):t.startsWith("M")?this.columnsM=parseInt(t.slice(1)):t.startsWith("L")?this.columnsL=parseInt(t.slice(1)):t.startsWith("XL")&&(this.columnsXl=parseInt(t.slice(2)))})}parseFormItemSpan(){this.labelSpan.split(" ").forEach(e=>{e.startsWith("S")?this.labelSpanS=parseInt(e.slice(1)):e.startsWith("M")?this.labelSpanM=parseInt(e.slice(1)):e.startsWith("L")?this.labelSpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.labelSpanXl=parseInt(e.slice(2)))}),this.emptySpan.split(" ").forEach(e=>{e.startsWith("S")?this.emptySpanS=parseInt(e.slice(1)):e.startsWith("M")?this.emptySpanM=parseInt(e.slice(1)):e.startsWith("L")?this.emptySpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.emptySpanXl=parseInt(e.slice(2)))})}setFormItemLayout(){this.parseFormItemSpan(),[{breakpoint:"S",labelSpan:this.labelSpanS,emptySpan:this.emptySpanS},{breakpoint:"M",labelSpan:this.labelSpanM,emptySpan:this.emptySpanM},{breakpoint:"L",labelSpan:this.labelSpanL,emptySpan:this.emptySpanL},{breakpoint:"XL",labelSpan:this.labelSpanXl,emptySpan:this.emptySpanXl}].forEach(e=>{if(this.isValidFormItemLayout(e.labelSpan,e.emptySpan)){const t=e.labelSpan===S?"1fr":`${e.labelSpan}fr ${S-(e.labelSpan+e.emptySpan)}fr ${e.emptySpan}fr`;this.style.setProperty(`--ui5-form-item-layout-${e.breakpoint}`,t)}else console.warn(`Form :: invalid usage of emptySpan and/or labelSpan in ${e.breakpoint} size. The labelSpan must be <=12 and when emptySpace is used - their combined values must not exceed 11.`),this.style.setProperty(`--ui5-form-item-layout-${e.breakpoint}`,e.breakpoint==="S"?Z:J)})}isValidFormItemLayout(e,t){return t===0?e<=S:e+t<=S-1}setFastNavGroup(){this.hasGroupItems?this.removeAttribute("data-sap-ui-fastnavgroup"):this.setAttribute("data-sap-ui-fastnavgroup","true")}setGroupsColSpan(){if(!this.hasGroupItems)return;const e=this.items.length;[...this.items].sort((n,a)=>a?.items.length-n?.items.length).forEach((n,a)=>{n.colsXl=this.getGroupsColSpan(this.columnsXl,e,a,n),n.colsL=this.getGroupsColSpan(this.columnsL,e,a,n),n.colsM=this.getGroupsColSpan(this.columnsM,e,a,n),n.colsS=this.getGroupsColSpan(this.columnsS,e,a,n)})}getGroupsColSpan(e,t,n,a){if(a.columnSpan)return a.columnSpan;if(e===1||e<=t)return 1;if(e%t===0)return e/t;const o=1,m=e-t;return m<=t?n<m?o+1:o:n===0?o+(m-t)+1:o+1}setItemsState(){this.items.forEach(e=>{e.itemSpacing=this.itemSpacing,e.accessibleMode=this.accessibleMode})}get hasGroupItems(){return this.items.some(e=>e.isGroup)}get hasHeader(){return this.hasCustomHeader||this.hasHeaderText}get hasHeaderText(){return!!this.headerText}get hasCustomHeader(){return!!this.header.length}get effectiveAccessibleName(){return this.accessibleName||this.accessibleNameRef?U(this):this.hasHeader?void 0:L.i18nBundle.getText(O)}get effectiveАccessibleNameRef(){if(!(this.accessibleName||this.accessibleNameRef))return this.hasHeaderText&&!this.hasCustomHeader?`${this._id}-header-text`:void 0}get effectiveAccessibleRole(){return this.hasGroupItems?"region":"form"}get groupItemsInfo(){return this.items.map((e,t)=>{const n=this.getItemsInfo(Array.from(e.children));Q.forEach(o=>{const m=e[`cols${o}`]||1,u=Math.ceil(n.length/m),y=m*u,z=m-(y-n.length)-1;let A=0;for(let g=0;g<y;g++){const R=Math.floor(g/u),E=g%u;E===u-1&&R>z||(n[A].item.style.setProperty(`--ui5-form-item-order-${o}`,`${R+E*m}`),A++)}});const a=e.effectiveAccessibleNameRef;return{groupItem:e,accessibleName:this.accessibleMode==="Edit"?e.getEffectiveAccessibleName(t):void 0,accessibleNameInner:this.accessibleMode==="Edit"?void 0:e.getEffectiveAccessibleName(t),accessibleNameRef:this.accessibleMode==="Edit"?a:void 0,accessibleNameRefInner:this.accessibleMode==="Edit"?void 0:a,items:this.getItemsInfo(Array.from(e.children)),role:this.accessibleMode==="Edit"?"form":void 0}})}get itemsInfo(){return this.getItemsInfo()}getItemsInfo(e){return(e||this.items).map(t=>({item:t,classes:t.columnSpan?`ui5-form-item-span-${t.columnSpan}`:"",classMap:{[`ui5-form-item-span-${t.columnSpan}`]:t.columnSpan!==void 0}}))}createAdditionalCSSStyleSheet(){[{breakpoint:"S",columns:this.columnsS},{breakpoint:"M",columns:this.columnsM},{breakpoint:"L",columns:this.columnsL},{breakpoint:"XL",columns:this.columnsXl}].forEach(e=>{const t=this.getAdditionalCSS(e.breakpoint,e.columns);t&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.getCSSStyleSheet(t)])})}getAdditionalCSS(e,t){if(f[e]>=t)return;const n=`${e}-${t}`;if(!F.has(n)){let a,o=f.S,m="",u=t;for(e==="S"?(o=f.S,a="@container (max-width: 599px) {"):e==="M"?(o=f.M,a="@container (width > 599px) and (width < 1024px) {"):e==="L"?(o=f.L,a="@container (width > 1023px) and (width < 1439px) {"):e==="XL"&&(a="@container (min-width: 1440px) {",o=f.XL);u>o;)m+=`
				...
				`,u--;const y=`${a}${m}}`;F.set(n,y)}return F.get(n)}getCSSStyleSheet(e){const t=new CSSStyleSheet;return t.replaceSync(e),t}};p([i()],l.prototype,"accessibleName",void 0);p([i()],l.prototype,"accessibleNameRef",void 0);p([i()],l.prototype,"accessibleMode",void 0);p([i()],l.prototype,"layout",void 0);p([i()],l.prototype,"labelSpan",void 0);p([i()],l.prototype,"emptySpan",void 0);p([i()],l.prototype,"headerText",void 0);p([i()],l.prototype,"headerLevel",void 0);p([i()],l.prototype,"itemSpacing",void 0);p([W()],l.prototype,"header",void 0);p([W({type:HTMLElement,default:!0,individualSlots:!0,invalidateOnChildChange:!0})],l.prototype,"items",void 0);p([i({type:Number})],l.prototype,"columnsS",void 0);p([i({type:Number})],l.prototype,"labelSpanS",void 0);p([i({type:Number})],l.prototype,"emptySpanS",void 0);p([i({type:Number})],l.prototype,"columnsM",void 0);p([i({type:Number})],l.prototype,"labelSpanM",void 0);p([i({type:Number})],l.prototype,"emptySpanM",void 0);p([i({type:Number})],l.prototype,"columnsL",void 0);p([i({type:Number})],l.prototype,"labelSpanL",void 0);p([i({type:Number})],l.prototype,"emptySpanL",void 0);p([i({type:Number})],l.prototype,"columnsXl",void 0);p([i({type:Number})],l.prototype,"labelSpanXl",void 0);p([i({type:Number})],l.prototype,"emptySpanXl",void 0);p([V("@ui5/webcomponents")],l,"i18nBundle",void 0);l=L=p([M({tag:"ui5-form",renderer:q,styles:K,template:P})],l);l.define();const _=C("ui5-form",["accessibleMode","accessibleName","accessibleNameRef","emptySpan","headerLevel","headerText","itemSpacing","labelSpan","layout"],[],["header"],[]);_.displayName="Form";try{_.displayName="Form",_.__docgenInfo={description:`The Form is a layout component that arranges labels and form fields (like input fields) pairs
...
**Note:** Available since [v2.16.0](https://github.com/UI5/webcomponents/releases/tag/v2.16.0) of **@ui5/webcomponents**.`,name:"accessibleMode",required:!1,type:{name:'FormAccessibleMode | "Display" | "Edit"'}},accessibleName:{defaultValue:{value:"undefined"},description:`Defines the accessible ARIA name of the component.
...
**Note:** Available since [v2.10.0](https://github.com/UI5/webcomponents/releases/tag/v2.10.0) of **@ui5/webcomponents**.`,name:"headerLevel",required:!1,type:{name:'TitleLevel | "H1" | "H2" | "H3" | "H4" | "H5" | "H6"'}},headerText:{defaultValue:{value:"undefined"},description:"Defines the header text of the component.\n\n**Note:** The property gets overridden by the `header` slot.",name:"headerText",required:!1,type:{name:"string"}},itemSpacing:{defaultValue:{value:'"Normal"'},description:`Defines the vertical spacing between form items.
...
to avoid "jumping" effect, caused by the hight difference between texts in "display"("non-edit") mode and the input fields in "edit" mode.`,name:"itemSpacing",required:!1,type:{name:'"Normal" | FormItemSpacing | "Large"'}},labelSpan:{defaultValue:{value:'"S12 M4 L4 XL4"'},description:`Defines the width proportion of the labels and fields of a form item by breakpoint.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var d=function(r,e,t,n){var a=arguments.length,o=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,n);else for(var u=r.length-1;u>=0;u--)(m=r[u])&&(o=(a<3?m(o):a>3?m(e,t,o):m(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o},N;let c=N=class extends T{constructor(){super(...arguments),this.headerLevel="H3",this.colsS=1,this.colsM=1,this.colsL=1,this.colsXl=1,this.itemSpacing="Normal"}onBeforeRendering(){this.processFormItems()}processFormItems(){this.items.forEach(e=>{e.itemSpacing=this.itemSpacing})}getEffectiveAccessibleName(e){if(this.accessibleName||this.accessibleNameRef)return U(this);if(!this.headerText)return N.i18nBundle.getText(B,e+1)}get effectiveAccessibleNameRef(){if(!(this.accessibleName||this.accessibleNameRef))return this.headerText?`${this._id}-group-header-text`:void 0}get isGroup(){return!0}};d([i()],c.prototype,"headerText",void 0);d([i()],c.prototype,"headerLevel",void 0);d([i({type:Number})],c.prototype,"columnSpan",void 0);d([i()],c.prototype,"accessibleName",void 0);d([i()],c.prototype,"accessibleNameRef",void 0);d([G({type:HTMLElement,default:!0})],c.prototype,"items",void 0);d([i({type:Number})],c.prototype,"colsS",void 0);d([i({type:Number})],c.prototype,"colsM",void 0);d([i({type:Number})],c.prototype,"colsL",void 0);d([i({type:Number})],c.prototype,"colsXl",void 0);d([i()],c.prototype,"itemSpacing",void 0);d([V("@ui5/webcomponents")],c,"i18nBundle",void 0);c=N=d([M({tag:"ui5-form-group",fastNavigation:!0})],c);c.define();const x=C("ui5-form-group",["accessibleName","accessibleNameRef","columnSpan","headerLevel","headerText"],[],[],[]);x.displayName="FormGroup";try{x.displayName="FormGroup",x.__docgenInfo={description:`The FormGroup (ui5-form-group) represents a group inside the Form (ui5-form) component
...
**Note:** Available since [v2.10.0](https://github.com/UI5/webcomponents/releases/tag/v2.10.0) of **@ui5/webcomponents**.`,name:"headerLevel",required:!1,type:{name:'TitleLevel | "H1" | "H2" | "H3" | "H4" | "H5" | "H6"'}},headerText:{defaultValue:{value:"undefined"},description:"Defines header text of the component.",name:"headerText",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.

__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function ee(){return s("div",{class:"ui5-form-item-root",children:s("div",{class:"ui5-form-item-layout",part:"layout",children:this.accessibleMode==="Edit"?te.call(this):oe.call(this)})})}function te(){return v(j,{children:[s("div",{class:"ui5-form-item-label",part:"label",children:s("slot",{name:"labelContent"})}),s("div",{class:"ui5-form-item-content",part:"content",children:this.content.map(r=>s("div",{class:"ui5-form-item-content-child",children:s("slot",{name:r._individualSlot})}))})]})}function oe(){return v(j,{children:[s("dt",{class:"ui5-form-item-label",part:"label",children:s("slot",{name:"labelContent"})}),s("dd",{class:"ui5-form-item-content",part:"content",children:this.content.map(r=>s("div",{class:"ui5-form-item-content-child",children:s("slot",{name:r._individualSlot})}))})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>H);w("@ui5/webcomponents","sap_horizon",async()=>$,"host");const ne=`:host(:not([hidden])){display:block;width:100%}:host([column-span="1"]){grid-column:span 1}:host([column-span="2"]){grid-column:span 2}:host([column-span="3"]){grid-column:span 3}:host([column-span="4"]){grid-column:span 4}:host([column-span="5"]){grid-column:span 5}:host([column-span="6"]){grid-column:span 6}.ui5-form-item-root{background-color:inherit;color:inherit}.ui5-form-item-layout{display:grid;grid-template-columns:var(--ui5-form-item-layout, 4fr 8fr 0fr);align-items:center}.ui5-form-item-label{padding:var(--ui5-form-item-label-padding, .125rem 0);padding-inline-end:.85rem;justify-self:var(--ui5-form-item-label-justify, end)}.ui5-form-item-content{overflow:hidden;width:100%;display:flex;padding:0 .25rem}.ui5-form-item-content-child{padding-inline-end:.5rem;box-sizing:border-box;width:100%}:host([item-spacing="Large"]) .ui5-form-item-layout{min-height:var(--_ui5_form_item_min_height);padding-top:var(--_ui5_form_item_padding);padding-bottom:var(--_ui5_form_item_padding);box-sizing:border-box}::slotted(*){width:100%}@container (max-width: 600px){:host{order:var(--ui5-form-item-order-S, unset)}}@container (width > 600px) and (width <= 1024px){:host{order:var(--ui5-form-item-order-M, unset)}}@container (width > 1024px) and (width <= 1440px){:host{order:var(--ui5-form-item-order-L, unset)}}@container (min-width: 1441px){:host{order:var(--ui5-form-item-order-Xl, unset)}}dd{all:unset}
`;var b=function(r,e,t,n){var a=arguments.length,o=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,n);else for(var u=r.length-1;u>=0;u--)(m=r[u])&&(o=(a<3?m(o):a>3?m(e,t,o):m(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let h=class extends T{constructor(){super(...arguments),this.itemSpacing="Normal",this.accessibleMode="Display"}get isGroup(){return!1}};b([i({type:Number})],h.prototype,"columnSpan",void 0);b([G()],h.prototype,"labelContent",void 0);b([G({type:HTMLElement,default:!0,individualSlots:!0})],h.prototype,"content",void 0);b([i()],h.prototype,"itemSpacing",void 0);b([i()],h.prototype,"accessibleMode",void 0);h=b([M({tag:"ui5-form-item",renderer:q,styles:ne,template:ee})],h);h.define();const I=C("ui5-form-item",["columnSpan"],[],["labelContent"],[]);I.displayName="FormItem";try{I.displayName="FormItem",I.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{_ as F,x as a,I as b};
