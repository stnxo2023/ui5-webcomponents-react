import{c as r,ah as b,ag as f,l as _,p as v,d as y,b as w,s as h,B as k,m as I,b6 as m,ai as T,c6 as N,b8 as D,c4 as S,cc as C,cd as M,ce as V,c5 as R,bd as U,c7 as q,A as x,cf as A,cg as E,ch as H,w as z}from"./iframe-D7AtRUpE.js";import{b as L,I as g}from"./Input-BNhpkyEe.js";import{T as O,g as P}from"./Token-Bn9BgD8D.js";import{v as W}from"./value-help-PQcb1gUG.js";function F(){return[L.call(this,{preContent:B,postContent:G})]}function B(){return _(f,{children:[r("span",{id:"hiddenText-nMore",class:"ui5-hidden-text",children:this._tokensCountText}),this.showValueHelpIcon&&r("span",{id:"hiddenText-value-help",class:"ui5-hidden-text",children:this._valueHelpText}),r(O,{class:"ui5-multi-input-tokenizer",opener:this.morePopoverOpener,popoverMinWidth:this._inputWidth,hidePopoverArrow:!0,expanded:this.tokenizerExpanded,onKeyDown:this._onTokenizerKeydown,onTokenDelete:this.tokenDelete,onFocusOut:this._tokenizerFocusOut,onShowMoreItemsPress:this._showMoreItemsPress,children:this.tokens.map(s=>r("slot",{name:s._individualSlot}))})]})}function G(){return r(f,{children:this.showValueHelpIcon&&r(b,{class:"inputIcon",name:W,accessibleName:this.valueHelpLabel,onMouseUp:this.valueHelpMouseUp,onMouseDown:this.valueHelpMouseDown,onClick:this.valueHelpPress})})}v("@ui5/webcomponents-theming","sap_horizon",async()=>y);v("@ui5/webcomponents","sap_horizon",async()=>w);const $=`.inputIcon{color:var(--_ui5-v2-16-0_input_icon_color);cursor:pointer;outline:none;padding:var(--_ui5-v2-16-0_input_icon_padding);border-inline-start:var(--_ui5-v2-16-0_input_icon_border);min-width:1rem;min-height:1rem;border-radius:var(--_ui5-v2-16-0_input_icon_border_radius)}.inputIcon.inputIcon--pressed{background:var(--_ui5-v2-16-0_input_icon_pressed_bg);box-shadow:var(--_ui5-v2-16-0_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-16-0_select_hover_icon_left_border);color:var(--_ui5-v2-16-0_input_icon_pressed_color)}.inputIcon:active{background-color:var(--sapButton_Active_Background);box-shadow:var(--_ui5-v2-16-0_input_icon_box_shadow);border-inline-start:var(--_ui5-v2-16-0_select_hover_icon_left_border);color:var(--_ui5-v2-16-0_input_icon_pressed_color)}.inputIcon:not(.inputIcon--pressed):not(:active):hover{background:var(--_ui5-v2-16-0_input_icon_hover_bg);box-shadow:var(--_ui5-v2-16-0_input_icon_box_shadow)}.inputIcon:hover{border-inline-start:var(--_ui5-v2-16-0_select_hover_icon_left_border);box-shadow:var(--_ui5-v2-16-0_input_icon_box_shadow)}:host{min-width:calc(var(--_ui5-v2-16-0_input_min_width) + (var(--_ui5-v2-16-0-input-icons-count)*var(--_ui5-v2-16-0_input_icon_width)))}:host([tokenizer-available]){min-width:calc(var(--_ui5-v2-16-0_input_min_width) + (var(--_ui5-v2-16-0-input-icons-count)*var(--_ui5-v2-16-0_input_icon_width)) + var(--_ui5-v2-16-0_input_tokenizer_min_width))}.ui5-multi-input-tokenizer{min-width:var(--_ui5-v2-16-0_input_tokenizer_min_width);max-width:calc(100% - 3rem - var(--_ui5-v2-16-0-input-icons-count) * var(--_ui5-v2-16-0_input_icon_min_width));border:none;width:auto;height:100%}:host([readonly]) .ui5-multi-input-tokenizer::part(n-more-text){color:var(--sapLinkColor)}.ui5-multi-input-tokenizer::part(n-more-text){padding-inline-end:var(--_ui5-v2-16-0_input_inner_space_to_n_more_text)}[inner-input][inner-input-with-icon]{padding:var(--_ui5-v2-16-0_input_inner_padding_with_icon)}:host([tokenizer-available]) [inner-input]{padding-inline-start:var(--_ui5-v2-16-0_input_inner_space_to_tokenizer)}:host(:not([tokenizer-available])) .ui5-multi-input-tokenizer{--_ui5-v2-16-0_input_tokenizer_min_width: 0px;width:var(--_ui5-v2-16-0_input_tokenizer_min_width)}
