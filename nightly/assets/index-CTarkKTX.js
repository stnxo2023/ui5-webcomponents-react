...
**Note:** Available since [v2.6.0](https://github.com/UI5/webcomponents/releases/tag/v2.6.0) of **@ui5/webcomponents**.`,name:"size",required:!1,type:{name:"enum",value:[{value:'"S"'},{value:'"L"'},{value:'"M"'},{value:'"S"'},{value:'"M"'},{value:'"L"'}]}},tooltip:{defaultValue:{value:"undefined"},description:`Defines the tooltip of the component.
