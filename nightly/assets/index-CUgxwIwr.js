...
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},accessibleName:{defaultValue:{value:"undefined"},description:`Defines the accessible ARIA name of the component.
...
to avoid "jumping" effect, caused by the hight difference between texts in "non-edit" mode and the input fields in "edit" mode.`,name:"itemSpacing",required:!1,type:{name:"enum",value:[{value:'"Large"'},{value:'"Normal"'},{value:'"Normal"'},{value:'"Large"'}]}},labelSpan:{defaultValue:{value:'"S12 M4 L4 XL4"'},description:`Defines the width proportion of the labels and fields of a form item by breakpoint.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function O(){return p("div",{class:"ui5-form-item-root",children:N("div",{class:"ui5-form-item-layout",part:"layout",children:[p("div",{class:"ui5-form-item-label",part:"label",children:p("slot",{name:"labelContent"})}),p("div",{class:"ui5-form-item-content",part:"content",children:this.content.map(i=>p("div",{class:"ui5-form-item-content-child",children:p("slot",{name:i._individualSlot})}))})]})})}L("@ui5/webcomponents-theming","sap_horizon",async()=>E);L("@ui5/webcomponents","sap_horizon",async()=>V);const P=`:host(:not([hidden])){display:block;width:100%}:host([column-span="1"]){grid-column:span 1}:host([column-span="2"]){grid-column:span 2}:host([column-span="3"]){grid-column:span 3}:host([column-span="4"]){grid-column:span 4}:host([column-span="5"]){grid-column:span 5}:host([column-span="6"]){grid-column:span 6}.ui5-form-item-root{container-type:inline-size;background-color:inherit;color:inherit}.ui5-form-item-layout{display:grid;grid-template-columns:var(--ui5-v2-14-0-form-item-layout);align-items:center}.ui5-form-item-label{padding:var(--ui5-v2-14-0-form-item-label-padding);padding-inline-end:var(--ui5-v2-14-0-form-item-label-padding-end);justify-self:var(--ui5-v2-14-0-form-item-label-justify)}.ui5-form-item-content{overflow:hidden;width:100%;display:flex;padding:0 .25rem}.ui5-form-item-content-child{padding-inline-end:.5rem;box-sizing:border-box;width:100%}:host([item-spacing="Large"]) .ui5-form-item-layout{min-height:var(--_ui5-v2-14-0_form_item_min_height);padding-top:var(--_ui5-v2-14-0_form_item_padding);padding-bottom:var(--_ui5-v2-14-0_form_item_padding);box-sizing:border-box}::slotted(*){width:100%}@container (max-width: 600px){:host{order:var(--ui5-v2-14-0-form-item-order-S, unset)}}@container (width > 600px) and (width <= 1024px){:host{order:var(--ui5-v2-14-0-form-item-order-M, unset)}}@container (width > 1024px) and (width <= 1440px){:host{order:var(--ui5-v2-14-0-form-item-order-L, unset)}}@container (min-width: 1441px){:host{order:var(--ui5-v2-14-0-form-item-order-Xl, unset)}}
`;var S=function(i,e,t,n){var a=arguments.length,o=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(i,e,t,n);else for(var m=i.length-1;m>=0;m--)(s=i[m])&&(o=(a<3?s(o):a>3?s(e,t,o):s(e,t))||o);return a>3&&o&&Object.defineProperty(e,t,o),o};let h=class extends G{constructor(){super(...arguments),this.itemSpacing="Normal"}get isGroup(){return!1}};S([r({type:Number})],h.prototype,"columnSpan",void 0);S([v()],h.prototype,"labelContent",void 0);S([v({type:HTMLElement,default:!0,individualSlots:!0})],h.prototype,"content",void 0);S([r()],h.prototype,"itemSpacing",void 0);h=S([M({tag:"ui5-form-item",renderer:R,styles:P,template:O})],h);h.define();const g=C("ui5-form-item",["columnSpan"],[],["labelContent"],[]);g.displayName="FormItem";try{g.displayName="FormItem",g.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"labelContent",required:!1,type:{name:"UI5WCSlotsNode"}},columnSpan:{defaultValue:{value:"undefined"},description:`Defines the column span of the component,
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}try{g.displayName="FormItem",g.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
one or more components (text or text fields), associated to it.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{y as F,b as a,g as b};
