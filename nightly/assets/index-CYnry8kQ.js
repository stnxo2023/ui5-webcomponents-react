import"./SuggestionItem-CRRSDxMr.js";import{w as n}from"./iframe-Ra0xSmd4.js";import"./SuggestionItemGroup-DEPCpC1O.js";const e=n("ui5-suggestion-item",["additionalText","text"],[],[],[]);e.displayName="SuggestionItem";try{e.displayName="SuggestionItem",e.__docgenInfo={description:"The `SuggestionItem` represents the suggestion item of the `Input`.\n\n__Note:__ This is a UI5 Web Component! [SuggestionItem UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/SuggestionItem) | [Repository](https://github.com/UI5/webcomponents)",displayName:"SuggestionItem",props:{additionalText:{defaultValue:{value:"undefined"},description:"Defines the `additionalText`, displayed in the end of the item.",name:"additionalText",required:!1,type:{name:"string"}},text:{defaultValue:{value:"undefined"},description:"Defines the text of the component.",name:"text",required:!1,type:{name:"string"}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
Use this prop carefully, overwriting CSS rules might break the component.`,name:"className",required:!1,type:{name:"string"}},style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
Use this prop carefully, some css properties might break the component.`,name:"style",required:!1,type:{name:"CSSProperties"}},waitForDefine:{defaultValue:null,description:`Defines whether the component should wait for the underlying custom element of the web component to be defined. This can be useful, for example, for using instance methods when mounting the component.

__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}const t=n("ui5-suggestion-item-group",["headerAccessibleName","headerText","wrappingType"],[],["header"],["move-over","move"]);t.displayName="SuggestionItemGroup";try{t.displayName="SuggestionItemGroup",t.__docgenInfo={description:"The `SuggestionItemGroup` is type of suggestion item,\nthat can be used to split the `Input` suggestions into groups.\n\n__Note:__ This is a UI5 Web Component! [SuggestionItemGroup UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/SuggestionItemGroup) | [Repository](https://github.com/UI5/webcomponents)",displayName:"SuggestionItemGroup",props:{children:{defaultValue:null,description:"Defines the items of the <code>ui5-suggestion-item-group</code>.\n\n__Supported Node Type/s:__ `Array<SuggestionListItem>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},header:{defaultValue:null,description:`Defines the header of the component.
