...
__Note:__ This is a UI5 Web Component! [Carousel UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/Carousel) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"Carousel",props:{children:{defaultValue:null,description:`Defines the content of the component.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},onNavigate:{defaultValue:null,description:`Fired whenever the page changes due to user interaction,
...
**Note:** Available since [v1.24](https://github.com/UI5/webcomponents/releases/tag/v1.24) of **@ui5/webcomponents**.`,name:"accessibleName",required:!1,type:{name:"string"}},accessibleNameRef:{defaultValue:{value:"undefined"},description:`Defines the IDs of the elements that label the input.

**Note:** Available since [v1.24](https://github.com/UI5/webcomponents/releases/tag/v1.24) of **@ui5/webcomponents**.`,name:"accessibleNameRef",required:!1,type:{name:"string"}},arrowsPlacement:{defaultValue:{value:'"Content"'},description:`Defines the position of arrows.

Available options are:

- \`Content\` - the arrows are placed on the sides of the current page.
- \`Navigation\` - the arrows are placed on the sides of the page indicator.`,name:"arrowsPlacement",required:!1,type:{name:'CarouselArrowsPlacement | "Content" | "Navigation"'}},backgroundDesign:{defaultValue:{value:'"Translucent"'},description:`Defines the carousel's background design.

**Note:** Available since [v1.14](https://github.com/UI5/webcomponents/releases/tag/v1.14) of **@ui5/webcomponents**.`,name:"backgroundDesign",required:!1,type:{name:'"Transparent" | BackgroundDesign | "Solid" | "Translucent"'}},cyclic:{defaultValue:{value:"false"},description:"Defines whether the carousel should loop, i.e show the first page after the last page is reached and vice versa.",name:"cyclic",required:!1,type:{name:"boolean"}},hideNavigationArrows:{defaultValue:{value:"false"},description:`Defines the visibility of the navigation arrows.
...
**Note:** Available since [v1.14](https://github.com/UI5/webcomponents/releases/tag/v1.14) of **@ui5/webcomponents**.`,name:"pageIndicatorBackgroundDesign",required:!1,type:{name:'"Transparent" | BackgroundDesign | "Solid" | "Translucent"'}},pageIndicatorBorderDesign:{defaultValue:{value:'"Solid"'},description:`Defines the page indicator border design.

**Note:** Available since [v1.14](https://github.com/UI5/webcomponents/releases/tag/v1.14) of **@ui5/webcomponents**.`,name:"pageIndicatorBorderDesign",required:!1,type:{name:'"None" | "Solid" | BorderDesign'}},pageIndicatorType:{defaultValue:{value:'"Default"'},description:`Defines the style of the page indicator.
Available options are:

- \`Default\` - The page indicator will be visualized as dots if there are fewer than 9 pages. If there are more pages, the page indicator will switch to displaying the current page and the total number of pages. (e.g. X of Y)
- \`Numeric\` - The page indicator will display the current page and the total number of pages. (e.g. X of Y)

**Note:** Available since [v1.10](https://github.com/UI5/webcomponents/releases/tag/v1.10) of **@ui5/webcomponents**.`,name:"pageIndicatorType",required:!1,type:{name:'"Default" | CarouselPageIndicatorType | "Numeric"'}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
