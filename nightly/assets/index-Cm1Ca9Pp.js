import"./Bar-DdbHcgPD.js";import{w as n}from"./iframe-CojmUvbr.js";const e=n("ui5-bar",["accessibleRole","design"],[],["endContent","startContent"],[]);e.displayName="Bar";try{e.displayName="Bar",e.__docgenInfo={description:`The Bar is a container which is primarily used to hold titles, buttons and input elements
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"startContent",required:!1,type:{name:"UI5WCSlotsNode"}},accessibleRole:{defaultValue:{value:'"Toolbar"'},description:`Specifies the ARIA role applied to the component for accessibility purposes.
