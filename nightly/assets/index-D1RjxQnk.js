...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function ee(){return s("div",{class:"ui5-form-item-root",children:s("div",{class:"ui5-form-item-layout",part:"layout",children:this.accessibleMode==="Edit"?te.call(this):oe.call(this)})})}function te(){return w(z,{children:[s("div",{class:"ui5-form-item-label",part:"label",children:s("slot",{name:"labelContent"})}),s("div",{class:"ui5-form-item-content",part:"content",children:this.content.map(r=>s("div",{class:"ui5-form-item-content-child",children:s("slot",{name:r._individualSlot})}))})]})}function oe(){return w(z,{children:[s("dt",{class:"ui5-form-item-label",part:"label",children:s("slot",{name:"labelContent"})}),s("dd",{class:"ui5-form-item-content",part:"content",children:this.content.map(r=>s("div",{class:"ui5-form-item-content-child",children:s("slot",{name:r._individualSlot})}))})]})}L("@ui5/webcomponents-theming","sap_horizon",async()=>$);L("@ui5/webcomponents","sap_horizon",async()=>V);const ne=`:host(:not([hidden])){display:block;width:100%}:host([column-span="1"]){grid-column:span 1}:host([column-span="2"]){grid-column:span 2}:host([column-span="3"]){grid-column:span 3}:host([column-span="4"]){grid-column:span 4}:host([column-span="5"]){grid-column:span 5}:host([column-span="6"]){grid-column:span 6}.ui5-form-item-root{container-type:inline-size;background-color:inherit;color:inherit}.ui5-form-item-layout{display:grid;grid-template-columns:var(--ui5-v2-17-0-rc-5-form-item-layout);align-items:center}.ui5-form-item-label{padding:var(--ui5-v2-17-0-rc-5-form-item-label-padding);padding-inline-end:var(--ui5-v2-17-0-rc-5-form-item-label-padding-end);justify-self:var(--ui5-v2-17-0-rc-5-form-item-label-justify)}.ui5-form-item-content{overflow:hidden;width:100%;display:flex;padding:0 .25rem}.ui5-form-item-content-child{padding-inline-end:.5rem;box-sizing:border-box;width:100%}:host([item-spacing="Large"]) .ui5-form-item-layout{min-height:var(--_ui5-v2-17-0-rc-5_form_item_min_height);padding-top:var(--_ui5-v2-17-0-rc-5_form_item_padding);padding-bottom:var(--_ui5-v2-17-0-rc-5_form_item_padding);box-sizing:border-box}::slotted(*){width:100%}@container (max-width: 600px){:host{order:var(--ui5-v2-17-0-rc-5-form-item-order-S, unset)}}@container (width > 600px) and (width <= 1024px){:host{order:var(--ui5-v2-17-0-rc-5-form-item-order-M, unset)}}@container (width > 1024px) and (width <= 1440px){:host{order:var(--ui5-v2-17-0-rc-5-form-item-order-L, unset)}}@container (min-width: 1441px){:host{order:var(--ui5-v2-17-0-rc-5-form-item-order-Xl, unset)}}dd{all:unset}
`;var y=function(r,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(r,e,t,n);else for(var u=r.length-1;u>=0;u--)(m=r[u])&&(o=(i<3?m(o):i>3?m(e,t,o):m(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let h=class extends G{constructor(){super(...arguments),this.itemSpacing="Normal",this.accessibleMode="Display"}get isGroup(){return!1}};y([a({type:Number})],h.prototype,"columnSpan",void 0);y([b()],h.prototype,"labelContent",void 0);y([b({type:HTMLElement,default:!0,individualSlots:!0})],h.prototype,"content",void 0);y([a()],h.prototype,"itemSpacing",void 0);y([a()],h.prototype,"accessibleMode",void 0);h=y([C({tag:"ui5-form-item",renderer:U,styles:ne,template:ee})],h);h.define();const T=A("ui5-form-item",["columnSpan"],[],["labelContent"],[]);T.displayName="FormItem";try{T.displayName="FormItem",T.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
