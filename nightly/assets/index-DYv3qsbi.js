import"./Tag-CRHSyhrL.js";import{w as n}from"./iframe-GIjPgZz_.js";const e=n("ui5-tag",["colorScheme","design","size","wrappingType"],["hideStateIcon","interactive"],["icon"],["click"]);e.displayName="Tag";try{e.displayName="Tag",e.__docgenInfo={description:`The \`Tag\` is a component which serves
...
**Note:** Available since [v1.22.0](https://github.com/UI5/webcomponents/releases/tag/v1.22.0) of **@ui5/webcomponents**.`,name:"design",required:!1,type:{name:"enum",value:[{value:'"Information"'},{value:'"Critical"'},{value:'"Neutral"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Set1"'},{value:'"Set2"'},{value:'"Neutral"'},{value:'"Information"'},{value:'"Positive"'},{value:'"Negative"'},{value:'"Critical"'},{value:'"Set1"'},{value:'"Set2"'}]}},hideStateIcon:{defaultValue:{value:"false"},description:`Defines if the default state icon is shown.
