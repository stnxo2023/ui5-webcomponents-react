import{w as t}from"./iframe-CJJIsx6F.js";const e=t("ui5-busy-indicator",["delay","size","text","textPlacement"],["active"],[],[]);e.displayName="BusyIndicator";try{e.displayName="BusyIndicator",e.__docgenInfo={description:`The \`BusyIndicator\` signals that some operation is going on and that the
...
__Note:__ This is a UI5 Web Component! [BusyIndicator UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/BusyIndicator) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"BusyIndicator",props:{children:{defaultValue:null,description:"Determines the content over which the component will appear.\n\n__Supported Node Type/s:__ `Array<Node>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},active:{defaultValue:{value:"false"},description:"Defines if the busy indicator is visible on the screen. By default it is not.",name:"active",required:!1,type:{name:"boolean"}},delay:{defaultValue:{value:"1000"},description:"Defines the delay in milliseconds, after which the busy indicator will be visible on the screen.",name:"delay",required:!1,type:{name:"number"}},size:{defaultValue:{value:'"M"'},description:"Defines the size of the component.",name:"size",required:!1,type:{name:'"S" | "M" | "L" | BusyIndicatorSize'}},text:{defaultValue:{value:"undefined"},description:"Defines text to be displayed below the component. It can be used to inform the user of the current operation.",name:"text",required:!1,type:{name:"string"}},textPlacement:{defaultValue:{value:'"Bottom"'},description:"Defines the placement of the text.",name:"textPlacement",required:!1,type:{name:'"Top" | "Bottom" | BusyIndicatorTextPlacement'}},className:{defaultValue:null,description:`CSS Class Name which will be appended to the most outer element of a component.
