...
__Note:__ This is a UI5 Web Component! [Panel UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/Panel) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"Panel",props:{children:{defaultValue:null,description:"Defines the content of the component. The content is visible only when the component is expanded.\n\n__Supported Node Type/s:__ `Array<Node>`",name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},header:{defaultValue:null,description:`Defines the component header area.
...
__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"header",required:!1,type:{name:"UI5WCSlotsNode"}},onToggle:{defaultValue:null,description:`Fired when the component is expanded/collapsed by user interaction.

| cancelable | bubbles |
| :--------: | :-----: |
| ❌|✅|`,name:"onToggle",required:!1,type:{name:"(event: Ui5CustomEvent<PanelDomRef, never>) => void"}},accessibleName:{defaultValue:{value:"undefined"},description:"Defines the accessible ARIA name of the component.",name:"accessibleName",required:!1,type:{name:"string"}},accessibleRole:{defaultValue:{value:'"Form"'},description:"Sets the accessible ARIA role of the component.\nDepending on the usage, you can change the role from the default `Form`\nto `Region` or `Complementary`.",name:"accessibleRole",required:!1,type:{name:'PanelAccessibleRole | "Complementary" | "Form" | "Region"'}},collapsed:{defaultValue:{value:"false"},description:"Indicates whether the component is collapsed and only the header is displayed.",name:"collapsed",required:!1,type:{name:"boolean"}},fixed:{defaultValue:{value:"false"},description:`Determines whether the component is in a fixed state that is not
expandable/collapsible by user interaction.`,name:"fixed",required:!1,type:{name:"boolean"}},headerLevel:{defaultValue:{value:'"H2"'},description:'Defines the "aria-level" of component heading,\nset by the `headerText`.',name:"headerLevel",required:!1,type:{name:'TitleLevel | "H1" | "H2" | "H3" | "H4" | "H5" | "H6"'}},headerText:{defaultValue:{value:"undefined"},description:`This property is used to set the header text of the component.
