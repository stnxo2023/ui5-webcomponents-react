...
- \`Navigation\` - the arrows are placed on the sides of the page indicator.`,name:"arrowsPlacement",required:!1,type:{name:'"Navigation" | CarouselArrowsPlacement | "Content"'}},backgroundDesign:{defaultValue:{value:'"Translucent"'},description:`Defines the carousel's background design.

**Note:** Available since [v1.14](https://github.com/UI5/webcomponents/releases/tag/v1.14) of **@ui5/webcomponents**.`,name:"backgroundDesign",required:!1,type:{name:'"Transparent" | "Solid" | BackgroundDesign | "Translucent"'}},cyclic:{defaultValue:{value:"false"},description:"Defines whether the carousel should loop, i.e show the first page after the last page is reached and vice versa.",name:"cyclic",required:!1,type:{name:"boolean"}},hideNavigationArrows:{defaultValue:{value:"false"},description:`Defines the visibility of the navigation arrows.
...
**Note:** Available since [v1.14](https://github.com/UI5/webcomponents/releases/tag/v1.14) of **@ui5/webcomponents**.`,name:"pageIndicatorBackgroundDesign",required:!1,type:{name:'"Transparent" | "Solid" | BackgroundDesign | "Translucent"'}},pageIndicatorBorderDesign:{defaultValue:{value:'"Solid"'},description:`Defines the page indicator border design.
