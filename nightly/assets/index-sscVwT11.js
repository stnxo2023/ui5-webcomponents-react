import{k as w,c as r,da as D,p as L,d as $,b as V,s as a,Q as b,aS as q,m as C,av as U,aA as G,x as _,bm as j,gx as O,w as E,gy as B,at as z}from"./iframe-D2RmpAtO.js";function P(){return w("div",{class:"ui5-form-root",role:this.effectiveAccessibleRole,"aria-label":this.effectiveAccessibleName,"aria-labelledby":this.effectiveАccessibleNameRef,children:[this.hasHeader&&r("div",{class:"ui5-form-header",part:"header",children:this.hasCustomHeader?r("slot",{name:"header"}):r(D,{id:`${this._id}-header-text`,level:this.headerLevel,children:this.headerText})}),this.hasGroupItems?k.call(this):Y.call(this)]})}function k(){return r("div",{class:"ui5-form-layout",part:"layout",children:this.groupItemsInfo.map(s=>{const e=s.groupItem;return r("div",{class:{"ui5-form-column":!0,[`ui5-form-column-spanL-${e.colsL}`]:!0,[`ui5-form-column-spanXL-${e.colsXl}`]:!0,[`ui5-form-column-spanM-${e.colsM}`]:!0,[`ui5-form-column-spanS-${e.colsS}`]:!0},part:"column",children:w("div",{class:"ui5-form-group",role:s.role,"aria-labelledby":s.accessibleNameRef,"aria-label":s.accessibleName,children:[e.headerText&&r("div",{class:"ui5-form-group-heading",children:r(D,{id:`${e._id}-group-header-text`,level:e.headerLevel,size:"H6",children:e.headerText})}),this.accessibleMode==="Edit"?r("div",{class:"ui5-form-group-layout",children:r("slot",{name:e._individualSlot})}):r("dl",{class:"ui5-form-group-layout","aria-labelledby":s.accessibleNameRefInner,"aria-label":s.accessibleNameInner,children:r("slot",{name:e._individualSlot})})]})})})})}function Y(){return this.accessibleMode==="Edit"?r("div",{class:"ui5-form-layout",part:"layout",children:X.call(this)}):r("dl",{class:"ui5-form-layout",part:"layout",children:X.call(this)})}function X(){return this.itemsInfo.map(s=>{const e=s.item;return r("div",{class:{"ui5-form-item":!0,[`ui5-form-item-span-${e.columnSpan}`]:e.columnSpan!==void 0},children:r("slot",{name:e._individualSlot})})})}L("@ui5/webcomponents-theming","sap_horizon",async()=>$);L("@ui5/webcomponents","sap_horizon",async()=>V);const Q=`@container (max-width: 600px){.ui5-form-layout{grid-template-columns:1fr}::slotted(*){justify-self:start}::slotted(:nth-child(2n)){margin-bottom:.5rem}}@container (width > 600px) and (width <= 1024px){.ui5-form-layout{grid-template-columns:1fr}:host([columns-m="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-m="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanM-2{grid-column:span 2}.ui5-form-column-spanM-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}}@container (width > 1024px) and (width <= 1440px){.ui5-form-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column{grid-template-columns:1fr}:host([columns-l="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-l="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-l="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanL-2{grid-column:span 2}.ui5-form-column-spanL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanL-3{grid-column:span 3}.ui5-form-column-spanL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}}@container (min-width: 1441px){.ui5-form-layout{grid-template-columns:repeat(3,1fr)}:host([columns-xl="1"]) .ui5-form-layout{grid-template-columns:1fr}:host([columns-xl="2"]) .ui5-form-layout{grid-template-columns:repeat(2,1fr)}:host([columns-xl="3"]) .ui5-form-layout{grid-template-columns:repeat(3,1fr)}:host([columns-xl="4"]) .ui5-form-layout{grid-template-columns:repeat(4,1fr)}:host([columns-xl="5"]) .ui5-form-layout{grid-template-columns:repeat(5,1fr)}:host([columns-xl="6"]) .ui5-form-layout{grid-template-columns:repeat(6,1fr)}.ui5-form-column-spanXL-2{grid-column:span 2}.ui5-form-column-spanXL-2 .ui5-form-group-layout{grid-template-columns:repeat(2,1fr)}.ui5-form-column-spanXL-3{grid-column:span 3}.ui5-form-column-spanXL-3 .ui5-form-group-layout{grid-template-columns:repeat(3,1fr)}.ui5-form-column-spanXL-4{grid-column:span 4}.ui5-form-column-spanXL-4 .ui5-form-group-layout{grid-template-columns:repeat(4,1fr)}.ui5-form-column-spanXL-5{grid-column:span 5}.ui5-form-column-spanXL-5 .ui5-form-group-layout{grid-template-columns:repeat(5,1fr)}.ui5-form-column-spanXL-6{grid-column:span 6}.ui5-form-column-spanXL-6 .ui5-form-group-layout{grid-template-columns:repeat(6,1fr)}}.ui5-form-item-span-2{grid-column:span 2}.ui5-form-item-span-3{grid-column:span 3}.ui5-form-item-span-4{grid-column:span 4}.ui5-form-item-span-5{grid-column:span 5}.ui5-form-item-span-6{grid-column:span 6}@container (max-width: 600px){.ui5-form-item,.ui5-form-group{--ui5-v2-18-0-form-item-layout: var(--ui5-v2-18-0-form-item-layout-S)}:host([label-span-s="12"]) .ui5-form-item,:host([label-span-s="12"]) .ui5-form-group{--ui5-v2-18-0-form-item-label-justify: var(--ui5-v2-18-0-form-item-label-justify-span12);--ui5-v2-18-0-form-item-label-padding: var(--ui5-v2-18-0-form-item-label-padding-span12)}}@container (width > 600px) and (width <= 1024px){.ui5-form-item,.ui5-form-group{--ui5-v2-18-0-form-item-layout: var(--ui5-v2-18-0-form-item-layout-M)}:host([label-span-m="12"]) .ui5-form-item,:host([label-span-m="12"]) .ui5-form-group{--ui5-v2-18-0-form-item-label-justify: var(--ui5-v2-18-0-form-item-label-justify-span12);--ui5-v2-18-0-form-item-label-padding: var(--ui5-v2-18-0-form-item-label-padding-span12)}}@container (width > 1024px) and (width <= 1440px){.ui5-form-item,.ui5-form-group{--ui5-v2-18-0-form-item-layout: var(--ui5-v2-18-0-form-item-layout-L)}:host([label-span-l="12"]) .ui5-form-item,:host([label-span-l="12"]) .ui5-form-group{--ui5-v2-18-0-form-item-label-justify: var(--ui5-v2-18-0-form-item-label-justify-span12);--ui5-v2-18-0-form-item-label-padding: var(--ui5-v2-18-0-form-item-label-padding-span12)}}@container (min-width: 1441px){.ui5-form-item,.ui5-form-group{--ui5-v2-18-0-form-item-layout: var(--ui5-v2-18-0-form-item-layout-XL)}:host([label-span-xl="12"]) .ui5-form-item,:host([label-span-xl="12"]) .ui5-form-group{--ui5-v2-18-0-form-item-label-justify: var(--ui5-v2-18-0-form-item-label-justify-span12);--ui5-v2-18-0-form-item-label-padding: var(--ui5-v2-18-0-form-item-label-padding-span12)}}:host{display:block}.ui5-form-root{display:flex;flex-direction:column;background-color:var(--sapGroup_ContentBackground);border-radius:.75rem;container-type:inline-size}.ui5-form-header{display:flex;min-height:2.75rem;align-items:center;border-bottom:1px solid var(--sapGroup_TitleBorderColor);padding:.875rem 1rem;box-sizing:border-box}.ui5-form-layout{display:grid;column-gap:1rem;row-gap:.125rem;padding:1rem .75rem}.ui5-form-group-layout{display:grid;column-gap:1rem}.ui5-form-group-heading{height:var(--_ui5-v2-18-0-form-group-heading-height);line-height:var(--_ui5-v2-18-0-form-group-heading-height);padding-inline-start:.25rem}.ui5-form-column{padding-top:.5rem;padding-bottom:1rem;box-sizing:border-box}::slotted([ui5-form-group]){display:contents}dl{all:unset}
`;var p=function(s,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,n);else for(var u=s.length-1;u>=0;u--)(m=s[u])&&(o=(i<3?m(o):i>3?m(e,t,o):m(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o},N;const F=new Map,f={S:1,M:2,L:3,XL:6},K=["S","M","L","Xl"],S=12,J="4fr 8fr 0fr",Z="1fr";let l=N=class extends G{constructor(){super(...arguments),this.accessibleMode="Display",this.layout="S1 M1 L2 XL3",this.labelSpan="S12 M4 L4 XL4",this.emptySpan="S0 M0 L0 XL0",this.headerLevel="H2",this.itemSpacing="Normal",this.columnsS=1,this.labelSpanS=12,this.emptySpanS=0,this.columnsM=1,this.labelSpanM=4,this.emptySpanM=0,this.columnsL=2,this.labelSpanL=4,this.emptySpanL=0,this.columnsXl=3,this.labelSpanXl=4,this.emptySpanXl=0}onBeforeRendering(){this.setColumnLayout(),this.setFormItemLayout(),this.setGroupsColSpan(),this.setItemsState()}onAfterRendering(){this.createAdditionalCSSStyleSheet(),this.setFastNavGroup()}setColumnLayout(){this.layout.split(" ").forEach(t=>{t.startsWith("S")?this.columnsS=parseInt(t.slice(1)):t.startsWith("M")?this.columnsM=parseInt(t.slice(1)):t.startsWith("L")?this.columnsL=parseInt(t.slice(1)):t.startsWith("XL")&&(this.columnsXl=parseInt(t.slice(2)))})}parseFormItemSpan(){this.labelSpan.split(" ").forEach(e=>{e.startsWith("S")?this.labelSpanS=parseInt(e.slice(1)):e.startsWith("M")?this.labelSpanM=parseInt(e.slice(1)):e.startsWith("L")?this.labelSpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.labelSpanXl=parseInt(e.slice(2)))}),this.emptySpan.split(" ").forEach(e=>{e.startsWith("S")?this.emptySpanS=parseInt(e.slice(1)):e.startsWith("M")?this.emptySpanM=parseInt(e.slice(1)):e.startsWith("L")?this.emptySpanL=parseInt(e.slice(1)):e.startsWith("XL")&&(this.emptySpanXl=parseInt(e.slice(2)))})}setFormItemLayout(){this.parseFormItemSpan(),[{breakpoint:"S",labelSpan:this.labelSpanS,emptySpan:this.emptySpanS},{breakpoint:"M",labelSpan:this.labelSpanM,emptySpan:this.emptySpanM},{breakpoint:"L",labelSpan:this.labelSpanL,emptySpan:this.emptySpanL},{breakpoint:"XL",labelSpan:this.labelSpanXl,emptySpan:this.emptySpanXl}].forEach(e=>{if(this.isValidFormItemLayout(e.labelSpan,e.emptySpan)){const t=e.labelSpan===S?"1fr":`${e.labelSpan}fr ${S-(e.labelSpan+e.emptySpan)}fr ${e.emptySpan}fr`;this.style.setProperty(_(`--ui5-form-item-layout-${e.breakpoint}`),t)}else console.warn(`Form :: invalid usage of emptySpan and/or labelSpan in ${e.breakpoint} size. The labelSpan must be <=12 and when emptySpace is used - their combined values must not exceed 11.`),this.style.setProperty(_(`--ui5-form-item-layout-${e.breakpoint}`),e.breakpoint==="S"?Z:J)})}isValidFormItemLayout(e,t){return t===0?e<=S:e+t<=S-1}setFastNavGroup(){this.hasGroupItems?this.removeAttribute("data-sap-ui-fastnavgroup"):this.setAttribute("data-sap-ui-fastnavgroup","true")}setGroupsColSpan(){if(!this.hasGroupItems)return;const e=this.items.length;[...this.items].sort((n,i)=>i?.items.length-n?.items.length).forEach((n,i)=>{n.colsXl=this.getGroupsColSpan(this.columnsXl,e,i,n),n.colsL=this.getGroupsColSpan(this.columnsL,e,i,n),n.colsM=this.getGroupsColSpan(this.columnsM,e,i,n),n.colsS=this.getGroupsColSpan(this.columnsS,e,i,n)})}getGroupsColSpan(e,t,n,i){if(i.columnSpan)return i.columnSpan;if(e===1||e<=t)return 1;if(e%t===0)return e/t;const o=1,m=e-t;return m<=t?n<m?o+1:o:n===0?o+(m-t)+1:o+1}setItemsState(){this.items.forEach(e=>{e.itemSpacing=this.itemSpacing,e.accessibleMode=this.accessibleMode})}get hasGroupItems(){return this.items.some(e=>e.isGroup)}get hasHeader(){return this.hasCustomHeader||this.hasHeaderText}get hasHeaderText(){return!!this.headerText}get hasCustomHeader(){return!!this.header.length}get effectiveAccessibleName(){return this.accessibleName||this.accessibleNameRef?j(this):this.hasHeader?void 0:N.i18nBundle.getText(O)}get effectiveАccessibleNameRef(){if(!(this.accessibleName||this.accessibleNameRef))return this.hasHeaderText&&!this.hasCustomHeader?`${this._id}-header-text`:void 0}get effectiveAccessibleRole(){return this.hasGroupItems?"region":"form"}get groupItemsInfo(){return this.items.map((e,t)=>{const n=this.getItemsInfo(Array.from(e.children));K.forEach(o=>{const m=e[`cols${o}`]||1,u=Math.ceil(n.length/m),g=m*u,W=m-(g-n.length)-1;let A=0;for(let v=0;v<g;v++){const R=Math.floor(v/u),H=v%u;H===u-1&&R>W||(n[A].item.style.setProperty(_(`--ui5-form-item-order-${o}`),`${R+H*m}`),A++)}});const i=e.effectiveAccessibleNameRef;return{groupItem:e,accessibleName:this.accessibleMode==="Edit"?e.getEffectiveAccessibleName(t):void 0,accessibleNameInner:this.accessibleMode==="Edit"?void 0:e.getEffectiveAccessibleName(t),accessibleNameRef:this.accessibleMode==="Edit"?i:void 0,accessibleNameRefInner:this.accessibleMode==="Edit"?void 0:i,items:this.getItemsInfo(Array.from(e.children)),role:this.accessibleMode==="Edit"?"form":void 0}})}get itemsInfo(){return this.getItemsInfo()}getItemsInfo(e){return(e||this.items).map(t=>({item:t,classes:t.columnSpan?`ui5-form-item-span-${t.columnSpan}`:"",classMap:{[`ui5-form-item-span-${t.columnSpan}`]:t.columnSpan!==void 0}}))}createAdditionalCSSStyleSheet(){[{breakpoint:"S",columns:this.columnsS},{breakpoint:"M",columns:this.columnsM},{breakpoint:"L",columns:this.columnsL},{breakpoint:"XL",columns:this.columnsXl}].forEach(e=>{const t=this.getAdditionalCSS(e.breakpoint,e.columns);t&&(this.shadowRoot.adoptedStyleSheets=[...this.shadowRoot.adoptedStyleSheets,this.getCSSStyleSheet(t)])})}getAdditionalCSS(e,t){if(f[e]>=t)return;const n=`${e}-${t}`;if(!F.has(n)){let i,o=f.S,m="",u=t;for(e==="S"?(o=f.S,i="@container (max-width: 599px) {"):e==="M"?(o=f.M,i="@container (width > 599px) and (width < 1024px) {"):e==="L"?(o=f.L,i="@container (width > 1023px) and (width < 1439px) {"):e==="XL"&&(i="@container (min-width: 1440px) {",o=f.XL);u>o;)m+=`
				...
				`,u--;const g=`${i}${m}}`;F.set(n,g)}return F.get(n)}getCSSStyleSheet(e){const t=new CSSStyleSheet;return t.replaceSync(e),t}};p([a()],l.prototype,"accessibleName",void 0);p([a()],l.prototype,"accessibleNameRef",void 0);p([a()],l.prototype,"accessibleMode",void 0);p([a()],l.prototype,"layout",void 0);p([a()],l.prototype,"labelSpan",void 0);p([a()],l.prototype,"emptySpan",void 0);p([a()],l.prototype,"headerText",void 0);p([a()],l.prototype,"headerLevel",void 0);p([a()],l.prototype,"itemSpacing",void 0);p([b({type:HTMLElement})],l.prototype,"header",void 0);p([b({type:HTMLElement,default:!0,individualSlots:!0,invalidateOnChildChange:!0})],l.prototype,"items",void 0);p([a({type:Number})],l.prototype,"columnsS",void 0);p([a({type:Number})],l.prototype,"labelSpanS",void 0);p([a({type:Number})],l.prototype,"emptySpanS",void 0);p([a({type:Number})],l.prototype,"columnsM",void 0);p([a({type:Number})],l.prototype,"labelSpanM",void 0);p([a({type:Number})],l.prototype,"emptySpanM",void 0);p([a({type:Number})],l.prototype,"columnsL",void 0);p([a({type:Number})],l.prototype,"labelSpanL",void 0);p([a({type:Number})],l.prototype,"emptySpanL",void 0);p([a({type:Number})],l.prototype,"columnsXl",void 0);p([a({type:Number})],l.prototype,"labelSpanXl",void 0);p([a({type:Number})],l.prototype,"emptySpanXl",void 0);p([q("@ui5/webcomponents")],l,"i18nBundle",void 0);l=N=p([C({tag:"ui5-form",renderer:U,styles:Q,template:P})],l);l.define();const x=E("ui5-form",["accessibleMode","accessibleName","accessibleNameRef","emptySpan","headerLevel","headerText","itemSpacing","labelSpan","layout"],[],["header"],[]);x.displayName="Form";try{x.displayName="Form",x.__docgenInfo={description:`The Form is a layout component that arranges labels and form fields (like input fields) pairs
...
to avoid "jumping" effect, caused by the hight difference between texts in "display"("non-edit") mode and the input fields in "edit" mode.`,name:"itemSpacing",required:!1,type:{name:"enum",value:[{value:'"Normal"'},{value:'"Large"'},{value:'"Normal"'},{value:'"Large"'}]}},labelSpan:{defaultValue:{value:'"S12 M4 L4 XL4"'},description:`Defines the width proportion of the labels and fields of a form item by breakpoint.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var d=function(s,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,n);else for(var u=s.length-1;u>=0;u--)(m=s[u])&&(o=(i<3?m(o):i>3?m(e,t,o):m(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o},I;let c=I=class extends G{constructor(){super(...arguments),this.headerLevel="H3",this.colsS=1,this.colsM=1,this.colsL=1,this.colsXl=1,this.itemSpacing="Normal"}onBeforeRendering(){this.processFormItems()}processFormItems(){this.items.forEach(e=>{e.itemSpacing=this.itemSpacing})}getEffectiveAccessibleName(e){if(this.accessibleName||this.accessibleNameRef)return j(this);if(!this.headerText)return I.i18nBundle.getText(B,e+1)}get effectiveAccessibleNameRef(){if(!(this.accessibleName||this.accessibleNameRef))return this.headerText?`${this._id}-group-header-text`:void 0}get isGroup(){return!0}};d([a()],c.prototype,"headerText",void 0);d([a()],c.prototype,"headerLevel",void 0);d([a({type:Number})],c.prototype,"columnSpan",void 0);d([a()],c.prototype,"accessibleName",void 0);d([a()],c.prototype,"accessibleNameRef",void 0);d([b({type:HTMLElement,default:!0})],c.prototype,"items",void 0);d([a({type:Number})],c.prototype,"colsS",void 0);d([a({type:Number})],c.prototype,"colsM",void 0);d([a({type:Number})],c.prototype,"colsL",void 0);d([a({type:Number})],c.prototype,"colsXl",void 0);d([a()],c.prototype,"itemSpacing",void 0);d([q("@ui5/webcomponents")],c,"i18nBundle",void 0);c=I=d([C({tag:"ui5-form-group",fastNavigation:!0})],c);c.define();const M=E("ui5-form-group",["accessibleName","accessibleNameRef","columnSpan","headerLevel","headerText"],[],[],[]);M.displayName="FormGroup";try{M.displayName="FormGroup",M.__docgenInfo={description:`The FormGroup (ui5-form-group) represents a group inside the Form (ui5-form) component
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function ee(){return r("div",{class:"ui5-form-item-root",children:r("div",{class:"ui5-form-item-layout",part:"layout",children:this.accessibleMode==="Edit"?te.call(this):oe.call(this)})})}function te(){return w(z,{children:[r("div",{class:"ui5-form-item-label",part:"label",children:r("slot",{name:"labelContent"})}),r("div",{class:"ui5-form-item-content",part:"content",children:this.content.map(s=>r("div",{class:"ui5-form-item-content-child",children:r("slot",{name:s._individualSlot})}))})]})}function oe(){return w(z,{children:[r("dt",{class:"ui5-form-item-label",part:"label",children:r("slot",{name:"labelContent"})}),r("dd",{class:"ui5-form-item-content",part:"content",children:this.content.map(s=>r("div",{class:"ui5-form-item-content-child",children:r("slot",{name:s._individualSlot})}))})]})}L("@ui5/webcomponents-theming","sap_horizon",async()=>$);L("@ui5/webcomponents","sap_horizon",async()=>V);const ne=`:host(:not([hidden])){display:block;width:100%}:host([column-span="1"]){grid-column:span 1}:host([column-span="2"]){grid-column:span 2}:host([column-span="3"]){grid-column:span 3}:host([column-span="4"]){grid-column:span 4}:host([column-span="5"]){grid-column:span 5}:host([column-span="6"]){grid-column:span 6}.ui5-form-item-root{container-type:inline-size;background-color:inherit;color:inherit}.ui5-form-item-layout{display:grid;grid-template-columns:var(--ui5-v2-18-0-form-item-layout);align-items:center}.ui5-form-item-label{padding:var(--ui5-v2-18-0-form-item-label-padding);padding-inline-end:var(--ui5-v2-18-0-form-item-label-padding-end);justify-self:var(--ui5-v2-18-0-form-item-label-justify)}.ui5-form-item-content{overflow:hidden;width:100%;display:flex;padding:0 .25rem}.ui5-form-item-content-child{padding-inline-end:.5rem;box-sizing:border-box;width:100%}:host([item-spacing="Large"]) .ui5-form-item-layout{min-height:var(--_ui5-v2-18-0_form_item_min_height);padding-top:var(--_ui5-v2-18-0_form_item_padding);padding-bottom:var(--_ui5-v2-18-0_form_item_padding);box-sizing:border-box}::slotted(*){width:100%}@container (max-width: 600px){:host{order:var(--ui5-v2-18-0-form-item-order-S, unset)}}@container (width > 600px) and (width <= 1024px){:host{order:var(--ui5-v2-18-0-form-item-order-M, unset)}}@container (width > 1024px) and (width <= 1440px){:host{order:var(--ui5-v2-18-0-form-item-order-L, unset)}}@container (min-width: 1441px){:host{order:var(--ui5-v2-18-0-form-item-order-Xl, unset)}}dd{all:unset}
`;var y=function(s,e,t,n){var i=arguments.length,o=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,m;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(s,e,t,n);else for(var u=s.length-1;u>=0;u--)(m=s[u])&&(o=(i<3?m(o):i>3?m(e,t,o):m(e,t))||o);return i>3&&o&&Object.defineProperty(e,t,o),o};let h=class extends G{constructor(){super(...arguments),this.itemSpacing="Normal",this.accessibleMode="Display"}get isGroup(){return!1}};y([a({type:Number})],h.prototype,"columnSpan",void 0);y([b()],h.prototype,"labelContent",void 0);y([b({type:HTMLElement,default:!0,individualSlots:!0})],h.prototype,"content",void 0);y([a()],h.prototype,"itemSpacing",void 0);y([a()],h.prototype,"accessibleMode",void 0);h=y([C({tag:"ui5-form-item",renderer:U,styles:ne,template:ee})],h);h.define();const T=E("ui5-form-item",["columnSpan"],[],["labelContent"],[]);T.displayName="FormItem";try{T.displayName="FormItem",T.__docgenInfo={description:`The FormItem (ui5-form-item) represents pair of a label and
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}export{x as F,M as a,T as b};
