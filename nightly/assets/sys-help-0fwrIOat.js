import{l as C,c,p as w,d as I,s,B as U,m as N,b6 as V,ai as L,b4 as D,b9 as q,b8 as M,w as T,a1 as z,_ as H,ag as k,f as _,ad as B}from"./iframe-m3wgL8DO.js";import{d as R}from"./parameters-bundle.css-7Zy0dxyD.js";import{S as F,a as x,b as A}from"./Search-Brwi1nH2.js";import{b8 as O,ak as P,b9 as $}from"./i18n-defaults-k5o3Svb4.js";function j(){return C("a",{class:"ui5-shellbar-branding-root",href:this.parsedRef,target:this.target,role:this._role,tabIndex:0,"aria-label":this.accessibleNameText,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:[c("span",{class:"ui5-shellbar-logo",children:c("slot",{name:"logo"})}),!this._isSBreakPoint&&c("bdi",{class:"ui5-shellbar-title",children:c("slot",{})})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>I);w("@ui5/webcomponents-fiori","sap_horizon",async()=>R);const G=`:host(:not([hidden])) .ui5-shellbar-branding-root{text-decoration:none}:host(:not([hidden])){display:inline}.ui5-shellbar-branding-root{overflow:hidden;display:flex;align-items:center;padding-block:.25rem;padding-inline:.25rem .5rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem;margin-inline-end:.5rem}.ui5-shellbar-branding-root:focus{outline:var(--_ui5-v2-16-1_shellbar_logo_outline);outline-offset:calc(-1 * var(--sapContent_FocusWidth));border-radius:var(--_ui5-v2-16-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:hover{box-shadow:var(--_ui5-v2-16-1_shellbar_button_box_shadow);border-radius:var(--_ui5-v2-16-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:active:focus{background:var(--sapShell_Active_Background);border:1px solid var(--sapButton_Lite_Active_BorderColor);color:var(--sapShell_Active_TextColor)}.ui5-shellbar-title{display:inline-block;font-family:var(--sapFontSemiboldDuplexFamily);margin:0;font-size:var(--_ui5-v2-16-1_shellbar_menu_button_title_font_size);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--sapShell_SubBrand_TextColor);margin-inline-start:.25rem}.ui5-shellbar-logo-area{overflow:hidden;display:flex;align-items:center;padding:.25rem .5rem .25rem .25rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem}::slotted([slot="logo"]){max-height:2rem;padding-inline:.25rem}::slotted([slot="logo"]):active{pointer-events:none}
`;var d=function(n,e,o,a){var r=arguments.length,t=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(r<3?l(t):r>3?l(e,o,t):l(e,o))||t);return r>3&&t&&Object.defineProperty(e,o,t),t};let p=class extends D{constructor(){super(...arguments),this._isSBreakPoint=!1}get parsedRef(){return this.href&&this.href.length>0?this.href:void 0}get _role(){return this.href&&this.href.length>0?"link":"button"}get accessibleNameText(){return this.accessibleName?this.accessibleName:this.shadowRoot?.querySelector("slot:not([name])")?.assignedNodes({flatten:!0}).find(o=>o.nodeType===Node.TEXT_NODE&&o.textContent?.trim())?.textContent.trim()}_fireClick(){this.fireDecoratorEvent("click")}_onclick(e){e.stopPropagation(),this._fireClick()}_onkeyup(e){q(e)&&this._fireClick()}_onkeydown(e){if(q(e)){e.preventDefault();return}M(e)&&this._fireClick()}};d([s()],p.prototype,"href",void 0);d([s()],p.prototype,"target",void 0);d([s()],p.prototype,"accessibleName",void 0);d([s({type:Boolean})],p.prototype,"_isSBreakPoint",void 0);d([U({type:HTMLElement,default:!0})],p.prototype,"content",void 0);d([U({type:HTMLElement})],p.prototype,"logo",void 0);p=d([N({tag:"ui5-shellbar-branding",languageAware:!0,renderer:L,template:j,styles:G}),V("click",{bubbles:!0})],p);p.define();const m=T("ui5-shellbar-branding",["accessibleName","href","target"],[],["logo"],["click"]);m.displayName="ShellBarBranding";try{m.displayName="ShellBarBranding",m.__docgenInfo={description:"The `ShellBarBranding` component is intended to be placed inside the branding slot of the\n`ShellBar` component. Its content has higher priority than the `primaryTitle` property\nand the `logo` slot of `ShellBar`.\n\n__Note:__ This is a UI5 Web Component! [ShellBarBranding UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/ShellBarBranding) | [Repository](https://github.com/UI5/webcomponents)",displayName:"ShellBarBranding",props:{children:{defaultValue:null,description:`Defines the title for the ui5-shellbar-branding component.

**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.

__Supported Node Type/s:__ \`Array<HTMLElement>\``,name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},logo:{defaultValue:null,description:"Defines the logo of the `ShellBar`.\nFor example, you can use `ui5-avatar` or `img` elements as logo.\n\n__Note:__ The content of the prop will be rendered into a [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot=\"logo\"`).\nSince you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to manually mount them as part of the component's children, especially when facing problems with the reading order of screen readers.\n\n__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the `slot` prop and appends it to the most outer element of your component.\nLearn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).\n\n__Supported Node Type/s:__ `Array<HTMLElement>`",name:"logo",required:!1,type:{name:"UI5WCSlotsNode"}},onClick:{defaultValue:null,description:`Fired, when the logo is activated.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var y=function(n,e,o,a){var r=arguments.length,t=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(r<3?l(t):r>3?l(e,o,t):l(e,o))||t);return r>3&&t&&Object.defineProperty(e,o,t),t};let h=class extends D{constructor(){super(...arguments),this.accessibilityAttributes={}}get stableDomRef(){return this.getAttribute("stable-dom-ref")||`${this._id}-stable-dom-ref`}fireClickEvent(e){return this.fireDecoratorEvent("click",{targetRef:e.target})}};y([s()],h.prototype,"icon",void 0);y([s()],h.prototype,"text",void 0);y([s()],h.prototype,"count",void 0);y([s({type:Object})],h.prototype,"accessibilityAttributes",void 0);h=y([N("ui5-shellbar-item"),V("click",{bubbles:!0,cancelable:!0})],h);h.define();const f=T("ui5-shellbar-item",["accessibilityAttributes","count","icon","text"],[],[],["click"]);f.displayName="ShellBarItem";try{f.displayName="ShellBarItem",f.__docgenInfo={description:`The \`ShellBarItem\` represents a custom item, that
might be added to the \`ShellBar\`.



__Note:__ This is a UI5 Web Component! [ShellBarItem UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/ShellBarItem) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"ShellBarItem",props:{onClick:{defaultValue:null,description:`Fired, when the item is pressed.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function K(){return F.call(this,X)}function X(){return c(k,{children:C("header",{slot:"header",class:"ui5-search-popup-searching-header",children:[c("div",{class:"ui5-shellbar-search-field-wrapper",children:x.call(this,{forceExpanded:!0})}),c(z,{design:H.Transparent,onClick:this._handleCancel,children:this.cancelButtonText})]})})}function J(){return C(k,{children:[x.call(this),K.call(this)]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>I);w("@ui5/webcomponents-fiori","sap_horizon",async()=>R);const Q=`:host(:not([collapsed])){min-width:13rem}
`;var W=function(n,e,o,a){var r=arguments.length,t=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(r<3?l(t):r>3?l(e,o,t):l(e,o))||t);return r>3&&t&&Object.defineProperty(e,o,t),t},u;let v=u=class extends A{constructor(){super(...arguments),this.autoOpen=!1}_handleSearchIconPress(){super._handleSearchIconPress(),this.collapsed?this.collapsed=!1:this.value||(this.collapsed=!0)}_onFocusOutSearch(e){_()||super._onFocusOutSearch(e)}_handleInput(e){super._handleInput(e),_()&&(this._performItemSelectionOnMobile=this._shouldPerformSelectionOnMobile(e.inputType))}get _effectiveIconTooltip(){return this.collapsed?u.i18nBundle.getText(O):this.value?u.i18nBundle.getText(P):u.i18nBundle.getText($)}get nativeInput(){const e=this.shadowRoot;return _()?e?.querySelector("[ui5-responsive-popover] input"):super.nativeInput}_onfocusin(){super._onfocusin(),this.autoOpen&&(this.open=!0,this.fireDecoratorEvent("open"))}onBeforeRendering(){super.onBeforeRendering(),_()&&(this.collapsed=!0)}};W([s({type:Boolean})],v.prototype,"autoOpen",void 0);v=u=W([N({tag:"ui5-shellbar-search",template:J,styles:[A.styles,Q]})],v);v.define();const b=T("ui5-shellbar-search",["accessibleDescription","accessibleName","placeholder","value"],["autoOpen","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);b.displayName="ShellBarSearch";try{b.displayName="ShellBarSearch",b.__docgenInfo={description:`Search field for the ShellBar component.

__Note:__ This is a UI5 Web Component! [ShellBarSearch UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/ShellBarSearch) | [Repository](https://github.com/UI5/webcomponents)`,displayName:"ShellBarSearch",props:{action:{defaultValue:null,description:`Defines the popup footer action button.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var E=function(n,e,o,a){var r=arguments.length,t=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(r<3?l(t):r>3?l(e,o,t):l(e,o))||t);return r>3&&t&&Object.defineProperty(e,o,t),t};let S=class extends D{constructor(){super(...arguments),this.visible=!1}};E([s({type:Boolean})],S.prototype,"visible",void 0);S=E([N({tag:"ui5-shellbar-spacer"})],S);S.define();const g=T("ui5-shellbar-spacer",[],[],[],[]);g.displayName="ShellBarSpacer";try{g.displayName="ShellBarSpacer",g.__docgenInfo={description:"The `ShellBarSpacer` is an element, used for visual separation between the two content parts of the `ShellBar`.\n**Note:** The `ShellBarSpacer` component is in an experimental state and is a subject to change.\n\n__Note:__ This is a UI5 Web Component! [ShellBarSpacer UI5 Web Component Documentation](https://ui5.github.io/webcomponents/components/fiori/ShellBarSpacer) | [Repository](https://github.com/UI5/webcomponents)",displayName:"ShellBarSpacer",props:{style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
