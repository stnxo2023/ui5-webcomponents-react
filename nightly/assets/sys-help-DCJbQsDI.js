import{l as C,c as p,p as S,d as I,s as r,A as U,m as N,b7 as V,ai as L,b5 as B,ba as q,b9 as z,w as T,a1 as M,_ as O,ag as k,f as _,ad as D}from"./iframe-B-pj6tCi.js";import{d as x}from"./parameters-bundle.css-MDhRcvbE.js";import{S as F,a as R,b as E}from"./Search-V8qJFGNm.js";import{b5 as H,ak as P,b6 as $}from"./i18n-defaults-BS8OTJAB.js";function j(){return C("a",{class:"ui5-shellbar-branding-root",href:this.parsedRef,target:this.target,role:this._role,tabIndex:0,"aria-label":this.accessibleNameText,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:[p("span",{class:"ui5-shellbar-logo",children:p("slot",{name:"logo"})}),!this._isSBreakPoint&&p("bdi",{class:"ui5-shellbar-title",children:p("slot",{})})]})}S("@ui5/webcomponents-theming","sap_horizon",async()=>I);S("@ui5/webcomponents-fiori","sap_horizon",async()=>x);const G=`:host(:not([hidden])) .ui5-shellbar-branding-root{text-decoration:none}:host(:not([hidden])){display:inline}.ui5-shellbar-branding-root{overflow:hidden;display:flex;align-items:center;padding-block:.25rem;padding-inline:.25rem .5rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem;margin-inline-end:.5rem}.ui5-shellbar-branding-root:focus{outline:var(--_ui5-v2-14-0_shellbar_logo_outline);border-radius:var(--_ui5-v2-14-0_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:hover{box-shadow:var(--_ui5-v2-14-0_shellbar_button_box_shadow);border-radius:var(--_ui5-v2-14-0_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:active:focus{background:var(--sapShell_Active_Background);border:1px solid var(--sapButton_Lite_Active_BorderColor);color:var(--sapShell_Active_TextColor)}.ui5-shellbar-title{display:inline-block;font-family:var(--sapFontSemiboldDuplexFamily);margin:0;font-size:var(--_ui5-v2-14-0_shellbar_menu_button_title_font_size);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--sapShell_SubBrand_TextColor);margin-inline-start:.25rem}.ui5-shellbar-logo-area{overflow:hidden;display:flex;align-items:center;padding:.25rem .5rem .25rem .25rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem}::slotted([slot="logo"]){max-height:2rem;max-width:3.75rem;pointer-events:none;padding-inline:.25rem}
`;var d=function(n,e,o,a){var i=arguments.length,t=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var s=n.length-1;s>=0;s--)(l=n[s])&&(t=(i<3?l(t):i>3?l(e,o,t):l(e,o))||t);return i>3&&t&&Object.defineProperty(e,o,t),t};let c=class extends B{constructor(){super(...arguments),this._isSBreakPoint=!1}get parsedRef(){return this.href&&this.href.length>0?this.href:void 0}get _role(){return this.href&&this.href.length>0?"link":"button"}get accessibleNameText(){return this.accessibleName?this.accessibleName:this.shadowRoot?.querySelector("slot:not([name])")?.assignedNodes({flatten:!0}).find(o=>o.nodeType===Node.TEXT_NODE&&o.textContent?.trim())?.textContent.trim()}_fireClick(){this.fireDecoratorEvent("click")}_onclick(e){e.stopPropagation(),this._fireClick()}_onkeyup(e){q(e)&&this._fireClick()}_onkeydown(e){if(q(e)){e.preventDefault();return}z(e)&&this._fireClick()}};d([r()],c.prototype,"href",void 0);d([r()],c.prototype,"target",void 0);d([r()],c.prototype,"accessibleName",void 0);d([r({type:Boolean})],c.prototype,"_isSBreakPoint",void 0);d([U({type:HTMLElement,default:!0})],c.prototype,"content",void 0);d([U({type:HTMLElement})],c.prototype,"logo",void 0);c=d([N({tag:"ui5-shellbar-branding",languageAware:!0,renderer:L,template:j,styles:G}),V("click",{bubbles:!0})],c);c.define();const m=T("ui5-shellbar-branding",["accessibleName","href","target"],[],["logo"],["click"]);m.displayName="ShellBarBranding";try{m.displayName="ShellBarBranding",m.__docgenInfo={description:"The `ShellBarBranding` component is intended to be placed inside the branding slot of the\n`ShellBar` component. Its content has higher priority than the `primaryTitle` property\nand the `logo` slot of `ShellBar`.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)",displayName:"ShellBarBranding",props:{children:{defaultValue:null,description:`Defines the title for the ui5-shellbar-branding component.

**Note:** Although this slot accepts HTML Elements, it is strongly recommended that you only use text in order to preserve the intended design.`,name:"children",required:!1,type:{name:"ReactNode | ReactNode[]"}},logo:{defaultValue:null,description:"Defines the logo of the `ShellBar`.\nFor example, you can use `ui5-avatar` or `img` elements as logo.\n\n__Note:__ The content of the prop will be rendered into a [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot=\"logo\"`).\nSince you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to manually mount them as part of the component's children, especially when facing problems with the reading order of screen readers.\n\n__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the `slot` prop and appends it to the most outer element of your component.\nLearn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).",name:"logo",required:!1,type:{name:"UI5WCSlotsNode"}},onClick:{defaultValue:null,description:`Fired, when the logo is activated.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var y=function(n,e,o,a){var i=arguments.length,t=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var s=n.length-1;s>=0;s--)(l=n[s])&&(t=(i<3?l(t):i>3?l(e,o,t):l(e,o))||t);return i>3&&t&&Object.defineProperty(e,o,t),t};let h=class extends B{constructor(){super(...arguments),this.accessibilityAttributes={}}get stableDomRef(){return this.getAttribute("stable-dom-ref")||`${this._id}-stable-dom-ref`}fireClickEvent(e){return this.fireDecoratorEvent("click",{targetRef:e.target})}};y([r()],h.prototype,"icon",void 0);y([r()],h.prototype,"text",void 0);y([r()],h.prototype,"count",void 0);y([r({type:Object})],h.prototype,"accessibilityAttributes",void 0);h=y([N("ui5-shellbar-item"),V("click",{bubbles:!0,cancelable:!0})],h);h.define();const f=T("ui5-shellbar-item",["accessibilityAttributes","count","icon","text"],[],[],["click"]);f.displayName="ShellBarItem";try{f.displayName="ShellBarItem",f.__docgenInfo={description:`The \`ShellBarItem\` represents a custom item, that
might be added to the \`ShellBar\`.



__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"ShellBarItem",props:{onClick:{defaultValue:null,description:`Fired, when the item is pressed.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function K(){return F.call(this,X)}function X(){return p(k,{children:C("header",{slot:"header",class:"ui5-search-popup-searching-header",children:[p("div",{class:"ui5-shellbar-search-field-wrapper",children:R.call(this,{forceExpanded:!0})}),p(M,{design:O.Transparent,onClick:this._handleCancel,children:this.cancelButtonText})]})})}function J(){return C(k,{children:[R.call(this),K.call(this)]})}S("@ui5/webcomponents-theming","sap_horizon",async()=>I);S("@ui5/webcomponents-fiori","sap_horizon",async()=>x);const Q=`:host(:not([collapsed])){min-width:13rem}
`;var W=function(n,e,o,a){var i=arguments.length,t=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var s=n.length-1;s>=0;s--)(l=n[s])&&(t=(i<3?l(t):i>3?l(e,o,t):l(e,o))||t);return i>3&&t&&Object.defineProperty(e,o,t),t},u;let v=u=class extends E{constructor(){super(...arguments),this.autoOpen=!1}_handleSearchIconPress(){super._handleSearchIconPress(),this.collapsed?this.collapsed=!1:this.value||(this.collapsed=!0)}_onFocusOutSearch(e){_()||super._onFocusOutSearch(e)}_handleInput(e){super._handleInput(e),_()&&(this._performItemSelectionOnMobile=this._shouldPerformSelectionOnMobile(e.inputType))}get _effectiveIconTooltip(){return this.collapsed?u.i18nBundle.getText(H):this.value?u.i18nBundle.getText(P):u.i18nBundle.getText($)}get nativeInput(){const e=this.shadowRoot;return _()?e?.querySelector("[ui5-responsive-popover] input"):super.nativeInput}_onfocusin(){super._onfocusin(),this.autoOpen&&(this.open=!0,this.fireDecoratorEvent("open"))}onBeforeRendering(){super.onBeforeRendering(),_()&&(this.collapsed=!0)}};W([r({type:Boolean})],v.prototype,"autoOpen",void 0);v=u=W([N({tag:"ui5-shellbar-search",template:J,styles:[E.styles,Q]})],v);v.define();const b=T("ui5-shellbar-search",["accessibleDescription","accessibleName","placeholder","value"],["autoOpen","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);b.displayName="ShellBarSearch";try{b.displayName="ShellBarSearch",b.__docgenInfo={description:`Search field for the ShellBar component.

__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)`,displayName:"ShellBarSearch",props:{action:{defaultValue:null,description:`Defines the popup footer action button.
...
**Note:** Available since [v2.11.0](https://github.com/UI5/webcomponents/releases/tag/v2.11.0) of **@ui5/webcomponents-fiori**.`,name:"filterButton",required:!1,type:{name:"UI5WCSlotsNode"}},illustration:{defaultValue:null,description:`Defines the illustrated message to be shown in the popup.
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"illustration",required:!1,type:{name:"UI5WCSlotsNode"}},messageArea:{defaultValue:null,description:`Defines the illustrated message to be shown in the popup.
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"messageArea",required:!1,type:{name:"UI5WCSlotsNode"}},scopes:{defaultValue:null,description:`Defines the component scope options.
...
__Note:__ When passing a custom React component to this prop, you have to make sure your component reads the \`slot\` prop and appends it to the most outer element of your component.
Learn more about it [here](https://ui5.github.io/webcomponents-react/v2/?path=/docs/knowledge-base-handling-slots--docs).`,name:"scopes",required:!1,type:{name:"UI5WCSlotsNode"}},onClose:{defaultValue:null,description:`Fired when the popup is closed.
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}var A=function(n,e,o,a){var i=arguments.length,t=i<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var s=n.length-1;s>=0;s--)(l=n[s])&&(t=(i<3?l(t):i>3?l(e,o,t):l(e,o))||t);return i>3&&t&&Object.defineProperty(e,o,t),t};let w=class extends B{constructor(){super(...arguments),this.visible=!1}};A([r({type:Boolean})],w.prototype,"visible",void 0);w=A([N({tag:"ui5-shellbar-spacer"})],w);w.define();const g=T("ui5-shellbar-spacer",[],[],[],[]);g.displayName="ShellBarSpacer";try{g.displayName="ShellBarSpacer",g.__docgenInfo={description:"The `ShellBarSpacer` is an element, used for visual separation between the two content parts of the `ShellBar`.\n**Note:** The `ShellBarSpacer` component is in an experimental state and is a subject to change.\n\n__Note__: This is a UI5 Web Component! [Repository](https://github.com/UI5/webcomponents) | [Documentation](https://ui5.github.io/webcomponents/)",displayName:"ShellBarSpacer",props:{style:{defaultValue:null,description:`Element style which will be appended to the most outer element of a component.
