import{l as C,c,p as w,d as I,s,A as U,m as N,b6 as V,ai as L,b4 as D,b9 as q,b8 as M,w as T,a1 as z,_ as H,ag as k,f as _,ad as B}from"./iframe-dhwXAt1u.js";import{d as x}from"./parameters-bundle.css-C9hTgWv9.js";import{S as O,a as A,b as R}from"./Search-BZevM6nx.js";import{b8 as F,ak as P,b9 as $}from"./i18n-defaults-DGnw9SAb.js";function j(){return C("a",{class:"ui5-shellbar-branding-root",href:this.parsedRef,target:this.target,role:this._role,tabIndex:0,"aria-label":this.accessibleNameText,onClick:this._onclick,onKeyDown:this._onkeydown,onKeyUp:this._onkeyup,children:[c("span",{class:"ui5-shellbar-logo",children:c("slot",{name:"logo"})}),!this._isSBreakPoint&&c("bdi",{class:"ui5-shellbar-title",children:c("slot",{})})]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>I);w("@ui5/webcomponents-fiori","sap_horizon",async()=>x);const G=`:host(:not([hidden])) .ui5-shellbar-branding-root{text-decoration:none}:host(:not([hidden])){display:inline}.ui5-shellbar-branding-root{overflow:hidden;display:flex;align-items:center;padding-block:.25rem;padding-inline:.25rem .5rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem;margin-inline-end:.5rem}.ui5-shellbar-branding-root:focus{outline:var(--_ui5-v2-15-1_shellbar_logo_outline);border-radius:var(--_ui5-v2-15-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:hover{box-shadow:var(--_ui5-v2-15-1_shellbar_button_box_shadow);border-radius:var(--_ui5-v2-15-1_shellbar_logo_border_radius)}.ui5-shellbar-branding-root:active:focus{background:var(--sapShell_Active_Background);border:1px solid var(--sapButton_Lite_Active_BorderColor);color:var(--sapShell_Active_TextColor)}.ui5-shellbar-title{display:inline-block;font-family:var(--sapFontSemiboldDuplexFamily);margin:0;font-size:var(--_ui5-v2-15-1_shellbar_menu_button_title_font_size);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--sapShell_SubBrand_TextColor);margin-inline-start:.25rem}.ui5-shellbar-logo-area{overflow:hidden;display:flex;align-items:center;padding:.25rem .5rem .25rem .25rem;box-sizing:border-box;cursor:pointer;background:var(--sapButton_Lite_Background);border:1px solid var(--sapButton_Lite_BorderColor);color:var(--sapShell_TextColor);margin-inline-start:.125rem}::slotted([slot="logo"]){max-height:2rem;max-width:3.75rem;pointer-events:none;padding-inline:.25rem}
...
__Note:__ This adds a rendering cycle to your component.`,name:"waitForDefine",required:!1,type:{name:"boolean"}}}}}catch{}function K(){return O.call(this,X)}function X(){return c(k,{children:C("header",{slot:"header",class:"ui5-search-popup-searching-header",children:[c("div",{class:"ui5-shellbar-search-field-wrapper",children:A.call(this,{forceExpanded:!0})}),c(z,{design:H.Transparent,onClick:this._handleCancel,children:this.cancelButtonText})]})})}function J(){return C(k,{children:[A.call(this),K.call(this)]})}w("@ui5/webcomponents-theming","sap_horizon",async()=>I);w("@ui5/webcomponents-fiori","sap_horizon",async()=>x);const Q=`:host(:not([collapsed])){min-width:13rem}
`;var W=function(n,e,o,a){var r=arguments.length,t=r<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,o):a,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,o,a);else for(var i=n.length-1;i>=0;i--)(l=n[i])&&(t=(r<3?l(t):r>3?l(e,o,t):l(e,o))||t);return r>3&&t&&Object.defineProperty(e,o,t),t},u;let v=u=class extends R{constructor(){super(...arguments),this.autoOpen=!1}_handleSearchIconPress(){super._handleSearchIconPress(),this.collapsed?this.collapsed=!1:this.value||(this.collapsed=!0)}_onFocusOutSearch(e){_()||super._onFocusOutSearch(e)}_handleInput(e){super._handleInput(e),_()&&(this._performItemSelectionOnMobile=this._shouldPerformSelectionOnMobile(e.inputType))}get _effectiveIconTooltip(){return this.collapsed?u.i18nBundle.getText(F):this.value?u.i18nBundle.getText(P):u.i18nBundle.getText($)}get nativeInput(){const e=this.shadowRoot;return _()?e?.querySelector("[ui5-responsive-popover] input"):super.nativeInput}_onfocusin(){super._onfocusin(),this.autoOpen&&(this.open=!0,this.fireDecoratorEvent("open"))}onBeforeRendering(){super.onBeforeRendering(),_()&&(this.collapsed=!0)}};W([s({type:Boolean})],v.prototype,"autoOpen",void 0);v=u=W([N({tag:"ui5-shellbar-search",template:J,styles:[R.styles,Q]})],v);v.define();const b=T("ui5-shellbar-search",["accessibleDescription","accessibleName","placeholder","value"],["autoOpen","loading","noTypeahead","open","showClearIcon"],["action","filterButton","illustration","messageArea","scopes"],["close","input","open","scope-change","search"]);b.displayName="ShellBarSearch";try{b.displayName="ShellBarSearch",b.__docgenInfo={description:`Search field for the ShellBar component.
