...
| `sortType`              | `string` OR<br/> `((rowA, rowB, columnId: string, descending: boolean)`<br />`=> number)` | String or custom **memoized** sort function.<br />Supported String Values: <ul><li>`basic`</li><li>`datetime`</li><li>`alphanumeric`</li></ul>**Default:**`'alphanumeric'`                                                                                                                                                                                                                                                                                                                                      |
