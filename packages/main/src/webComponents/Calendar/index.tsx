...
interface CalendarPropTypes
  extends
    ...
    Omit<
      CommonProps,
      keyof CalendarAttributes | 'calendarLegend' | 'children' | 'disabledDates' | 'specialDates' | 'onSelectionChange'
    > {
  /**
...
const Calendar = withWebComponent<CalendarPropTypes, CalendarDomRef>(
  ...
  ['hideWeekNumbers'],
  ['calendarLegend', 'disabledDates', 'specialDates'],
  ['selection-change'],
);
