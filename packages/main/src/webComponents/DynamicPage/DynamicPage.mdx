...
- Adding a `ResizeObserver` to measure the title/header wrapper (`.ui5-dynamic-page-title-header-wrapper`) inside the shadow root of the component.
...
<ArgTypesWithNote metaOf={ComponentStories} of={DynamicPageHeader} />

## DynamicPageTitle

<Description of={DynamicPageTitle} />
<ArgTypesWithNote metaOf={ComponentStories} of={DynamicPageTitle} />
