...
import { Option, OptionCustom, OptionGroup } from '../index.ts';
import SubcomponentsSection from '@sb/docs/SubcomponentsSection.md?raw';
import * as ComponentStories from './Select.stories';

<Meta of={ComponentStories} />

<DocsHeader of={ComponentStories} since="0.4.0" mergeSubComponents subComponents={['OptionCustom', 'OptionGroup']} />
...
You can group options by wrapping them in `OptionGroup` components. Use the `headerText` prop to define the group's header.

<Canvas of={ComponentStories.WithOptionGroups} />
...
<ArgTypesWithNote metaOf={ComponentStories} of={Option} />

## OptionCustom

<Description of={OptionCustom} />
<ArgTypesWithNote metaOf={ComponentStories} of={OptionCustom} />

## OptionGroup

<Description of={OptionGroup} />
<ArgTypesWithNote metaOf={ComponentStories} of={OptionGroup} />
