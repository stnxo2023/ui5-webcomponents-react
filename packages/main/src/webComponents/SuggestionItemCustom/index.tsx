...
interface SuggestionItemCustomPropTypes
  extends
    SuggestionItemCustomAttributes,
    Omit<CommonProps, keyof SuggestionItemCustomAttributes | 'children' | 'onClick'> {
  /**
   ...
   * | ❌|✅|
   */
  onClick?: (event: Ui5CustomEvent<SuggestionItemCustomDomRef, ListItemBaseClickEventDetail>) => void;
}
